...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tS3Connection_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tS3Connection_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.temp_path+"/configUpdated.txt")).getAbsolutePath().replace("\\","/");
...
out1_tmp.value = row5.key.equals("fechaFin") ? TalendDate.formatDate("yyyy-MM-dd",TalendDate.getCurrentDate()) : row2.value ;
out1 = out1_tmp;
// ###############################
...
public void tS3Connection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_2 = context.SecretAccessKey; 
            ...
            com.amazonaws.auth.AWSCredentials credentials_tS3Connection_2 = new com.amazonaws.auth.BasicAWSCredentials(context.AccessKeyId,decryptedPassword_tS3Connection_2);
            com.amazonaws.auth.AWSCredentialsProvider credentialsProvider_tS3Connection_2 = new com.amazonaws.auth.AWSStaticCredentialsProvider(credentials_tS3Connection_2);
		...
		cc_tS3Connection_2.setUserAgent("APN/1.0 Talend/8.0 Studio/8.0 (Talend Open Studio)");
            ...
            com.amazonaws.services.s3.AmazonS3ClientBuilder builder_tS3Connection_2 = com.amazonaws.services.s3.AmazonS3ClientBuilder.standard();
        ...
        if(useRegionEndpoint_tS3Connection_2 && regionEndpoint_tS3Connection_2 != null && !regionEndpoint_tS3Connection_2.isEmpty()) {
                builder_tS3Connection_2.withEndpointConfiguration(new com.amazonaws.client.builder.AwsClientBuilder.EndpointConfiguration(regionEndpoint_tS3Connection_2,null))
        ...
        builder_tS3Connection_2.withCredentials(credentialsProvider_tS3Connection_2).withClientConfiguration(cc_tS3Connection_2);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Connection_2:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String millisecTime_tS3Put_1 = null;
		...
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Put_1 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_2");
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/configUpdated.txt";
...
row2Struct row2 = new row2Struct();
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// source node:tSampleRow_1 - inputs:(row1) outputs:(row2,row2) | target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = UpdateConfigFileContext.class.getClassLoader().getResourceAsStream("pacifico/updateconfigfilecontext_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = UpdateConfigFileContext.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : UpdateConfigFileContext");
        }
...
if (execStat) {
    ...
    private void closeS3Connections() {
        try {
    	com.amazonaws.services.s3.AmazonS3Client conn_tS3Connection_2 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_2");
...
/************************************************************************************************
 *     128563 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:45:40 PM CST
 ************************************************************************************************/