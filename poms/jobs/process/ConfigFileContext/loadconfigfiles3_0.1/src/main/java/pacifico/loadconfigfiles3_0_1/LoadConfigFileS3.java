...
package pacifico.loadconfigfiles3_0_1;
...
/**
 * Job: LoadConfigFileS3 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class LoadConfigFileS3 implements TalendJob {
	...
	private final String jobName = "LoadConfigFileS3";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LoadConfigFileS3.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LoadConfigFileS3.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/config.txt";
	...
	public static void main(String[] args) {
		final LoadConfigFileS3 LoadConfigFileS3Class = new LoadConfigFileS3();

		int exitCode = LoadConfigFileS3Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadConfigFileS3.class.getClassLoader()
					.getResourceAsStream("pacifico/loadconfigfiles3_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = LoadConfigFileS3.class.getClassLoader()
		...
		} catch (TalendException e_tS3Connection_2) {
			globalMap.put("tS3Connection_2_SUBPROCESS_STATE", -1);

			e_tS3Connection_2.printStackTrace();
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadConfigFileS3");
		}
...
/************************************************************************************************
 * 43330 characters generated by Talend Open Studio for Data Integration on the
 * January 25, 2023 at 11:20:00 PM CST
 ************************************************************************************************/