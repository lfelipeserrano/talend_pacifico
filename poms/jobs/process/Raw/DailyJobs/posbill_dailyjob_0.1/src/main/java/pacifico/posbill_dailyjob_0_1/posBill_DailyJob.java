...
///////////////////////    			
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:b+4h13WVJeAstSe/VvPpHjfMyZbdyPl5ZBP1cQqVvXzKs9k94w==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM pos_bill where create_date between '" + context.fechaInicio
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.value != null) {
							sb_tFileOutputDelimited_1
									.append(row1.value.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
///////////////////////		
						...
						if (row2.name != null) { //
							row_tLogRow_1[1] = String.valueOf(row2.name);

						} //

						if (row2.value != null) { //
							row_tLogRow_1[2] = row2.value.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString();

						} //

						if (row2.create_uid != null) { //
							row_tLogRow_1[3] = String.valueOf(row2.create_uid);

						} //

						if (row2.create_date != null) { //
							row_tLogRow_1[4] = FormatterUtils.format_Date(row2.create_date, "dd-MM-yyyy");

						} //

						if (row2.write_uid != null) { //
							row_tLogRow_1[5] = String.valueOf(row2.write_uid);

						} //

						if (row2.write_date != null) { //
							row_tLogRow_1[6] = FormatterUtils.format_Date(row2.write_date, "dd-MM-yyyy");
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = posBill_DailyJob.class.getClassLoader()
					.getResourceAsStream("pacifico/posbill_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = posBill_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : posBill_DailyJob");
		}
...
/************************************************************************************************
 * 95859 characters generated by Talend Open Studio for Data Integration on the
 * January 26, 2023 at 12:01:23 AM CST
 ************************************************************************************************/