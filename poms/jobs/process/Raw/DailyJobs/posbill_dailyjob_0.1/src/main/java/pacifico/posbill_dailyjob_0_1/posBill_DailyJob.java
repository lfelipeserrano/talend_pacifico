...
package pacifico.posbill_dailyjob_0_1;
...
/**
 * Job: posBill_DailyJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class posBill_DailyJob implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "posBill_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				posBill_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(posBill_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_posBill_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_posBill_DailyJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_posBill_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_posBill_DailyJob.length == 0) {
   					commonByteArray_PACIFICO_posBill_DailyJob = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_posBill_DailyJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_posBill_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_posBill_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_posBill_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_posBill_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_posBill_DailyJob) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DxF5Zyd+0sGGH6gdO8C/6DIZSFMCUkq+rQ/xMfByaWwbrPBV7A==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM pos_bill where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
            ...
            row1.value = rs_tDBInput_1.getBigDecimal(3);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.create_uid = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.create_uid = null;
            }
		                    }
			...
			row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.write_uid = null;
							} else {
		                          
            row1.write_uid = rs_tDBInput_1.getInt(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.write_uid = null;
            }
		                    }
			...
			row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(row1.value != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.value.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posBill_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final posBill_DailyJob posBill_DailyJobClass = new posBill_DailyJob();

        int exitCode = posBill_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = posBill_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/posbill_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = posBill_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : posBill_DailyJob");
        }
...
/************************************************************************************************
 *     92193 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:45 PM CST
 ************************************************************************************************/