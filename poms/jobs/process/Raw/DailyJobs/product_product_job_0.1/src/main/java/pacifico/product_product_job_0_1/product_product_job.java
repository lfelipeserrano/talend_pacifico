...
package pacifico.product_product_job_0_1;
...
/**
 * Job: product_product_job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class product_product_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "product_product_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				product_product_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(product_product_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_product_product_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_product_product_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_product_product_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_product_product_job.length == 0) {
   					commonByteArray_PACIFICO_product_product_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_product_product_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_product_product_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_product_product_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_product_product_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_product_product_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_product_product_job) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:u3MEfXKEYVv8Sjyp8j8zHx9AGUiziPh6lZ4wBL0afwhExARrQA==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM product_product where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
        	...
        	row1.default_code = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.active = null;
							} else {
	                         		
            row1.active = rs_tDBInput_1.getBoolean(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.active = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.product_tmpl_id = 0;
							} else {
		                          
            row1.product_tmpl_id = rs_tDBInput_1.getInt(5);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.barcode = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.combination_indices = null;
							} else {
	                         		
        	row1.combination_indices = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.volume = null;
							} else {
		                          
            row1.volume = rs_tDBInput_1.getBigDecimal(8);
            if(rs_tDBInput_1.wasNull()){
                    row1.volume = null;
            }
		                    }
            ...
            row1.weight = rs_tDBInput_1.getBigDecimal(9);
            if(rs_tDBInput_1.wasNull()){
                    row1.weight = null;
            }
		                    }
            ...
            row1.can_image_variant_1024_be_zoomed = rs_tDBInput_1.getBoolean(10);
            if(rs_tDBInput_1.wasNull()){
                    row1.can_image_variant_1024_be_zoomed = null;
            }
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.combination_indices != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.combination_indices
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.volume != null) {
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.can_image_variant_1024_be_zoomed != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.can_image_variant_1024_be_zoomed
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productProduct_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final product_product_job product_product_jobClass = new product_product_job();

        int exitCode = product_product_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = product_product_job.class.getClassLoader().getResourceAsStream("pacifico/product_product_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = product_product_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_product_job");
        }
...
/************************************************************************************************
 *     103477 characters generated by Talend Open Studio for Data Integration 
