...
package pacifico.pos_order_line_job_0_1;
...
/**
 * Job: pos_order_line_job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class pos_order_line_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "pos_order_line_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				pos_order_line_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(pos_order_line_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_pos_order_line_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_pos_order_line_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_pos_order_line_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_pos_order_line_job.length == 0) {
   					commonByteArray_PACIFICO_pos_order_line_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_pos_order_line_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_pos_order_line_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_pos_order_line_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_pos_order_line_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_pos_order_line_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_pos_order_line_job) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6eBiSYDCPwZkJNGjDUlYEWhWz4McZEW70Dg5zkDH8nM22SQ4nQ==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM pos_order_line where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(row1.qty != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.qty.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.price_subtotal_incl.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.sale_order_origin_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.sale_order_line_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.sale_order_line_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.down_payment_details != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.down_payment_details
                        );
                            }
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posOrderLine_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final pos_order_line_job pos_order_line_jobClass = new pos_order_line_job();

        int exitCode = pos_order_line_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = pos_order_line_job.class.getClassLoader().getResourceAsStream("pacifico/pos_order_line_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = pos_order_line_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_order_line_job");
        }
...
/************************************************************************************************
 *     113652 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:18:50 PM CST
 ************************************************************************************************/