...
public class pos_payment_job implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:tSbilN3ftsz8HyT1GcAzpxKoSnmYN8ipuS2BxRNG/vmF3trtmQ==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:YGhwIpd6Ad7IQwuC4lZ/vG52RraDu5hqkKRgTRprMam6RJ8AouuoCUHoC5OYwLnVJdGOq5xzcSYuNstni81hKup8dAA=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "posPayment_20221031.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pos_payment_job.class.getClassLoader()
					.getResourceAsStream("pacifico/pos_payment_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pos_payment_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_payment_job");
		}
...
/************************************************************************************************
 * 86046 characters generated by Talend Open Studio for Data Integration on the
 * December 9, 2022 at 1:03:46 AM CST
 ************************************************************************************************/