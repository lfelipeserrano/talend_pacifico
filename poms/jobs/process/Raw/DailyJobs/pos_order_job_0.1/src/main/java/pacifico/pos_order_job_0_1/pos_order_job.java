 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:vVzVI60Gk3ayhh/N/lHqcKWABaWLyUaPjJJjn/WjjC3l3Bk9KA==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM pos_order where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = pos_order_job.class.getClassLoader().getResourceAsStream("pacifico/pos_order_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = pos_order_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_order_job");
        }
...
/************************************************************************************************
 *     125613 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:42 PM CST
 ************************************************************************************************/