 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9N38G/nAAYxj6J4cuW+InEvcsZ5VGzSmUIifUTlGUgOZf1/EWg==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM sale_order where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "saleOrder_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = sale_order_job.class.getClassLoader().getResourceAsStream("pacifico/sale_order_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = sale_order_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : sale_order_job");
        }
...
/************************************************************************************************
 *     145601 characters generated by Talend Open Studio for Data Integration 
