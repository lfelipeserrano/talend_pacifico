...
public class productAttributeValue_DailyJob implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(productAttributeValue_DailyJob.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:CE0IpKPbdXH6Z4wmct5xCo65YSDivJ0gv5kBahJaOh0mShbEng==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.is_custom != null) {
							sb_tFileOutputDelimited_1.append(row1.is_custom);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.html_color != null) {
							sb_tFileOutputDelimited_1.append(row1.html_color);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.color != null) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:wjUvJ3qcdqniIp5ubpM73QjpF0f/TBJN2/keDsdghzgFeqVNDV3E2bjzAD8VX8pXuFigtD75mtpvZuZEwOnKkBJkxro=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttributeValue.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = productAttributeValue_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/productattributevalue_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = productAttributeValue_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : productAttributeValue_DailyJob");
		}
...
/************************************************************************************************
 * 76460 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:40:05 PM CST
 ************************************************************************************************/