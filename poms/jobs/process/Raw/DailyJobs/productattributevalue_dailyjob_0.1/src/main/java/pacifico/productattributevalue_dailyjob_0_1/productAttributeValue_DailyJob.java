...
package pacifico.productattributevalue_dailyjob_0_1;
...
/**
 * Job: productAttributeValue_DailyJob Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class productAttributeValue_DailyJob implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "productAttributeValue_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				productAttributeValue_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(productAttributeValue_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_productAttributeValue_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_productAttributeValue_DailyJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_productAttributeValue_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_productAttributeValue_DailyJob.length == 0) {
   					commonByteArray_PACIFICO_productAttributeValue_DailyJob = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_productAttributeValue_DailyJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_productAttributeValue_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_productAttributeValue_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_productAttributeValue_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_productAttributeValue_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_productAttributeValue_DailyJob) {
			        ...
			        this.attribute_id = dis.readInt();
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.is_custom = dis.readBoolean();
           				}
					
					this.html_color = readString(dis);
					...
					// Boolean
						...
						if(this.is_custom == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeBoolean(this.is_custom);
		            	}
					
					// String
				
						writeString(this.html_color,dos);
    ...
    public String toString() {
		...
		sb.append(",is_custom="+String.valueOf(is_custom));
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp_path+"/productAttributeValue.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("attribute_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("is_custom");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("html_color");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:HZt0wQCHJq4s7oHmNMxCp9goGV3ZZmyYKuJa64go7uV/mb71tQ==");
...
+"\"sequence\", \n  \"product_attribute_value\".\"attribute_id\", \n  \"product_attribute_value\".\"is_custom\", \n  \"produc"
+"t_attribute_value\".\"html_color\", \n  \"product_attribute_value\".\"color\", \n  \"product_attribute_value\".\"create_ui"
+"d\", \n  \"product_attribute_value\".\"create_date\", \n  \"product_attribute_value\".\"write_uid\", \n  \"product_attribut"
+"e_value\".\"write_date\"\nFROM \"product_attribute_value\"";
            ...
            row1.sequence = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    row1.sequence = null;
            }
		                    }
            ...
            row1.attribute_id = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.is_custom = rs_tDBInput_1.getBoolean(5);
            if(rs_tDBInput_1.wasNull()){
                    row1.is_custom = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.html_color = null;
							} else {
	                         		
        	row1.html_color = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.color = null;
							} else {
		                          
            row1.color = rs_tDBInput_1.getInt(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.color = null;
            }
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.is_custom != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.is_custom
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.html_color != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.html_color
                        );
                            }
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productAttributeValue.csv";
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/productAttributeValue.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final productAttributeValue_DailyJob productAttributeValue_DailyJobClass = new productAttributeValue_DailyJob();

        int exitCode = productAttributeValue_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = productAttributeValue_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/productattributevalue_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = productAttributeValue_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : productAttributeValue_DailyJob");
        }
...
/************************************************************************************************
 *     78414 characters generated by Talend Open Studio for Data Integration 
