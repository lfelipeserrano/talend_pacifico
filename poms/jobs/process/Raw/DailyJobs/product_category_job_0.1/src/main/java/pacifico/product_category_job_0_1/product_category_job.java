...
package pacifico.product_category_job_0_1;
...
/**
 * Job: product_category_job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class product_category_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "product_category_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				product_category_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(product_category_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_product_category_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_product_category_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_product_category_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_product_category_job.length == 0) {
   					commonByteArray_PACIFICO_product_category_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_product_category_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_product_category_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_product_category_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_product_category_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_product_category_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_product_category_job) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.write_date = readDate(dis);
						...
						this.removal_strategy_id = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.removal_strategy_id,dos);
    ...
    public String toString() {
		...
		sb.append(",removal_strategy_id="+String.valueOf(removal_strategy_id));
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:49LjTuKo50KRQdzd6HZsBjsJnHSgMu4gr9uoRyz/knAMMKyTeg==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM product_category where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.complete_name = null;
							} else {
	                         		
        	row1.complete_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.parent_id = null;
							} else {
		                          
            row1.parent_id = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.parent_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.parent_path = null;
							} else {
	                         		
        	row1.parent_path = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.create_uid = null;
							} else {
		                          
            row1.create_uid = rs_tDBInput_1.getInt(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.create_uid = null;
            }
		                    }
			...
			row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.write_uid = null;
							} else {
		                          
            row1.write_uid = rs_tDBInput_1.getInt(8);
            if(rs_tDBInput_1.wasNull()){
                    row1.write_uid = null;
            }
		                    }
			...
			row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 9);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.removal_strategy_id = null;
							} else {
		                          
            row1.removal_strategy_id = rs_tDBInput_1.getInt(10);
            if(rs_tDBInput_1.wasNull()){
                    row1.removal_strategy_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.packaging_reserve_method = null;
							} else {
	                         		
        	row1.packaging_reserve_method = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.removal_strategy_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.removal_strategy_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.packaging_reserve_method != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.packaging_reserve_method
                        );
                            }
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productCategory_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final product_category_job product_category_jobClass = new product_category_job();

        int exitCode = product_category_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = product_category_job.class.getClassLoader().getResourceAsStream("pacifico/product_category_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = product_category_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_category_job");
        }
...
/************************************************************************************************
 *     97429 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:47 PM CST
 ************************************************************************************************/