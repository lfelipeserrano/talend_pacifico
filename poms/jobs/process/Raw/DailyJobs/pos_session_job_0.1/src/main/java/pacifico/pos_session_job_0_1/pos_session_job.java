 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:cOR3WVl4KjJj/LUUo9dYprIusSgavm7/nQVOQU5Phm4wO0q2Sw==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM pos_session where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posSession_" + context.fechaFin.replaceAll("-","") +".csv";
...
/************************************************************************************************
 *     115130 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:44 PM CST
 ************************************************************************************************/