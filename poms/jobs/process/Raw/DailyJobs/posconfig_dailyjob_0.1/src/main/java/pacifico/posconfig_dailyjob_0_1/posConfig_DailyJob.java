...
package pacifico.posconfig_dailyjob_0_1;
...
/**
 * Job: posConfig_DailyJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class posConfig_DailyJob implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "posConfig_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				posConfig_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(posConfig_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_posConfig_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_posConfig_DailyJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_posConfig_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_posConfig_DailyJob.length == 0) {
   					commonByteArray_PACIFICO_posConfig_DailyJob = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_posConfig_DailyJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_posConfig_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_posConfig_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_posConfig_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_posConfig_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_posConfig_DailyJob) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9qeSAxSXXkH2pj57/S7pTjEIcFRO7kDy/dOODOgQqA5U2TCqjQ==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM pos_config where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posConfig_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final posConfig_DailyJob posConfig_DailyJobClass = new posConfig_DailyJob();

        int exitCode = posConfig_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = posConfig_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/posconfig_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = posConfig_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : posConfig_DailyJob");
        }
...
/************************************************************************************************
 *     211747 characters generated by Talend Open Studio for Data Integration 
