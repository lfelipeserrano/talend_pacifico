...
package pacifico.productattributeproducttemplaterel_dailyjob_0_1;
...
/**
 * Job: productAttributeProductTemplateRel_DailyJob Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class productAttributeProductTemplateRel_DailyJob implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "productAttributeProductTemplateRel_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				productAttributeProductTemplateRel_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(productAttributeProductTemplateRel_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_productAttributeProductTemplateRel_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_productAttributeProductTemplateRel_DailyJob = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.product_attribute_id;
						
							result = prime * result + (int) this.product_template_id;
	...
	public boolean equals(Object obj) {
		...
		final row1Struct other = (row1Struct) obj;
						...
						if (this.product_attribute_id != other.product_attribute_id)
							return false;
					
						if (this.product_template_id != other.product_template_id)
							return false;
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_productAttributeProductTemplateRel_DailyJob) {

        	try {

        		int length = 0;
		
			        this.product_attribute_id = dis.readInt();
					
			        this.product_template_id = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.product_attribute_id);
					
					// int
				
		            	dos.writeInt(this.product_template_id);
    ...
    public int compareTo(row1Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.product_attribute_id, other.product_attribute_id);
						if(returnValue != 0) {
							return returnValue;
						}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp_path+"/productAttributeProductTemplateRel.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5UcvEocFOlNL7T9Tfmd3WnMYfYu16jsZRNsVKyR3z03CGqqbJQ==");
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.product_attribute_id = 0;
							} else {
		                          
            row1.product_attribute_id = rs_tDBInput_1.getInt(1);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.product_template_id = 0;
							} else {
		                          
            row1.product_template_id = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        sb_tFileOutputDelimited_1.append(
                            row1.product_attribute_id
                        );
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        sb_tFileOutputDelimited_1.append(
                            row1.product_template_id
                        );
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productAttributeProductTemplateRel.csv";
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/productAttributeProductTemplateRel.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final productAttributeProductTemplateRel_DailyJob productAttributeProductTemplateRel_DailyJobClass = new productAttributeProductTemplateRel_DailyJob();

        int exitCode = productAttributeProductTemplateRel_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = productAttributeProductTemplateRel_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/productattributeproducttemplaterel_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = productAttributeProductTemplateRel_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : productAttributeProductTemplateRel_DailyJob");
        }
...
/************************************************************************************************
 *     64314 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:18:56 PM CST
 ************************************************************************************************/