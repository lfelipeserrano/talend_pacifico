 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5oZ4QzRBE4A1X8eKAhrmr2n2b/Zr4QFsn3h8Sp9rZGQZqWu7lQ==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM res_country where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "resCountry_" + context.fechaFin.replaceAll("-","") +".csv";
...
/************************************************************************************************
 *     103438 characters generated by Talend Open Studio for Data Integration 
