...
package pacifico.res_partner_job_0_1;
...
/**
 * Job: res_partner_job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class res_partner_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "res_partner_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				res_partner_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(res_partner_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_res_partner_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_res_partner_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_res_partner_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_res_partner_job.length == 0) {
   					commonByteArray_PACIFICO_res_partner_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_res_partner_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_res_partner_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_res_partner_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_res_partner_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_res_partner_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_res_partner_job) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:iHwJHC8Qc+Ak75/gYxWdfZN0UCJthJAhCMr9yMM6CiiyEg9QZw==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM res_partner where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.commercial_partner_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.commercial_company_name != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.commercial_company_name
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.signup_expiration, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.additional_info
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.phone_sanitized != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.phone_sanitized
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row1.last_time_entries_checked, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "resPartner_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final res_partner_job res_partner_jobClass = new res_partner_job();

        int exitCode = res_partner_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = res_partner_job.class.getClassLoader().getResourceAsStream("pacifico/res_partner_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = res_partner_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : res_partner_job");
        }
...
/************************************************************************************************
 *     163275 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:53 PM CST
 ************************************************************************************************/