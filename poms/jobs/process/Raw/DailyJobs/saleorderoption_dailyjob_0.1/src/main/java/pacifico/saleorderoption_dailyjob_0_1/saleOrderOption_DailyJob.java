...
package pacifico.saleorderoption_dailyjob_0_1;
...
/**
 * Job: saleOrderOption_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class saleOrderOption_DailyJob implements TalendJob {
	...
	private final String jobName = "saleOrderOption_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					saleOrderOption_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(saleOrderOption_DailyJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_saleOrderOption_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_saleOrderOption_DailyJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_saleOrderOption_DailyJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_saleOrderOption_DailyJob.length == 0) {
						commonByteArray_PACIFICO_saleOrderOption_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_saleOrderOption_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_saleOrderOption_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_saleOrderOption_DailyJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_saleOrderOption_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_saleOrderOption_DailyJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_saleOrderOption_DailyJob) {
...
///////////////////////    			
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("line_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:As917/OPzqOyXhgzdok6jyJ7J4RZKBT0gPE5bGBPoIcwPu4XXg==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM \"sale_order_option\" where \"create_date\" >= '2022-05-27' OR \"write_date\" >= '2022-05-27'";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.line_id = rs_tDBInput_1.getInt(3);
							if (rs_tDBInput_1.wasNull()) {
								row1.line_id = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row1.discount = rs_tDBInput_1.getBigDecimal(7);
							if (rs_tDBInput_1.wasNull()) {
								row1.discount = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.uom_id = rs_tDBInput_1.getInt(8);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							row1.quantity = rs_tDBInput_1.getBigDecimal(9);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							...
							row1.sequence = rs_tDBInput_1.getInt(10);
							if (rs_tDBInput_1.wasNull()) {
								row1.sequence = null;
							}
						}
						...
						if (row1.line_id != null) {
							sb_tFileOutputDelimited_1.append(row1.line_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.name != null) {
						...
						if (row1.quantity != null) {
							sb_tFileOutputDelimited_1
									.append(row1.quantity.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
///////////////////////		
						...
						if (row2.order_id != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.order_id));
						...
						if (row2.line_id != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.line_id));
						...
						strBuffer_tLogRow_1.append(String.valueOf(row2.product_id));
						...
						if (row2.price_unit != null) { //
							...
							strBuffer_tLogRow_1.append(
									row2.price_unit.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						...
						if (row2.discount != null) { //
							...
							strBuffer_tLogRow_1
									.append(row2.discount.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());

						} //

						strBuffer_tLogRow_1.append("|");

						strBuffer_tLogRow_1.append(String.valueOf(row2.uom_id));
						...
						if (row2.quantity != null) { //
							...
							strBuffer_tLogRow_1
									.append(row2.quantity.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						...
						if (row2.sequence != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.sequence));
						...
						if (row2.create_uid != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.create_uid));
						...
						if (row2.create_date != null) { //
							...
							strBuffer_tLogRow_1.append(FormatterUtils.format_Date(row2.create_date, "dd-MM-yyyy"));
						...
						if (row2.write_uid != null) { //
							...
							strBuffer_tLogRow_1.append(String.valueOf(row2.write_uid));
						...
						if (row2.write_date != null) { //
							...
							strBuffer_tLogRow_1.append(FormatterUtils.format_Date(row2.write_date, "dd-MM-yyyy"));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final saleOrderOption_DailyJob saleOrderOption_DailyJobClass = new saleOrderOption_DailyJob();

		int exitCode = saleOrderOption_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = saleOrderOption_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/saleorderoption_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = saleOrderOption_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : saleOrderOption_DailyJob");
		}
...
/************************************************************************************************
 * 104974 characters generated by Talend Open Studio for Data Integration on the
 * January 26, 2023 at 11:46:11 PM CST
 ************************************************************************************************/