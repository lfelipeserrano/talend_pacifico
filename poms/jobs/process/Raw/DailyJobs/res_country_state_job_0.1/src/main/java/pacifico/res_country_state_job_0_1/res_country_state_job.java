...
package pacifico.res_country_state_job_0_1;
...
/**
 * Job: res_country_state_job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class res_country_state_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "res_country_state_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				res_country_state_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(res_country_state_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_res_country_state_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_res_country_state_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_res_country_state_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_res_country_state_job.length == 0) {
   					commonByteArray_PACIFICO_res_country_state_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_res_country_state_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_res_country_state_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_res_country_state_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_res_country_state_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_res_country_state_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_res_country_state_job) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aoesecl+qojvoRQFzUsgwOYmA5z3XHVZQLqsDu0LSwdTdhvp7A==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM res_country_state where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
            ...
            row1.country_id = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.code = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.create_uid = null;
							} else {
		                          
            row1.create_uid = rs_tDBInput_1.getInt(5);
            if(rs_tDBInput_1.wasNull()){
                    row1.create_uid = null;
            }
		                    }
            ...
            row1.write_uid = rs_tDBInput_1.getInt(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.write_uid = null;
            }
		                    }
			...
			row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 8);
		                    }
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "resCountryState_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final res_country_state_job res_country_state_jobClass = new res_country_state_job();

        int exitCode = res_country_state_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = res_country_state_job.class.getClassLoader().getResourceAsStream("pacifico/res_country_state_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = res_country_state_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : res_country_state_job");
        }
...
/************************************************************************************************
 *     93212 characters generated by Talend Open Studio for Data Integration 
