 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:SehRxw7gJp+fF6oG/4imPQqYJF9iwim48TMafuwPovhPCFS1qQ==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM product_template where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.description_purchase
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.description_sale != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.description_sale
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(row1.volume != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.volume.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.weight != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.weight.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.can_image_1024_be_zoomed
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.has_configurable_attributes != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.has_configurable_attributes
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.description_picking
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.description_pickingout != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.description_pickingout
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.description_pickingin != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.description_pickingin
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.available_in_pos != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.available_in_pos
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productTemplate_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = product_template.class.getClassLoader().getResourceAsStream("pacifico/product_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = product_template.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_template");
        }
...
/************************************************************************************************
 *     141864 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:18:52 PM CST
 ************************************************************************************************/