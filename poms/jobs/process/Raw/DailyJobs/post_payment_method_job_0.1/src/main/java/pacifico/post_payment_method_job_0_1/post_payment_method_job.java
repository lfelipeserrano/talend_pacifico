...
package pacifico.post_payment_method_job_0_1;
...
/**
 * Job: post_payment_method_job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class post_payment_method_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "post_payment_method_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				post_payment_method_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(post_payment_method_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_post_payment_method_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_post_payment_method_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_post_payment_method_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_post_payment_method_job.length == 0) {
   					commonByteArray_PACIFICO_post_payment_method_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_post_payment_method_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_post_payment_method_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_post_payment_method_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_post_payment_method_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_post_payment_method_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_post_payment_method_job) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    public String loopKey;
			    ...
			    public Integer outstanding_account_id;

				public Integer getOutstanding_account_id () {
					return this.outstanding_account_id;
				}
				
			    public Integer receivable_account_id;

				public Integer getReceivable_account_id () {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.name = readString(dis);
						...
						this.outstanding_account_id = readInteger(dis);
					
						this.receivable_account_id = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.outstanding_account_id,dos);
					
					// Integer
				
						writeInteger(this.receivable_account_id,dos);
    ...
    public String toString() {
		...
		sb.append(",name="+name);
		sb.append(",outstanding_account_id="+String.valueOf(outstanding_account_id));
		sb.append(",receivable_account_id="+String.valueOf(receivable_account_id));
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3Zj0zmqz9/KKD8HpKJREljCELR6cH0/x7H0eK2opMKPFteNVbw==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM pos_payment_method  where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.outstanding_account_id = null;
							} else {
		                          
            row1.outstanding_account_id = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    row1.outstanding_account_id = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.receivable_account_id = null;
							} else {
		                          
            row1.receivable_account_id = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.receivable_account_id = null;
            }
		                    }
            ...
            row1.is_cash_count = rs_tDBInput_1.getBoolean(5);
            if(rs_tDBInput_1.wasNull()){
                    row1.is_cash_count = null;
            }
		                    }
            ...
            row1.journal_id = rs_tDBInput_1.getInt(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.journal_id = null;
            }
		                    }
            ...
            row1.split_transactions = rs_tDBInput_1.getBoolean(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.split_transactions = null;
            }
		                    }
            ...
            if(rs_tDBInput_1.wasNull()){
                    row1.company_id = null;
							...
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.use_payment_terminal = null;
							} else {
	                         		
        	row1.use_payment_terminal = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.active = null;
							} else {
	                         		
            row1.active = rs_tDBInput_1.getBoolean(10);
            if(rs_tDBInput_1.wasNull()){
                    row1.active = null;
            }
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.outstanding_account_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.outstanding_account_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.receivable_account_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.receivable_account_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.is_cash_count != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.is_cash_count
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.split_transactions != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.split_transactions
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.use_payment_terminal != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.use_payment_terminal
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.active != null) {
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posPaymentMethod_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final post_payment_method_job post_payment_method_jobClass = new post_payment_method_job();

        int exitCode = post_payment_method_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = post_payment_method_job.class.getClassLoader().getResourceAsStream("pacifico/post_payment_method_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = post_payment_method_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : post_payment_method_job");
        }
...
/************************************************************************************************
 *     103963 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:49 PM CST
 ************************************************************************************************/