...
package pacifico.product_attribute_job_0_1;
...
/**
 * Job: product_attribute_job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class product_attribute_job implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "product_attribute_job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				product_attribute_job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(product_attribute_job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_product_attribute_job = new byte[0];
    static byte[] commonByteArray_PACIFICO_product_attribute_job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_product_attribute_job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_product_attribute_job.length == 0) {
   					commonByteArray_PACIFICO_product_attribute_job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_product_attribute_job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_product_attribute_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_product_attribute_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_product_attribute_job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_product_attribute_job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_product_attribute_job) {
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:QYUjbcH9UaOAUa7expSspuD+NdvVDLhzDZ3LmpK0NpHw81yEXw==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT * FROM product_attribute where create_date between '" + context.fechaInicio + "' and '" + context.fechaFin + "' OR  write_date between '" + context.fechaInicio + "' and '" + context.fechaFin +"'";
            ...
            if(rs_tDBInput_1.wasNull()){
                    row1.sequence = null;
							...
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.create_variant = null;
							} else {
	                         		
        	row1.create_variant = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.display_type = null;
							} else {
	                         		
        	row1.display_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productAttribute_" + context.fechaFin.replaceAll("-","") +".csv";
 ...
 */
    ...
    public static void main(String[] args){
        final product_attribute_job product_attribute_jobClass = new product_attribute_job();

        int exitCode = product_attribute_jobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = product_attribute_job.class.getClassLoader().getResourceAsStream("pacifico/product_attribute_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = product_attribute_job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_attribute_job");
        }
...
/************************************************************************************************
 *     94622 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:44:48 PM CST
 ************************************************************************************************/