 ...
 * @status
 */
public class LoadCsv implements TalendJob {
	...
	private final String jobName = "LoadCsv";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LoadCsv.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.accounttax_job_0_1.accountTax_Job childJob_tRunJob_1 = new pacifico.accounttax_job_0_1.accountTax_Job();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.posbill_job_0_1.posBill_Job childJob_tRunJob_2 = new pacifico.posbill_job_0_1.posBill_Job();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.posconfig_job_0_1.posConfig_Job childJob_tRunJob_3 = new pacifico.posconfig_job_0_1.posConfig_Job();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleorder_job_0_1.saleOrder_Job childJob_tRunJob_4 = new pacifico.saleorder_job_0_1.saleOrder_Job();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleorderoption_job_0_1.saleOrderOption_Job childJob_tRunJob_5 = new pacifico.saleorderoption_job_0_1.saleOrderOption_Job();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplate_job_0_1.saleOrderTemplate_Job childJob_tRunJob_6 = new pacifico.saleordertemplate_job_0_1.saleOrderTemplate_Job();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplateline_job_0_1.saleOrderTemplateLine_Job childJob_tRunJob_7 = new pacifico.saleordertemplateline_job_0_1.saleOrderTemplateLine_Job();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplateoption_job_0_1.saleOrderTemplateOption_Job childJob_tRunJob_8 = new pacifico.saleordertemplateoption_job_0_1.saleOrderTemplateOption_Job();
				// pass DataSources
	...
	public static void main(String[] args) {
		final LoadCsv LoadCsvClass = new LoadCsv();

		int exitCode = LoadCsvClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LoadCsv.class.getClassLoader()
					.getResourceAsStream("pacifico/loadcsv_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = LoadCsv.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LoadCsv");
		}
...
/************************************************************************************************
 * 79695 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:10:04 PM CST
 ************************************************************************************************/