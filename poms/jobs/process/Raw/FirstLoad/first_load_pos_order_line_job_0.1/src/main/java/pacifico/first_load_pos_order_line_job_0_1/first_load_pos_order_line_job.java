...
package pacifico.first_load_pos_order_line_job_0_1;
...
/**
 * Job: first_load_pos_order_line_job Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class first_load_pos_order_line_job implements TalendJob {
	...
	private final String jobName = "first_load_pos_order_line_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_pos_order_line_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_pos_order_line_job.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_pos_order_line_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_pos_order_line_job = new byte[0];
		...
		public BigDecimal price_subtotal_incl;
		...
		public Integer refunded_orderline_id;

		public Integer getRefunded_orderline_id() {
		...
		public Integer sale_order_origin_id;

		public Integer getSale_order_origin_id() {
			return this.sale_order_origin_id;
		}

		public Integer sale_order_line_id;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_pos_order_line_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_pos_order_line_job.length == 0) {
						commonByteArray_PACIFICO_first_load_pos_order_line_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_pos_order_line_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_pos_order_line_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_pos_order_line_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_pos_order_line_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_pos_order_line_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_pos_order_line_job) {
				...
				try {
					...
					this.price_subtotal_incl = (BigDecimal) dis.readObject();

					this.total_cost = (BigDecimal) dis.readObject();
					...
					this.refunded_orderline_id = readInteger(dis);
					...
					this.sale_order_origin_id = readInteger(dis);

					this.sale_order_line_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.price_subtotal_incl);

				// BigDecimal

				dos.writeObject(this.total_cost);
				...
				writeInteger(this.refunded_orderline_id, dos);
				...
				writeInteger(this.sale_order_origin_id, dos);

				// Integer

				writeInteger(this.sale_order_line_id, dos);
		...
		public String toString() {
			...
			sb.append(",refunded_orderline_id=" + String.valueOf(refunded_orderline_id));
			...
			sb.append(",sale_order_origin_id=" + String.valueOf(sale_order_origin_id));
			sb.append(",sale_order_line_id=" + String.valueOf(sale_order_line_id));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:wWiaeiA9u/AZZGjQCX6VosPP3Yt4mwikAmxwLNo08v3wjGyPDw==");
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"pos_order_line\".\"id\", \n  \"pos_order_line\".\"company_id\", \n  \"pos_order_line\".\"name\", \n  \"pos_ord"
						+ "er_line\".\"notice\", \n  \"pos_order_line\".\"product_id\", \n  \"pos_order_line\".\"price_unit\", \n  \"pos_order_line\"."
						+ "\"qty\", \n  \"pos_order_line\".\"price_subtotal\", \n  \"pos_order_line\".\"price_subtotal_incl\", \n  \"pos_order_line\"."
						+ "\"total_cost\", \n  \"pos_order_line\".\"is_total_cost_computed\", \n  \"pos_order_line\".\"discount\", \n  \"pos_order_lin"
						+ "e\".\"order_id\", \n  \"pos_order_line\".\"full_product_name\", \n  \"pos_order_line\".\"customer_note\", \n  \"pos_order_l"
						+ "ine\".\"refunded_orderline_id\", \n  \"pos_order_line\".\"create_uid\", \n  \"pos_order_line\".\"create_date\", \n  \"pos_o"
						+ "rder_line\".\"write_uid\", \n  \"pos_order_line\".\"write_date\", \n  \"pos_order_line\".\"sale_order_origin_id\", \n  \"po"
						+ "s_order_line\".\"sale_order_line_id\", \n  \"pos_order_line\".\"down_payment_details\"\nFROM \"pos_order_line\"";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.company_id = rs_tDBInput_1.getInt(2);
							if (rs_tDBInput_1.wasNull()) {
								row1.company_id = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.notice = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row1.qty = rs_tDBInput_1.getBigDecimal(7);
							if (rs_tDBInput_1.wasNull()) {
								row1.qty = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.price_subtotal = rs_tDBInput_1.getBigDecimal(8);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							row1.price_subtotal_incl = rs_tDBInput_1.getBigDecimal(9);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row1.total_cost = null;
						} else {

							row1.total_cost = rs_tDBInput_1.getBigDecimal(10);
							if (rs_tDBInput_1.wasNull()) {
								row1.total_cost = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							...
							row1.is_total_cost_computed = rs_tDBInput_1.getBoolean(11);
							if (rs_tDBInput_1.wasNull()) {
								row1.is_total_cost_computed = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_1 < 13) {
							...
							row1.order_id = rs_tDBInput_1.getInt(13);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							row1.full_product_name = null;
						} else {

							row1.full_product_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							row1.customer_note = null;
						} else {

							row1.customer_note = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
						}
						if (colQtyInRs_tDBInput_1 < 16) {
							row1.refunded_orderline_id = null;
						} else {

							row1.refunded_orderline_id = rs_tDBInput_1.getInt(16);
							if (rs_tDBInput_1.wasNull()) {
								row1.refunded_orderline_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 17) {
							...
							row1.create_uid = rs_tDBInput_1.getInt(17);
							if (rs_tDBInput_1.wasNull()) {
								row1.create_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 18) {
							...
							row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 18);
						}
						if (colQtyInRs_tDBInput_1 < 19) {
							row1.write_uid = null;
						} else {

							row1.write_uid = rs_tDBInput_1.getInt(19);
							if (rs_tDBInput_1.wasNull()) {
								row1.write_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 20) {
							...
							row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 20);
						}
						if (colQtyInRs_tDBInput_1 < 21) {
							row1.sale_order_origin_id = null;
						} else {

							row1.sale_order_origin_id = rs_tDBInput_1.getInt(21);
							if (rs_tDBInput_1.wasNull()) {
								row1.sale_order_origin_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 22) {
							row1.sale_order_line_id = null;
						} else {

							row1.sale_order_line_id = rs_tDBInput_1.getInt(22);
							if (rs_tDBInput_1.wasNull()) {
								row1.sale_order_line_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 23) {
							row1.down_payment_details = null;
						} else {

							row1.down_payment_details = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, false);
						}
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.notice != null) {
							sb_tFileOutputDelimited_1.append(row1.notice);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.product_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.price_unit != null) {
							sb_tFileOutputDelimited_1.append(row1.price_unit);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.qty != null) {
							sb_tFileOutputDelimited_1
									.append(row1.qty.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.price_subtotal_incl != null) {
							sb_tFileOutputDelimited_1.append(row1.price_subtotal_incl
									.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.total_cost != null) {
							sb_tFileOutputDelimited_1.append(
									row1.total_cost.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.is_total_cost_computed != null) {
							sb_tFileOutputDelimited_1.append(row1.is_total_cost_computed);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.full_product_name != null) {
							sb_tFileOutputDelimited_1.append(row1.full_product_name);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.customer_note != null) {
							sb_tFileOutputDelimited_1.append(row1.customer_note);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.refunded_orderline_id != null) {
							sb_tFileOutputDelimited_1.append(row1.refunded_orderline_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.sale_order_origin_id != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_order_origin_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_order_line_id != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_order_line_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.down_payment_details != null) {
							sb_tFileOutputDelimited_1.append(row1.down_payment_details);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:PTkLLO27if8PbXAwqkwEzrY9xrbXf2AFGLgavrzH7WRY5IU83zJUQwP14RY4nPmoP40e132Iis+e4pfCqi7/gLUZAVc=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "posOrderLine_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_pos_order_line_job first_load_pos_order_line_jobClass = new first_load_pos_order_line_job();

		int exitCode = first_load_pos_order_line_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_pos_order_line_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_pos_order_line_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_pos_order_line_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_pos_order_line_job");
		}
...
/************************************************************************************************
 * 95215 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 9:41:26 PM CST
 ************************************************************************************************/