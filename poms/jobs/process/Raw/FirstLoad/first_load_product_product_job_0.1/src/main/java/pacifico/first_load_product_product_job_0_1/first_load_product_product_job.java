...
package pacifico.first_load_product_product_job_0_1;
...
/**
 * Job: first_load_product_product_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_product_product_job implements TalendJob {
	...
	private final String jobName = "first_load_product_product_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_product_product_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_product_product_job.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_product_product_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_product_product_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_product_product_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_product_product_job.length == 0) {
						commonByteArray_PACIFICO_first_load_product_product_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_product_product_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_product_product_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_product_product_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_product_product_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_product_product_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_product_product_job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kDAeK0nuPiPeM7J7Azf22eFyH/70qB+Dkv07EQTyKgzv08ha7Q==");
				...
				String dbquery_tDBInput_1 = "select * from product_product";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.product_tmpl_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.combination_indices != null) {
							sb_tFileOutputDelimited_1.append(row1.combination_indices);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.volume != null) {
						...
						if (row1.can_image_variant_1024_be_zoomed != null) {
							sb_tFileOutputDelimited_1.append(row1.can_image_variant_1024_be_zoomed);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:lJDrO41kT4sWIKIE5bTbtgJAxtoEz3Kx9hQqcShOQZsxhW+4BXAOByISKIj/8glFIB3pICkPo7pSq3fsiJ7e+PaXrCs=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "productProduct_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_product_product_job first_load_product_product_jobClass = new first_load_product_product_job();

		int exitCode = first_load_product_product_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_product_product_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_product_product_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_product_product_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_product_product_job");
		}
...
/************************************************************************************************
 * 81714 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:04:00 PM CST
 ************************************************************************************************/