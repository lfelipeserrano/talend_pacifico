...
package pacifico.masterjob_0_1;
 ...
 * @status
 */
public class MasterJob implements TalendJob {
	...
	private final String jobName = "MasterJob";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MasterJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.rawmasterjob_0_1.RawMasterJob childJob_tRunJob_1 = new pacifico.rawmasterjob_0_1.RawMasterJob();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.main_stage_job_daily_0_1.main_stage_job_daily childJob_tRunJob_2 = new pacifico.main_stage_job_daily_0_1.main_stage_job_daily();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.presentationmasterjob_0_1.PresentationMasterJob childJob_tRunJob_3 = new pacifico.presentationmasterjob_0_1.PresentationMasterJob();
				// pass DataSources
	...
	public static void main(String[] args) {
		final MasterJob MasterJobClass = new MasterJob();

		int exitCode = MasterJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MasterJob.class.getClassLoader()
					.getResourceAsStream("pacifico/masterjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MasterJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MasterJob");
		}
...
/************************************************************************************************
 * 44008 characters generated by Talend Open Studio for Data Integration on the
 * January 30, 2023 at 11:20:00 PM CST
 ************************************************************************************************/