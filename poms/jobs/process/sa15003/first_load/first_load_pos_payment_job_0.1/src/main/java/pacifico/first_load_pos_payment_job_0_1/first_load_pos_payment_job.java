...
package pacifico.first_load_pos_payment_job_0_1;
...
/**
 * Job: first_load_pos_payment_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_pos_payment_job implements TalendJob {
	...
	private final String jobName = "first_load_pos_payment_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_pos_payment_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_pos_payment_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_pos_payment_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_pos_payment_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_pos_payment_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_pos_payment_job.length == 0) {
						commonByteArray_PACIFICO_first_load_pos_payment_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_pos_payment_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_pos_payment_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_pos_payment_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_pos_payment_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_pos_payment_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_pos_payment_job) {
				...
				try {
					...
					this.pos_order_id = dis.readInt();

					this.amount = (BigDecimal) dis.readObject();

					this.payment_method_id = dis.readInt();
					...
					this.account_move_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.pos_order_id);
				...
				dos.writeInt(this.payment_method_id);
				...
				writeInteger(this.account_move_id, dos);
		...
		public String toString() {
			...
			sb.append(",account_move_id=" + String.valueOf(account_move_id));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:qv4YY5Ut3LCAU1kRXpK+FvV2o+6wBmd84FcDpxG18QDK/IG2RA==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM pos_payment";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.pos_order_id = rs_tDBInput_1.getInt(3);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.amount = rs_tDBInput_1.getBigDecimal(4);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row1.payment_method_id = 0;
						} else {

							row1.payment_method_id = rs_tDBInput_1.getInt(5);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row1.payment_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row1.session_id = null;
						} else {

							row1.session_id = rs_tDBInput_1.getInt(7);
							if (rs_tDBInput_1.wasNull()) {
								row1.session_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.company_id = rs_tDBInput_1.getInt(8);
							if (rs_tDBInput_1.wasNull()) {
								row1.company_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							row1.card_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row1.cardholder_name = null;
						} else {

							row1.cardholder_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row1.transaction_id = null;
						} else {

							row1.transaction_id = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							row1.payment_status = null;
						} else {

							row1.payment_status = routines.system.JDBCUtil.getString(rs_tDBInput_1, 12, false);
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							row1.ticket = null;
						} else {

							row1.ticket = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							row1.is_change = null;
						} else {

							row1.is_change = rs_tDBInput_1.getBoolean(14);
							if (rs_tDBInput_1.wasNull()) {
								row1.is_change = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							row1.account_move_id = null;
						} else {

							row1.account_move_id = rs_tDBInput_1.getInt(15);
							if (rs_tDBInput_1.wasNull()) {
								row1.account_move_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 16) {
							...
							row1.create_uid = rs_tDBInput_1.getInt(16);
							if (rs_tDBInput_1.wasNull()) {
								row1.create_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 17) {
							...
							row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 17);
						}
						if (colQtyInRs_tDBInput_1 < 18) {
							row1.write_uid = null;
						} else {

							row1.write_uid = rs_tDBInput_1.getInt(18);
							if (rs_tDBInput_1.wasNull()) {
								row1.write_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 19) {
							...
							row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 19);
						}
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.pos_order_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.amount != null) {
							sb_tFileOutputDelimited_1
									.append(row1.amount.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.payment_date != null) {
							sb_tFileOutputDelimited_1
									.append(FormatterUtils.format_Date(row1.payment_date, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.session_id != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.card_type != null) {
							sb_tFileOutputDelimited_1.append(row1.card_type);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.cardholder_name != null) {
							sb_tFileOutputDelimited_1.append(row1.cardholder_name);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.transaction_id != null) {
							sb_tFileOutputDelimited_1.append(row1.transaction_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.payment_status != null) {
							sb_tFileOutputDelimited_1.append(row1.payment_status);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.ticket != null) {
							sb_tFileOutputDelimited_1.append(row1.ticket);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.is_change != null) {
							sb_tFileOutputDelimited_1.append(row1.is_change);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.account_move_id != null) {
							sb_tFileOutputDelimited_1.append(row1.account_move_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:L4ivq+G8EXeg2STmWZDX52uLVrQsj1eP/mU8JMEeyrnhDlxEy1wLzItzwUuRJwrOBA4A89TMBLO0BYWSvC8k6HCfGKo=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "posPayment_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_pos_payment_job first_load_pos_payment_jobClass = new first_load_pos_payment_job();

		int exitCode = first_load_pos_payment_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_pos_payment_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_pos_payment_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_pos_payment_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_pos_payment_job");
		}
...
/************************************************************************************************
 * 86391 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:11:21 PM CST
 ************************************************************************************************/