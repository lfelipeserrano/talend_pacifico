...
package pacifico.first_load_product_template_job_0_1;
...
/**
 * Job: first_load_product_template_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_product_template_job implements TalendJob {
	...
	private final String jobName = "first_load_product_template_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_product_template_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_product_template_job.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_product_template_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_product_template_job = new byte[0];
		...
		public int uom_po_id;

		public int getUom_po_id() {
		...
		public Boolean getAvailable_in_pos() {
			return this.available_in_pos;
		}

		public Boolean to_weight;

		public Boolean getTo_weight() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_product_template_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_product_template_job.length == 0) {
						commonByteArray_PACIFICO_first_load_product_template_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_product_template_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_product_template_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_product_template_job, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_product_template_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_product_template_job, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_product_template_job) {
				...
				try {
					...
					if (length == -1) {
						...
						this.sale_delay = dis.readDouble();
					}
					...
					length = dis.readByte();
					if (length == -1) {
						this.available_in_pos = null;
					} else {
						this.available_in_pos = dis.readBoolean();
					}
					...
					if (length == -1) {
						...
						this.to_weight = dis.readBoolean();
					}

					this.pos_categ_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.sale_delay == null) {
					...
					dos.writeByte(0);
					dos.writeDouble(this.sale_delay);
				}
				...
				if (this.available_in_pos == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.available_in_pos);
				}

				// Boolean

				if (this.to_weight == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.to_weight);
				}

				// Integer

				writeInteger(this.pos_categ_id, dos);
		...
		public String toString() {
			...
			sb.append(",available_in_pos=" + String.valueOf(available_in_pos));
			sb.append(",to_weight=" + String.valueOf(to_weight));
			sb.append(",pos_categ_id=" + String.valueOf(pos_categ_id));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:zd+8hBLKtIkR4i3Ul9zOTMusooDpePB70I8Bkv9znSydb/ksKQ==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM product_template";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							row1.description_purchase = null;
						} else {

							row1.description_purchase = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row1.description_sale = null;
						} else {

							row1.description_sale = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							row1.detailed_type = null;
						} else {

							row1.detailed_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							row1.type = null;
						} else {

							row1.type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row1.categ_id = 0;
						} else {

							row1.categ_id = rs_tDBInput_1.getInt(10);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							...
							row1.list_price = rs_tDBInput_1.getBigDecimal(11);
							if (rs_tDBInput_1.wasNull()) {
								row1.list_price = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							...
							row1.volume = rs_tDBInput_1.getBigDecimal(12);
							if (rs_tDBInput_1.wasNull()) {
								row1.volume = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							...
							row1.weight = rs_tDBInput_1.getBigDecimal(13);
							if (rs_tDBInput_1.wasNull()) {
								row1.weight = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							...
							row1.sale_ok = rs_tDBInput_1.getBoolean(14);
							if (rs_tDBInput_1.wasNull()) {
								row1.sale_ok = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							...
							row1.purchase_ok = rs_tDBInput_1.getBoolean(15);
							if (rs_tDBInput_1.wasNull()) {
								row1.purchase_ok = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 16) {
							...
							row1.uom_id = rs_tDBInput_1.getInt(16);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 17) {
							...
							row1.uom_po_id = rs_tDBInput_1.getInt(17);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 18) {
							...
							row1.company_id = rs_tDBInput_1.getInt(18);
							if (rs_tDBInput_1.wasNull()) {
								row1.company_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 19) {
							...
							row1.active = rs_tDBInput_1.getBoolean(19);
							if (rs_tDBInput_1.wasNull()) {
								row1.active = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 20) {
							...
							row1.color = rs_tDBInput_1.getInt(20);
							if (rs_tDBInput_1.wasNull()) {
								row1.color = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 21) {
							row1.default_code = null;
						} else {

							row1.default_code = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, false);
						}
						if (colQtyInRs_tDBInput_1 < 22) {
							row1.can_image_1024_be_zoomed = null;
						} else {

							row1.can_image_1024_be_zoomed = rs_tDBInput_1.getBoolean(22);
							if (rs_tDBInput_1.wasNull()) {
								row1.can_image_1024_be_zoomed = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 23) {
							...
							row1.has_configurable_attributes = rs_tDBInput_1.getBoolean(23);
							if (rs_tDBInput_1.wasNull()) {
								row1.has_configurable_attributes = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 24) {
							...
							row1.priority = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
						}
						if (colQtyInRs_tDBInput_1 < 25) {
							row1.create_uid = null;
						} else {

							row1.create_uid = rs_tDBInput_1.getInt(25);
							if (rs_tDBInput_1.wasNull()) {
								row1.create_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 26) {
							...
							row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 26);
						}
						if (colQtyInRs_tDBInput_1 < 27) {
							row1.write_uid = null;
						} else {

							row1.write_uid = rs_tDBInput_1.getInt(27);
							if (rs_tDBInput_1.wasNull()) {
								row1.write_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 28) {
							...
							row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 28);
						}
						if (colQtyInRs_tDBInput_1 < 29) {
							row1.service_type = null;
						} else {

							row1.service_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, false);
						}
						if (colQtyInRs_tDBInput_1 < 30) {
							row1.sale_line_warn = null;
						} else {

							row1.sale_line_warn = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30, false);
						}
						if (colQtyInRs_tDBInput_1 < 31) {
							row1.sale_line_warn_msg = null;
						} else {

							row1.sale_line_warn_msg = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, false);
						}
						if (colQtyInRs_tDBInput_1 < 32) {
							row1.expense_policy = null;
						} else {

							row1.expense_policy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 32, false);
						}
						if (colQtyInRs_tDBInput_1 < 33) {
							row1.invoice_policy = null;
						} else {

							row1.invoice_policy = routines.system.JDBCUtil.getString(rs_tDBInput_1, 33, false);
						}
						if (colQtyInRs_tDBInput_1 < 34) {
							row1.sale_delay = null;
						} else {

							row1.sale_delay = rs_tDBInput_1.getDouble(34);
							if (rs_tDBInput_1.wasNull()) {
								row1.sale_delay = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 35) {
							...
							row1.tracking = routines.system.JDBCUtil.getString(rs_tDBInput_1, 35, false);
						}
						if (colQtyInRs_tDBInput_1 < 36) {
							row1.description_picking = null;
						} else {

							row1.description_picking = routines.system.JDBCUtil.getString(rs_tDBInput_1, 36, false);
						}
						if (colQtyInRs_tDBInput_1 < 37) {
							row1.description_pickingout = null;
						} else {

							row1.description_pickingout = routines.system.JDBCUtil.getString(rs_tDBInput_1, 37, false);
						}
						if (colQtyInRs_tDBInput_1 < 38) {
							row1.description_pickingin = null;
						} else {

							row1.description_pickingin = routines.system.JDBCUtil.getString(rs_tDBInput_1, 38, false);
						}
						if (colQtyInRs_tDBInput_1 < 39) {
							row1.available_in_pos = null;
						} else {

							row1.available_in_pos = rs_tDBInput_1.getBoolean(39);
							if (rs_tDBInput_1.wasNull()) {
								row1.available_in_pos = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 40) {
							...
							row1.to_weight = rs_tDBInput_1.getBoolean(40);
							if (rs_tDBInput_1.wasNull()) {
								row1.to_weight = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 41) {
							row1.pos_categ_id = null;
						} else {

							row1.pos_categ_id = rs_tDBInput_1.getInt(41);
							if (rs_tDBInput_1.wasNull()) {
								row1.pos_categ_id = null;
							}
						}
						...
						if (row1.description != null) {
							sb_tFileOutputDelimited_1.append(row1.description);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.description_purchase != null) {
							sb_tFileOutputDelimited_1.append(row1.description_purchase);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.description_sale != null) {
							sb_tFileOutputDelimited_1.append(row1.description_sale);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.detailed_type != null) {
							sb_tFileOutputDelimited_1.append(row1.detailed_type);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.type != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.categ_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.list_price != null) {
							sb_tFileOutputDelimited_1.append(
									row1.list_price.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.volume != null) {
							sb_tFileOutputDelimited_1
									.append(row1.volume.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.weight != null) {
							sb_tFileOutputDelimited_1
									.append(row1.weight.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_ok != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_ok);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.purchase_ok != null) {
							sb_tFileOutputDelimited_1.append(row1.purchase_ok);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.uom_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.uom_po_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.default_code != null) {
							sb_tFileOutputDelimited_1.append(row1.default_code);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.can_image_1024_be_zoomed != null) {
							sb_tFileOutputDelimited_1.append(row1.can_image_1024_be_zoomed);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.has_configurable_attributes != null) {
							sb_tFileOutputDelimited_1.append(row1.has_configurable_attributes);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.priority != null) {
							sb_tFileOutputDelimited_1.append(row1.priority);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.service_type != null) {
							sb_tFileOutputDelimited_1.append(row1.service_type);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_line_warn != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_line_warn);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_line_warn_msg != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_line_warn_msg);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.expense_policy != null) {
							sb_tFileOutputDelimited_1.append(row1.expense_policy);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.invoice_policy != null) {
							sb_tFileOutputDelimited_1.append(row1.invoice_policy);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_delay != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_delay);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.tracking != null) {
							sb_tFileOutputDelimited_1.append(row1.tracking);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.description_picking != null) {
							sb_tFileOutputDelimited_1.append(row1.description_picking);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.description_pickingout != null) {
							sb_tFileOutputDelimited_1.append(row1.description_pickingout);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.description_pickingin != null) {
							sb_tFileOutputDelimited_1.append(row1.description_pickingin);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.available_in_pos != null) {
							sb_tFileOutputDelimited_1.append(row1.available_in_pos);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.to_weight != null) {
							sb_tFileOutputDelimited_1.append(row1.to_weight);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.pos_categ_id != null) {
							sb_tFileOutputDelimited_1.append(row1.pos_categ_id);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:D6MXFYWywfLtvAkwaOdJY0MKpe5U4+Eav4yd2jbYjVX+74iU2DRB9NLU9VCPUSCj8Oh16c0SdCMTOq53mHn/eN/+ZfY=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "productTemplate_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_product_template_job first_load_product_template_jobClass = new first_load_product_template_job();

		int exitCode = first_load_product_template_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_product_template_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_product_template_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_product_template_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_product_template_job");
		}
...
/************************************************************************************************
 * 120269 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:14:33 PM CST
 ************************************************************************************************/