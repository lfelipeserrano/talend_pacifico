...
package pacifico.first_load_pos_session_job_0_1;
...
/**
 * Job: first_load_pos_session_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_pos_session_job implements TalendJob {
	...
	private final String jobName = "first_load_pos_session_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_pos_session_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_pos_session_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_pos_session_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_pos_session_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_pos_session_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_pos_session_job.length == 0) {
						commonByteArray_PACIFICO_first_load_pos_session_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_pos_session_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_pos_session_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_pos_session_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_pos_session_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_pos_session_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_pos_session_job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:adD++jVxNIuZ037DY5G1b8eopnkGzZ7ziKvBFJfAYfHe1Df+uw==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM pos_session";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.config_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.name != null) {
						...
						if (row1.start_at != null) {
							sb_tFileOutputDelimited_1.append(FormatterUtils.format_Date(row1.start_at, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.stop_at != null) {
							sb_tFileOutputDelimited_1.append(FormatterUtils.format_Date(row1.stop_at, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.state != null) {
						...
						if (row1.login_number != null) {
							sb_tFileOutputDelimited_1.append(row1.login_number);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.opening_notes != null) {
							sb_tFileOutputDelimited_1.append(row1.opening_notes);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.cash_journal_id != null) {
							sb_tFileOutputDelimited_1.append(row1.cash_journal_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.cash_register_id != null) {
							sb_tFileOutputDelimited_1.append(row1.cash_register_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.cash_real_difference != null) {
							sb_tFileOutputDelimited_1.append(row1.cash_real_difference
									.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.cash_real_transaction != null) {
							sb_tFileOutputDelimited_1.append(row1.cash_real_transaction
									.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.cash_real_expected != null) {
							sb_tFileOutputDelimited_1.append(row1.cash_real_expected
									.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.rescue != null) {
							sb_tFileOutputDelimited_1.append(row1.rescue);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.move_id != null) {
							sb_tFileOutputDelimited_1.append(row1.move_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.update_stock_at_closing != null) {
							sb_tFileOutputDelimited_1.append(row1.update_stock_at_closing);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:MfA1Yj7yBXknTg5GmYdO4ZjivZBEh98HJTPJqB2IvG49mmixr1NLaDNyjRfOh8l6EjsI62R7rYp8vnhLzGC0Hcfzhxw=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "posSessions_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_pos_session_job first_load_pos_session_jobClass = new first_load_pos_session_job();

		int exitCode = first_load_pos_session_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_pos_session_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_pos_session_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_pos_session_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_pos_session_job");
		}
...
/************************************************************************************************
 * 93432 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:12:37 PM CST
 ************************************************************************************************/