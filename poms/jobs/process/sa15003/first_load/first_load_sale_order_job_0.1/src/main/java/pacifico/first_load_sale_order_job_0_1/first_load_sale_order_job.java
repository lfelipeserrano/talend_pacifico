...
package pacifico.first_load_sale_order_job_0_1;
...
/**
 * Job: first_load_sale_order_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_sale_order_job implements TalendJob {
	...
	private final String jobName = "first_load_sale_order_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_sale_order_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_sale_order_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_sale_order_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_sale_order_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_sale_order_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_sale_order_job.length == 0) {
						commonByteArray_PACIFICO_first_load_sale_order_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_sale_order_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_sale_order_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_sale_order_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_sale_order_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_sale_order_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_sale_order_job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Tk8UBmo0AE5Oim6jX/f5G20eQ/NFLeakg9932aL4W2RTUtO4rw==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM sale_order";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.campaign_id != null) {
							sb_tFileOutputDelimited_1.append(row1.campaign_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.source_id != null) {
							sb_tFileOutputDelimited_1.append(row1.source_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.medium_id != null) {
							sb_tFileOutputDelimited_1.append(row1.medium_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.access_token != null) {
							sb_tFileOutputDelimited_1.append(row1.access_token);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.name != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.origin != null) {
							sb_tFileOutputDelimited_1.append(row1.origin);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.client_order_ref != null) {
							sb_tFileOutputDelimited_1.append(row1.client_order_ref);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.reference != null) {
							sb_tFileOutputDelimited_1.append(row1.reference);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.state != null) {
						...
						if (row1.validity_date != null) {
							sb_tFileOutputDelimited_1
									.append(FormatterUtils.format_Date(row1.validity_date, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.partner_invoice_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.partner_shipping_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.analytic_account_id != null) {
							sb_tFileOutputDelimited_1.append(row1.analytic_account_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.payment_term_id != null) {
							sb_tFileOutputDelimited_1.append(row1.payment_term_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.signed_by != null) {
							sb_tFileOutputDelimited_1.append(row1.signed_by);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.signed_on != null) {
							sb_tFileOutputDelimited_1.append(FormatterUtils.format_Date(row1.signed_on, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.commitment_date != null) {
							sb_tFileOutputDelimited_1
									.append(FormatterUtils.format_Date(row1.commitment_date, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.show_update_pricelist != null) {
							sb_tFileOutputDelimited_1.append(row1.show_update_pricelist);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.sale_order_template_id != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_order_template_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.incoterm != null) {
							sb_tFileOutputDelimited_1.append(row1.incoterm);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.picking_policy != null) {
							sb_tFileOutputDelimited_1.append(row1.picking_policy);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						sb_tFileOutputDelimited_1.append(row1.warehouse_id);
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.effective_date != null) {
							sb_tFileOutputDelimited_1
									.append(FormatterUtils.format_Date(row1.effective_date, "dd-MM-yyyy"));
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LPT9d2oVgMkqg8anJKa6Kkpw9mPoCNbMviIBJVQfxMu1lkoeRwuz7gnddHGoxJWbHVSXaqlSlt5ZYmEvDbqwkhGyKEU=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "saleOrder_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_sale_order_job first_load_sale_order_jobClass = new first_load_sale_order_job();

		int exitCode = first_load_sale_order_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_sale_order_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_sale_order_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_sale_order_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_sale_order_job");
		}
...
/************************************************************************************************
 * 123903 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:15:09 PM CST
 ************************************************************************************************/