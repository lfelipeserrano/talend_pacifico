...
package pacifico.pospaymentmethod_stage_0_1;
...
/**
 * Job: posPaymentMethod_stage Purpose: <br>
 ...
 * @status
 */
public class posPaymentMethod_stage implements TalendJob {
	...
	private final String jobName = "posPaymentMethod_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					posPaymentMethod_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(posPaymentMethod_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:EgsvUpwaF1vrTWPFlZNOJeqtlmrTKFV3KJnxsuDP2jw69vKVNWm8l03vhzaWbx0R5NuzbORpM32RqLT3Dsqp1XAJnJw=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "posPaymentMethod_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "posPaymentMethod.csv";
	...
	public static void main(String[] args) {
		final posPaymentMethod_stage posPaymentMethod_stageClass = new posPaymentMethod_stage();

		int exitCode = posPaymentMethod_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = posPaymentMethod_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/pospaymentmethod_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = posPaymentMethod_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : posPaymentMethod_stage");
		}
...
/************************************************************************************************
 * 39162 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:39:14 PM CST
 ************************************************************************************************/