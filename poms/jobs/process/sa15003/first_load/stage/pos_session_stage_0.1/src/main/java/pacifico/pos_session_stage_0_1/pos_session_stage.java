...
package pacifico.pos_session_stage_0_1;
...
/**
 * Job: pos_session_stage Purpose: <br>
 ...
 * @status
 */
public class pos_session_stage implements TalendJob {
	...
	private final String jobName = "pos_session_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					pos_session_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(pos_session_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jmmWROrte2PjotzD9IqIxDk/QaGNTUPTeLmzfEdd1fUugKBXJx6jiJ7Egdor4OSI6zdyY75OOv/lnlnOZLhv/tsd4SE=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "posSessions_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "posSession.csv";
	...
	public static void main(String[] args) {
		final pos_session_stage pos_session_stageClass = new pos_session_stage();

		int exitCode = pos_session_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pos_session_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/pos_session_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pos_session_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_session_stage");
		}
...
/************************************************************************************************
 * 39081 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:36:05 PM CST
 ************************************************************************************************/