...
package pacifico.pos_order_line_stage_0_1;
...
/**
 * Job: pos_order_line_stage Purpose: <br>
 ...
 * @status
 */
public class pos_order_line_stage implements TalendJob {
	...
	private final String jobName = "pos_order_line_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					pos_order_line_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(pos_order_line_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:icqff8wirA56wn2NT+6yOKSrMZtQThoI3ISf8tF0vMycXNpbrnF5gGqCt4QfRUC4sR+Q/i3MKPVyJgoWVQtnazS+wCE=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "posOrderLine_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "posOrderLine.csv";
	...
	public static void main(String[] args) {
		final pos_order_line_stage pos_order_line_stageClass = new pos_order_line_stage();

		int exitCode = pos_order_line_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pos_order_line_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/pos_order_line_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pos_order_line_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_order_line_stage");
		}
...
/************************************************************************************************
 * 39126 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:33:44 PM CST
 ************************************************************************************************/