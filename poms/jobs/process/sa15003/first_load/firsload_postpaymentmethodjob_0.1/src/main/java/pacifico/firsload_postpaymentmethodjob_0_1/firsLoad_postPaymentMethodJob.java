...
package pacifico.firsload_postpaymentmethodjob_0_1;
...
/**
 * Job: firsLoad_postPaymentMethodJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class firsLoad_postPaymentMethodJob implements TalendJob {
	...
	private final String jobName = "firsLoad_postPaymentMethodJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					firsLoad_postPaymentMethodJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(firsLoad_postPaymentMethodJob.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_firsLoad_postPaymentMethodJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob.length == 0) {
						commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_firsLoad_postPaymentMethodJob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_firsLoad_postPaymentMethodJob) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+Ck3Bt1VfNCAdJRNhVXNu76aQwOyKIOMcdddUGBCnwCWsilB7w==");
				...
				String dbquery_tDBInput_1 = "SELECT * FROM pos_payment_method";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.outstanding_account_id != null) {
							sb_tFileOutputDelimited_1.append(row1.outstanding_account_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.receivable_account_id != null) {
							sb_tFileOutputDelimited_1.append(row1.receivable_account_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.is_cash_count != null) {
							sb_tFileOutputDelimited_1.append(row1.is_cash_count);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.journal_id != null) {
							sb_tFileOutputDelimited_1.append(row1.journal_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.split_transactions != null) {
							sb_tFileOutputDelimited_1.append(row1.split_transactions);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.use_payment_terminal != null) {
							sb_tFileOutputDelimited_1.append(row1.use_payment_terminal);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.active != null) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:tDg1t3QzFQkNe8wNvSokqiFEyfJaeEHePQV6P73WyoePK+eo1GlEevQoSIA5a1oAwKQ+z1M2ch8ak014iOKx8lx7aCI=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "posPaymentMethod_20221026.csv";
	...
	public static void main(String[] args) {
		final firsLoad_postPaymentMethodJob firsLoad_postPaymentMethodJobClass = new firsLoad_postPaymentMethodJob();

		int exitCode = firsLoad_postPaymentMethodJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = firsLoad_postPaymentMethodJob.class.getClassLoader().getResourceAsStream(
					"pacifico/firsload_postpaymentmethodjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = firsLoad_postPaymentMethodJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : firsLoad_postPaymentMethodJob");
		}
...
/************************************************************************************************
 * 81985 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:13:43 PM CST
 ************************************************************************************************/