...
public class main_job implements TalendJob {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.pos_order_job_0_1.pos_order_job childJob_tRunJob_1 = new pacifico.pos_order_job_0_1.pos_order_job();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.pos_session_job_0_1.pos_session_job childJob_tRunJob_10 = new pacifico.pos_session_job_0_1.pos_session_job();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.pos_payment_job_0_1.pos_payment_job childJob_tRunJob_6 = new pacifico.pos_payment_job_0_1.pos_payment_job();
				// pass DataSources
	...
	public void tRunJob_28Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.sale_order_job_0_1.sale_order_job childJob_tRunJob_28 = new pacifico.sale_order_job_0_1.sale_order_job();
				// pass DataSources
	...
	public void tRunJob_21Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.product_template_0_1.product_template childJob_tRunJob_21 = new pacifico.product_template_0_1.product_template();
				// pass DataSources
	...
	public void tRunJob_15Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.post_payment_method_job_0_1.post_payment_method_job childJob_tRunJob_15 = new pacifico.post_payment_method_job_0_1.post_payment_method_job();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main_job.class.getClassLoader()
					.getResourceAsStream("pacifico/main_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = main_job.class.getClassLoader()
...
/************************************************************************************************
 * 72846 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:31:00 PM CST
 ************************************************************************************************/