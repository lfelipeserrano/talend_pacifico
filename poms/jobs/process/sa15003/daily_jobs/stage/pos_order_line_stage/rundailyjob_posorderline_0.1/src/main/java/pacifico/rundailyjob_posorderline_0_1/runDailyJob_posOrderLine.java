...
public class runDailyJob_posOrderLine implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_posOrderLine.class.getClassLoader().getResourceAsStream(
					"pacifico/rundailyjob_posorderline_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_posOrderLine.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runDailyJob_posOrderLine");
		}
...
/************************************************************************************************
 * 37103 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:40:48 PM CST
 ************************************************************************************************/