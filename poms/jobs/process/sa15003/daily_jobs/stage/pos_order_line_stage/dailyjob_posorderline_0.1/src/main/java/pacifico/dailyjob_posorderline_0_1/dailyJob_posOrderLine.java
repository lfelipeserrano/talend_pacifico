...
package pacifico.dailyjob_posorderline_0_1;
...
/**
 * Job: dailyJob_posOrderLine Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class dailyJob_posOrderLine implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dailyJob_posOrderLine";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dailyJob_posOrderLine.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dailyJob_posOrderLine.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_dailyJob_posOrderLine = new byte[0];
    static byte[] commonByteArray_PACIFICO_dailyJob_posOrderLine = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_dailyJob_posOrderLine.length) {
				if(length < 1024 && commonByteArray_PACIFICO_dailyJob_posOrderLine.length == 0) {
   					commonByteArray_PACIFICO_dailyJob_posOrderLine = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_dailyJob_posOrderLine = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_dailyJob_posOrderLine, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_dailyJob_posOrderLine, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_dailyJob_posOrderLine, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_dailyJob_posOrderLine, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_dailyJob_posOrderLine) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"US-ASCII"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("name");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("notice");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        ...
                                        outtFileOutputDelimited_1.write("price_subtotal");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("price_subtotal_incl");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("total_cost");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("is_total_cost_computed");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("discount");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("order_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("full_product_name");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("customer_note");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("refunded_orderline_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        ...
                                        outtFileOutputDelimited_1.write("write_date");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("sale_order_origin_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("sale_order_line_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("down_payment_details");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","company_id","name","notice","product_id","price_unit","qty","price_subtotal","price_subtotal_incl","total_cost","is_total_cost_computed","discount","order_id","full_product_name","customer_note","refunded_orderline_id","create_uid","create_date","write_uid","write_date","sale_order_origin_id","sale_order_line_id","down_payment_details",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 3;
							...
							row5.notice = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
					...
					columnIndexWithD_tFileInputDelimited_3 = 4;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.product_id = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_id", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 5;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.price_unit = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_unit", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
    							
						} else {						
							
								
									row5.price_unit = null;
					...
					columnIndexWithD_tFileInputDelimited_3 = 6;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.qty = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"qty", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 7;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.price_subtotal = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_subtotal", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
    							
						} else {						
							
								
									row5.price_subtotal = null;
					...
					columnIndexWithD_tFileInputDelimited_3 = 8;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.price_subtotal_incl = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_subtotal_incl", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
    							
						} else {						
							
								
									row5.price_subtotal_incl = null;
					...
					columnIndexWithD_tFileInputDelimited_3 = 9;
							...
							row5.total_cost = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
					...
					columnIndexWithD_tFileInputDelimited_3 = 10;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.is_total_cost_computed = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_total_cost_computed", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
    							
						} else {						
							
								
									row5.is_total_cost_computed = null;
					...
					columnIndexWithD_tFileInputDelimited_3 = 11;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.discount = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"discount", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 12;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row5.order_id = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_3) {
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"order_id", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 13;
							...
							row5.full_product_name = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 14;
					
							row5.customer_note = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 15;
					
							row5.refunded_orderline_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 20;
							...
							row5.sale_order_origin_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 21;
					
							row5.sale_order_line_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 22;
					
							row5.down_payment_details = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
			...
			row6.name = row5.name;								
			row6.notice = row5.notice;								
			row6.product_id = row5.product_id;								
			row6.price_unit = row5.price_unit;								
			row6.qty = row5.qty;								
			row6.price_subtotal = row5.price_subtotal;								
			row6.price_subtotal_incl = row5.price_subtotal_incl;								
			row6.total_cost = row5.total_cost;								
			row6.is_total_cost_computed = row5.is_total_cost_computed;								
			row6.discount = row5.discount;								
			row6.order_id = row5.order_id;								
			row6.full_product_name = row5.full_product_name;								
			row6.customer_note = row5.customer_note;								
			row6.refunded_orderline_id = row5.refunded_orderline_id;								
			...
			row6.sale_order_origin_id = row5.sale_order_origin_id;								
			row6.sale_order_line_id = row5.sale_order_line_id;								
			row6.down_payment_details = row5.down_payment_details;			
...
///////////////////////		
	    		...
	    		if(row6.product_id != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row6.product_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.price_unit != null) { //              
                 row_tLogRow_1[5]=    						
								FormatterUtils.formatUnwithE(row6.price_unit)
					          ;	
	    		...
	    		if(row6.qty != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row6.qty)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.price_subtotal != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(row6.price_subtotal)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.price_subtotal_incl != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(row6.price_subtotal_incl)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.total_cost != null) { //              
                 row_tLogRow_1[9]=    						    
				                String.valueOf(row6.total_cost)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.is_total_cost_computed != null) { //              
                 row_tLogRow_1[10]=    						    
				                String.valueOf(row6.is_total_cost_computed)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.discount != null) { //              
                 row_tLogRow_1[11]=    						
								FormatterUtils.formatUnwithE(row6.discount)
					          ;	
	    		...
	    		if(row6.order_id != null) { //              
                 row_tLogRow_1[12]=    						    
				                String.valueOf(row6.order_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.full_product_name != null) { //              
                 row_tLogRow_1[13]=    						    
				                String.valueOf(row6.full_product_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.customer_note != null) { //              
                 row_tLogRow_1[14]=    						    
				                String.valueOf(row6.customer_note)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.refunded_orderline_id != null) { //              
                 row_tLogRow_1[15]=    						    
				                String.valueOf(row6.refunded_orderline_id)			
					          ;	
	    		...
	    		if(row6.sale_order_origin_id != null) { //              
                 row_tLogRow_1[20]=    						    
				                String.valueOf(row6.sale_order_origin_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.sale_order_line_id != null) { //              
                 row_tLogRow_1[21]=    						    
				                String.valueOf(row6.sale_order_line_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.down_payment_details != null) { //              
                 row_tLogRow_1[22]=    						    
				                String.valueOf(row6.down_payment_details)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.price_subtotal != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.price_subtotal
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.price_subtotal_incl != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.price_subtotal_incl
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.total_cost != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.total_cost
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.is_total_cost_computed != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.is_total_cost_computed
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.discount != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.discount
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.full_product_name != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.full_product_name
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.customer_note != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.customer_note
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.refunded_orderline_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.refunded_orderline_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.sale_order_origin_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.sale_order_origin_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.sale_order_line_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.sale_order_line_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.down_payment_details != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.down_payment_details
                        );
                            }
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","company_id","name","notice","product_id","price_unit","qty","price_subtotal","price_subtotal_incl","total_cost","is_total_cost_computed","discount","order_id","full_product_name","customer_note","refunded_orderline_id","create_uid","create_date","write_uid","write_date","sale_order_origin_id","sale_order_line_id","down_payment_details",});        
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_unit", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_subtotal", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_subtotal_incl", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_total_cost_computed", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"discount", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"order_id", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 13;
							...
							row1.full_product_name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 15;
							...
							row1.refunded_orderline_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 20;
							...
							row1.sale_order_origin_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 21;
					
							row1.sale_order_line_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 22;
					
							row1.down_payment_details = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
out1_tmp.notice = row1.notice ;
out1_tmp.product_id = row1.product_id ;
out1_tmp.price_unit = row1.price_unit ;
out1_tmp.qty = row1.qty ;
out1_tmp.price_subtotal = row1.price_subtotal ;
out1_tmp.price_subtotal_incl = row1.price_subtotal_incl ;
out1_tmp.total_cost = row1.total_cost ;
out1_tmp.is_total_cost_computed = row1.is_total_cost_computed ;
out1_tmp.discount = row1.discount ;
out1_tmp.order_id = row1.order_id ;
out1_tmp.full_product_name = row1.full_product_name ;
out1_tmp.customer_note = row1.customer_note ;
out1_tmp.refunded_orderline_id = row1.refunded_orderline_id ;
...
out1_tmp.sale_order_origin_id = row1.sale_order_origin_id ;
out1_tmp.sale_order_line_id = row1.sale_order_line_id ;
out1_tmp.down_payment_details = row1.down_payment_details ;
out1 = out1_tmp;
...
///////////////////////		
	    		...
	    		if(out1.product_id != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(out1.product_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.price_unit != null) { //              
                 row_tLogRow_2[5]=    						
								FormatterUtils.formatUnwithE(out1.price_unit)
					          ;	
	    		...
	    		if(out1.qty != null) { //              
                 row_tLogRow_2[6]=    						    
				                String.valueOf(out1.qty)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.price_subtotal != null) { //              
                 row_tLogRow_2[7]=    						    
				                String.valueOf(out1.price_subtotal)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.price_subtotal_incl != null) { //              
                 row_tLogRow_2[8]=    						    
				                String.valueOf(out1.price_subtotal_incl)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.total_cost != null) { //              
                 row_tLogRow_2[9]=    						    
				                String.valueOf(out1.total_cost)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.is_total_cost_computed != null) { //              
                 row_tLogRow_2[10]=    						    
				                String.valueOf(out1.is_total_cost_computed)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.discount != null) { //              
                 row_tLogRow_2[11]=    						
								FormatterUtils.formatUnwithE(out1.discount)
					          ;	
	    		...
	    		if(out1.full_product_name != null) { //              
                 row_tLogRow_2[13]=    						    
				                String.valueOf(out1.full_product_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.customer_note != null) { //              
                 row_tLogRow_2[14]=    						    
				                String.valueOf(out1.customer_note)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.refunded_orderline_id != null) { //              
                 row_tLogRow_2[15]=    						    
				                String.valueOf(out1.refunded_orderline_id)			
					          ;	
	    		...
	    		if(out1.sale_order_origin_id != null) { //              
                 row_tLogRow_2[20]=    						    
				                String.valueOf(out1.sale_order_origin_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.sale_order_line_id != null) { //              
                 row_tLogRow_2[21]=    						    
				                String.valueOf(out1.sale_order_line_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.down_payment_details != null) { //              
                 row_tLogRow_2[22]=    						    
				                String.valueOf(out1.down_payment_details)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.price_subtotal != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.price_subtotal
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.price_subtotal_incl != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.price_subtotal_incl
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.total_cost != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.total_cost
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.is_total_cost_computed != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.is_total_cost_computed
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.discount != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.discount
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.full_product_name != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.full_product_name
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.customer_note != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.customer_note
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.refunded_orderline_id != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.refunded_orderline_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.sale_order_origin_id != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.sale_order_origin_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.sale_order_line_id != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.sale_order_line_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.down_payment_details != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.down_payment_details
                        );
                            }
...
// for output
			...
			row6.name = row4.name;								
			row6.notice = row4.notice;								
			row6.product_id = row4.product_id;								
			row6.price_unit = row4.price_unit;								
			row6.qty = row4.qty;								
			row6.price_subtotal = row4.price_subtotal;								
			row6.price_subtotal_incl = row4.price_subtotal_incl;								
			row6.total_cost = row4.total_cost;								
			row6.is_total_cost_computed = row4.is_total_cost_computed;								
			row6.discount = row4.discount;								
			row6.order_id = row4.order_id;								
			row6.full_product_name = row4.full_product_name;								
			row6.customer_note = row4.customer_note;								
			row6.refunded_orderline_id = row4.refunded_orderline_id;								
			...
			row6.sale_order_origin_id = row4.sale_order_origin_id;								
			row6.sale_order_line_id = row4.sale_order_line_id;								
			row6.down_payment_details = row4.down_payment_details;			
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tKjOHs5TDNUCug4ORjWPWotbuQBwfVrouo/ZOuVKq9bXRVGYk/BcDydrTLOxOdNIWNPgNuypCmfax12pbb+Ir8lpHWI=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posOrderLine.csv";
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_unit", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_subtotal", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_subtotal_incl", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_total_cost_computed", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"discount", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"order_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 13;
							...
							row2.full_product_name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 15;
							...
							row2.refunded_orderline_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 20;
							...
							row2.sale_order_origin_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 21;
					
							row2.sale_order_line_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 22;
					
							row2.down_payment_details = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
if(row2 != null) { 
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.notice = row2.notice;
				
				row2_HashRow.product_id = row2.product_id;
				
				row2_HashRow.price_unit = row2.price_unit;
				
				row2_HashRow.qty = row2.qty;
				
				row2_HashRow.price_subtotal = row2.price_subtotal;
				
				row2_HashRow.price_subtotal_incl = row2.price_subtotal_incl;
				
				row2_HashRow.total_cost = row2.total_cost;
				
				row2_HashRow.is_total_cost_computed = row2.is_total_cost_computed;
				
				row2_HashRow.discount = row2.discount;
				
				row2_HashRow.order_id = row2.order_id;
				
				row2_HashRow.full_product_name = row2.full_product_name;
				
				row2_HashRow.customer_note = row2.customer_note;
				
				row2_HashRow.refunded_orderline_id = row2.refunded_orderline_id;
				...
				row2_HashRow.sale_order_origin_id = row2.sale_order_origin_id;
				
				row2_HashRow.sale_order_line_id = row2.sale_order_line_id;
				
				row2_HashRow.down_payment_details = row2.down_payment_details;
 ...
 */
    ...
    public static void main(String[] args){
        final dailyJob_posOrderLine dailyJob_posOrderLineClass = new dailyJob_posOrderLine();

        int exitCode = dailyJob_posOrderLineClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJob_posOrderLine.class.getClassLoader().getResourceAsStream("pacifico/dailyjob_posorderline_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJob_posOrderLine.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJob_posOrderLine");
        }
...
/************************************************************************************************
 *     377958 characters generated by Talend Open Studio for Data Integration 
 *     on the December 7, 2022 at 11:39:36 PM CST
 ************************************************************************************************/