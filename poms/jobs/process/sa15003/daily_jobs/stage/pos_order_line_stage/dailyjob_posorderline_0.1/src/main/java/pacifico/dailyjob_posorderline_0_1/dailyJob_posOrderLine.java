		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:99W8SKGrKknaLRE/WOF832jGDloBfV+iJaMJv57ydGnszV57CMAPK1AeOYy/oVTYtNazqT/D5CcheubLz7w9rVekfho=");
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"price_unit", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"price_subtotal", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"price_subtotal_incl", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_total_cost_computed", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"discount", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"order_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.full_product_name = fid_tFileInputDelimited_3
							...
							row5.refunded_orderline_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							row5.sale_order_origin_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 21;

							row5.sale_order_line_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 22;

							row5.down_payment_details = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
...
///////////////////////		
							...
							if (row6.company_id != null) { //
								row_tLogRow_1[1] = String.valueOf(row6.company_id);
							...
							if (row6.notice != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.notice);

							} //

							if (row6.product_id != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.product_id);

							} //

							if (row6.price_unit != null) { //
								row_tLogRow_1[5] = FormatterUtils.formatUnwithE(row6.price_unit);

							} //

							if (row6.qty != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.qty);

							} //

							if (row6.price_subtotal != null) { //
								row_tLogRow_1[7] = String.valueOf(row6.price_subtotal);

							} //

							if (row6.price_subtotal_incl != null) { //
								row_tLogRow_1[8] = String.valueOf(row6.price_subtotal_incl);

							} //

							if (row6.total_cost != null) { //
								row_tLogRow_1[9] = String.valueOf(row6.total_cost);

							} //

							if (row6.is_total_cost_computed != null) { //
								row_tLogRow_1[10] = String.valueOf(row6.is_total_cost_computed);

							} //

							if (row6.discount != null) { //
								row_tLogRow_1[11] = FormatterUtils.formatUnwithE(row6.discount);

							} //

							if (row6.order_id != null) { //
								row_tLogRow_1[12] = String.valueOf(row6.order_id);

							} //

							if (row6.full_product_name != null) { //
								row_tLogRow_1[13] = String.valueOf(row6.full_product_name);

							} //

							if (row6.customer_note != null) { //
								row_tLogRow_1[14] = String.valueOf(row6.customer_note);

							} //

							if (row6.refunded_orderline_id != null) { //
								row_tLogRow_1[15] = String.valueOf(row6.refunded_orderline_id);

							} //

							if (row6.create_uid != null) { //
								row_tLogRow_1[16] = String.valueOf(row6.create_uid);

							} //

							if (row6.create_date != null) { //
								row_tLogRow_1[17] = FormatterUtils.format_Date(row6.create_date, "dd-MM-yyyy");

							} //

							if (row6.write_uid != null) { //
								row_tLogRow_1[18] = String.valueOf(row6.write_uid);

							} //

							if (row6.write_date != null) { //
								row_tLogRow_1[19] = FormatterUtils.format_Date(row6.write_date, "dd-MM-yyyy");

							} //

							if (row6.sale_order_origin_id != null) { //
								row_tLogRow_1[20] = String.valueOf(row6.sale_order_origin_id);

							} //

							if (row6.sale_order_line_id != null) { //
								row_tLogRow_1[21] = String.valueOf(row6.sale_order_line_id);

							} //

							if (row6.down_payment_details != null) { //
								row_tLogRow_1[22] = String.valueOf(row6.down_payment_details);
...
///////////////////////    			
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.notice != null) {
								sb_tFileOutputDelimited_1.append(row7.notice);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.price_unit != null) {
								sb_tFileOutputDelimited_1.append(row7.price_unit);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.qty != null) {
								sb_tFileOutputDelimited_1.append(row7.qty);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.price_subtotal != null) {
								sb_tFileOutputDelimited_1.append(row7.price_subtotal);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.price_subtotal_incl != null) {
								sb_tFileOutputDelimited_1.append(row7.price_subtotal_incl);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.total_cost != null) {
								sb_tFileOutputDelimited_1.append(row7.total_cost);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.is_total_cost_computed != null) {
								sb_tFileOutputDelimited_1.append(row7.is_total_cost_computed);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.discount != null) {
								sb_tFileOutputDelimited_1.append(row7.discount);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.full_product_name != null) {
								sb_tFileOutputDelimited_1.append(row7.full_product_name);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.customer_note != null) {
								sb_tFileOutputDelimited_1.append(row7.customer_note);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.refunded_orderline_id != null) {
								sb_tFileOutputDelimited_1.append(row7.refunded_orderline_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.sale_order_origin_id != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_order_origin_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.sale_order_line_id != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_order_line_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.down_payment_details != null) {
								sb_tFileOutputDelimited_1.append(row7.down_payment_details);
							}
...
///////////////////////		
								...
								if (out1.company_id != null) { //
									row_tLogRow_2[1] = String.valueOf(out1.company_id);
								...
								if (out1.notice != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.notice);

								} //

								if (out1.product_id != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.product_id);

								} //

								if (out1.price_unit != null) { //
									row_tLogRow_2[5] = FormatterUtils.formatUnwithE(out1.price_unit);

								} //

								if (out1.qty != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.qty);

								} //

								if (out1.price_subtotal != null) { //
									row_tLogRow_2[7] = String.valueOf(out1.price_subtotal);

								} //

								if (out1.price_subtotal_incl != null) { //
									row_tLogRow_2[8] = String.valueOf(out1.price_subtotal_incl);

								} //

								if (out1.total_cost != null) { //
									row_tLogRow_2[9] = String.valueOf(out1.total_cost);

								} //

								if (out1.is_total_cost_computed != null) { //
									row_tLogRow_2[10] = String.valueOf(out1.is_total_cost_computed);

								} //

								if (out1.discount != null) { //
									row_tLogRow_2[11] = FormatterUtils.formatUnwithE(out1.discount);

								} //

								if (out1.order_id != null) { //
									row_tLogRow_2[12] = String.valueOf(out1.order_id);

								} //

								if (out1.full_product_name != null) { //
									row_tLogRow_2[13] = String.valueOf(out1.full_product_name);

								} //

								if (out1.customer_note != null) { //
									row_tLogRow_2[14] = String.valueOf(out1.customer_note);

								} //

								if (out1.refunded_orderline_id != null) { //
									row_tLogRow_2[15] = String.valueOf(out1.refunded_orderline_id);

								} //

								if (out1.create_uid != null) { //
									row_tLogRow_2[16] = String.valueOf(out1.create_uid);

								} //

								if (out1.create_date != null) { //
									row_tLogRow_2[17] = FormatterUtils.format_Date(out1.create_date, "dd-MM-yyyy");

								} //

								if (out1.write_uid != null) { //
									row_tLogRow_2[18] = String.valueOf(out1.write_uid);

								} //

								if (out1.write_date != null) { //
									row_tLogRow_2[19] = FormatterUtils.format_Date(out1.write_date, "dd-MM-yyyy");

								} //

								if (out1.sale_order_origin_id != null) { //
									row_tLogRow_2[20] = String.valueOf(out1.sale_order_origin_id);

								} //

								if (out1.sale_order_line_id != null) { //
									row_tLogRow_2[21] = String.valueOf(out1.sale_order_line_id);

								} //

								if (out1.down_payment_details != null) { //
									row_tLogRow_2[22] = String.valueOf(out1.down_payment_details);
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.notice != null) {
									sb_tFileOutputDelimited_2.append(row3.notice);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.product_id != null) {
									sb_tFileOutputDelimited_2.append(row3.product_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.price_unit != null) {
									sb_tFileOutputDelimited_2.append(row3.price_unit);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.qty != null) {
									sb_tFileOutputDelimited_2.append(row3.qty);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.price_subtotal != null) {
									sb_tFileOutputDelimited_2.append(row3.price_subtotal);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.price_subtotal_incl != null) {
									sb_tFileOutputDelimited_2.append(row3.price_subtotal_incl);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.total_cost != null) {
									sb_tFileOutputDelimited_2.append(row3.total_cost);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.is_total_cost_computed != null) {
									sb_tFileOutputDelimited_2.append(row3.is_total_cost_computed);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.discount != null) {
									sb_tFileOutputDelimited_2.append(row3.discount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.order_id != null) {
									sb_tFileOutputDelimited_2.append(row3.order_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.full_product_name != null) {
									sb_tFileOutputDelimited_2.append(row3.full_product_name);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.customer_note != null) {
									sb_tFileOutputDelimited_2.append(row3.customer_note);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.refunded_orderline_id != null) {
									sb_tFileOutputDelimited_2.append(row3.refunded_orderline_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.sale_order_origin_id != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_order_origin_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.sale_order_line_id != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_order_line_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.down_payment_details != null) {
									sb_tFileOutputDelimited_2.append(row3.down_payment_details);
								}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJob_posOrderLine.class.getClassLoader()
					.getResourceAsStream("pacifico/dailyjob_posorderline_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJob_posOrderLine.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJob_posOrderLine");
		}
...
/************************************************************************************************
 * 377958 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 11:21:51 PM CST
 ************************************************************************************************/