...
public class getStage_posOrderLine implements TalendJob {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "posOrderLine_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_posOrderLine.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_posorderline_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_posOrderLine.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_posOrderLine");
		}
