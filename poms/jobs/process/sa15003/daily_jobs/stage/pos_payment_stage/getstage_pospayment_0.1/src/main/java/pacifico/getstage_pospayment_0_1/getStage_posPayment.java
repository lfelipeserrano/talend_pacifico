...
public class getStage_posPayment implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:79YDjHOPPEyGiOs8Czs8bdmeZcZpO//6UmRQvMlTYTboWTMQ624+e+u9xTOQp4+ZXlA8d9hGJbdS1pAGtvfeAYV1Nb4=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "posPayment_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_posPayment.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_pospayment_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_posPayment.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_posPayment");
		}
 ...
 * November 2, 2022 at 11:34:38 PM CST
 ************************************************************************************************/