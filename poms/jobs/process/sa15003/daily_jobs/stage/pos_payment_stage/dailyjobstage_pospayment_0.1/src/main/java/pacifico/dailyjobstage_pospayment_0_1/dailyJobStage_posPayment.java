...
package pacifico.dailyjobstage_pospayment_0_1;
...
/**
 * Job: dailyJobStage_posPayment Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class dailyJobStage_posPayment implements TalendJob {
	...
	private final String jobName = "dailyJobStage_posPayment";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dailyJobStage_posPayment.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dailyJobStage_posPayment.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:rLCnb+3SobK16MOtZdtNK5e0RRxyoS1FdK7mwv5nmeFMDE+ghODvz5hgublyt+94rN9e76arxWAnxcMVT0eNNu8DUY8=");
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_dailyJobStage_posPayment = new byte[0];
		static byte[] commonByteArray_PACIFICO_dailyJobStage_posPayment = new byte[0];
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_posPayment) {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.pos_order_id = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.pos_order_id = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.pos_order_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.pos_order_id, dos, objectOut);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.pos_order_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pos_order_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.pos_order_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.amount = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.payment_method_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"payment_method_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.payment_method_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.payment_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"payment_date", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.payment_date = null;
							...
							row2.card_type = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							row2.cardholder_name = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 10;

							row2.transaction_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 11;

							row2.payment_status = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 12;

							row2.ticket = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.is_change = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_change", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.account_move_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.pos_order_id = row2.pos_order_id;

							row2_HashRow.amount = row2.amount;

							row2_HashRow.payment_method_id = row2.payment_method_id;

							row2_HashRow.payment_date = row2.payment_date;

							row2_HashRow.session_id = row2.session_id;

							row2_HashRow.company_id = row2.company_id;

							row2_HashRow.card_type = row2.card_type;

							row2_HashRow.cardholder_name = row2.cardholder_name;

							row2_HashRow.transaction_id = row2.transaction_id;

							row2_HashRow.payment_status = row2.payment_status;

							row2_HashRow.ticket = row2.ticket;

							row2_HashRow.is_change = row2.is_change;

							row2_HashRow.account_move_id = row2.account_move_id;
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_dailyJobStage_posPayment.length) {
					if (length < 1024 && commonByteArray_PACIFICO_dailyJobStage_posPayment.length == 0) {
						commonByteArray_PACIFICO_dailyJobStage_posPayment = new byte[1024];
					} else {
						commonByteArray_PACIFICO_dailyJobStage_posPayment = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_dailyJobStage_posPayment, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_posPayment, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_dailyJobStage_posPayment, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_posPayment, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("pos_order_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("amount");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("payment_method_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("payment_date");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("session_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("company_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("card_type");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("cardholder_name");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("transaction_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("payment_status");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("ticket");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("is_change");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("account_move_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
				...
				util_tLogRow_1.addRow(new String[] { "id", "name", "pos_order_id", "amount", "payment_method_id",
						"payment_date", "session_id", "company_id", "card_type", "cardholder_name", "transaction_id",
						"payment_status", "ticket", "is_change", "account_move_id", "create_uid", "create_date",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.pos_order_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pos_order_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.pos_order_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.payment_method_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"payment_method_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.payment_method_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.payment_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"payment_date", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.payment_date = null;
							...
							row5.card_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 9;

							row5.cardholder_name = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 10;

							row5.transaction_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 11;

							row5.payment_status = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 12;

							row5.ticket = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.is_change = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_change", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.account_move_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
							...
							row6.id = row5.id;
							row6.name = row5.name;
							row6.pos_order_id = row5.pos_order_id;
							row6.amount = row5.amount;
							row6.payment_method_id = row5.payment_method_id;
							row6.payment_date = row5.payment_date;
							row6.session_id = row5.session_id;
							row6.company_id = row5.company_id;
							row6.card_type = row5.card_type;
							row6.cardholder_name = row5.cardholder_name;
							row6.transaction_id = row5.transaction_id;
							row6.payment_status = row5.payment_status;
							row6.ticket = row5.ticket;
							row6.is_change = row5.is_change;
							row6.account_move_id = row5.account_move_id;
...
///////////////////////		
							...
							if (row6.pos_order_id != null) { //
								row_tLogRow_1[2] = String.valueOf(row6.pos_order_id);

							} //

							if (row6.amount != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.amount);

							} //

							if (row6.payment_method_id != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.payment_method_id);

							} //

							if (row6.payment_date != null) { //
								row_tLogRow_1[5] = FormatterUtils.format_Date(row6.payment_date, "dd-MM-yyyy");

							} //

							if (row6.session_id != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.session_id);

							} //

							if (row6.company_id != null) { //
								row_tLogRow_1[7] = String.valueOf(row6.company_id);

							} //

							if (row6.card_type != null) { //
								row_tLogRow_1[8] = String.valueOf(row6.card_type);

							} //

							if (row6.cardholder_name != null) { //
								row_tLogRow_1[9] = String.valueOf(row6.cardholder_name);

							} //

							if (row6.transaction_id != null) { //
								row_tLogRow_1[10] = String.valueOf(row6.transaction_id);

							} //

							if (row6.payment_status != null) { //
								row_tLogRow_1[11] = String.valueOf(row6.payment_status);

							} //

							if (row6.ticket != null) { //
								row_tLogRow_1[12] = String.valueOf(row6.ticket);

							} //

							if (row6.is_change != null) { //
								row_tLogRow_1[13] = String.valueOf(row6.is_change);

							} //

							if (row6.account_move_id != null) { //
								row_tLogRow_1[14] = String.valueOf(row6.account_move_id);

							} //

							if (row6.create_uid != null) { //
								row_tLogRow_1[15] = String.valueOf(row6.create_uid);

							} //

							if (row6.create_date != null) { //
								row_tLogRow_1[16] = FormatterUtils.format_Date(row6.create_date, "dd-MM-yyyy");

							} //

							if (row6.write_uid != null) { //
								row_tLogRow_1[17] = String.valueOf(row6.write_uid);

							} //

							if (row6.write_date != null) { //
								row_tLogRow_1[18] = FormatterUtils.format_Date(row6.write_date, "dd-MM-yyyy");
...
///////////////////////    			
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.pos_order_id != null) {
								sb_tFileOutputDelimited_1.append(row7.pos_order_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.amount != null) {
								sb_tFileOutputDelimited_1.append(row7.amount);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.payment_method_id != null) {
								sb_tFileOutputDelimited_1.append(row7.payment_method_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.payment_date != null) {
								sb_tFileOutputDelimited_1
										.append(FormatterUtils.format_Date(row7.payment_date, "dd-MM-yyyy"));
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.card_type != null) {
								sb_tFileOutputDelimited_1.append(row7.card_type);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.cardholder_name != null) {
								sb_tFileOutputDelimited_1.append(row7.cardholder_name);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.transaction_id != null) {
								sb_tFileOutputDelimited_1.append(row7.transaction_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.payment_status != null) {
								sb_tFileOutputDelimited_1.append(row7.payment_status);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.ticket != null) {
								sb_tFileOutputDelimited_1.append(row7.ticket);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.is_change != null) {
								sb_tFileOutputDelimited_1.append(row7.is_change);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.account_move_id != null) {
								sb_tFileOutputDelimited_1.append(row7.account_move_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				...
				util_tLogRow_2.addRow(new String[] { "id", "name", "pos_order_id", "amount", "payment_method_id",
						"payment_date", "session_id", "company_id", "card_type", "cardholder_name", "transaction_id",
						"payment_status", "ticket", "is_change", "account_move_id", "create_uid", "create_date",
						"write_uid", "write_date", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.pos_order_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pos_order_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.pos_order_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.payment_method_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"payment_method_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.payment_method_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.payment_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"payment_date", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.card_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							row1.cardholder_name = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.transaction_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							row1.payment_status = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							row1.ticket = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.is_change = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_change", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.account_move_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									out1_tmp.pos_order_id = row1.pos_order_id;
									out1_tmp.amount = row1.amount;
									out1_tmp.payment_method_id = row1.payment_method_id;
									out1_tmp.payment_date = row1.payment_date;
									out1_tmp.session_id = row1.session_id;
									out1_tmp.company_id = row1.company_id;
									out1_tmp.card_type = row1.card_type;
									out1_tmp.cardholder_name = row1.cardholder_name;
									out1_tmp.transaction_id = row1.transaction_id;
									out1_tmp.payment_status = row1.payment_status;
									out1_tmp.ticket = row1.ticket;
									out1_tmp.is_change = row1.is_change;
									out1_tmp.account_move_id = row1.account_move_id;
...
///////////////////////		
								...
								if (out1.pos_order_id != null) { //
									row_tLogRow_2[2] = String.valueOf(out1.pos_order_id);

								} //

								if (out1.amount != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.amount);

								} //

								if (out1.payment_method_id != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.payment_method_id);

								} //

								if (out1.payment_date != null) { //
									row_tLogRow_2[5] = FormatterUtils.format_Date(out1.payment_date, "dd-MM-yyyy");

								} //

								if (out1.session_id != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.session_id);

								} //

								if (out1.company_id != null) { //
									row_tLogRow_2[7] = String.valueOf(out1.company_id);

								} //

								if (out1.card_type != null) { //
									row_tLogRow_2[8] = String.valueOf(out1.card_type);

								} //

								if (out1.cardholder_name != null) { //
									row_tLogRow_2[9] = String.valueOf(out1.cardholder_name);

								} //

								if (out1.transaction_id != null) { //
									row_tLogRow_2[10] = String.valueOf(out1.transaction_id);

								} //

								if (out1.payment_status != null) { //
									row_tLogRow_2[11] = String.valueOf(out1.payment_status);

								} //

								if (out1.ticket != null) { //
									row_tLogRow_2[12] = String.valueOf(out1.ticket);

								} //

								if (out1.is_change != null) { //
									row_tLogRow_2[13] = String.valueOf(out1.is_change);

								} //

								if (out1.account_move_id != null) { //
									row_tLogRow_2[14] = String.valueOf(out1.account_move_id);

								} //

								if (out1.create_uid != null) { //
									row_tLogRow_2[15] = String.valueOf(out1.create_uid);

								} //

								if (out1.create_date != null) { //
									row_tLogRow_2[16] = FormatterUtils.format_Date(out1.create_date, "dd-MM-yyyy");

								} //

								if (out1.write_uid != null) { //
									row_tLogRow_2[17] = String.valueOf(out1.write_uid);

								} //

								if (out1.write_date != null) { //
									row_tLogRow_2[18] = FormatterUtils.format_Date(out1.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.pos_order_id != null) {
									sb_tFileOutputDelimited_2.append(row3.pos_order_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.amount != null) {
									sb_tFileOutputDelimited_2.append(row3.amount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.payment_method_id != null) {
									sb_tFileOutputDelimited_2.append(row3.payment_method_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.payment_date != null) {
									sb_tFileOutputDelimited_2
											.append(FormatterUtils.format_Date(row3.payment_date, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.card_type != null) {
									sb_tFileOutputDelimited_2.append(row3.card_type);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.cardholder_name != null) {
									sb_tFileOutputDelimited_2.append(row3.cardholder_name);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.transaction_id != null) {
									sb_tFileOutputDelimited_2.append(row3.transaction_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.payment_status != null) {
									sb_tFileOutputDelimited_2.append(row3.payment_status);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.ticket != null) {
									sb_tFileOutputDelimited_2.append(row3.ticket);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.is_change != null) {
									sb_tFileOutputDelimited_2.append(row3.is_change);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.account_move_id != null) {
									sb_tFileOutputDelimited_2.append(row3.account_move_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
// for output
								...
								row6.id = row4.id;
								row6.name = row4.name;
								row6.pos_order_id = row4.pos_order_id;
								row6.amount = row4.amount;
								row6.payment_method_id = row4.payment_method_id;
								row6.payment_date = row4.payment_date;
								row6.session_id = row4.session_id;
								row6.company_id = row4.company_id;
								row6.card_type = row4.card_type;
								row6.cardholder_name = row4.cardholder_name;
								row6.transaction_id = row4.transaction_id;
								row6.payment_status = row4.payment_status;
								row6.ticket = row4.ticket;
								row6.is_change = row4.is_change;
								row6.account_move_id = row4.account_move_id;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dailyJobStage_posPayment dailyJobStage_posPaymentClass = new dailyJobStage_posPayment();

		int exitCode = dailyJobStage_posPaymentClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_posPayment.class.getClassLoader().getResourceAsStream(
					"pacifico/dailyjobstage_pospayment_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_posPayment.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_posPayment");
		}
...
/************************************************************************************************
 * 329992 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:37:05 PM CST
 ************************************************************************************************/