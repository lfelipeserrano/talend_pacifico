		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:lNDGa/TvI3ouxwDLwnh2As1uJ17fqeTACyAvZx9FK2/H1tAMSHotkWQvd0xAKY12DTSSGxzjlxLt6rL7u9p/l2p0ng8=");
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row2.client_order_ref = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_signature", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_payment", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_invoice_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_shipping_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"currency_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.analytic_account_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount_untaxed", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.payment_term_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"team_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.commitment_date = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 36;

							row2.show_update_pricelist = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.sale_order_template_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "id", "campaign_id", "source_id", "medium_id",
						"message_main_attachment_id", "access_token", "name", "origin", "client_order_ref", "reference",
						"state", "date_order", "validity_date", "require_signature", "require_payment", "create_date",
						"user_id", "partner_id", "partner_invoice_id", "partner_shipping_id", "pricelist_id",
						"currency_id", "analytic_account_id", "invoice_status", "note", "amount_untaxed", "amount_tax",
						"amount_total", "currency_rate", "payment_term_id", "fiscal_position_id", "company_id",
						"team_id", "signed_by", "signed_on", "commitment_date", "show_update_pricelist", "create_uid",
						"write_uid", "write_date", "sale_order_template_id", "incoterm", "picking_policy",
						"warehouse_id", "procurement_group_id", "effective_date", });
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							row5.client_order_ref = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_signature", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_payment", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_invoice_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_shipping_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"currency_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.analytic_account_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount_untaxed", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.payment_term_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"team_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.commitment_date = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 36;

							row5.show_update_pricelist = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							row5.sale_order_template_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"warehouse_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
///////////////////////		
							...
							if (row6.campaign_id != null) { //
								row_tLogRow_1[1] = String.valueOf(row6.campaign_id);

							} //

							if (row6.source_id != null) { //
								row_tLogRow_1[2] = String.valueOf(row6.source_id);

							} //

							if (row6.medium_id != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.medium_id);

							} //

							if (row6.message_main_attachment_id != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.message_main_attachment_id);

							} //

							if (row6.access_token != null) { //
								row_tLogRow_1[5] = String.valueOf(row6.access_token);

							} //

							if (row6.name != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.name);

							} //

							if (row6.origin != null) { //
								row_tLogRow_1[7] = String.valueOf(row6.origin);

							} //

							if (row6.client_order_ref != null) { //
								row_tLogRow_1[8] = String.valueOf(row6.client_order_ref);

							} //

							if (row6.reference != null) { //
								row_tLogRow_1[9] = String.valueOf(row6.reference);

							} //

							if (row6.state != null) { //
								row_tLogRow_1[10] = String.valueOf(row6.state);

							} //

							if (row6.date_order != null) { //
								row_tLogRow_1[11] = FormatterUtils.format_Date(row6.date_order, "dd-MM-yyyy");

							} //

							if (row6.validity_date != null) { //
								row_tLogRow_1[12] = String.valueOf(row6.validity_date);

							} //

							if (row6.require_signature != null) { //
								row_tLogRow_1[13] = String.valueOf(row6.require_signature);

							} //

							if (row6.require_payment != null) { //
								row_tLogRow_1[14] = String.valueOf(row6.require_payment);

							} //

							if (row6.create_date != null) { //
								row_tLogRow_1[15] = FormatterUtils.format_Date(row6.create_date, "dd-MM-yyyy");

							} //

							if (row6.user_id != null) { //
								row_tLogRow_1[16] = String.valueOf(row6.user_id);

							} //

							if (row6.partner_id != null) { //
								row_tLogRow_1[17] = String.valueOf(row6.partner_id);

							} //

							if (row6.partner_invoice_id != null) { //
								row_tLogRow_1[18] = String.valueOf(row6.partner_invoice_id);

							} //

							if (row6.partner_shipping_id != null) { //
								row_tLogRow_1[19] = String.valueOf(row6.partner_shipping_id);

							} //

							if (row6.pricelist_id != null) { //
								row_tLogRow_1[20] = String.valueOf(row6.pricelist_id);

							} //

							if (row6.currency_id != null) { //
								row_tLogRow_1[21] = String.valueOf(row6.currency_id);

							} //

							if (row6.analytic_account_id != null) { //
								row_tLogRow_1[22] = String.valueOf(row6.analytic_account_id);

							} //

							if (row6.invoice_status != null) { //
								row_tLogRow_1[23] = String.valueOf(row6.invoice_status);

							} //

							if (row6.note != null) { //
								row_tLogRow_1[24] = String.valueOf(row6.note);

							} //

							if (row6.amount_untaxed != null) { //
								row_tLogRow_1[25] = String.valueOf(row6.amount_untaxed);

							} //

							if (row6.amount_tax != null) { //
								row_tLogRow_1[26] = String.valueOf(row6.amount_tax);

							} //

							if (row6.amount_total != null) { //
								row_tLogRow_1[27] = String.valueOf(row6.amount_total);

							} //

							if (row6.currency_rate != null) { //
								row_tLogRow_1[28] = String.valueOf(row6.currency_rate);

							} //

							if (row6.payment_term_id != null) { //
								row_tLogRow_1[29] = String.valueOf(row6.payment_term_id);

							} //

							if (row6.fiscal_position_id != null) { //
								row_tLogRow_1[30] = String.valueOf(row6.fiscal_position_id);

							} //

							if (row6.company_id != null) { //
								row_tLogRow_1[31] = String.valueOf(row6.company_id);

							} //

							if (row6.team_id != null) { //
								row_tLogRow_1[32] = String.valueOf(row6.team_id);

							} //

							if (row6.signed_by != null) { //
								row_tLogRow_1[33] = String.valueOf(row6.signed_by);

							} //

							if (row6.signed_on != null) { //
								row_tLogRow_1[34] = String.valueOf(row6.signed_on);

							} //

							if (row6.commitment_date != null) { //
								row_tLogRow_1[35] = String.valueOf(row6.commitment_date);

							} //

							if (row6.show_update_pricelist != null) { //
								row_tLogRow_1[36] = String.valueOf(row6.show_update_pricelist);

							} //

							if (row6.create_uid != null) { //
								row_tLogRow_1[37] = String.valueOf(row6.create_uid);

							} //

							if (row6.write_uid != null) { //
								row_tLogRow_1[38] = String.valueOf(row6.write_uid);

							} //

							if (row6.write_date != null) { //
								row_tLogRow_1[39] = FormatterUtils.format_Date(row6.write_date, "dd-MM-yyyy");

							} //

							if (row6.sale_order_template_id != null) { //
								row_tLogRow_1[40] = String.valueOf(row6.sale_order_template_id);

							} //

							if (row6.incoterm != null) { //
								row_tLogRow_1[41] = String.valueOf(row6.incoterm);

							} //

							if (row6.picking_policy != null) { //
								row_tLogRow_1[42] = String.valueOf(row6.picking_policy);

							} //

							if (row6.warehouse_id != null) { //
								row_tLogRow_1[43] = String.valueOf(row6.warehouse_id);

							} //

							if (row6.procurement_group_id != null) { //
								row_tLogRow_1[44] = String.valueOf(row6.procurement_group_id);

							} //

							if (row6.effective_date != null) { //
								row_tLogRow_1[45] = String.valueOf(row6.effective_date);
...
///////////////////////    			
							...
							if (row7.campaign_id != null) {
								sb_tFileOutputDelimited_1.append(row7.campaign_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.source_id != null) {
								sb_tFileOutputDelimited_1.append(row7.source_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.medium_id != null) {
								sb_tFileOutputDelimited_1.append(row7.medium_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.access_token != null) {
								sb_tFileOutputDelimited_1.append(row7.access_token);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.name != null) {
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.origin != null) {
								sb_tFileOutputDelimited_1.append(row7.origin);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.client_order_ref != null) {
								sb_tFileOutputDelimited_1.append(row7.client_order_ref);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.reference != null) {
								sb_tFileOutputDelimited_1.append(row7.reference);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.state != null) {
							...
							if (row7.validity_date != null) {
								sb_tFileOutputDelimited_1.append(row7.validity_date);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.require_signature != null) {
								sb_tFileOutputDelimited_1.append(row7.require_signature);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.require_payment != null) {
								sb_tFileOutputDelimited_1.append(row7.require_payment);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.partner_invoice_id != null) {
								sb_tFileOutputDelimited_1.append(row7.partner_invoice_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.partner_shipping_id != null) {
								sb_tFileOutputDelimited_1.append(row7.partner_shipping_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.currency_id != null) {
								sb_tFileOutputDelimited_1.append(row7.currency_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.analytic_account_id != null) {
								sb_tFileOutputDelimited_1.append(row7.analytic_account_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.invoice_status != null) {
								sb_tFileOutputDelimited_1.append(row7.invoice_status);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.note != null) {
							...
							if (row7.amount_untaxed != null) {
								sb_tFileOutputDelimited_1.append(row7.amount_untaxed);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.payment_term_id != null) {
								sb_tFileOutputDelimited_1.append(row7.payment_term_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.signed_by != null) {
								sb_tFileOutputDelimited_1.append(row7.signed_by);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.signed_on != null) {
								sb_tFileOutputDelimited_1.append(row7.signed_on);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.commitment_date != null) {
								sb_tFileOutputDelimited_1.append(row7.commitment_date);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.show_update_pricelist != null) {
								sb_tFileOutputDelimited_1.append(row7.show_update_pricelist);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.sale_order_template_id != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_order_template_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.incoterm != null) {
								sb_tFileOutputDelimited_1.append(row7.incoterm);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.picking_policy != null) {
								sb_tFileOutputDelimited_1.append(row7.picking_policy);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.warehouse_id != null) {
								sb_tFileOutputDelimited_1.append(row7.warehouse_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.effective_date != null) {
								sb_tFileOutputDelimited_1.append(row7.effective_date);
							}
				...
				util_tLogRow_2.addRow(new String[] { "id", "campaign_id", "source_id", "medium_id",
						"message_main_attachment_id", "access_token", "name", "origin", "client_order_ref", "reference",
						"state", "date_order", "validity_date", "require_signature", "require_payment", "create_date",
						"user_id", "partner_id", "partner_invoice_id", "partner_shipping_id", "pricelist_id",
						"currency_id", "analytic_account_id", "invoice_status", "note", "amount_untaxed", "amount_tax",
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.client_order_ref = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_signature", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_payment", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_invoice_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"partner_shipping_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"currency_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.analytic_account_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount_untaxed", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.payment_term_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"team_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.commitment_date = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 36;

							row1.show_update_pricelist = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.sale_order_template_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
								...
								if (out1.campaign_id != null) { //
									row_tLogRow_2[1] = String.valueOf(out1.campaign_id);

								} //

								if (out1.source_id != null) { //
									row_tLogRow_2[2] = String.valueOf(out1.source_id);

								} //

								if (out1.medium_id != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.medium_id);

								} //

								if (out1.message_main_attachment_id != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.message_main_attachment_id);

								} //

								if (out1.access_token != null) { //
									row_tLogRow_2[5] = String.valueOf(out1.access_token);

								} //

								if (out1.name != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.name);

								} //

								if (out1.origin != null) { //
									row_tLogRow_2[7] = String.valueOf(out1.origin);

								} //

								if (out1.client_order_ref != null) { //
									row_tLogRow_2[8] = String.valueOf(out1.client_order_ref);

								} //

								if (out1.reference != null) { //
									row_tLogRow_2[9] = String.valueOf(out1.reference);

								} //

								if (out1.state != null) { //
									row_tLogRow_2[10] = String.valueOf(out1.state);

								} //

								if (out1.date_order != null) { //
									row_tLogRow_2[11] = FormatterUtils.format_Date(out1.date_order, "dd-MM-yyyy");

								} //

								if (out1.validity_date != null) { //
									row_tLogRow_2[12] = String.valueOf(out1.validity_date);

								} //

								if (out1.require_signature != null) { //
									row_tLogRow_2[13] = String.valueOf(out1.require_signature);

								} //

								if (out1.require_payment != null) { //
									row_tLogRow_2[14] = String.valueOf(out1.require_payment);

								} //

								if (out1.create_date != null) { //
									row_tLogRow_2[15] = FormatterUtils.format_Date(out1.create_date, "dd-MM-yyyy");

								} //

								if (out1.user_id != null) { //
									row_tLogRow_2[16] = String.valueOf(out1.user_id);

								} //

								if (out1.partner_id != null) { //
									row_tLogRow_2[17] = String.valueOf(out1.partner_id);

								} //

								if (out1.partner_invoice_id != null) { //
									row_tLogRow_2[18] = String.valueOf(out1.partner_invoice_id);

								} //

								if (out1.partner_shipping_id != null) { //
									row_tLogRow_2[19] = String.valueOf(out1.partner_shipping_id);

								} //

								if (out1.pricelist_id != null) { //
									row_tLogRow_2[20] = String.valueOf(out1.pricelist_id);

								} //

								if (out1.currency_id != null) { //
									row_tLogRow_2[21] = String.valueOf(out1.currency_id);

								} //

								if (out1.analytic_account_id != null) { //
									row_tLogRow_2[22] = String.valueOf(out1.analytic_account_id);

								} //

								if (out1.invoice_status != null) { //
									row_tLogRow_2[23] = String.valueOf(out1.invoice_status);

								} //

								if (out1.note != null) { //
									row_tLogRow_2[24] = String.valueOf(out1.note);

								} //

								if (out1.amount_untaxed != null) { //
									row_tLogRow_2[25] = String.valueOf(out1.amount_untaxed);

								} //

								if (out1.amount_tax != null) { //
									row_tLogRow_2[26] = String.valueOf(out1.amount_tax);

								} //

								if (out1.amount_total != null) { //
									row_tLogRow_2[27] = String.valueOf(out1.amount_total);

								} //

								if (out1.currency_rate != null) { //
									row_tLogRow_2[28] = String.valueOf(out1.currency_rate);

								} //

								if (out1.payment_term_id != null) { //
									row_tLogRow_2[29] = String.valueOf(out1.payment_term_id);

								} //

								if (out1.fiscal_position_id != null) { //
									row_tLogRow_2[30] = String.valueOf(out1.fiscal_position_id);

								} //

								if (out1.company_id != null) { //
									row_tLogRow_2[31] = String.valueOf(out1.company_id);

								} //

								if (out1.team_id != null) { //
									row_tLogRow_2[32] = String.valueOf(out1.team_id);

								} //

								if (out1.signed_by != null) { //
									row_tLogRow_2[33] = String.valueOf(out1.signed_by);

								} //

								if (out1.signed_on != null) { //
									row_tLogRow_2[34] = String.valueOf(out1.signed_on);

								} //

								if (out1.commitment_date != null) { //
									row_tLogRow_2[35] = String.valueOf(out1.commitment_date);

								} //

								if (out1.show_update_pricelist != null) { //
									row_tLogRow_2[36] = String.valueOf(out1.show_update_pricelist);

								} //

								if (out1.create_uid != null) { //
									row_tLogRow_2[37] = String.valueOf(out1.create_uid);

								} //

								if (out1.write_uid != null) { //
									row_tLogRow_2[38] = String.valueOf(out1.write_uid);

								} //

								if (out1.write_date != null) { //
									row_tLogRow_2[39] = FormatterUtils.format_Date(out1.write_date, "dd-MM-yyyy");

								} //

								if (out1.sale_order_template_id != null) { //
									row_tLogRow_2[40] = String.valueOf(out1.sale_order_template_id);

								} //

								if (out1.incoterm != null) { //
									row_tLogRow_2[41] = String.valueOf(out1.incoterm);

								} //

								if (out1.picking_policy != null) { //
									row_tLogRow_2[42] = String.valueOf(out1.picking_policy);

								} //

								if (out1.warehouse_id != null) { //
									row_tLogRow_2[43] = String.valueOf(out1.warehouse_id);

								} //

								if (out1.procurement_group_id != null) { //
									row_tLogRow_2[44] = String.valueOf(out1.procurement_group_id);

								} //

								if (out1.effective_date != null) { //
									row_tLogRow_2[45] = String.valueOf(out1.effective_date);
...
///////////////////////    			
								...
								if (row3.campaign_id != null) {
									sb_tFileOutputDelimited_2.append(row3.campaign_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.source_id != null) {
									sb_tFileOutputDelimited_2.append(row3.source_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.medium_id != null) {
									sb_tFileOutputDelimited_2.append(row3.medium_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.access_token != null) {
									sb_tFileOutputDelimited_2.append(row3.access_token);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.name != null) {
								...
								if (row3.client_order_ref != null) {
									sb_tFileOutputDelimited_2.append(row3.client_order_ref);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.reference != null) {
									sb_tFileOutputDelimited_2.append(row3.reference);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.state != null) {
								...
								if (row3.validity_date != null) {
									sb_tFileOutputDelimited_2.append(row3.validity_date);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.require_signature != null) {
									sb_tFileOutputDelimited_2.append(row3.require_signature);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.require_payment != null) {
									sb_tFileOutputDelimited_2.append(row3.require_payment);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.partner_invoice_id != null) {
									sb_tFileOutputDelimited_2.append(row3.partner_invoice_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.partner_shipping_id != null) {
									sb_tFileOutputDelimited_2.append(row3.partner_shipping_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.currency_id != null) {
									sb_tFileOutputDelimited_2.append(row3.currency_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.analytic_account_id != null) {
									sb_tFileOutputDelimited_2.append(row3.analytic_account_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.invoice_status != null) {
									sb_tFileOutputDelimited_2.append(row3.invoice_status);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.note != null) {
								...
								if (row3.amount_untaxed != null) {
									sb_tFileOutputDelimited_2.append(row3.amount_untaxed);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.payment_term_id != null) {
									sb_tFileOutputDelimited_2.append(row3.payment_term_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.signed_by != null) {
									sb_tFileOutputDelimited_2.append(row3.signed_by);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.signed_on != null) {
									sb_tFileOutputDelimited_2.append(row3.signed_on);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.commitment_date != null) {
									sb_tFileOutputDelimited_2.append(row3.commitment_date);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.show_update_pricelist != null) {
									sb_tFileOutputDelimited_2.append(row3.show_update_pricelist);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.sale_order_template_id != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_order_template_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.incoterm != null) {
									sb_tFileOutputDelimited_2.append(row3.incoterm);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.picking_policy != null) {
									sb_tFileOutputDelimited_2.append(row3.picking_policy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.warehouse_id != null) {
									sb_tFileOutputDelimited_2.append(row3.warehouse_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.effective_date != null) {
									sb_tFileOutputDelimited_2.append(row3.effective_date);
								}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_saleOrder.class.getClassLoader()
					.getResourceAsStream("pacifico/dailyjobstage_saleorder_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_saleOrder.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_saleOrder");
		}
...
/************************************************************************************************
 * 553390 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:55:27 PM CST
 ************************************************************************************************/