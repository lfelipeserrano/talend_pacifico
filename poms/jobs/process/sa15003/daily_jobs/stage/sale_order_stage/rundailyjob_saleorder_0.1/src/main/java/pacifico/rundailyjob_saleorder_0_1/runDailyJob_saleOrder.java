...
public class runDailyJob_saleOrder implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_saleOrder.class.getClassLoader()
					.getResourceAsStream("pacifico/rundailyjob_saleorder_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_saleOrder.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_saleOrder");
		}
...
/************************************************************************************************
 * 37057 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:48:39 PM CST
 ************************************************************************************************/