...
package pacifico.dailyjobstage_producttemplate_0_1;
...
/**
 * Job: dailyJobStage_productTemplate Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class dailyJobStage_productTemplate implements TalendJob {
	...
	private final String jobName = "dailyJobStage_productTemplate";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dailyJobStage_productTemplate.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dailyJobStage_productTemplate.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:/d1TCbiu8cys+M7SLhRYgvvpYLnW1fA7ChoWfeluJ4ziMzqZ+jNIK/doyvp36Ks+ahqMaHFzrk2hwZg25o9BhmXYH6E=");
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_dailyJobStage_productTemplate = new byte[0];
		static byte[] commonByteArray_PACIFICO_dailyJobStage_productTemplate = new byte[0];
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_productTemplate) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "row2", temp, ex_tFileInputDelimited_2),
							...
							row2.description_purchase = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row2.description_sale = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							row2.detailed_type = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.categ_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"categ_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.list_price = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"list_price", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.list_price = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.volume = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"volume", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.weight = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"weight", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.sale_ok = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_ok", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.purchase_ok = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"purchase_ok", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.purchase_ok = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.uom_po_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_po_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.default_code = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.can_image_1024_be_zoomed = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"can_image_1024_be_zoomed", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.can_image_1024_be_zoomed = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.has_configurable_attributes = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"has_configurable_attributes", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.has_configurable_attributes = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.priority = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"priority", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.service_type = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 29;

							row2.sale_line_warn = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 30;

							row2.sale_line_warn_msg = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 31;

							row2.expense_policy = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 32;

							row2.invoice_policy = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.sale_delay = ParserUtils.parseTo_Float(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_delay", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.sale_delay = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 34;

							row2.tracking = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 35;

							row2.description_picking = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 36;

							row2.description_pickingout = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 37;

							row2.description_pickingin = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 38;

							row2.available_in_pos = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 39;

							row2.to_weight = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 40;

							row2.pos_categ_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.description_purchase = row2.description_purchase;

							row2_HashRow.description_sale = row2.description_sale;

							row2_HashRow.detailed_type = row2.detailed_type;

							row2_HashRow.type = row2.type;

							row2_HashRow.categ_id = row2.categ_id;

							row2_HashRow.list_price = row2.list_price;

							row2_HashRow.volume = row2.volume;

							row2_HashRow.weight = row2.weight;

							row2_HashRow.sale_ok = row2.sale_ok;

							row2_HashRow.purchase_ok = row2.purchase_ok;

							row2_HashRow.uom_id = row2.uom_id;

							row2_HashRow.uom_po_id = row2.uom_po_id;
							...
							row2_HashRow.default_code = row2.default_code;

							row2_HashRow.can_image_1024_be_zoomed = row2.can_image_1024_be_zoomed;

							row2_HashRow.has_configurable_attributes = row2.has_configurable_attributes;

							row2_HashRow.priority = row2.priority;
							...
							row2_HashRow.service_type = row2.service_type;

							row2_HashRow.sale_line_warn = row2.sale_line_warn;

							row2_HashRow.sale_line_warn_msg = row2.sale_line_warn_msg;

							row2_HashRow.expense_policy = row2.expense_policy;

							row2_HashRow.invoice_policy = row2.invoice_policy;

							row2_HashRow.sale_delay = row2.sale_delay;

							row2_HashRow.tracking = row2.tracking;

							row2_HashRow.description_picking = row2.description_picking;

							row2_HashRow.description_pickingout = row2.description_pickingout;

							row2_HashRow.description_pickingin = row2.description_pickingin;

							row2_HashRow.available_in_pos = row2.available_in_pos;

							row2_HashRow.to_weight = row2.to_weight;

							row2_HashRow.pos_categ_id = row2.pos_categ_id;
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_dailyJobStage_productTemplate.length) {
					if (length < 1024 && commonByteArray_PACIFICO_dailyJobStage_productTemplate.length == 0) {
						commonByteArray_PACIFICO_dailyJobStage_productTemplate = new byte[1024];
					} else {
						commonByteArray_PACIFICO_dailyJobStage_productTemplate = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_dailyJobStage_productTemplate, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_productTemplate, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_dailyJobStage_productTemplate, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_productTemplate, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_productTemplate) {
				...
				try {
					...
					this.description_purchase = readString(dis);

					this.description_sale = readString(dis);

					this.detailed_type = readString(dis);

					this.type = readString(dis);

					this.categ_id = readInteger(dis);

					this.list_price = readInteger(dis);
					...
					this.uom_id = readInteger(dis);

					this.uom_po_id = readInteger(dis);
					...
					this.sale_line_warn = readString(dis);

					this.sale_line_warn_msg = readString(dis);

					this.expense_policy = readString(dis);

					this.invoice_policy = readString(dis);
					...
					this.tracking = readString(dis);

					this.description_picking = readString(dis);

					this.description_pickingout = readString(dis);

					this.description_pickingin = readString(dis);

					this.available_in_pos = readString(dis);

					this.to_weight = readString(dis);

					this.pos_categ_id = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.description_purchase, dos);

				// String

				writeString(this.description_sale, dos);

				// String

				writeString(this.detailed_type, dos);
				...
				writeInteger(this.categ_id, dos);

				// Integer

				writeInteger(this.list_price, dos);
				...
				writeInteger(this.uom_id, dos);

				// Integer

				writeInteger(this.uom_po_id, dos);
				...
				writeString(this.sale_line_warn, dos);

				// String

				writeString(this.sale_line_warn_msg, dos);

				// String

				writeString(this.expense_policy, dos);

				// String

				writeString(this.invoice_policy, dos);
				...
				writeString(this.tracking, dos);

				// String

				writeString(this.description_picking, dos);

				// String

				writeString(this.description_pickingout, dos);

				// String

				writeString(this.description_pickingin, dos);

				// String

				writeString(this.available_in_pos, dos);

				// String

				writeString(this.to_weight, dos);

				// String

				writeString(this.pos_categ_id, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("description_purchase");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("description_sale");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("detailed_type");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("type");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("categ_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("list_price");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("volume");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("weight");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("sale_ok");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("purchase_ok");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("uom_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("uom_po_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("default_code");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("can_image_1024_be_zoomed");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("has_configurable_attributes");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("service_type");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("sale_line_warn");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("sale_line_warn_msg");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("expense_policy");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("invoice_policy");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("sale_delay");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("tracking");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("description_picking");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("description_pickingout");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("description_pickingin");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("available_in_pos");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("to_weight");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("pos_categ_id");
				...
				util_tLogRow_1.addRow(new String[] { "id", "message_main_attachment_id", "name", "sequence",
						"description", "description_purchase", "description_sale", "detailed_type", "type", "categ_id",
						"list_price", "volume", "weight", "sale_ok", "purchase_ok", "uom_id", "uom_po_id", "company_id",
						"active", "color", "default_code", "can_image_1024_be_zoomed", "has_configurable_attributes",
						"priority", "create_uid", "create_date", "write_uid", "write_date", "service_type",
						"sale_line_warn", "sale_line_warn_msg", "expense_policy", "invoice_policy", "sale_delay",
						"tracking", "description_picking", "description_pickingout", "description_pickingin",
						"available_in_pos", "to_weight", "pos_categ_id", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.sequence = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "row5", temp, ex_tFileInputDelimited_3),
							...
							row5.description = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 5;

							row5.description_purchase = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 6;

							row5.description_sale = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 7;

							row5.detailed_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.categ_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"categ_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.list_price = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"list_price", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.list_price = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.volume = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"volume", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.weight = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"weight", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.sale_ok = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_ok", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.purchase_ok = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"purchase_ok", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.purchase_ok = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.uom_po_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_po_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.color = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 20;

							row5.default_code = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.can_image_1024_be_zoomed = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"can_image_1024_be_zoomed", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.can_image_1024_be_zoomed = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.has_configurable_attributes = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"has_configurable_attributes", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.has_configurable_attributes = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.priority = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"priority", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							row5.service_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 29;

							row5.sale_line_warn = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 30;

							row5.sale_line_warn_msg = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 31;

							row5.expense_policy = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 32;

							row5.invoice_policy = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.sale_delay = ParserUtils.parseTo_Float(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_delay", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.sale_delay = null;

							}

							columnIndexWithD_tFileInputDelimited_3 = 34;

							row5.tracking = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 35;

							row5.description_picking = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 36;

							row5.description_pickingout = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 37;

							row5.description_pickingin = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 38;

							row5.available_in_pos = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 39;

							row5.to_weight = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 40;

							row5.pos_categ_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
							...
							row6.description_purchase = row5.description_purchase;
							row6.description_sale = row5.description_sale;
							row6.detailed_type = row5.detailed_type;
							row6.type = row5.type;
							row6.categ_id = row5.categ_id;
							row6.list_price = row5.list_price;
							row6.volume = row5.volume;
							row6.weight = row5.weight;
							row6.sale_ok = row5.sale_ok;
							row6.purchase_ok = row5.purchase_ok;
							row6.uom_id = row5.uom_id;
							row6.uom_po_id = row5.uom_po_id;
							row6.company_id = row5.company_id;
							row6.active = row5.active;
							row6.color = row5.color;
							row6.default_code = row5.default_code;
							row6.can_image_1024_be_zoomed = row5.can_image_1024_be_zoomed;
							row6.has_configurable_attributes = row5.has_configurable_attributes;
							row6.priority = row5.priority;
							...
							row6.service_type = row5.service_type;
							row6.sale_line_warn = row5.sale_line_warn;
							row6.sale_line_warn_msg = row5.sale_line_warn_msg;
							row6.expense_policy = row5.expense_policy;
							row6.invoice_policy = row5.invoice_policy;
							row6.sale_delay = row5.sale_delay;
							row6.tracking = row5.tracking;
							row6.description_picking = row5.description_picking;
							row6.description_pickingout = row5.description_pickingout;
							row6.description_pickingin = row5.description_pickingin;
							row6.available_in_pos = row5.available_in_pos;
							row6.to_weight = row5.to_weight;
							row6.pos_categ_id = row5.pos_categ_id;
...
///////////////////////		
							...
							if (row6.name != null) { //
								row_tLogRow_1[2] = String.valueOf(row6.name);

							} //

							if (row6.sequence != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.sequence);

							} //

							if (row6.description != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.description);

							} //

							if (row6.description_purchase != null) { //
								row_tLogRow_1[5] = String.valueOf(row6.description_purchase);

							} //

							if (row6.description_sale != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.description_sale);

							} //

							if (row6.detailed_type != null) { //
								row_tLogRow_1[7] = String.valueOf(row6.detailed_type);

							} //

							if (row6.type != null) { //
								row_tLogRow_1[8] = String.valueOf(row6.type);

							} //

							if (row6.categ_id != null) { //
								row_tLogRow_1[9] = String.valueOf(row6.categ_id);

							} //

							if (row6.list_price != null) { //
								row_tLogRow_1[10] = String.valueOf(row6.list_price);

							} //

							if (row6.volume != null) { //
								row_tLogRow_1[11] = String.valueOf(row6.volume);

							} //

							if (row6.weight != null) { //
								row_tLogRow_1[12] = String.valueOf(row6.weight);

							} //

							if (row6.sale_ok != null) { //
								row_tLogRow_1[13] = String.valueOf(row6.sale_ok);

							} //

							if (row6.purchase_ok != null) { //
								row_tLogRow_1[14] = String.valueOf(row6.purchase_ok);

							} //

							if (row6.uom_id != null) { //
								row_tLogRow_1[15] = String.valueOf(row6.uom_id);

							} //

							if (row6.uom_po_id != null) { //
								row_tLogRow_1[16] = String.valueOf(row6.uom_po_id);

							} //

							if (row6.company_id != null) { //
								row_tLogRow_1[17] = String.valueOf(row6.company_id);

							} //

							if (row6.active != null) { //
								row_tLogRow_1[18] = String.valueOf(row6.active);

							} //

							if (row6.color != null) { //
								row_tLogRow_1[19] = String.valueOf(row6.color);

							} //

							if (row6.default_code != null) { //
								row_tLogRow_1[20] = String.valueOf(row6.default_code);

							} //

							if (row6.can_image_1024_be_zoomed != null) { //
								row_tLogRow_1[21] = String.valueOf(row6.can_image_1024_be_zoomed);

							} //

							if (row6.has_configurable_attributes != null) { //
								row_tLogRow_1[22] = String.valueOf(row6.has_configurable_attributes);

							} //

							if (row6.priority != null) { //
								row_tLogRow_1[23] = String.valueOf(row6.priority);

							} //

							if (row6.create_uid != null) { //
								row_tLogRow_1[24] = String.valueOf(row6.create_uid);

							} //

							if (row6.create_date != null) { //
								row_tLogRow_1[25] = FormatterUtils.format_Date(row6.create_date, "dd-MM-yyyy");

							} //

							if (row6.write_uid != null) { //
								row_tLogRow_1[26] = String.valueOf(row6.write_uid);

							} //

							if (row6.write_date != null) { //
								row_tLogRow_1[27] = FormatterUtils.format_Date(row6.write_date, "dd-MM-yyyy");

							} //

							if (row6.service_type != null) { //
								row_tLogRow_1[28] = String.valueOf(row6.service_type);

							} //

							if (row6.sale_line_warn != null) { //
								row_tLogRow_1[29] = String.valueOf(row6.sale_line_warn);

							} //

							if (row6.sale_line_warn_msg != null) { //
								row_tLogRow_1[30] = String.valueOf(row6.sale_line_warn_msg);

							} //

							if (row6.expense_policy != null) { //
								row_tLogRow_1[31] = String.valueOf(row6.expense_policy);

							} //

							if (row6.invoice_policy != null) { //
								row_tLogRow_1[32] = String.valueOf(row6.invoice_policy);

							} //

							if (row6.sale_delay != null) { //
								row_tLogRow_1[33] = FormatterUtils.formatUnwithE(row6.sale_delay);

							} //

							if (row6.tracking != null) { //
								row_tLogRow_1[34] = String.valueOf(row6.tracking);

							} //

							if (row6.description_picking != null) { //
								row_tLogRow_1[35] = String.valueOf(row6.description_picking);

							} //

							if (row6.description_pickingout != null) { //
								row_tLogRow_1[36] = String.valueOf(row6.description_pickingout);

							} //

							if (row6.description_pickingin != null) { //
								row_tLogRow_1[37] = String.valueOf(row6.description_pickingin);

							} //

							if (row6.available_in_pos != null) { //
								row_tLogRow_1[38] = String.valueOf(row6.available_in_pos);

							} //

							if (row6.to_weight != null) { //
								row_tLogRow_1[39] = String.valueOf(row6.to_weight);

							} //

							if (row6.pos_categ_id != null) { //
								row_tLogRow_1[40] = String.valueOf(row6.pos_categ_id);
...
///////////////////////    			
							...
							if (row7.sequence != null) {
								sb_tFileOutputDelimited_1.append(row7.sequence);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.description != null) {
								sb_tFileOutputDelimited_1.append(row7.description);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.description_purchase != null) {
								sb_tFileOutputDelimited_1.append(row7.description_purchase);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.description_sale != null) {
								sb_tFileOutputDelimited_1.append(row7.description_sale);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.detailed_type != null) {
								sb_tFileOutputDelimited_1.append(row7.detailed_type);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.type != null) {
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.categ_id != null) {
								sb_tFileOutputDelimited_1.append(row7.categ_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.list_price != null) {
								sb_tFileOutputDelimited_1.append(row7.list_price);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.volume != null) {
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.sale_ok != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_ok);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.purchase_ok != null) {
								sb_tFileOutputDelimited_1.append(row7.purchase_ok);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.uom_id != null) {
								sb_tFileOutputDelimited_1.append(row7.uom_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.uom_po_id != null) {
								sb_tFileOutputDelimited_1.append(row7.uom_po_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.default_code != null) {
								sb_tFileOutputDelimited_1.append(row7.default_code);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.can_image_1024_be_zoomed != null) {
								sb_tFileOutputDelimited_1.append(row7.can_image_1024_be_zoomed);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.has_configurable_attributes != null) {
								sb_tFileOutputDelimited_1.append(row7.has_configurable_attributes);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.priority != null) {
								sb_tFileOutputDelimited_1.append(row7.priority);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.service_type != null) {
								sb_tFileOutputDelimited_1.append(row7.service_type);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.sale_line_warn != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_line_warn);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.sale_line_warn_msg != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_line_warn_msg);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.expense_policy != null) {
								sb_tFileOutputDelimited_1.append(row7.expense_policy);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.invoice_policy != null) {
								sb_tFileOutputDelimited_1.append(row7.invoice_policy);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.sale_delay != null) {
								sb_tFileOutputDelimited_1.append(row7.sale_delay);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.tracking != null) {
								sb_tFileOutputDelimited_1.append(row7.tracking);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.description_picking != null) {
								sb_tFileOutputDelimited_1.append(row7.description_picking);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.description_pickingout != null) {
								sb_tFileOutputDelimited_1.append(row7.description_pickingout);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.description_pickingin != null) {
								sb_tFileOutputDelimited_1.append(row7.description_pickingin);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.available_in_pos != null) {
								sb_tFileOutputDelimited_1.append(row7.available_in_pos);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.to_weight != null) {
								sb_tFileOutputDelimited_1.append(row7.to_weight);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.pos_categ_id != null) {
								sb_tFileOutputDelimited_1.append(row7.pos_categ_id);
							}
				...
				util_tLogRow_2.addRow(new String[] { "id", "message_main_attachment_id", "name", "sequence",
						"description", "description_purchase", "description_sale", "detailed_type", "type", "categ_id",
						"list_price", "volume", "weight", "sale_ok", "purchase_ok", "uom_id", "uom_po_id", "company_id",
						"active", "color", "default_code", "can_image_1024_be_zoomed", "has_configurable_attributes",
						"priority", "create_uid", "create_date", "write_uid", "write_date", "service_type",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "row1", temp, ex_tFileInputDelimited_1),
							...
							row1.description_purchase = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.description_sale = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							row1.detailed_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.categ_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"categ_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.list_price = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"list_price", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.volume = ParserUtils.parseTo_Integer(temp);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.weight = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"weight", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.sale_ok = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_ok", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.purchase_ok = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"purchase_ok", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.purchase_ok = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.uom_po_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_po_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.default_code = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.can_image_1024_be_zoomed = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"can_image_1024_be_zoomed", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.can_image_1024_be_zoomed = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.has_configurable_attributes = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"has_configurable_attributes", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.has_configurable_attributes = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.priority = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"priority", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.service_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 29;

							row1.sale_line_warn = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 30;

							row1.sale_line_warn_msg = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 31;

							row1.expense_policy = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 32;

							row1.invoice_policy = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.sale_delay = ParserUtils.parseTo_Float(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_delay", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.sale_delay = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 34;

							row1.tracking = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 35;

							row1.description_picking = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 36;

							row1.description_pickingout = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 37;

							row1.description_pickingin = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 38;

							row1.available_in_pos = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 39;

							row1.to_weight = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 40;

							row1.pos_categ_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									out1_tmp.description_purchase = row1.description_purchase;
									out1_tmp.description_sale = row1.description_sale;
									out1_tmp.detailed_type = row1.detailed_type;
									out1_tmp.type = row1.type;
									out1_tmp.categ_id = row1.categ_id;
									out1_tmp.list_price = row1.list_price;
									out1_tmp.volume = row1.volume;
									out1_tmp.weight = row1.weight;
									out1_tmp.sale_ok = row1.sale_ok;
									out1_tmp.purchase_ok = row1.purchase_ok;
									out1_tmp.uom_id = row1.uom_id;
									out1_tmp.uom_po_id = row1.uom_po_id;
									out1_tmp.company_id = row1.company_id;
									out1_tmp.active = row1.active;
									out1_tmp.color = row1.color;
									out1_tmp.default_code = row1.default_code;
									out1_tmp.can_image_1024_be_zoomed = row1.can_image_1024_be_zoomed;
									out1_tmp.has_configurable_attributes = row1.has_configurable_attributes;
									out1_tmp.priority = row1.priority;
									...
									out1_tmp.service_type = row1.service_type;
									out1_tmp.sale_line_warn = row1.sale_line_warn;
									out1_tmp.sale_line_warn_msg = row1.sale_line_warn_msg;
									out1_tmp.expense_policy = row1.expense_policy;
									out1_tmp.invoice_policy = row1.invoice_policy;
									out1_tmp.sale_delay = row1.sale_delay;
									out1_tmp.tracking = row1.tracking;
									out1_tmp.description_picking = row1.description_picking;
									out1_tmp.description_pickingout = row1.description_pickingout;
									out1_tmp.description_pickingin = row1.description_pickingin;
									out1_tmp.available_in_pos = row1.available_in_pos;
									out1_tmp.to_weight = row1.to_weight;
									out1_tmp.pos_categ_id = row1.pos_categ_id;
									out1 = out1_tmp;
...
///////////////////////		
								...
								String[] row_tLogRow_2 = new String[41];
								...
								if (out1.name != null) { //
									row_tLogRow_2[2] = String.valueOf(out1.name);

								} //

								if (out1.sequence != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.sequence);

								} //

								if (out1.description != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.description);

								} //

								if (out1.description_purchase != null) { //
									row_tLogRow_2[5] = String.valueOf(out1.description_purchase);

								} //

								if (out1.description_sale != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.description_sale);

								} //

								if (out1.detailed_type != null) { //
									row_tLogRow_2[7] = String.valueOf(out1.detailed_type);

								} //

								if (out1.type != null) { //
									row_tLogRow_2[8] = String.valueOf(out1.type);

								} //

								if (out1.categ_id != null) { //
									row_tLogRow_2[9] = String.valueOf(out1.categ_id);

								} //

								if (out1.list_price != null) { //
									row_tLogRow_2[10] = String.valueOf(out1.list_price);

								} //

								if (out1.volume != null) { //
									row_tLogRow_2[11] = String.valueOf(out1.volume);

								} //

								if (out1.weight != null) { //
									row_tLogRow_2[12] = String.valueOf(out1.weight);

								} //

								if (out1.sale_ok != null) { //
									row_tLogRow_2[13] = String.valueOf(out1.sale_ok);

								} //

								if (out1.purchase_ok != null) { //
									row_tLogRow_2[14] = String.valueOf(out1.purchase_ok);

								} //

								if (out1.uom_id != null) { //
									row_tLogRow_2[15] = String.valueOf(out1.uom_id);

								} //

								if (out1.uom_po_id != null) { //
									row_tLogRow_2[16] = String.valueOf(out1.uom_po_id);

								} //

								if (out1.company_id != null) { //
									row_tLogRow_2[17] = String.valueOf(out1.company_id);

								} //

								if (out1.active != null) { //
									row_tLogRow_2[18] = String.valueOf(out1.active);

								} //

								if (out1.color != null) { //
									row_tLogRow_2[19] = String.valueOf(out1.color);

								} //

								if (out1.default_code != null) { //
									row_tLogRow_2[20] = String.valueOf(out1.default_code);

								} //

								if (out1.can_image_1024_be_zoomed != null) { //
									row_tLogRow_2[21] = String.valueOf(out1.can_image_1024_be_zoomed);

								} //

								if (out1.has_configurable_attributes != null) { //
									row_tLogRow_2[22] = String.valueOf(out1.has_configurable_attributes);

								} //

								if (out1.priority != null) { //
									row_tLogRow_2[23] = String.valueOf(out1.priority);

								} //

								if (out1.create_uid != null) { //
									row_tLogRow_2[24] = String.valueOf(out1.create_uid);

								} //

								if (out1.create_date != null) { //
									row_tLogRow_2[25] = FormatterUtils.format_Date(out1.create_date, "dd-MM-yyyy");

								} //

								if (out1.write_uid != null) { //
									row_tLogRow_2[26] = String.valueOf(out1.write_uid);

								} //

								if (out1.write_date != null) { //
									row_tLogRow_2[27] = FormatterUtils.format_Date(out1.write_date, "dd-MM-yyyy");

								} //

								if (out1.service_type != null) { //
									row_tLogRow_2[28] = String.valueOf(out1.service_type);

								} //

								if (out1.sale_line_warn != null) { //
									row_tLogRow_2[29] = String.valueOf(out1.sale_line_warn);

								} //

								if (out1.sale_line_warn_msg != null) { //
									row_tLogRow_2[30] = String.valueOf(out1.sale_line_warn_msg);

								} //

								if (out1.expense_policy != null) { //
									row_tLogRow_2[31] = String.valueOf(out1.expense_policy);

								} //

								if (out1.invoice_policy != null) { //
									row_tLogRow_2[32] = String.valueOf(out1.invoice_policy);

								} //

								if (out1.sale_delay != null) { //
									row_tLogRow_2[33] = FormatterUtils.formatUnwithE(out1.sale_delay);

								} //

								if (out1.tracking != null) { //
									row_tLogRow_2[34] = String.valueOf(out1.tracking);

								} //

								if (out1.description_picking != null) { //
									row_tLogRow_2[35] = String.valueOf(out1.description_picking);

								} //

								if (out1.description_pickingout != null) { //
									row_tLogRow_2[36] = String.valueOf(out1.description_pickingout);

								} //

								if (out1.description_pickingin != null) { //
									row_tLogRow_2[37] = String.valueOf(out1.description_pickingin);

								} //

								if (out1.available_in_pos != null) { //
									row_tLogRow_2[38] = String.valueOf(out1.available_in_pos);

								} //

								if (out1.to_weight != null) { //
									row_tLogRow_2[39] = String.valueOf(out1.to_weight);

								} //

								if (out1.pos_categ_id != null) { //
									row_tLogRow_2[40] = String.valueOf(out1.pos_categ_id);
...
///////////////////////    			
								...
								if (row3.sequence != null) {
									sb_tFileOutputDelimited_2.append(row3.sequence);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.description != null) {
									sb_tFileOutputDelimited_2.append(row3.description);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.description_purchase != null) {
									sb_tFileOutputDelimited_2.append(row3.description_purchase);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.description_sale != null) {
									sb_tFileOutputDelimited_2.append(row3.description_sale);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.detailed_type != null) {
									sb_tFileOutputDelimited_2.append(row3.detailed_type);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.type != null) {
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.categ_id != null) {
									sb_tFileOutputDelimited_2.append(row3.categ_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.list_price != null) {
									sb_tFileOutputDelimited_2.append(row3.list_price);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.volume != null) {
									sb_tFileOutputDelimited_2.append(row3.volume);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.weight != null) {
									sb_tFileOutputDelimited_2.append(row3.weight);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.sale_ok != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_ok);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.purchase_ok != null) {
									sb_tFileOutputDelimited_2.append(row3.purchase_ok);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.uom_id != null) {
									sb_tFileOutputDelimited_2.append(row3.uom_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.uom_po_id != null) {
									sb_tFileOutputDelimited_2.append(row3.uom_po_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.default_code != null) {
									sb_tFileOutputDelimited_2.append(row3.default_code);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.can_image_1024_be_zoomed != null) {
									sb_tFileOutputDelimited_2.append(row3.can_image_1024_be_zoomed);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.has_configurable_attributes != null) {
									sb_tFileOutputDelimited_2.append(row3.has_configurable_attributes);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.service_type != null) {
									sb_tFileOutputDelimited_2.append(row3.service_type);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.sale_line_warn != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_line_warn);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.sale_line_warn_msg != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_line_warn_msg);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.expense_policy != null) {
									sb_tFileOutputDelimited_2.append(row3.expense_policy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.invoice_policy != null) {
									sb_tFileOutputDelimited_2.append(row3.invoice_policy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.sale_delay != null) {
									sb_tFileOutputDelimited_2.append(row3.sale_delay);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.tracking != null) {
									sb_tFileOutputDelimited_2.append(row3.tracking);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.description_picking != null) {
									sb_tFileOutputDelimited_2.append(row3.description_picking);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.description_pickingout != null) {
									sb_tFileOutputDelimited_2.append(row3.description_pickingout);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.description_pickingin != null) {
									sb_tFileOutputDelimited_2.append(row3.description_pickingin);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.available_in_pos != null) {
									sb_tFileOutputDelimited_2.append(row3.available_in_pos);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.to_weight != null) {
									sb_tFileOutputDelimited_2.append(row3.to_weight);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.pos_categ_id != null) {
									sb_tFileOutputDelimited_2.append(row3.pos_categ_id);
								}
...
// for output
								...
								row6.description_purchase = row4.description_purchase;
								row6.description_sale = row4.description_sale;
								row6.detailed_type = row4.detailed_type;
								row6.type = row4.type;
								row6.categ_id = row4.categ_id;
								row6.list_price = row4.list_price;
								row6.volume = row4.volume;
								row6.weight = row4.weight;
								row6.sale_ok = row4.sale_ok;
								row6.purchase_ok = row4.purchase_ok;
								row6.uom_id = row4.uom_id;
								row6.uom_po_id = row4.uom_po_id;
								row6.company_id = row4.company_id;
								row6.active = row4.active;
								row6.color = row4.color;
								row6.default_code = row4.default_code;
								row6.can_image_1024_be_zoomed = row4.can_image_1024_be_zoomed;
								row6.has_configurable_attributes = row4.has_configurable_attributes;
								row6.priority = row4.priority;
								...
								row6.service_type = row4.service_type;
								row6.sale_line_warn = row4.sale_line_warn;
								row6.sale_line_warn_msg = row4.sale_line_warn_msg;
								row6.expense_policy = row4.expense_policy;
								row6.invoice_policy = row4.invoice_policy;
								row6.sale_delay = row4.sale_delay;
								row6.tracking = row4.tracking;
								row6.description_picking = row4.description_picking;
								row6.description_pickingout = row4.description_pickingout;
								row6.description_pickingin = row4.description_pickingin;
								row6.available_in_pos = row4.available_in_pos;
								row6.to_weight = row4.to_weight;
								row6.pos_categ_id = row4.pos_categ_id;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dailyJobStage_productTemplate dailyJobStage_productTemplateClass = new dailyJobStage_productTemplate();

		int exitCode = dailyJobStage_productTemplateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_productTemplate.class.getClassLoader().getResourceAsStream(
					"pacifico/dailyjobstage_producttemplate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_productTemplate.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_productTemplate");
		}
...
/************************************************************************************************
 * 536869 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:51:03 PM CST
 ************************************************************************************************/