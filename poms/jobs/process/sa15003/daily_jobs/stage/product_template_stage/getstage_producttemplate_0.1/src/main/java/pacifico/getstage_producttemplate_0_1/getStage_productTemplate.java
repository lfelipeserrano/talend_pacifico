...
public class getStage_productTemplate implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:WgvRtaVAgKpukY542BaVC2/CemZ2w6pL+KqSAUvhw4PI2p2NvHBaSLmAs+ULB2SRAf6jeKFL6NjiTBNsgmgdL3moMyk=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "productTemplate_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_productTemplate.class.getClassLoader().getResourceAsStream(
					"pacifico/getstage_producttemplate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_productTemplate.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getStage_productTemplate");
		}
...
/************************************************************************************************
 * 38840 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:49:25 PM CST
 ************************************************************************************************/