...
public class getStage_posSession implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:eScNl/i1p2ykfxll7vXutYRC9oIBzaE7drsCZKn0YuWoRp8uyWptIlVTcsmlFjoO5KG/UqMSReHGCoS9xpXXviFUWyg=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "posSession_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_posSession.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_possession_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_posSession.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_posSession");
		}
...
/************************************************************************************************
 * 38760 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:38:40 PM CST
 ************************************************************************************************/