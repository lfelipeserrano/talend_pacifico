...
public class runDailyJob_posSession implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_posSession.class.getClassLoader()
					.getResourceAsStream("pacifico/rundailyjob_possession_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_posSession.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_posSession");
		}
 ...
 * December 5, 2022 at 10:42:09 PM CST
 ************************************************************************************************/