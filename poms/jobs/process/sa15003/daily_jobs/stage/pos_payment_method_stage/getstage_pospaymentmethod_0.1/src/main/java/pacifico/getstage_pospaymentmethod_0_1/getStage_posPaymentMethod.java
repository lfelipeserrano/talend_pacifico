...
public class getStage_posPaymentMethod implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:sOU0avpc/5q6YxL8OvtVYPpW8yVCDsMz6wbKT+5a3mlVUpmmjqcizXeY5mMv/PKXEusUr184hL/4eGRi36vjmJ04pmY=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "posPaymentMethod_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_posPaymentMethod.class.getClassLoader().getResourceAsStream(
					"pacifico/getstage_pospaymentmethod_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_posPaymentMethod.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getStage_posPaymentMethod");
		}
...
/************************************************************************************************
 * 38856 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:44:54 PM CST
 ************************************************************************************************/