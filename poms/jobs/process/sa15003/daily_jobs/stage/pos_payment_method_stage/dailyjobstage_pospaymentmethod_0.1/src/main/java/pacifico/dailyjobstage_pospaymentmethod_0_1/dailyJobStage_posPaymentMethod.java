...
package pacifico.dailyjobstage_pospaymentmethod_0_1;
...
/**
 * Job: dailyJobStage_posPaymentMethod Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class dailyJobStage_posPaymentMethod implements TalendJob {
	...
	private final String jobName = "dailyJobStage_posPaymentMethod";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dailyJobStage_posPaymentMethod.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dailyJobStage_posPaymentMethod.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:0MC3hTYDqVnjhWMy0NK/AvChfCF/h0hTSRyFeiQd6YiztEdMwHx29vXIGAPFlTRLNsc9CucUoSTUyQXz+NMD7VstxnM=");
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_dailyJobStage_posPaymentMethod = new byte[0];
		static byte[] commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod = new byte[0];
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_posPaymentMethod) {
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row2.outstanding_account_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row2.receivable_account_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.is_cash_count = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_cash_count", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.is_cash_count = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 5;

							row2.journal_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.split_transactions = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"split_transactions", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.split_transactions = null;
							...
							row2.use_payment_terminal = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.outstanding_account_id = row2.outstanding_account_id;

							row2_HashRow.receivable_account_id = row2.receivable_account_id;

							row2_HashRow.is_cash_count = row2.is_cash_count;

							row2_HashRow.journal_id = row2.journal_id;

							row2_HashRow.split_transactions = row2.split_transactions;

							row2_HashRow.company_id = row2.company_id;

							row2_HashRow.use_payment_terminal = row2.use_payment_terminal;
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod.length) {
					if (length < 1024 && commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod.length == 0) {
						commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod = new byte[1024];
					} else {
						commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_posPaymentMethod, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_posPaymentMethod) {
				...
				try {
					...
					this.outstanding_account_id = readString(dis);

					this.receivable_account_id = readString(dis);
					...
					this.journal_id = readString(dis);
					...
					this.use_payment_terminal = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.outstanding_account_id, dos);

				// String

				writeString(this.receivable_account_id, dos);
				...
				writeString(this.journal_id, dos);
				...
				writeString(this.use_payment_terminal, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("outstanding_account_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("receivable_account_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("is_cash_count");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("journal_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("split_transactions");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("company_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("use_payment_terminal");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
				...
				util_tLogRow_1.addRow(new String[] { "id", "name", "outstanding_account_id", "receivable_account_id",
						"is_cash_count", "journal_id", "split_transactions", "company_id", "use_payment_terminal",
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							row5.outstanding_account_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 3;

							row5.receivable_account_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.is_cash_count = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_cash_count", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.is_cash_count = null;

							}

							columnIndexWithD_tFileInputDelimited_3 = 5;

							row5.journal_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.split_transactions = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"split_transactions", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.split_transactions = null;
							...
							row5.use_payment_terminal = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
							...
							row6.id = row5.id;
							row6.name = row5.name;
							row6.outstanding_account_id = row5.outstanding_account_id;
							row6.receivable_account_id = row5.receivable_account_id;
							row6.is_cash_count = row5.is_cash_count;
							row6.journal_id = row5.journal_id;
							row6.split_transactions = row5.split_transactions;
							row6.company_id = row5.company_id;
							row6.use_payment_terminal = row5.use_payment_terminal;
...
///////////////////////		
							...
							if (row6.outstanding_account_id != null) { //
								row_tLogRow_1[2] = String.valueOf(row6.outstanding_account_id);

							} //

							if (row6.receivable_account_id != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.receivable_account_id);

							} //

							if (row6.is_cash_count != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.is_cash_count);

							} //

							if (row6.journal_id != null) { //
								row_tLogRow_1[5] = String.valueOf(row6.journal_id);

							} //

							if (row6.split_transactions != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.split_transactions);
							...
							if (row6.use_payment_terminal != null) { //
								row_tLogRow_1[8] = String.valueOf(row6.use_payment_terminal);

							} //

							if (row6.active != null) { //
								row_tLogRow_1[9] = String.valueOf(row6.active);
							...
							if (row6.create_date != null) { //
								row_tLogRow_1[11] = FormatterUtils.format_Date(row6.create_date, "dd-MM-yyyy");
							...
							if (row6.write_date != null) { //
								row_tLogRow_1[13] = FormatterUtils.format_Date(row6.write_date, "dd-MM-yyyy");
...
///////////////////////    			
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.outstanding_account_id != null) {
								sb_tFileOutputDelimited_1.append(row7.outstanding_account_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.receivable_account_id != null) {
								sb_tFileOutputDelimited_1.append(row7.receivable_account_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.is_cash_count != null) {
								sb_tFileOutputDelimited_1.append(row7.is_cash_count);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.journal_id != null) {
								sb_tFileOutputDelimited_1.append(row7.journal_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.split_transactions != null) {
								sb_tFileOutputDelimited_1.append(row7.split_transactions);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.use_payment_terminal != null) {
								sb_tFileOutputDelimited_1.append(row7.use_payment_terminal);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.active != null) {
				...
				util_tLogRow_2.addRow(new String[] { "id", "name", "outstanding_account_id", "receivable_account_id",
						"is_cash_count", "journal_id", "split_transactions", "company_id", "use_payment_terminal",
						"active", "create_uid", "create_date", "write_uid", "write_date", });
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.outstanding_account_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.receivable_account_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.is_cash_count = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_cash_count", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.is_cash_count = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.journal_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.split_transactions = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"split_transactions", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.split_transactions = null;
							...
							row1.use_payment_terminal = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									out1_tmp.outstanding_account_id = row1.outstanding_account_id;
									out1_tmp.receivable_account_id = row1.receivable_account_id;
									out1_tmp.is_cash_count = row1.is_cash_count;
									out1_tmp.journal_id = row1.journal_id;
									out1_tmp.split_transactions = row1.split_transactions;
									out1_tmp.company_id = row1.company_id;
									out1_tmp.use_payment_terminal = row1.use_payment_terminal;
...
///////////////////////		
								...
								if (out1.outstanding_account_id != null) { //
									row_tLogRow_2[2] = String.valueOf(out1.outstanding_account_id);

								} //

								if (out1.receivable_account_id != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.receivable_account_id);

								} //

								if (out1.is_cash_count != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.is_cash_count);

								} //

								if (out1.journal_id != null) { //
									row_tLogRow_2[5] = String.valueOf(out1.journal_id);

								} //

								if (out1.split_transactions != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.split_transactions);
								...
								if (out1.use_payment_terminal != null) { //
									row_tLogRow_2[8] = String.valueOf(out1.use_payment_terminal);

								} //

								if (out1.active != null) { //
									row_tLogRow_2[9] = String.valueOf(out1.active);
								...
								if (out1.create_date != null) { //
									row_tLogRow_2[11] = FormatterUtils.format_Date(out1.create_date, "dd-MM-yyyy");
								...
								if (out1.write_date != null) { //
									row_tLogRow_2[13] = FormatterUtils.format_Date(out1.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.outstanding_account_id != null) {
									sb_tFileOutputDelimited_2.append(row3.outstanding_account_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.receivable_account_id != null) {
									sb_tFileOutputDelimited_2.append(row3.receivable_account_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.is_cash_count != null) {
									sb_tFileOutputDelimited_2.append(row3.is_cash_count);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.journal_id != null) {
									sb_tFileOutputDelimited_2.append(row3.journal_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.split_transactions != null) {
									sb_tFileOutputDelimited_2.append(row3.split_transactions);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.use_payment_terminal != null) {
									sb_tFileOutputDelimited_2.append(row3.use_payment_terminal);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.active != null) {
...
// for output
								...
								row6.id = row4.id;
								row6.name = row4.name;
								row6.outstanding_account_id = row4.outstanding_account_id;
								row6.receivable_account_id = row4.receivable_account_id;
								row6.is_cash_count = row4.is_cash_count;
								row6.journal_id = row4.journal_id;
								row6.split_transactions = row4.split_transactions;
								row6.company_id = row4.company_id;
								row6.use_payment_terminal = row4.use_payment_terminal;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dailyJobStage_posPaymentMethod dailyJobStage_posPaymentMethodClass = new dailyJobStage_posPaymentMethod();

		int exitCode = dailyJobStage_posPaymentMethodClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_posPaymentMethod.class.getClassLoader().getResourceAsStream(
					"pacifico/dailyjobstage_pospaymentmethod_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_posPaymentMethod.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_posPaymentMethod");
		}
...
/************************************************************************************************
 * 304048 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:47:21 PM CST
 ************************************************************************************************/