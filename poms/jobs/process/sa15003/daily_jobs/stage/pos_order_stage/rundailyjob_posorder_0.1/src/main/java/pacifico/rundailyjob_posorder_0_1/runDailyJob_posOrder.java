...
public class runDailyJob_posOrder implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_posOrder.class.getClassLoader()
					.getResourceAsStream("pacifico/rundailyjob_posorder_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_posOrder.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_posOrder");
		}
...
/************************************************************************************************
 * 37035 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:41:09 PM CST
 ************************************************************************************************/