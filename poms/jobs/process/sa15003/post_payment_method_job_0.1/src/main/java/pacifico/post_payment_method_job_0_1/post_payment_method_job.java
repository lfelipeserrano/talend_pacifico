...
public class post_payment_method_job implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:WAmRpk0NwSgJFM6fDzEZloLjSQR+Fcj2gbPvwX8ki6pJKDLf0Q==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jZ6NV7upr2QF2MaxcZ1EpZvYMQ94VfrJLGWbsD09H0hbAc+15nIdj5K/+PjbWBPccYZPY2J+1nhQOeKOCrGRdLOxAMw=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "pos_payment_method.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = post_payment_method_job.class.getClassLoader()
					.getResourceAsStream("pacifico/post_payment_method_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = post_payment_method_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : post_payment_method_job");
		}
...
/************************************************************************************************
 * 81798 characters generated by Talend Open Studio for Data Integration on the
 * October 23, 2022 at 11:06:20 PM CST
 ************************************************************************************************/