...
package pacifico.sale_order_job_0_1;
 ...
 * @status
 */
public class sale_order_job implements TalendJob {
	...
	private final String jobName = "sale_order_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					sale_order_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(sale_order_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_sale_order_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_sale_order_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_sale_order_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_sale_order_job.length == 0) {
						commonByteArray_PACIFICO_sale_order_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_sale_order_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_sale_order_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_sale_order_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_sale_order_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_sale_order_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_sale_order_job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LogMHn154JvNlhaghjG4NBOe0oTu2vd1zL8fudL6P1aeB1+zgw==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:r4xMZLQ4IlA400zZLXKGqSio/dUUfWxNmeEpFIJPvIra8fd43gHbmUTzUNac9naLnGGtDEr38ZXSXucO+nVtqw3FCeI=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "sale_order.csv";
	...
	public static void main(String[] args) {
		final sale_order_job sale_order_jobClass = new sale_order_job();

		int exitCode = sale_order_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = sale_order_job.class.getClassLoader()
					.getResourceAsStream("pacifico/sale_order_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sale_order_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : sale_order_job");
		}
...
/************************************************************************************************
 * 123565 characters generated by Talend Open Studio for Data Integration on the
 * October 23, 2022 at 11:08:46 PM CST
 ************************************************************************************************/