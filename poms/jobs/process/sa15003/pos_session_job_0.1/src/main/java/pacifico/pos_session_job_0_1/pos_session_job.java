...
public class pos_session_job implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:6flcMR56N6w1Z3i7uNe0eVj5bCe05yPnQYVerOU+5IDjA3p60A==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:yMy/MnAuXSRe8sVKNhGRmtC9HWQ/Tfj7TTvr4UzIWPjo4HcC28r0Czzuo2sLePuw9vFMDnZp/1dsM7NArNJnu9t5GKc=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "pos_session.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pos_session_job.class.getClassLoader()
					.getResourceAsStream("pacifico/pos_session_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pos_session_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_session_job");
		}
...
/************************************************************************************************
 * 93093 characters generated by Talend Open Studio for Data Integration on the
 * October 23, 2022 at 11:04:09 PM CST
 ************************************************************************************************/