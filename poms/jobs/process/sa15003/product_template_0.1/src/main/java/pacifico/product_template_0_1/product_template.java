...
package pacifico.product_template_0_1;
...
/**
 * Job: product_template Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class product_template implements TalendJob {
	...
	private final String jobName = "product_template";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					product_template.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(product_template.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_product_template = new byte[0];
		static byte[] commonByteArray_PACIFICO_product_template = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_product_template.length) {
					if (length < 1024 && commonByteArray_PACIFICO_product_template.length == 0) {
						commonByteArray_PACIFICO_product_template = new byte[1024];
					} else {
						commonByteArray_PACIFICO_product_template = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_product_template, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_product_template, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_product_template, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_product_template, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_product_template) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:nk/zkLcuE457joMUmTAAMwfGengkUO2CtKWb0QE6IwDj4qLxhg==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:z/pn20cds4CwT3UutuoEOYMcJgiNOZSb8IlovcHISZHBw8fKCD82u7H/fr5Fwj5uvEUUGgtaNqJsMULAngDtmKx79HA=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "product_template.csv";
	...
	public static void main(String[] args) {
		final product_template product_templateClass = new product_template();

		int exitCode = product_templateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = product_template.class.getClassLoader()
					.getResourceAsStream("pacifico/product_template_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = product_template.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_template");
		}
...
/************************************************************************************************
 * 119811 characters generated by Talend Open Studio for Data Integration on the
 * October 23, 2022 at 11:07:58 PM CST
 ************************************************************************************************/