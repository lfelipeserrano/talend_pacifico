...
package pacifico.rundailyjob_productproduct_0_1;
...
/**
 * Job: runDailyJob_productProduct Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_productProduct implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_productProduct";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_productProduct.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_productProduct.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_productproduct_0_1.getStage_productProduct childJob_tRunJob_3 = new pacifico.getstage_productproduct_0_1.getStage_productProduct();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_productproduct_0_1.dailyJobStage_productProduct childJob_tRunJob_1 = new pacifico.dailyjobstage_productproduct_0_1.dailyJobStage_productProduct();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_productProduct runDailyJob_productProductClass = new runDailyJob_productProduct();

        int exitCode = runDailyJob_productProductClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_productProduct.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_productproduct_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_productProduct.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_productProduct");
        }
...
/************************************************************************************************
 *     37167 characters generated by Talend Open Studio for Data Integration 
