...
public class runDailyJob_productProduct implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_productProduct.class.getClassLoader().getResourceAsStream(
					"pacifico/rundailyjob_productproduct_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_productProduct.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runDailyJob_productProduct");
		}
...
/************************************************************************************************
 * 37167 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:37:59 PM CST
 ************************************************************************************************/