...
package pacifico.dailyjobstage_rescountry_0_1;
...
/**
 * Job: dailyJobStage_resCountry Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class dailyJobStage_resCountry implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dailyJobStage_resCountry";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dailyJobStage_resCountry.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dailyJobStage_resCountry.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_dailyJobStage_resCountry) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.currency_id = readString(dis);
					
					this.phone_code = readString(dis);
					
					this.name_position = readString(dis);
					
					this.vat_label = readString(dis);
					
					this.state_required = readString(dis);
					
					this.zip_required = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.address_view_id,dos);
					
					// String
				
						writeString(this.currency_id,dos);
					
					// String
				
						writeString(this.phone_code,dos);
					...
					// String
						...
						writeString(this.state_required,dos);
					
					// String
				
						writeString(this.zip_required,dos);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","name","code","address_view_id","currency_id","phone_code","name_position","vat_label","state_required","zip_required","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 2;
							...
							row5.code = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 3;
					
							row5.address_view_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
			...
			row6.name_position = row5.name_position;								
			row6.vat_label = row5.vat_label;								
			row6.state_required = row5.state_required;								
			row6.zip_required = row5.zip_required;								
...
///////////////////////		
	    		...
	    		if(row6.address_view_id != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row6.address_view_id)			
					          ;	
	    		...
	    		if(row6.phone_code != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row6.phone_code)			
					          ;	
	    		...
	    		if(row6.name_position != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row6.name_position)			
					          ;	
	    		...
	    		if(row6.state_required != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(row6.state_required)			
					          ;	
	    		...
	    		if(row6.zip_required != null) { //              
                 row_tLogRow_1[9]=    						    
				                String.valueOf(row6.zip_required)			
					          ;	
	    		...
	    		if(row6.create_date != null) { //              
                 row_tLogRow_1[11]=    						    
				                String.valueOf(row6.create_date)			
					          ;	
	    		...
	    		if(row6.write_date != null) { //              
                 row_tLogRow_1[13]=    						    
				                String.valueOf(row6.write_date)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.phone_code != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.phone_code
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.name_position != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.name_position
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.vat_label != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.vat_label
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.state_required != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.state_required
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.zip_required != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.zip_required
                        );
                            }
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","name","code","address_view_id","currency_id","phone_code","name_position","vat_label","state_required","zip_required","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							row1.address_view_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
out1_tmp.name_position = row1.name_position ;
out1_tmp.vat_label = row1.vat_label ;
out1_tmp.state_required = row1.state_required ;
out1_tmp.zip_required = row1.zip_required ;
...
///////////////////////		
	    		...
	    		if(out1.address_view_id != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(out1.address_view_id)			
					          ;	
	    		...
	    		if(out1.phone_code != null) { //              
                 row_tLogRow_2[5]=    						    
				                String.valueOf(out1.phone_code)			
					          ;	
	    		...
	    		if(out1.name_position != null) { //              
                 row_tLogRow_2[6]=    						    
				                String.valueOf(out1.name_position)			
					          ;	
	    		...
	    		if(out1.state_required != null) { //              
                 row_tLogRow_2[8]=    						    
				                String.valueOf(out1.state_required)			
					          ;	
	    		...
	    		if(out1.zip_required != null) { //              
                 row_tLogRow_2[9]=    						    
				                String.valueOf(out1.zip_required)			
					          ;	
	    		...
	    		if(out1.create_date != null) { //              
                 row_tLogRow_2[11]=    						    
				                String.valueOf(out1.create_date)			
					          ;	
	    		...
	    		if(out1.write_date != null) { //              
                 row_tLogRow_2[13]=    						    
				                String.valueOf(out1.write_date)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.phone_code != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.phone_code
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.name_position != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.name_position
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.vat_label != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.vat_label
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.state_required != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.state_required
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.zip_required != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.zip_required
                        );
                            }
...
// for output
			...
			row6.name_position = row4.name_position;								
			row6.vat_label = row4.vat_label;								
			row6.state_required = row4.state_required;								
			row6.zip_required = row4.zip_required;								
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Mj7RF9DuAFNNxfNnEKQE9EtAOla6twCV1RFbmcce6b3fhvmX+MV9voKMDvILEjxH7avsKUOzJ9rNIDVDbH0l9+rp9Ug=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "resCountry.csv";
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 3;
							...
							row2.address_view_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
if(row2 != null) { 
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.phone_code = row2.phone_code;
				
				row2_HashRow.name_position = row2.name_position;
				
				row2_HashRow.vat_label = row2.vat_label;
				
				row2_HashRow.state_required = row2.state_required;
				
				row2_HashRow.zip_required = row2.zip_required;
 ...
 */
    ...
    public static void main(String[] args){
        final dailyJobStage_resCountry dailyJobStage_resCountryClass = new dailyJobStage_resCountry();

        int exitCode = dailyJobStage_resCountryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJobStage_resCountry.class.getClassLoader().getResourceAsStream("pacifico/dailyjobstage_rescountry_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJobStage_resCountry.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJobStage_resCountry");
        }
...
/************************************************************************************************
 *     250689 characters generated by Talend Open Studio for Data Integration 
 *     on the December 7, 2022 at 11:47:40 PM CST
 ************************************************************************************************/