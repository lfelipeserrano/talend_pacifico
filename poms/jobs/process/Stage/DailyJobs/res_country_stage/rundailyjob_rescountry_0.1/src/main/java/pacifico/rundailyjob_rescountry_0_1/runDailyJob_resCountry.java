...
package pacifico.rundailyjob_rescountry_0_1;
...
/**
 * Job: runDailyJob_resCountry Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_resCountry implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_resCountry";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_resCountry.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_resCountry.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_rescountry_0_1.getStage_resCountry childJob_tRunJob_3 = new pacifico.getstage_rescountry_0_1.getStage_resCountry();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_rescountry_0_1.dailyJobStage_resCountry childJob_tRunJob_1 = new pacifico.dailyjobstage_rescountry_0_1.dailyJobStage_resCountry();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_resCountry runDailyJob_resCountryClass = new runDailyJob_resCountry();

        int exitCode = runDailyJob_resCountryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_resCountry.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_rescountry_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_resCountry.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_resCountry");
        }
...
/************************************************************************************************
 *     37079 characters generated by Talend Open Studio for Data Integration 
