...
package pacifico.rundailyjob_producttemplate_0_1;
...
/**
 * Job: runDailyJob_productTemplate Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_productTemplate implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_productTemplate";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_productTemplate.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_productTemplate.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_producttemplate_0_1.getStage_productTemplate childJob_tRunJob_3 = new pacifico.getstage_producttemplate_0_1.getStage_productTemplate();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_producttemplate_0_1.dailyJobStage_productTemplate childJob_tRunJob_1 = new pacifico.dailyjobstage_producttemplate_0_1.dailyJobStage_productTemplate();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_productTemplate runDailyJob_productTemplateClass = new runDailyJob_productTemplate();

        int exitCode = runDailyJob_productTemplateClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_productTemplate.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_producttemplate_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_productTemplate.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_productTemplate");
        }
