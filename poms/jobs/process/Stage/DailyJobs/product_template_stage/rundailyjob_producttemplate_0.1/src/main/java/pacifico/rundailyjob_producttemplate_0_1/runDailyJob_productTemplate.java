...
public class runDailyJob_productTemplate implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_productTemplate.class.getClassLoader().getResourceAsStream(
					"pacifico/rundailyjob_producttemplate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_productTemplate.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runDailyJob_productTemplate");
		}
 ...
 * December 7, 2022 at 11:44:10 PM CST
 ************************************************************************************************/