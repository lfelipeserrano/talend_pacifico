...
public class main_stage_job_daily implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main_stage_job_daily.class.getClassLoader()
					.getResourceAsStream("pacifico/main_stage_job_daily_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = main_stage_job_daily.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : main_stage_job_daily");
		}
...
/************************************************************************************************
 * 181783 characters generated by Talend Open Studio for Data Integration on the
 * January 7, 2023 at 10:33:04 PM CST
 ************************************************************************************************/