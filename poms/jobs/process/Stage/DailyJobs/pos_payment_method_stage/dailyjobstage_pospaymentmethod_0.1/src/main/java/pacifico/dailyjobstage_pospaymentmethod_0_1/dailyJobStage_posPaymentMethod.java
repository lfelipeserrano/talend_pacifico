		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dailyJobStage_posPaymentMethod.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","name","outstanding_account_id","receivable_account_id","is_cash_count","journal_id","split_transactions","company_id","use_payment_terminal","active","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 2;
							...
							row5.outstanding_account_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 3;
					
							row5.receivable_account_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_cash_count", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"split_transactions", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 8;
							...
							row5.use_payment_terminal = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
///////////////////////		
	    		...
	    		if(row6.outstanding_account_id != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row6.outstanding_account_id)			
					          ;	
	    		...
	    		if(row6.receivable_account_id != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row6.receivable_account_id)			
					          ;	
	    		...
	    		if(row6.is_cash_count != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row6.is_cash_count)			
					          ;	
	    		...
	    		if(row6.journal_id != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row6.journal_id)			
					          ;	
	    		...
	    		if(row6.split_transactions != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row6.split_transactions)			
					          ;	
	    		...
	    		if(row6.use_payment_terminal != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(row6.use_payment_terminal)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row7.outstanding_account_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.receivable_account_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.receivable_account_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","name","outstanding_account_id","receivable_account_id","is_cash_count","journal_id","split_transactions","company_id","use_payment_terminal","active","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.outstanding_account_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row1.receivable_account_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_cash_count", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"split_transactions", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
							...
							row1.use_payment_terminal = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
	    		...
	    		if(out1.outstanding_account_id != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(out1.outstanding_account_id)			
					          ;	
	    		...
	    		if(out1.receivable_account_id != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(out1.receivable_account_id)			
					          ;	
	    		...
	    		if(out1.is_cash_count != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(out1.is_cash_count)			
					          ;	
	    		...
	    		if(out1.journal_id != null) { //              
                 row_tLogRow_2[5]=    						    
				                String.valueOf(out1.journal_id)			
					          ;	
	    		...
	    		if(out1.split_transactions != null) { //              
                 row_tLogRow_2[6]=    						    
				                String.valueOf(out1.split_transactions)			
					          ;	
	    		...
	    		if(out1.use_payment_terminal != null) { //              
                 row_tLogRow_2[8]=    						    
				                String.valueOf(out1.use_payment_terminal)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            row3.outstanding_account_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.receivable_account_id != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.receivable_account_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:9U00aPBqN+Pz8JJajZd1N8OKeerwSilVeiO1DUPkARpGVv1J7oFCCa7YOqSS//+tArpb7KpU8Asa9Ewgj1q8FlpzI+Q=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posPaymentMethod.csv";
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 2;
							...
							row2.outstanding_account_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 3;
					
							row2.receivable_account_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_cash_count", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"split_transactions", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 8;
							...
							row2.use_payment_terminal = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJobStage_posPaymentMethod.class.getClassLoader().getResourceAsStream("pacifico/dailyjobstage_pospaymentmethod_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJobStage_posPaymentMethod.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJobStage_posPaymentMethod");
        }
...
/************************************************************************************************
 *     304051 characters generated by Talend Open Studio for Data Integration 
 *     on the December 7, 2022 at 11:42:52 PM CST
 ************************************************************************************************/