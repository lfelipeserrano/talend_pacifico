...
package pacifico.getstage_pospaymentmethod_0_1;
...
/**
 * Job: getStage_posPaymentMethod Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getStage_posPaymentMethod implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getStage_posPaymentMethod";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getStage_posPaymentMethod.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getStage_posPaymentMethod.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_getStage_posPaymentMethod = new byte[0];
    static byte[] commonByteArray_PACIFICO_getStage_posPaymentMethod = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_getStage_posPaymentMethod.length) {
				if(length < 1024 && commonByteArray_PACIFICO_getStage_posPaymentMethod.length == 0) {
   					commonByteArray_PACIFICO_getStage_posPaymentMethod = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_getStage_posPaymentMethod = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_getStage_posPaymentMethod, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getStage_posPaymentMethod, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_getStage_posPaymentMethod, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getStage_posPaymentMethod, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_getStage_posPaymentMethod) {
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "posPaymentMethod_" + context.fechaFin.replaceAll("-","") +".csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posPaymentMethod.csv");
 ...
 */
    ...
    public static void main(String[] args){
        final getStage_posPaymentMethod getStage_posPaymentMethodClass = new getStage_posPaymentMethod();

        int exitCode = getStage_posPaymentMethodClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getStage_posPaymentMethod.class.getClassLoader().getResourceAsStream("pacifico/getstage_pospaymentmethod_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getStage_posPaymentMethod.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_posPaymentMethod");
        }
...
/************************************************************************************************
 *     60875 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:11 PM CST
 ************************************************************************************************/