...
package pacifico.rundailyjob_pospaymentmethod_0_1;
...
/**
 * Job: runDailyJob_posPaymentMethod Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_posPaymentMethod implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_posPaymentMethod";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_posPaymentMethod.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_posPaymentMethod.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_pospaymentmethod_0_1.getStage_posPaymentMethod childJob_tRunJob_3 = new pacifico.getstage_pospaymentmethod_0_1.getStage_posPaymentMethod();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_pospaymentmethod_0_1.dailyJobStage_posPaymentMethod childJob_tRunJob_1 = new pacifico.dailyjobstage_pospaymentmethod_0_1.dailyJobStage_posPaymentMethod();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_posPaymentMethod runDailyJob_posPaymentMethodClass = new runDailyJob_posPaymentMethod();

        int exitCode = runDailyJob_posPaymentMethodClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_posPaymentMethod.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_pospaymentmethod_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_posPaymentMethod.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_posPaymentMethod");
        }
