...
package pacifico.getposbillstage_dailyjob_0_1;
...
/**
 * Job: getPosBillStage_DailyJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getPosBillStage_DailyJob implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getPosBillStage_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getPosBillStage_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getPosBillStage_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_getPosBillStage_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_getPosBillStage_DailyJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_getPosBillStage_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_getPosBillStage_DailyJob.length == 0) {
   					commonByteArray_PACIFICO_getPosBillStage_DailyJob = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_getPosBillStage_DailyJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_getPosBillStage_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getPosBillStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_getPosBillStage_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getPosBillStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_getPosBillStage_DailyJob) {
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "posBill_" + context.fechaFin.replaceAll("-","") +".csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posBill.csv");
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.name = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"name", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
///////////////////////		
	    		...
	    		if(row2.name != null) { //              
                 row_tLogRow_2[1]=    						
								FormatterUtils.formatUnwithE(row2.name)
					          ;	
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.name = ParserUtils.parseTo_Float(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"name", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.value = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"value", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
///////////////////////		
	    		...
	    		if(row1.name != null) { //              
                 row_tLogRow_1[1]=    						
								FormatterUtils.formatUnwithE(row1.name)
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final getPosBillStage_DailyJob getPosBillStage_DailyJobClass = new getPosBillStage_DailyJob();

        int exitCode = getPosBillStage_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getPosBillStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/getposbillstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getPosBillStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getPosBillStage_DailyJob");
        }
...
/************************************************************************************************
 *     123528 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:15 PM CST
 ************************************************************************************************/