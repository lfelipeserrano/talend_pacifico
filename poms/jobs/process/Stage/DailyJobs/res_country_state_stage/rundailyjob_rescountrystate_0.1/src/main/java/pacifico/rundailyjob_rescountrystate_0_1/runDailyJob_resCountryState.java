...
package pacifico.rundailyjob_rescountrystate_0_1;
...
/**
 * Job: runDailyJob_resCountryState Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_resCountryState implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_resCountryState";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_resCountryState.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_resCountryState.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_rescountrystate_0_1.getStage_resCountryState childJob_tRunJob_3 = new pacifico.getstage_rescountrystate_0_1.getStage_resCountryState();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_rescountrystate_0_1.dailyJobStage_resCountryState childJob_tRunJob_1 = new pacifico.dailyjobstage_rescountrystate_0_1.dailyJobStage_resCountryState();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_resCountryState runDailyJob_resCountryStateClass = new runDailyJob_resCountryState();

        int exitCode = runDailyJob_resCountryStateClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_resCountryState.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_rescountrystate_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_resCountryState.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_resCountryState");
        }
...
/************************************************************************************************
 *     37189 characters generated by Talend Open Studio for Data Integration 
