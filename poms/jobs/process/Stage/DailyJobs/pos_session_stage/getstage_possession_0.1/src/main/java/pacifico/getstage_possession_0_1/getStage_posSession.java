...
package pacifico.getstage_possession_0_1;
...
/**
 * Job: getStage_posSession Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getStage_posSession implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getStage_posSession";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getStage_posSession.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getStage_posSession.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_getStage_posSession = new byte[0];
    static byte[] commonByteArray_PACIFICO_getStage_posSession = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_getStage_posSession.length) {
				if(length < 1024 && commonByteArray_PACIFICO_getStage_posSession.length == 0) {
   					commonByteArray_PACIFICO_getStage_posSession = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_getStage_posSession = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_getStage_posSession, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getStage_posSession, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_getStage_posSession, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getStage_posSession, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_getStage_posSession) {
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "posSession_" + context.fechaFin.replaceAll("-","") +".csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posSession.csv");
 ...
 */
    ...
    public static void main(String[] args){
        final getStage_posSession getStage_posSessionClass = new getStage_posSession();

        int exitCode = getStage_posSessionClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getStage_posSession.class.getClassLoader().getResourceAsStream("pacifico/getstage_possession_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getStage_posSession.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_posSession");
        }
 ...
 *     on the February 1, 2023 at 11:45:11 PM CST
 ************************************************************************************************/