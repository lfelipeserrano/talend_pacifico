...
package pacifico.rundailyjob_posorderline_0_1;
...
/**
 * Job: runDailyJob_posOrderLine Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_posOrderLine implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_posOrderLine";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_posOrderLine.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_posOrderLine.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_posorderline_0_1.getStage_posOrderLine childJob_tRunJob_3 = new pacifico.getstage_posorderline_0_1.getStage_posOrderLine();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjob_posorderline_0_1.dailyJob_posOrderLine childJob_tRunJob_1 = new pacifico.dailyjob_posorderline_0_1.dailyJob_posOrderLine();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_posOrderLine runDailyJob_posOrderLineClass = new runDailyJob_posOrderLine();

        int exitCode = runDailyJob_posOrderLineClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_posOrderLine.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_posorderline_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_posOrderLine.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_posOrderLine");
        }
...
/************************************************************************************************
 *     37103 characters generated by Talend Open Studio for Data Integration 
