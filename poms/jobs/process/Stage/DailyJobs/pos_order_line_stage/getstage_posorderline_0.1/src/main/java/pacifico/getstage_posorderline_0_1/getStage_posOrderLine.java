...
package pacifico.getstage_posorderline_0_1;
...
/**
 * Job: getStage_posOrderLine Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getStage_posOrderLine implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "getStage_posOrderLine";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getStage_posOrderLine.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getStage_posOrderLine.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2A50/YrfW7TopqCgFaSNN/h7wXWU5m7kswrfkL+MvBxPitjxL9L2POE5AdJDb0L6FHlkHaE9jvdUw7nx3pDRyBZByD4=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "posOrderLine_20221031.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posOrderLine.csv");
...
///////////////////////		
	    		...
	    		if(row2.price_unit != null) { //              
                 row_tLogRow_2[5]=    						
								FormatterUtils.formatUnwithE(row2.price_unit)
					          ;	
	    		...
	    		if(row2.price_subtotal != null) { //              
                 row_tLogRow_2[7]=    						    
				                String.valueOf(row2.price_subtotal)			
					          ;	
	    		...
	    		if(row2.price_subtotal_incl != null) { //              
                 row_tLogRow_2[8]=    						    
				                String.valueOf(row2.price_subtotal_incl)			
					          ;	
	    		...
	    		if(row2.total_cost != null) { //              
                 row_tLogRow_2[9]=    						    
				                String.valueOf(row2.total_cost)			
					          ;	
	    		...
	    		if(row2.is_total_cost_computed != null) { //              
                 row_tLogRow_2[10]=    						    
				                String.valueOf(row2.is_total_cost_computed)			
					          ;	
	    		...
	    		if(row2.discount != null) { //              
                 row_tLogRow_2[11]=    						
								FormatterUtils.formatUnwithE(row2.discount)
					          ;	
	    		...
	    		if(row2.full_product_name != null) { //              
                 row_tLogRow_2[13]=    						    
				                String.valueOf(row2.full_product_name)			
					          ;	
	    		...
	    		if(row2.customer_note != null) { //              
                 row_tLogRow_2[14]=    						    
				                String.valueOf(row2.customer_note)			
					          ;	
	    		...
	    		if(row2.refunded_orderline_id != null) { //              
                 row_tLogRow_2[15]=    						    
				                String.valueOf(row2.refunded_orderline_id)			
					          ;	
	    		...
	    		if(row2.sale_order_origin_id != null) { //              
                 row_tLogRow_2[20]=    						    
				                String.valueOf(row2.sale_order_origin_id)			
					          ;	
	    		...
	    		if(row2.sale_order_line_id != null) { //              
                 row_tLogRow_2[21]=    						    
				                String.valueOf(row2.sale_order_line_id)			
					          ;	
	    		...
	    		if(row2.down_payment_details != null) { //              
                 row_tLogRow_2[22]=    						    
				                String.valueOf(row2.down_payment_details)			
					          ;	
...
///////////////////////		
	    		...
	    		if(row1.price_unit != null) { //              
                 row_tLogRow_1[5]=    						
								FormatterUtils.formatUnwithE(row1.price_unit)
					          ;	
	    		...
	    		if(row1.price_subtotal != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(row1.price_subtotal)			
					          ;	
	    		...
	    		if(row1.price_subtotal_incl != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(row1.price_subtotal_incl)			
					          ;	
	    		...
	    		if(row1.total_cost != null) { //              
                 row_tLogRow_1[9]=    						    
				                String.valueOf(row1.total_cost)			
					          ;	
	    		...
	    		if(row1.is_total_cost_computed != null) { //              
                 row_tLogRow_1[10]=    						    
				                String.valueOf(row1.is_total_cost_computed)			
					          ;	
	    		...
	    		if(row1.discount != null) { //              
                 row_tLogRow_1[11]=    						
								FormatterUtils.formatUnwithE(row1.discount)
					          ;	
	    		...
	    		if(row1.full_product_name != null) { //              
                 row_tLogRow_1[13]=    						    
				                String.valueOf(row1.full_product_name)			
					          ;	
	    		...
	    		if(row1.customer_note != null) { //              
                 row_tLogRow_1[14]=    						    
				                String.valueOf(row1.customer_note)			
					          ;	
	    		...
	    		if(row1.refunded_orderline_id != null) { //              
                 row_tLogRow_1[15]=    						    
				                String.valueOf(row1.refunded_orderline_id)			
					          ;	
	    		...
	    		if(row1.sale_order_origin_id != null) { //              
                 row_tLogRow_1[20]=    						    
				                String.valueOf(row1.sale_order_origin_id)			
					          ;	
	    		...
	    		if(row1.sale_order_line_id != null) { //              
                 row_tLogRow_1[21]=    						    
				                String.valueOf(row1.sale_order_line_id)			
					          ;	
	    		...
	    		if(row1.down_payment_details != null) { //              
                 row_tLogRow_1[22]=    						    
				                String.valueOf(row1.down_payment_details)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final getStage_posOrderLine getStage_posOrderLineClass = new getStage_posOrderLine();

        int exitCode = getStage_posOrderLineClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getStage_posOrderLine.class.getClassLoader().getResourceAsStream("pacifico/getstage_posorderline_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getStage_posOrderLine.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_posOrderLine");
        }
...
/************************************************************************************************
 *     158181 characters generated by Talend Open Studio for Data Integration 
