...
package pacifico.rundailyjob_productattribute_0_1;
...
/**
 * Job: runDailyJob_productAttribute Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_productAttribute implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_productAttribute";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_productAttribute.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_productAttribute.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_productattribute_0_1.getStage_productAttribute childJob_tRunJob_3 = new pacifico.getstage_productattribute_0_1.getStage_productAttribute();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_productattribute_0_1.dailyJobStage_productAttribute childJob_tRunJob_1 = new pacifico.dailyjobstage_productattribute_0_1.dailyJobStage_productAttribute();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_productAttribute runDailyJob_productAttributeClass = new runDailyJob_productAttribute();

        int exitCode = runDailyJob_productAttributeClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_productAttribute.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_productattribute_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_productAttribute.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_productAttribute");
        }
...
/************************************************************************************************
 *     37211 characters generated by Talend Open Studio for Data Integration 
