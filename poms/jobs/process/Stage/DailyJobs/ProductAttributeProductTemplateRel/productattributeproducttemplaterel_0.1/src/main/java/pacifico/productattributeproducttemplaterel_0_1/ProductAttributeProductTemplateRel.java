...
package pacifico.productattributeproducttemplaterel_0_1;
...
/**
 * Job: ProductAttributeProductTemplateRel Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class ProductAttributeProductTemplateRel implements TalendJob {
...
public String getSecretAccessKey(){
	...
	private final String jobName = "ProductAttributeProductTemplateRel";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProductAttributeProductTemplateRel.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProductAttributeProductTemplateRel.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Copy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    try{
        ...
        final String from_key_tS3Copy_1 = "productAttributeProductTemplateRel.csv";
        final String to_bucket_tS3Copy_1 = "libreriapacifico/stage"; 
        final String to_key_tS3Copy_1 = "productAttributeProductTemplateRel.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final ProductAttributeProductTemplateRel ProductAttributeProductTemplateRelClass = new ProductAttributeProductTemplateRel();

        int exitCode = ProductAttributeProductTemplateRelClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProductAttributeProductTemplateRel.class.getClassLoader().getResourceAsStream("pacifico/productattributeproducttemplaterel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ProductAttributeProductTemplateRel.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductAttributeProductTemplateRel");
        }
...
/************************************************************************************************
 *     40669 characters generated by Talend Open Studio for Data Integration 
