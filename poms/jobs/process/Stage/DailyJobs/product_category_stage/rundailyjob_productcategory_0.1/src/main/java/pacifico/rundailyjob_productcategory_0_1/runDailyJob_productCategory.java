...
package pacifico.rundailyjob_productcategory_0_1;
...
/**
 * Job: runDailyJob_productCategory Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_productCategory implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_productCategory";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_productCategory.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_productCategory.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_productcategory_0_1.getStage_productCategory childJob_tRunJob_3 = new pacifico.getstage_productcategory_0_1.getStage_productCategory();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_productcategory_0_1.dailyJobStage_productCategory childJob_tRunJob_1 = new pacifico.dailyjobstage_productcategory_0_1.dailyJobStage_productCategory();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_productCategory runDailyJob_productCategoryClass = new runDailyJob_productCategory();

        int exitCode = runDailyJob_productCategoryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_productCategory.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_productcategory_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_productCategory.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_productCategory");
        }
