...
public class runDailyJob_resPartner implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_resPartner.class.getClassLoader()
					.getResourceAsStream("pacifico/rundailyjob_respartner_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_resPartner.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_resPartner");
		}
...
/************************************************************************************************
 * 37079 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:38:59 PM CST
 ************************************************************************************************/