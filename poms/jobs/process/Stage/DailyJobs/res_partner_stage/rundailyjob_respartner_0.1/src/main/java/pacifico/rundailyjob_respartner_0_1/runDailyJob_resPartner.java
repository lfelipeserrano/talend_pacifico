...
package pacifico.rundailyjob_respartner_0_1;
...
/**
 * Job: runDailyJob_resPartner Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_resPartner implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_resPartner";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_resPartner.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_resPartner.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_respartner_0_1.getStage_resPartner childJob_tRunJob_3 = new pacifico.getstage_respartner_0_1.getStage_resPartner();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_respartner_0_1.dailyJobStage_resPartner childJob_tRunJob_1 = new pacifico.dailyjobstage_respartner_0_1.dailyJobStage_resPartner();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_resPartner runDailyJob_resPartnerClass = new runDailyJob_resPartner();

        int exitCode = runDailyJob_resPartnerClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_resPartner.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_respartner_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_resPartner.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_resPartner");
        }
 ...
 *     on the January 7, 2023 at 10:25:34 PM CST
 ************************************************************************************************/