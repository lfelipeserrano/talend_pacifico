...
package pacifico.rundailyjob_saleorder_0_1;
...
/**
 * Job: runDailyJob_saleOrder Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_saleOrder implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_saleOrder";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_saleOrder.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_saleOrder.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_saleorder_0_1.getStage_saleOrder childJob_tRunJob_3 = new pacifico.getstage_saleorder_0_1.getStage_saleOrder();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_saleorder_0_1.dailyJobStage_saleOrder childJob_tRunJob_1 = new pacifico.dailyjobstage_saleorder_0_1.dailyJobStage_saleOrder();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_saleOrder runDailyJob_saleOrderClass = new runDailyJob_saleOrder();

        int exitCode = runDailyJob_saleOrderClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_saleOrder.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_saleorder_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_saleOrder.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_saleOrder");
        }
...
/************************************************************************************************
 *     37057 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:37 PM CST
 ************************************************************************************************/