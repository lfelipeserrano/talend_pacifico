 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProductAttributeValue.class.getClassLoader().getResourceAsStream("pacifico/productattributevalue_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ProductAttributeValue.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductAttributeValue");
        }
...
/************************************************************************************************
 *     40461 characters generated by Talend Open Studio for Data Integration 
