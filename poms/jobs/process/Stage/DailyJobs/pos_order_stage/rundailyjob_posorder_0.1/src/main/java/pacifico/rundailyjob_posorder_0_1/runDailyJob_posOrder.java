...
package pacifico.rundailyjob_posorder_0_1;
...
/**
 * Job: runDailyJob_posOrder Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_posOrder implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_posOrder";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_posOrder.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_posOrder.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_posorder_0_1.getStage_posOrder childJob_tRunJob_3 = new pacifico.getstage_posorder_0_1.getStage_posOrder();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_posorder_0_1.dailyJobStage_posOrder childJob_tRunJob_1 = new pacifico.dailyjobstage_posorder_0_1.dailyJobStage_posOrder();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_posOrder runDailyJob_posOrderClass = new runDailyJob_posOrder();

        int exitCode = runDailyJob_posOrderClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_posOrder.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_posorder_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_posOrder.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_posOrder");
        }
...
/************************************************************************************************
 *     37035 characters generated by Talend Open Studio for Data Integration 
