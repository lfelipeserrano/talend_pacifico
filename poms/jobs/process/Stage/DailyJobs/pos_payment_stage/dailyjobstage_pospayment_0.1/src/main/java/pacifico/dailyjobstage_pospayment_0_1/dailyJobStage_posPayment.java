 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","name","pos_order_id","amount","payment_method_id","payment_date","session_id","company_id","card_type","cardholder_name","transaction_id","payment_status","ticket","is_change","account_move_id","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"pos_order_id", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"amount", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"payment_method_id", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"payment_date", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 9;
							...
							row5.cardholder_name = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_change", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 14;
							...
							row5.account_move_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
///////////////////////		
	    		...
	    		if(row6.pos_order_id != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row6.pos_order_id)			
					          ;	
	    		...
	    		if(row6.payment_method_id != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row6.payment_method_id)			
					          ;	
	    		...
	    		if(row6.payment_date != null) { //              
                 row_tLogRow_1[5]=    						
								FormatterUtils.format_Date(row6.payment_date, "dd-MM-yyyy")
					          ;	
	    		...
	    		if(row6.cardholder_name != null) { //              
                 row_tLogRow_1[9]=    						    
				                String.valueOf(row6.cardholder_name)			
					          ;	
	    		...
	    		if(row6.transaction_id != null) { //              
                 row_tLogRow_1[10]=    						    
				                String.valueOf(row6.transaction_id)			
					          ;	
	    		...
	    		if(row6.payment_status != null) { //              
                 row_tLogRow_1[11]=    						    
				                String.valueOf(row6.payment_status)			
					          ;	
	    		...
	    		if(row6.account_move_id != null) { //              
                 row_tLogRow_1[14]=    						    
				                String.valueOf(row6.account_move_id)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row7.payment_method_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.payment_date != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row7.payment_date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","name","pos_order_id","amount","payment_method_id","payment_date","session_id","company_id","card_type","cardholder_name","transaction_id","payment_status","ticket","is_change","account_move_id","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"pos_order_id", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"payment_method_id", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"payment_date", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 9;
							...
							row1.cardholder_name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_change", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 14;
							...
							row1.account_move_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
	    		...
	    		if(out1.pos_order_id != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(out1.pos_order_id)			
					          ;	
	    		...
	    		if(out1.payment_method_id != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(out1.payment_method_id)			
					          ;	
	    		...
	    		if(out1.payment_date != null) { //              
                 row_tLogRow_2[5]=    						
								FormatterUtils.format_Date(out1.payment_date, "dd-MM-yyyy")
					          ;	
	    		...
	    		if(out1.cardholder_name != null) { //              
                 row_tLogRow_2[9]=    						    
				                String.valueOf(out1.cardholder_name)			
					          ;	
	    		...
	    		if(out1.transaction_id != null) { //              
                 row_tLogRow_2[10]=    						    
				                String.valueOf(out1.transaction_id)			
					          ;	
	    		...
	    		if(out1.payment_status != null) { //              
                 row_tLogRow_2[11]=    						    
				                String.valueOf(out1.payment_status)			
					          ;	
	    		...
	    		if(out1.account_move_id != null) { //              
                 row_tLogRow_2[14]=    						    
				                String.valueOf(out1.account_move_id)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            row3.payment_method_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.payment_date != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row3.payment_date, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:OgNgDJh+N79JjYL1fH52Xfy6jDS5+XG/3krOXlSdTUIX1wSmGATGxkbNkVkQiPGMdmZDvhBzdVVL4MLmbAg9neR4p8g=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posPayment.csv";
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"pos_order_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"amount", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"payment_method_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"payment_date", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 9;
							...
							row2.cardholder_name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_change", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 14;
							...
							row2.account_move_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJobStage_posPayment.class.getClassLoader().getResourceAsStream("pacifico/dailyjobstage_pospayment_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJobStage_posPayment.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJobStage_posPayment");
        }
...
/************************************************************************************************
 *     329989 characters generated by Talend Open Studio for Data Integration 
 *     on the December 7, 2022 at 11:41:46 PM CST
 ************************************************************************************************/