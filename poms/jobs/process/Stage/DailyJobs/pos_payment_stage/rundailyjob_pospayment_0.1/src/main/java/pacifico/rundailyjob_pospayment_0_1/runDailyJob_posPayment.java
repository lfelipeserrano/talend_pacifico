...
package pacifico.rundailyjob_pospayment_0_1;
...
/**
 * Job: runDailyJob_posPayment Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_posPayment implements TalendJob {
...
public String getSecretAccessKey(){
	...
	private final String jobName = "runDailyJob_posPayment";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_posPayment.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_posPayment.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_pospayment_0_1.getStage_posPayment childJob_tRunJob_3 = new pacifico.getstage_pospayment_0_1.getStage_posPayment();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_pospayment_0_1.dailyJobStage_posPayment childJob_tRunJob_1 = new pacifico.dailyjobstage_pospayment_0_1.dailyJobStage_posPayment();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_posPayment runDailyJob_posPaymentClass = new runDailyJob_posPayment();

        int exitCode = runDailyJob_posPaymentClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_posPayment.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_pospayment_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_posPayment.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_posPayment");
        }
...
/************************************************************************************************
 *     38579 characters generated by Talend Open Studio for Data Integration 
