...
package pacifico.rundailyjob_rescompany_0_1;
...
/**
 * Job: runDailyJob_resCompany Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class runDailyJob_resCompany implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "runDailyJob_resCompany";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				runDailyJob_resCompany.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(runDailyJob_resCompany.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pacifico.getstage_rescompany_0_1.getStage_resCompany childJob_tRunJob_3 = new pacifico.getstage_rescompany_0_1.getStage_resCompany();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.dailyjobstage_rescompany_0_1.dailyJobStage_resCompany childJob_tRunJob_1 = new pacifico.dailyjobstage_rescompany_0_1.dailyJobStage_resCompany();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final runDailyJob_resCompany runDailyJob_resCompanyClass = new runDailyJob_resCompany();

        int exitCode = runDailyJob_resCompanyClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = runDailyJob_resCompany.class.getClassLoader().getResourceAsStream("pacifico/rundailyjob_rescompany_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = runDailyJob_resCompany.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : runDailyJob_resCompany");
        }
 ...
 *     on the February 1, 2023 at 11:45:27 PM CST
 ************************************************************************************************/