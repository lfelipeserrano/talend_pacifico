...
package pacifico.posbill_stage_0_1;
...
/**
 * Job: posBill_Stage Purpose: <br>
 * Description: Move account taxt data to stage <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class posBill_Stage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "posBill_Stage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				posBill_Stage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(posBill_Stage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yIiS66PDQxzUt5D8/kDeSvp9NXlWR4aUxcURy9FxUzNQ6CjH5Buywqm+AMoWz8rbKFAGaUDwzBXAzjGrcPuafh7RRcI=");
...
public void tS3Copy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    try{
        ...
        final String from_key_tS3Copy_1 = "posBill_20221026.csv";
        final String to_bucket_tS3Copy_1 = "libreriapacifico/stage"; 
        final String to_key_tS3Copy_1 = "posBill.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final posBill_Stage posBill_StageClass = new posBill_Stage();

        int exitCode = posBill_StageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = posBill_Stage.class.getClassLoader().getResourceAsStream("pacifico/posbill_stage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = posBill_Stage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : posBill_Stage");
        }
...
/************************************************************************************************
 *     39018 characters generated by Talend Open Studio for Data Integration 
