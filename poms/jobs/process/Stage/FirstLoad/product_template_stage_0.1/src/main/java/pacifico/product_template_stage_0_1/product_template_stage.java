...
package pacifico.product_template_stage_0_1;
...
/**
 * Job: product_template_stage Purpose: <br>
 ...
 * @status
 */
public class product_template_stage implements TalendJob {
	...
	private final String jobName = "product_template_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					product_template_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(product_template_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:8kb4iWJobvtDUSZtJTnUZ+veTHz6Q18lMU0Cb1jAhzbvcWn7NWG3yQIB+3kApUyHeiPAd9YApLHWRVlTWYEDmrHGzTk=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "productTemplate_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "productTemplate.csv";
	...
	public static void main(String[] args) {
		final product_template_stage product_template_stageClass = new product_template_stage();

		int exitCode = product_template_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = product_template_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/product_template_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = product_template_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : product_template_stage");
		}
...
/************************************************************************************************
 * 39160 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:36:50 PM CST
 ************************************************************************************************/