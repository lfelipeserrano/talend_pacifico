...
package pacifico.sales_order_stage_0_1;
...
/**
 * Job: sales_order_stage Purpose: <br>
 ...
 * @status
 */
public class sales_order_stage implements TalendJob {
	...
	private final String jobName = "sales_order_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					sales_order_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(sales_order_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:F9OGopDHj2ORhBJv6+/WprvZPAVrAcH4cNXErIwGHUSI6riFgxU1/CrIzx2zB2PnnyBgf/PJLVnLAKuNRrsCpDJ6qoo=");
	...
	public static void main(String[] args) {
		final sales_order_stage sales_order_stageClass = new sales_order_stage();

		int exitCode = sales_order_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = sales_order_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/sales_order_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sales_order_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : sales_order_stage");
		}
...
/************************************************************************************************
 * 39078 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:38:21 PM CST
 ************************************************************************************************/