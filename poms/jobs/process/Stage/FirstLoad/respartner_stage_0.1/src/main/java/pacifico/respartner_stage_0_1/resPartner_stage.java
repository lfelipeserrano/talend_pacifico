...
package pacifico.respartner_stage_0_1;
...
/**
 * Job: resPartner_stage Purpose: <br>
 ...
 * @status
 */
public class resPartner_stage implements TalendJob {
	...
	private final String jobName = "resPartner_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					resPartner_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(resPartner_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ea5c5WH9gm3iErNq5y1qK4NnUCtTkeVzr9I3cx0d6+TPVjA+eaykHmFqs62uuBEAFQoqg/8CMrEoWvmeCisML0jxNEk=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "resPartner_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "resPartner.csv";
	...
	public static void main(String[] args) {
		final resPartner_stage resPartner_stageClass = new resPartner_stage();

		int exitCode = resPartner_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = resPartner_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/respartner_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = resPartner_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : resPartner_stage");
		}
 ...
 * October 27, 2022 at 10:57:22 PM CST
 ************************************************************************************************/