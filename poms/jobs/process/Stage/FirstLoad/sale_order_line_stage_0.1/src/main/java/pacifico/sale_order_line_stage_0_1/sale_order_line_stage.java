...
package pacifico.sale_order_line_stage_0_1;
...
/**
 * Job: sale_order_line_stage Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class sale_order_line_stage implements TalendJob {
	...
	private final String jobName = "sale_order_line_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					sale_order_line_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(sale_order_line_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:mGVtl9BWMn/YyKmM5KWHh8t9rCQjY74aPrt8HP94gtYIvzZy/a6vwRggaTQ0K+saXL8K90KE+a42TMQbU59CU5JUrHM=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "saleOrderLine_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "saleOrderLine.csv";
	...
	public static void main(String[] args) {
		final sale_order_line_stage sale_order_line_stageClass = new sale_order_line_stage();

		int exitCode = sale_order_line_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = sale_order_line_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/sale_order_line_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = sale_order_line_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : sale_order_line_stage");
		}
...
/************************************************************************************************
 * 39111 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:37:14 PM CST
 ************************************************************************************************/