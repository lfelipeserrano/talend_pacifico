...
package pacifico.pos_payment_stage_0_1;
...
/**
 * Job: pos_payment_stage Purpose: <br>
 ...
 * @status
 */
public class pos_payment_stage implements TalendJob {
	...
	private final String jobName = "pos_payment_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					pos_payment_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(pos_payment_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:xv+falZV/WwOUQZP7ab3qmjRDHfMSCcVNPsYpFOuUFhcUsuX851MbtacW3oUA4pqaJ0+BskfV1Bm2kvRJuKGDvl9Z6E=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "posPayment_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "posPayment.csv";
	...
	public static void main(String[] args) {
		final pos_payment_stage pos_payment_stageClass = new pos_payment_stage();

		int exitCode = pos_payment_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pos_payment_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/pos_payment_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pos_payment_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : pos_payment_stage");
		}
...
/************************************************************************************************
 * 39080 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:34:45 PM CST
 ************************************************************************************************/