...
package pacifico.productcategory_stage_0_1;
...
/**
 * Job: productCategory_stage Purpose: <br>
 ...
 * @status
 */
public class productCategory_stage implements TalendJob {
	...
	private final String jobName = "productCategory_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					productCategory_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(productCategory_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:sCoWiYkoiD811h9/JLEdpeh7PW6IhEECLFdQMqYRQSn4ZFdJqj0lSal1pirb8iBvSyn5naZvnfr6I03P3KkQsXWlnuE=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "productCategory_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "productCategory.csv";
	...
	public static void main(String[] args) {
		final productCategory_stage productCategory_stageClass = new productCategory_stage();

		int exitCode = productCategory_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = productCategory_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/productcategory_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = productCategory_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : productCategory_stage");
		}
...
/************************************************************************************************
 * 39146 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:52:35 PM CST
 ************************************************************************************************/