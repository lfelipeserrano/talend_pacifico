...
package pacifico.rescountrystate_stage_0_1;
...
/**
 * Job: resCountryState_stage Purpose: <br>
 ...
 * @status
 */
public class resCountryState_stage implements TalendJob {
	...
	private final String jobName = "resCountryState_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					resCountryState_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(resCountryState_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:DP4nA812U2opNah8dwMiZgOzkTxk3Rp07u/KdgIKHmaCk7wCzPMuPiaJ9O9KCfZRo+4tc9d6Ow8d6z1Mzi0byQdjTwU=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "resCountryState_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "resCountryState.csv";
	...
	public static void main(String[] args) {
		final resCountryState_stage resCountryState_stageClass = new resCountryState_stage();

		int exitCode = resCountryState_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = resCountryState_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/rescountrystate_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = resCountryState_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : resCountryState_stage");
		}
 ...
 * October 27, 2022 at 10:56:36 PM CST
 ************************************************************************************************/