...
package pacifico.saleorderoption_stage_0_1;
...
/**
 * Job: saleOrderOption_Stage Purpose: <br>
 * Description: Move account taxt data to stage <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class saleOrderOption_Stage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "saleOrderOption_Stage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				saleOrderOption_Stage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(saleOrderOption_Stage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:bCjGU74yixkMmeZIeKv3g0YBGXQyORY2V0N4BU0UT+kHBMC957LCI72EisazaP80leuAaPALjgKX2wVtWpa3pE/7k4o=");
...
public void tS3Copy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    try{
        ...
        final String from_key_tS3Copy_1 = "saleOrderOption_20221026.csv";
        final String to_bucket_tS3Copy_1 = "libreriapacifico/stage"; 
        final String to_key_tS3Copy_1 = "saleOrderOption.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final saleOrderOption_Stage saleOrderOption_StageClass = new saleOrderOption_Stage();

        int exitCode = saleOrderOption_StageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = saleOrderOption_Stage.class.getClassLoader().getResourceAsStream("pacifico/saleorderoption_stage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = saleOrderOption_Stage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrderOption_Stage");
        }
...
/************************************************************************************************
 *     39146 characters generated by Talend Open Studio for Data Integration 
