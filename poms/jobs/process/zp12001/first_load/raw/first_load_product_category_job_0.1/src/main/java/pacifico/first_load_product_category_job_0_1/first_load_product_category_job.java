...
package pacifico.first_load_product_category_job_0_1;
...
/**
 * Job: first_load_product_category_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_product_category_job implements TalendJob {
	...
	private final String jobName = "first_load_product_category_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_product_category_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_product_category_job.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_product_category_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_product_category_job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_product_category_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_product_category_job.length == 0) {
						commonByteArray_PACIFICO_first_load_product_category_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_product_category_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_product_category_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_product_category_job, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_product_category_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_product_category_job, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_product_category_job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:+p+6ZrQwxnV2XgYs8WYd54Uwk8jTqPUdz1iSaWoPrUz8twzzUA==");
				...
				String dbquery_tDBInput_1 = "select * from product_category";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 11) {
							...
							row1.packaging_reserve_method = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11,
									false);
						}
						...
						if (row1.complete_name != null) {
							sb_tFileOutputDelimited_1.append(row1.complete_name);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.parent_path != null) {
							sb_tFileOutputDelimited_1.append(row1.parent_path);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.removal_strategy_id != null) {
							sb_tFileOutputDelimited_1.append(row1.removal_strategy_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.packaging_reserve_method != null) {
							sb_tFileOutputDelimited_1.append(row1.packaging_reserve_method);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:cFhYZ7g4IWlGDDVCxqDBbP4yDc9+bOxKEVVck2S1GY8QSyuKECAbJiyGUJGGv601giy9u0rcGyQsg70sxN2n9u7WpNs=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "productCategory_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_product_category_job first_load_product_category_jobClass = new first_load_product_category_job();

		int exitCode = first_load_product_category_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_product_category_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_product_category_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_product_category_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_product_category_job");
		}
...
/************************************************************************************************
 * 75650 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:02:39 PM CST
 ************************************************************************************************/