...
package pacifico.rescountry_stage_0_1;
...
/**
 * Job: resCountry_stage Purpose: <br>
 ...
 * @status
 */
public class resCountry_stage implements TalendJob {
	...
	private final String jobName = "resCountry_stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					resCountry_stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(resCountry_stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:D571jLB4bQWDPUvk8+1DMvMrlZslU4tvh0aWCCbYtvN9gP6MfUoGB0MPROVQOHmvNKqc+Uj2ch9iAoFB13RtBKRlHP8=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "resCountry_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "resCountry.csv";
	...
	public static void main(String[] args) {
		final resCountry_stage resCountry_stageClass = new resCountry_stage();

		int exitCode = resCountry_stageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = resCountry_stage.class.getClassLoader()
					.getResourceAsStream("pacifico/rescountry_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = resCountry_stage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : resCountry_stage");
		}
...
/************************************************************************************************
 * 39066 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 10:55:13 PM CST
 ************************************************************************************************/