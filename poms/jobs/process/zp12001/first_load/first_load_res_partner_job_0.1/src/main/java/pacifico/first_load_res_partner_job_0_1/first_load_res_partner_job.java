...
package pacifico.first_load_res_partner_job_0_1;
...
/**
 * Job: first_load_res_partner_job Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class first_load_res_partner_job implements TalendJob {
	...
	private final String jobName = "first_load_res_partner_job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					first_load_res_partner_job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(first_load_res_partner_job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_first_load_res_partner_job = new byte[0];
		static byte[] commonByteArray_PACIFICO_first_load_res_partner_job = new byte[0];
		...
		public BigDecimal partner_latitude;

		public BigDecimal getPartner_latitude() {
			return this.partner_latitude;
		}

		public BigDecimal partner_longitude;

		public BigDecimal getPartner_longitude() {
		...
		public java.util.Date signup_expiration;

		public java.util.Date getSignup_expiration() {
		...
		public BigDecimal debit_limit;

		public BigDecimal getDebit_limit() {
			return this.debit_limit;
		}

		public java.util.Date last_time_entries_checked;

		public java.util.Date getLast_time_entries_checked() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_first_load_res_partner_job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_first_load_res_partner_job.length == 0) {
						commonByteArray_PACIFICO_first_load_res_partner_job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_first_load_res_partner_job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_first_load_res_partner_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_res_partner_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_first_load_res_partner_job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_first_load_res_partner_job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_first_load_res_partner_job) {
				...
				try {
					...
					this.partner_latitude = (BigDecimal) dis.readObject();

					this.partner_longitude = (BigDecimal) dis.readObject();
					...
					this.industry_id = readInteger(dis);
					...
					this.signup_expiration = readDate(dis);
					...
					this.debit_limit = (BigDecimal) dis.readObject();

					this.last_time_entries_checked = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.employee == null) {
					...
					dos.writeByte(0);
					dos.writeBoolean(this.employee);
				}
				...
				dos.writeObject(this.partner_latitude);

				// BigDecimal

				dos.writeObject(this.partner_longitude);
				...
				writeInteger(this.industry_id, dos);
				...
				writeDate(this.signup_expiration, dos);
				...
				dos.writeObject(this.debit_limit);

				// java.util.Date

				writeDate(this.last_time_entries_checked, dos);
		...
		public String toString() {
			...
			sb.append(",employee=" + String.valueOf(employee));
			...
			sb.append(",partner_latitude=" + String.valueOf(partner_latitude));
			sb.append(",partner_longitude=" + String.valueOf(partner_longitude));
			sb.append(",email=" + email);
			sb.append(",phone=" + phone);
			sb.append(",mobile=" + mobile);
			sb.append(",is_company=" + String.valueOf(is_company));
			sb.append(",industry_id=" + String.valueOf(industry_id));
			...
			sb.append(",signup_expiration=" + String.valueOf(signup_expiration));
			...
			sb.append(",debit_limit=" + String.valueOf(debit_limit));
			sb.append(",last_time_entries_checked=" + String.valueOf(last_time_entries_checked));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:KlMrdE+Uwv+D0A6jZ5C5BwpGoKJWSCeRt9EGabnOz52Xk05yKg==");
				...
				String dbquery_tDBInput_1 = "select * from res_partner";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 4);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row1.display_name = null;
						} else {

							row1.display_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row1.title = rs_tDBInput_1.getInt(7);
							if (rs_tDBInput_1.wasNull()) {
								row1.title = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.parent_id = rs_tDBInput_1.getInt(8);
							if (rs_tDBInput_1.wasNull()) {
								row1.parent_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							row1.ref = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row1.lang = null;
						} else {

							row1.lang = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row1.tz = null;
						} else {

							row1.tz = routines.system.JDBCUtil.getString(rs_tDBInput_1, 11, false);
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							row1.user_id = null;
						} else {

							row1.user_id = rs_tDBInput_1.getInt(12);
							if (rs_tDBInput_1.wasNull()) {
								row1.user_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							...
							row1.vat = routines.system.JDBCUtil.getString(rs_tDBInput_1, 13, false);
						}
						if (colQtyInRs_tDBInput_1 < 14) {
							row1.website = null;
						} else {

							row1.website = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
						}
						if (colQtyInRs_tDBInput_1 < 15) {
							row1.comment = null;
						} else {

							row1.comment = routines.system.JDBCUtil.getString(rs_tDBInput_1, 15, false);
						}
						if (colQtyInRs_tDBInput_1 < 16) {
							row1.credit_limit = null;
						} else {

							row1.credit_limit = rs_tDBInput_1.getDouble(16);
							if (rs_tDBInput_1.wasNull()) {
								row1.credit_limit = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 17) {
							...
							row1.active = rs_tDBInput_1.getBoolean(17);
							if (rs_tDBInput_1.wasNull()) {
								row1.active = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 18) {
							...
							row1.employee = rs_tDBInput_1.getBoolean(18);
							if (rs_tDBInput_1.wasNull()) {
								row1.employee = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 19) {
							...
							row1.function = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, false);
						}
						if (colQtyInRs_tDBInput_1 < 20) {
							row1.type = null;
						} else {

							row1.type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, false);
						}
						if (colQtyInRs_tDBInput_1 < 21) {
							row1.street = null;
						} else {

							row1.street = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, false);
						}
						if (colQtyInRs_tDBInput_1 < 22) {
							row1.street2 = null;
						} else {

							row1.street2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
						}
						if (colQtyInRs_tDBInput_1 < 23) {
							row1.zip = null;
						} else {

							row1.zip = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, false);
						}
						...
						if (colQtyInRs_tDBInput_1 < 25) {
							...
							row1.state_id = rs_tDBInput_1.getInt(25);
							if (rs_tDBInput_1.wasNull()) {
								row1.state_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 26) {
							...
							row1.country_id = rs_tDBInput_1.getInt(26);
							if (rs_tDBInput_1.wasNull()) {
								row1.country_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 27) {
							row1.partner_latitude = null;
						} else {

							row1.partner_latitude = rs_tDBInput_1.getBigDecimal(27);
							if (rs_tDBInput_1.wasNull()) {
								row1.partner_latitude = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 28) {
							row1.partner_longitude = null;
						} else {

							row1.partner_longitude = rs_tDBInput_1.getBigDecimal(28);
							if (rs_tDBInput_1.wasNull()) {
								row1.partner_longitude = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 29) {
							...
							row1.email = routines.system.JDBCUtil.getString(rs_tDBInput_1, 29, false);
						}
						if (colQtyInRs_tDBInput_1 < 30) {
							row1.phone = null;
						} else {

							row1.phone = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30, false);
						}
						if (colQtyInRs_tDBInput_1 < 31) {
							row1.mobile = null;
						} else {

							row1.mobile = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, false);
						}
						if (colQtyInRs_tDBInput_1 < 32) {
							row1.is_company = null;
						} else {

							row1.is_company = rs_tDBInput_1.getBoolean(32);
							if (rs_tDBInput_1.wasNull()) {
								row1.is_company = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 33) {
							row1.industry_id = null;
						} else {

							row1.industry_id = rs_tDBInput_1.getInt(33);
							if (rs_tDBInput_1.wasNull()) {
								row1.industry_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 34) {
							...
							row1.color = rs_tDBInput_1.getInt(34);
							if (rs_tDBInput_1.wasNull()) {
								row1.color = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 35) {
							...
							row1.partner_share = rs_tDBInput_1.getBoolean(35);
							if (rs_tDBInput_1.wasNull()) {
								row1.partner_share = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 36) {
							...
							row1.commercial_partner_id = rs_tDBInput_1.getInt(36);
							if (rs_tDBInput_1.wasNull()) {
								row1.commercial_partner_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 37) {
							row1.commercial_company_name = null;
						} else {

							row1.commercial_company_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 37, false);
						}
						if (colQtyInRs_tDBInput_1 < 38) {
							row1.company_name = null;
						} else {

							row1.company_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 38, false);
						}
						if (colQtyInRs_tDBInput_1 < 39) {
							row1.create_uid = null;
						} else {

							row1.create_uid = rs_tDBInput_1.getInt(39);
							if (rs_tDBInput_1.wasNull()) {
								row1.create_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 40) {
							...
							row1.write_uid = rs_tDBInput_1.getInt(40);
							if (rs_tDBInput_1.wasNull()) {
								row1.write_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 41) {
							...
							row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 41);
						}
						if (colQtyInRs_tDBInput_1 < 42) {
							row1.message_main_attachment_id = null;
						} else {

							row1.message_main_attachment_id = rs_tDBInput_1.getInt(42);
							if (rs_tDBInput_1.wasNull()) {
								row1.message_main_attachment_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 43) {
							row1.email_normalized = null;
						} else {

							row1.email_normalized = routines.system.JDBCUtil.getString(rs_tDBInput_1, 43, false);
						}
						if (colQtyInRs_tDBInput_1 < 44) {
							row1.message_bounce = null;
						} else {

							row1.message_bounce = rs_tDBInput_1.getInt(44);
							if (rs_tDBInput_1.wasNull()) {
								row1.message_bounce = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 45) {
							row1.signup_token = null;
						} else {

							row1.signup_token = routines.system.JDBCUtil.getString(rs_tDBInput_1, 45, false);
						}
						if (colQtyInRs_tDBInput_1 < 46) {
							row1.signup_type = null;
						} else {

							row1.signup_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 46, false);
						}
						if (colQtyInRs_tDBInput_1 < 47) {
							row1.signup_expiration = null;
						} else {

							row1.signup_expiration = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 47);
						}
						if (colQtyInRs_tDBInput_1 < 48) {
							row1.team_id = null;
						} else {

							row1.team_id = rs_tDBInput_1.getInt(48);
							if (rs_tDBInput_1.wasNull()) {
								row1.team_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 49) {
							...
							row1.partner_gid = rs_tDBInput_1.getInt(49);
							if (rs_tDBInput_1.wasNull()) {
								row1.partner_gid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 50) {
							row1.additional_info = null;
						} else {

							row1.additional_info = routines.system.JDBCUtil.getString(rs_tDBInput_1, 50, false);
						}
						if (colQtyInRs_tDBInput_1 < 51) {
							row1.phone_sanitized = null;
						} else {

							row1.phone_sanitized = routines.system.JDBCUtil.getString(rs_tDBInput_1, 51, false);
						}
						if (colQtyInRs_tDBInput_1 < 52) {
							row1.debit_limit = null;
						} else {

							row1.debit_limit = rs_tDBInput_1.getBigDecimal(52);
							if (rs_tDBInput_1.wasNull()) {
								row1.debit_limit = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 53) {
							row1.last_time_entries_checked = null;
						} else {

							row1.last_time_entries_checked = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 53);
						}
						if (colQtyInRs_tDBInput_1 < 54) {
							row1.invoice_warn = null;
						} else {

							row1.invoice_warn = routines.system.JDBCUtil.getString(rs_tDBInput_1, 54, false);
						}
						if (colQtyInRs_tDBInput_1 < 55) {
							row1.invoice_warn_msg = null;
						} else {

							row1.invoice_warn_msg = routines.system.JDBCUtil.getString(rs_tDBInput_1, 55, false);
						}
						if (colQtyInRs_tDBInput_1 < 56) {
							row1.supplier_rank = null;
						} else {

							row1.supplier_rank = rs_tDBInput_1.getInt(56);
							if (rs_tDBInput_1.wasNull()) {
								row1.supplier_rank = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 57) {
							...
							row1.customer_rank = rs_tDBInput_1.getInt(57);
							if (rs_tDBInput_1.wasNull()) {
								row1.customer_rank = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 58) {
							...
							row1.sale_warn = routines.system.JDBCUtil.getString(rs_tDBInput_1, 58, false);
						}
						if (colQtyInRs_tDBInput_1 < 59) {
							row1.sale_warn_msg = null;
						} else {

							row1.sale_warn_msg = routines.system.JDBCUtil.getString(rs_tDBInput_1, 59, false);
						}
						if (colQtyInRs_tDBInput_1 < 60) {
							row1.picking_warn = null;
						} else {

							row1.picking_warn = routines.system.JDBCUtil.getString(rs_tDBInput_1, 60, false);
						}
						if (colQtyInRs_tDBInput_1 < 61) {
							row1.picking_warn_msg = null;
						} else {

							row1.picking_warn_msg = routines.system.JDBCUtil.getString(rs_tDBInput_1, 61, false);
						}
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.display_name != null) {
							sb_tFileOutputDelimited_1.append(row1.display_name);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.date != null) {
							sb_tFileOutputDelimited_1.append(FormatterUtils.format_Date(row1.date, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.title != null) {
						...
						if (row1.parent_id != null) {
							sb_tFileOutputDelimited_1.append(row1.parent_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.ref != null) {
							sb_tFileOutputDelimited_1.append(row1.ref);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.lang != null) {
							sb_tFileOutputDelimited_1.append(row1.lang);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.tz != null) {
							sb_tFileOutputDelimited_1.append(row1.tz);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.user_id != null) {
							sb_tFileOutputDelimited_1.append(row1.user_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.vat != null) {
							sb_tFileOutputDelimited_1.append(row1.vat);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.website != null) {
							sb_tFileOutputDelimited_1.append(row1.website);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.credit_limit != null) {
							sb_tFileOutputDelimited_1.append(row1.credit_limit);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.active != null) {
							sb_tFileOutputDelimited_1.append(row1.active);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.employee != null) {
							sb_tFileOutputDelimited_1.append(row1.employee);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.function != null) {
							sb_tFileOutputDelimited_1.append(row1.function);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.type != null) {
							sb_tFileOutputDelimited_1.append(row1.type);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.street != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.street2 != null) {
							sb_tFileOutputDelimited_1.append(row1.street2);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.zip != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.state_id != null) {
							sb_tFileOutputDelimited_1.append(row1.state_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.country_id != null) {
							sb_tFileOutputDelimited_1.append(row1.country_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.partner_latitude != null) {
							sb_tFileOutputDelimited_1.append(
									row1.partner_latitude.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.partner_longitude != null) {
							sb_tFileOutputDelimited_1.append(
									row1.partner_longitude.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.email != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.mobile != null) {
							sb_tFileOutputDelimited_1.append(row1.mobile);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.is_company != null) {
							sb_tFileOutputDelimited_1.append(row1.is_company);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.industry_id != null) {
							sb_tFileOutputDelimited_1.append(row1.industry_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.color != null) {
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.partner_share != null) {
							sb_tFileOutputDelimited_1.append(row1.partner_share);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.commercial_partner_id != null) {
							sb_tFileOutputDelimited_1.append(row1.commercial_partner_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.commercial_company_name != null) {
							sb_tFileOutputDelimited_1.append(row1.commercial_company_name);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.company_name != null) {
							sb_tFileOutputDelimited_1.append(row1.company_name);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.message_main_attachment_id != null) {
							sb_tFileOutputDelimited_1.append(row1.message_main_attachment_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.email_normalized != null) {
							sb_tFileOutputDelimited_1.append(row1.email_normalized);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.message_bounce != null) {
							sb_tFileOutputDelimited_1.append(row1.message_bounce);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.signup_token != null) {
							sb_tFileOutputDelimited_1.append(row1.signup_token);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.signup_type != null) {
							sb_tFileOutputDelimited_1.append(row1.signup_type);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.signup_expiration != null) {
							sb_tFileOutputDelimited_1
									.append(FormatterUtils.format_Date(row1.signup_expiration, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.team_id != null) {
							sb_tFileOutputDelimited_1.append(row1.team_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.partner_gid != null) {
							sb_tFileOutputDelimited_1.append(row1.partner_gid);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.additional_info != null) {
							sb_tFileOutputDelimited_1.append(row1.additional_info);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.phone_sanitized != null) {
							sb_tFileOutputDelimited_1.append(row1.phone_sanitized);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.debit_limit != null) {
							sb_tFileOutputDelimited_1.append(
									row1.debit_limit.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.last_time_entries_checked != null) {
							sb_tFileOutputDelimited_1
									.append(FormatterUtils.format_Date(row1.last_time_entries_checked, "dd-MM-yyyy"));
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.invoice_warn != null) {
							sb_tFileOutputDelimited_1.append(row1.invoice_warn);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.invoice_warn_msg != null) {
							sb_tFileOutputDelimited_1.append(row1.invoice_warn_msg);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.supplier_rank != null) {
							sb_tFileOutputDelimited_1.append(row1.supplier_rank);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.customer_rank != null) {
							sb_tFileOutputDelimited_1.append(row1.customer_rank);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_warn != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_warn);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.sale_warn_msg != null) {
							sb_tFileOutputDelimited_1.append(row1.sale_warn_msg);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.picking_warn != null) {
							sb_tFileOutputDelimited_1.append(row1.picking_warn);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.picking_warn_msg != null) {
							sb_tFileOutputDelimited_1.append(row1.picking_warn_msg);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:SyYV3gkiArhwavp7G7vynJLfnE3HGuL7dkzG3lpQKKhg8jdazsF59JjJi2VdaPJbbsHGzHOWcnUFEiDpbQ0Ry1+4cXo=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "resPartner_20221026.csv";
	...
	public static void main(String[] args) {
		final first_load_res_partner_job first_load_res_partner_jobClass = new first_load_res_partner_job();

		int exitCode = first_load_res_partner_jobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = first_load_res_partner_job.class.getClassLoader().getResourceAsStream(
					"pacifico/first_load_res_partner_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = first_load_res_partner_job.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : first_load_res_partner_job");
		}
...
/************************************************************************************************
 * 141561 characters generated by Talend Open Studio for Data Integration on the
 * October 26, 2022 at 11:06:27 PM CST
 ************************************************************************************************/