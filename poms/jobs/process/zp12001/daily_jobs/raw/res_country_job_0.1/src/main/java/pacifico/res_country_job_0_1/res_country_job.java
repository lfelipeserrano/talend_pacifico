...
public class res_country_job implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:WHv5Ko//PuoA6Qe7FCaZgntCFhjSAx78lCmWlcZqmUEJTecWWA==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (row1.address_view_id != null) {
							sb_tFileOutputDelimited_1.append(row1.address_view_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						...
						if (row1.phone_code != null) {
							sb_tFileOutputDelimited_1.append(row1.phone_code);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.name_position != null) {
							sb_tFileOutputDelimited_1.append(row1.name_position);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.vat_label != null) {
							sb_tFileOutputDelimited_1.append(row1.vat_label);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.state_required != null) {
							sb_tFileOutputDelimited_1.append(row1.state_required);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.zip_required != null) {
							sb_tFileOutputDelimited_1.append(row1.zip_required);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:eBODPFIjAtygISAMEF9Mde+SC6q+zimm0ooJJqg/n4/QD7o177VIL7U8F0lWj8q133JBx4vpCexTb/l7VNjZ7ccwFUY=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = res_country_job.class.getClassLoader()
					.getResourceAsStream("pacifico/res_country_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = res_country_job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : res_country_job");
		}
...
/************************************************************************************************
 * 78402 characters generated by Talend Open Studio for Data Integration on the
 * December 3, 2022 at 11:52:55 PM CST
 ************************************************************************************************/