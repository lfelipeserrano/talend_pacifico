...
package pacifico.main_job_daily_zp12001_0_1;
...
/**
 * Job: main_job_daily_zp12001 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class main_job_daily_zp12001 implements TalendJob {
	...
	private final String jobName = "main_job_daily_zp12001";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					main_job_daily_zp12001.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(main_job_daily_zp12001.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.product_attribute_job_0_1.product_attribute_job childJob_tRunJob_1 = new pacifico.product_attribute_job_0_1.product_attribute_job();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.product_product_job_0_1.product_product_job childJob_tRunJob_6 = new pacifico.product_product_job_0_1.product_product_job();
				// pass DataSources
	...
	public void tRunJob_15Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.res_country_job_0_1.res_country_job childJob_tRunJob_15 = new pacifico.res_country_job_0_1.res_country_job();
				// pass DataSources
	...
	public void tRunJob_21Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.res_country_state_job_0_1.res_country_state_job childJob_tRunJob_21 = new pacifico.res_country_state_job_0_1.res_country_state_job();
				// pass DataSources
	...
	public void tRunJob_28Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.res_partner_job_0_1.res_partner_job childJob_tRunJob_28 = new pacifico.res_partner_job_0_1.res_partner_job();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.res_company_job_0_1.res_company_job childJob_tRunJob_10 = new pacifico.res_company_job_0_1.res_company_job();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.product_category_job_0_1.product_category_job childJob_tRunJob_3 = new pacifico.product_category_job_0_1.product_category_job();
				// pass DataSources
	...
	public static void main(String[] args) {
		final main_job_daily_zp12001 main_job_daily_zp12001Class = new main_job_daily_zp12001();

		int exitCode = main_job_daily_zp12001Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main_job_daily_zp12001.class.getClassLoader()
					.getResourceAsStream("pacifico/main_job_daily_zp12001_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = main_job_daily_zp12001.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : main_job_daily_zp12001");
		}
...
/************************************************************************************************
 * 73106 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:31:37 PM CST
 ************************************************************************************************/