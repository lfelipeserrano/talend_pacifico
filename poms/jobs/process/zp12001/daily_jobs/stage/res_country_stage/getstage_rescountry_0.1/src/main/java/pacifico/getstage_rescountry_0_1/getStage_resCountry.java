...
public class getStage_resCountry implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:stoqpqpeDFUlRHfOKFTm1+yMuYe6/iFcKSkhJyAR6Xa4mDZG3CK6B6YfVrYL31DKPrztJSPSop0AtmOqKr916AUWE1Y=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "resCountry_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_resCountry.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_rescountry_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_resCountry.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_resCountry");
		}
 ...
 * November 2, 2022 at 11:40:24 PM CST
 ************************************************************************************************/