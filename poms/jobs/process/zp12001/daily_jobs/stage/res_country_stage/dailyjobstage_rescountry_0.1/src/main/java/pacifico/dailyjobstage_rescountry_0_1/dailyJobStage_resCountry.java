...
///////////////////////		
							...
							if (row6.code != null) { //
								row_tLogRow_1[2] = String.valueOf(row6.code);
...
///////////////////////    			
							...
							if (row7.address_view_id != null) {
								sb_tFileOutputDelimited_1.append(row7.address_view_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.phone_code != null) {
								sb_tFileOutputDelimited_1.append(row7.phone_code);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.name_position != null) {
								sb_tFileOutputDelimited_1.append(row7.name_position);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.vat_label != null) {
								sb_tFileOutputDelimited_1.append(row7.vat_label);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.state_required != null) {
								sb_tFileOutputDelimited_1.append(row7.state_required);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.zip_required != null) {
								sb_tFileOutputDelimited_1.append(row7.zip_required);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.create_date != null) {
								sb_tFileOutputDelimited_1.append(row7.create_date);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row7.write_date != null) {
								sb_tFileOutputDelimited_1.append(row7.write_date);
							}
...
///////////////////////		
								...
								if (out1.code != null) { //
									row_tLogRow_2[2] = String.valueOf(out1.code);
...
///////////////////////    			
								...
								if (row3.address_view_id != null) {
									sb_tFileOutputDelimited_2.append(row3.address_view_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.phone_code != null) {
									sb_tFileOutputDelimited_2.append(row3.phone_code);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.name_position != null) {
									sb_tFileOutputDelimited_2.append(row3.name_position);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.vat_label != null) {
									sb_tFileOutputDelimited_2.append(row3.vat_label);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.state_required != null) {
									sb_tFileOutputDelimited_2.append(row3.state_required);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.zip_required != null) {
									sb_tFileOutputDelimited_2.append(row3.zip_required);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.create_date != null) {
									sb_tFileOutputDelimited_2.append(row3.create_date);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (row3.write_date != null) {
									sb_tFileOutputDelimited_2.append(row3.write_date);
								}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_resCountry.class.getClassLoader().getResourceAsStream(
					"pacifico/dailyjobstage_rescountry_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_resCountry.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_resCountry");
		}
