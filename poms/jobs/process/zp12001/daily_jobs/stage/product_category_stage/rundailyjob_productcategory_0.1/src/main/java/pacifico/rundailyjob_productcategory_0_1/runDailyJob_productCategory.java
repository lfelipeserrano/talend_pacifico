...
public class runDailyJob_productCategory implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_productCategory.class.getClassLoader().getResourceAsStream(
					"pacifico/rundailyjob_productcategory_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_productCategory.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runDailyJob_productCategory");
		}
...
/************************************************************************************************
 * 37189 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:37:45 PM CST
 ************************************************************************************************/