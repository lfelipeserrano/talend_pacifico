...
public class runDailyJob_productAttribute implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(runDailyJob_productAttribute.this,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_productAttribute.class.getClassLoader().getResourceAsStream(
					"pacifico/rundailyjob_productattribute_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_productAttribute.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runDailyJob_productAttribute");
		}
...
/************************************************************************************************
 * 37211 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:43:30 PM CST
 ************************************************************************************************/