...
package pacifico.dailyjobstage_productattribute_0_1;
...
/**
 * Job: dailyJobStage_productAttribute Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class dailyJobStage_productAttribute implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dailyJobStage_productAttribute";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dailyJobStage_productAttribute.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dailyJobStage_productAttribute.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_dailyJobStage_productAttribute = new byte[0];
    static byte[] commonByteArray_PACIFICO_dailyJobStage_productAttribute = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_dailyJobStage_productAttribute.length) {
				if(length < 1024 && commonByteArray_PACIFICO_dailyJobStage_productAttribute.length == 0) {
   					commonByteArray_PACIFICO_dailyJobStage_productAttribute = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_dailyJobStage_productAttribute = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_dailyJobStage_productAttribute, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_productAttribute, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_dailyJobStage_productAttribute, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_productAttribute, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_dailyJobStage_productAttribute) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"US-ASCII"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("sequence");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("create_variant");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","name","sequence","create_variant","display_type","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 3;
							...
							row5.create_variant = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 4;
					
							row5.display_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
			...
			row6.create_variant = row5.create_variant;								
			row6.display_type = row5.display_type;								
...
///////////////////////		
	    		...
	    		if(row6.create_variant != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row6.create_variant)			
					          ;	
							
	    		} //			
    			   				
	    		if(row6.display_type != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row6.display_type)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.create_variant != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.create_variant
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.display_type != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.display_type
                        );
                            }
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","name","sequence","create_variant","display_type","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							row1.create_variant = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
out1_tmp.create_variant = row1.create_variant ;
out1_tmp.display_type = row1.display_type ;
...
///////////////////////		
	    		...
	    		if(out1.create_variant != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(out1.create_variant)			
					          ;	
							
	    		} //			
    			   				
	    		if(out1.display_type != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(out1.display_type)			
					          ;	
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.create_variant != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.create_variant
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.display_type != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.display_type
                        );
                            }
...
// for output
			...
			row6.create_variant = row4.create_variant;								
			row6.display_type = row4.display_type;								
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:A68HQf/Nm5NJKhAh2wuJ1chU1z0aYq3Dq7CdSF/YCD3aPPZkRsgsz1rNcA08iou2BULFpRzn1Ez1diqKCRLFFVB+3OI=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "productAttribute.csv";
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
	...
	public void copyDataTo(row2Struct other) {
		...
		other.id = this.id;
	            ...
	            other.create_variant = this.create_variant;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.create_variant = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.create_variant = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.sequence, dos, oos);
						...
						writeString(this.create_variant, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.sequence, dos, objectOut);
						...
						writeString(this.create_variant, dos, objectOut);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 3;
							...
							row2.create_variant = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
if(row2 != null) { 
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.create_variant = row2.create_variant;
				
				row2_HashRow.display_type = row2.display_type;
 ...
 */
    ...
    public static void main(String[] args){
        final dailyJobStage_productAttribute dailyJobStage_productAttributeClass = new dailyJobStage_productAttribute();

        int exitCode = dailyJobStage_productAttributeClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJobStage_productAttribute.class.getClassLoader().getResourceAsStream("pacifico/dailyjobstage_productattribute_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJobStage_productAttribute.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJobStage_productAttribute");
        }
...
/************************************************************************************************
 *     240409 characters generated by Talend Open Studio for Data Integration 
 *     on the December 5, 2022 at 10:43:30 PM CST
 ************************************************************************************************/