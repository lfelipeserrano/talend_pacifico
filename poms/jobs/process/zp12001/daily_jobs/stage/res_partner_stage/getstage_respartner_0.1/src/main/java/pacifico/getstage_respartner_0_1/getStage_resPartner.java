...
public class getStage_resPartner implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:7vW28n/EBa0tFwzUMKXcHavXHTQmgJUiLxPRAnm2yQWfr2zI87Bep6+N37dVD6C0ka2fXA0aWPaRuuBjZpgQ8PJAnQ4=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "resPartner_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_resPartner.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_respartner_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_resPartner.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_resPartner");
		}
 ...
 * November 3, 2022 at 12:06:03 AM CST
 ************************************************************************************************/