...
public class getStage_productProduct implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:NjedeTD57UmtgxqfXLuHqW9Xr77GgESQhk2lzylhzuYI1MoKBpWI4zLjZCzp0IeU46SQ+w8/vZQAFxMQUhRW3mz9z+c=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "productProduct_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_productProduct.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_productproduct_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_productProduct.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getStage_productProduct");
		}
...
/************************************************************************************************
 * 38824 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:31:18 PM CST
 ************************************************************************************************/