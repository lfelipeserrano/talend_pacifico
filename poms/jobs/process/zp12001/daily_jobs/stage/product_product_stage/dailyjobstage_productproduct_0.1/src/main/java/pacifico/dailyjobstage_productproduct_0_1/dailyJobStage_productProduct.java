		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dailyJobStage_productProduct.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:O42bshLbd5tYsPE5ciD12qVzqU8caQJ4oxTyydzjjKgogpnViZhlXNcTWoWIuT5QZSzBpGzFKM7nofHmQTXYA2gdi2Y=");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","message_main_attachment_id","default_code","active","product_tmpl_id","barcode","combination_indices","volume","weight","can_image_variant_1024_be_zoomed","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_tmpl_id", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 6;
							...
							row5.combination_indices = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"can_image_variant_1024_be_zoomed", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
///////////////////////		
	    		...
	    		if(row6.product_tmpl_id != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row6.product_tmpl_id)			
					          ;	
	    		...
	    		if(row6.combination_indices != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row6.combination_indices)			
					          ;	
	    		...
	    		if(row6.can_image_variant_1024_be_zoomed != null) { //              
                 row_tLogRow_1[9]=    						    
				                String.valueOf(row6.can_image_variant_1024_be_zoomed)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row7.can_image_variant_1024_be_zoomed
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","message_main_attachment_id","default_code","active","product_tmpl_id","barcode","combination_indices","volume","weight","can_image_variant_1024_be_zoomed","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_tmpl_id", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 6;
							...
							row1.combination_indices = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"can_image_variant_1024_be_zoomed", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
///////////////////////		
	    		...
	    		if(out1.product_tmpl_id != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(out1.product_tmpl_id)			
					          ;	
	    		...
	    		if(out1.combination_indices != null) { //              
                 row_tLogRow_2[6]=    						    
				                String.valueOf(out1.combination_indices)			
					          ;	
	    		...
	    		if(out1.can_image_variant_1024_be_zoomed != null) { //              
                 row_tLogRow_2[9]=    						    
				                String.valueOf(out1.can_image_variant_1024_be_zoomed)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            row3.can_image_variant_1024_be_zoomed
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_tmpl_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 6;
							...
							row2.combination_indices = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"can_image_variant_1024_be_zoomed", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJobStage_productProduct.class.getClassLoader().getResourceAsStream("pacifico/dailyjobstage_productproduct_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJobStage_productProduct.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJobStage_productProduct");
        }
...
/************************************************************************************************
 *     296467 characters generated by Talend Open Studio for Data Integration 
 *     on the December 7, 2022 at 11:37:59 PM CST
 ************************************************************************************************/