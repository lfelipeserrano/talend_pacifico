...
package pacifico.dailyjobstage_productproduct_0_1;
...
/**
 * Job: dailyJobStage_productProduct Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class dailyJobStage_productProduct implements TalendJob {
	...
	private final String jobName = "dailyJobStage_productProduct";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dailyJobStage_productProduct.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dailyJobStage_productProduct.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LTRwU5CM08CgGyFm/ZLGm/6ySBv2uWoor5O8VkRUvOJTznNEastsz4m9k7PWBGrCVC4bXC4/j7pidQoJ/RpzHhSN4iI=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "productProduct.csv";
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_dailyJobStage_productProduct = new byte[0];
		static byte[] commonByteArray_PACIFICO_dailyJobStage_productProduct = new byte[0];
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_productProduct) {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.product_tmpl_id = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.product_tmpl_id = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.product_tmpl_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.product_tmpl_id, dos, objectOut);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.product_tmpl_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_tmpl_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.product_tmpl_id = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 5;

							row2.barcode = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row2.combination_indices = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							row2.volume = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.can_image_variant_1024_be_zoomed = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"can_image_variant_1024_be_zoomed", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.can_image_variant_1024_be_zoomed = null;
...
// Start of branch "row2"
						if (row2 != null) {
							...
							row2_HashRow.product_tmpl_id = row2.product_tmpl_id;

							row2_HashRow.barcode = row2.barcode;

							row2_HashRow.combination_indices = row2.combination_indices;

							row2_HashRow.volume = row2.volume;

							row2_HashRow.weight = row2.weight;

							row2_HashRow.can_image_variant_1024_be_zoomed = row2.can_image_variant_1024_be_zoomed;
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_dailyJobStage_productProduct.length) {
					if (length < 1024 && commonByteArray_PACIFICO_dailyJobStage_productProduct.length == 0) {
						commonByteArray_PACIFICO_dailyJobStage_productProduct = new byte[1024];
					} else {
						commonByteArray_PACIFICO_dailyJobStage_productProduct = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_dailyJobStage_productProduct, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_productProduct, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_dailyJobStage_productProduct, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_productProduct, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("product_tmpl_id");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("barcode");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("combination_indices");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("volume");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("weight");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("can_image_variant_1024_be_zoomed");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
				...
				util_tLogRow_1.addRow(new String[] { "id", "message_main_attachment_id", "default_code", "active",
						"product_tmpl_id", "barcode", "combination_indices", "volume", "weight",
						"can_image_variant_1024_be_zoomed", "create_uid", "create_date", "write_uid", "write_date", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.product_tmpl_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_tmpl_id", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.product_tmpl_id = null;

							}

							columnIndexWithD_tFileInputDelimited_3 = 5;

							row5.barcode = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 6;

							row5.combination_indices = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 7;

							row5.volume = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 8;

							row5.weight = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row5.can_image_variant_1024_be_zoomed = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"can_image_variant_1024_be_zoomed", "row5", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								row5.can_image_variant_1024_be_zoomed = null;
...
// for output
							...
							row6.product_tmpl_id = row5.product_tmpl_id;
							row6.barcode = row5.barcode;
							row6.combination_indices = row5.combination_indices;
							row6.volume = row5.volume;
							row6.weight = row5.weight;
							row6.can_image_variant_1024_be_zoomed = row5.can_image_variant_1024_be_zoomed;
...
///////////////////////		
							...
							if (row6.default_code != null) { //
								row_tLogRow_1[2] = String.valueOf(row6.default_code);

							} //

							if (row6.active != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.active);

							} //

							if (row6.product_tmpl_id != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.product_tmpl_id);

							} //

							if (row6.barcode != null) { //
								row_tLogRow_1[5] = String.valueOf(row6.barcode);

							} //

							if (row6.combination_indices != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.combination_indices);

							} //

							if (row6.volume != null) { //
								row_tLogRow_1[7] = String.valueOf(row6.volume);

							} //

							if (row6.weight != null) { //
								row_tLogRow_1[8] = String.valueOf(row6.weight);

							} //

							if (row6.can_image_variant_1024_be_zoomed != null) { //
								row_tLogRow_1[9] = String.valueOf(row6.can_image_variant_1024_be_zoomed);
...
///////////////////////    			
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.product_tmpl_id != null) {
								sb_tFileOutputDelimited_1.append(row7.product_tmpl_id);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.combination_indices != null) {
								sb_tFileOutputDelimited_1.append(row7.combination_indices);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.volume != null) {
							...
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row7.can_image_variant_1024_be_zoomed != null) {
								sb_tFileOutputDelimited_1.append(row7.can_image_variant_1024_be_zoomed);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				...
				util_tLogRow_2.addRow(new String[] { "id", "message_main_attachment_id", "default_code", "active",
						"product_tmpl_id", "barcode", "combination_indices", "volume", "weight",
						"can_image_variant_1024_be_zoomed", "create_uid", "create_date", "write_uid", "write_date", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.product_tmpl_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_tmpl_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.product_tmpl_id = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.barcode = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.combination_indices = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							row1.volume = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.can_image_variant_1024_be_zoomed = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"can_image_variant_1024_be_zoomed", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.can_image_variant_1024_be_zoomed = null;
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									out1_tmp.product_tmpl_id = row1.product_tmpl_id;
									out1_tmp.barcode = row1.barcode;
									out1_tmp.combination_indices = row1.combination_indices;
									out1_tmp.volume = row1.volume;
									out1_tmp.weight = row1.weight;
									out1_tmp.can_image_variant_1024_be_zoomed = row1.can_image_variant_1024_be_zoomed;
...
///////////////////////		
								...
								if (out1.default_code != null) { //
									row_tLogRow_2[2] = String.valueOf(out1.default_code);

								} //

								if (out1.active != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.active);

								} //

								if (out1.product_tmpl_id != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.product_tmpl_id);

								} //

								if (out1.barcode != null) { //
									row_tLogRow_2[5] = String.valueOf(out1.barcode);

								} //

								if (out1.combination_indices != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.combination_indices);
								...
								if (out1.weight != null) { //
									row_tLogRow_2[8] = String.valueOf(out1.weight);

								} //

								if (out1.can_image_variant_1024_be_zoomed != null) { //
									row_tLogRow_2[9] = String.valueOf(out1.can_image_variant_1024_be_zoomed);
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.product_tmpl_id != null) {
									sb_tFileOutputDelimited_2.append(row3.product_tmpl_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.barcode != null) {
									sb_tFileOutputDelimited_2.append(row3.barcode);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.combination_indices != null) {
									sb_tFileOutputDelimited_2.append(row3.combination_indices);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.volume != null) {
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (row3.can_image_variant_1024_be_zoomed != null) {
									sb_tFileOutputDelimited_2.append(row3.can_image_variant_1024_be_zoomed);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
// for output
								...
								row6.product_tmpl_id = row4.product_tmpl_id;
								row6.barcode = row4.barcode;
								row6.combination_indices = row4.combination_indices;
								row6.volume = row4.volume;
								row6.weight = row4.weight;
								row6.can_image_variant_1024_be_zoomed = row4.can_image_variant_1024_be_zoomed;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dailyJobStage_productProduct dailyJobStage_productProductClass = new dailyJobStage_productProduct();

		int exitCode = dailyJobStage_productProductClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_productProduct.class.getClassLoader().getResourceAsStream(
					"pacifico/dailyjobstage_productproduct_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_productProduct.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_productProduct");
		}
...
/************************************************************************************************
 * 296467 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:32:56 PM CST
 ************************************************************************************************/