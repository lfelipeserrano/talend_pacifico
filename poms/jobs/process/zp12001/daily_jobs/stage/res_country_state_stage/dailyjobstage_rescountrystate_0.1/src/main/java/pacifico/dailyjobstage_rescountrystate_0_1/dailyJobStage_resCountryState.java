...
package pacifico.dailyjobstage_rescountrystate_0_1;
...
/**
 * Job: dailyJobStage_resCountryState Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class dailyJobStage_resCountryState implements TalendJob {
	...
	private final String jobName = "dailyJobStage_resCountryState";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dailyJobStage_resCountryState.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dailyJobStage_resCountryState.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:rd3S5GZzycJPRe28wmAnF8Zigd8+hZt3frso6WpOit64c8KPu/ZRvZ+ioGduS4ZAbpxwnDKXselA5eVtFA0/SNbfCcw=");
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_dailyJobStage_resCountryState = new byte[0];
		static byte[] commonByteArray_PACIFICO_dailyJobStage_resCountryState = new byte[0];
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_dailyJobStage_resCountryState) {
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_dailyJobStage_resCountryState.length) {
					if (length < 1024 && commonByteArray_PACIFICO_dailyJobStage_resCountryState.length == 0) {
						commonByteArray_PACIFICO_dailyJobStage_resCountryState = new byte[1024];
					} else {
						commonByteArray_PACIFICO_dailyJobStage_resCountryState = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_dailyJobStage_resCountryState, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_resCountryState, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_dailyJobStage_resCountryState, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_dailyJobStage_resCountryState, 0, length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void tFileInputDelimited_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "id", "country_id", "name", "code", "create_uid", "create_date",
...
///////////////////////		
							...
							if (row6.country_id != null) { //
								row_tLogRow_1[1] = String.valueOf(row6.country_id);
							...
							if (row6.code != null) { //
								row_tLogRow_1[3] = String.valueOf(row6.code);

							} //

							if (row6.create_uid != null) { //
								row_tLogRow_1[4] = String.valueOf(row6.create_uid);

							} //

							if (row6.create_date != null) { //
								row_tLogRow_1[5] = FormatterUtils.format_Date(row6.create_date, "dd-MM-yyyy");

							} //

							if (row6.write_uid != null) { //
								row_tLogRow_1[6] = String.valueOf(row6.write_uid);

							} //

							if (row6.write_date != null) { //
								row_tLogRow_1[7] = FormatterUtils.format_Date(row6.write_date, "dd-MM-yyyy");
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "country_id", "name", "code", "create_uid", "create_date",
						"write_uid", "write_date", });
...
///////////////////////		
								...
								if (out1.country_id != null) { //
									row_tLogRow_2[1] = String.valueOf(out1.country_id);
								...
								if (out1.code != null) { //
									row_tLogRow_2[3] = String.valueOf(out1.code);

								} //

								if (out1.create_uid != null) { //
									row_tLogRow_2[4] = String.valueOf(out1.create_uid);

								} //

								if (out1.create_date != null) { //
									row_tLogRow_2[5] = FormatterUtils.format_Date(out1.create_date, "dd-MM-yyyy");

								} //

								if (out1.write_uid != null) { //
									row_tLogRow_2[6] = String.valueOf(out1.write_uid);

								} //

								if (out1.write_date != null) { //
									row_tLogRow_2[7] = FormatterUtils.format_Date(out1.write_date, "dd-MM-yyyy");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dailyJobStage_resCountryState dailyJobStage_resCountryStateClass = new dailyJobStage_resCountryState();

		int exitCode = dailyJobStage_resCountryStateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJobStage_resCountryState.class.getClassLoader().getResourceAsStream(
					"pacifico/dailyjobstage_rescountrystate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJobStage_resCountryState.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : dailyJobStage_resCountryState");
		}
...
/************************************************************************************************
 * 232290 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 11:57:21 PM CST
 ************************************************************************************************/