		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dailyJobStage_resCountryState.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","country_id","name","code","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"country_id", "row5", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","country_id","name","code","create_uid","create_date","write_uid","write_date",});        
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:xkfq9BbnTzHz4ONyfJ5OlBjQFiOKtxmj+wsAek9I8r1byq8A8r+t4BjJsgBmW86qMa9QBp1mR4iwQW2rkXYEix/ZNAw=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "resCountryState.csv";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dailyJobStage_resCountryState.class.getClassLoader().getResourceAsStream("pacifico/dailyjobstage_rescountrystate_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dailyJobStage_resCountryState.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJobStage_resCountryState");
        }
...
/************************************************************************************************
 *     232292 characters generated by Talend Open Studio for Data Integration 
 *     on the December 7, 2022 at 11:47:52 PM CST
 ************************************************************************************************/