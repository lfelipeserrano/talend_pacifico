...
public class runDailyJob_resCountryState implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runDailyJob_resCountryState.class.getClassLoader().getResourceAsStream(
					"pacifico/rundailyjob_rescountrystate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runDailyJob_resCountryState.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runDailyJob_resCountryState");
		}
 ...
 * December 7, 2022 at 11:47:52 PM CST
 ************************************************************************************************/