...
public class getStage_resCountryState implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:GfxxHuXRKgCvCatogwU76RRxsry4c8pAWvEWy9MWlPlkUjzVa1+YnR+gEBqZkVDrIo0AYv2onl+EFGXsP7lbz8WGT+k=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "resCountryState_20221031.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_resCountryState.class.getClassLoader().getResourceAsStream(
					"pacifico/getstage_rescountrystate_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_resCountryState.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getStage_resCountryState");
		}
 ...
 * November 2, 2022 at 11:58:02 PM CST
 ************************************************************************************************/