		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				sbuilder_tDBConnection_1.append("//")
						.append("redshift-cluster-1.csmpgpbaharn.us-east-1.redshift.amazonaws.com").append(":")
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:yehQ5YplD5fu2jk+xHvI1hoMjTjXzo13FgJkuWrbNOMD2pJK");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_2.append("COPY ").append("\"").append(tableName_tDBBulkExec_2).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_2 = context.SecretAccessKey;
				command_tDBBulkExec_2.append("s3://").append("libreriapacifico/presentation").append("/")
						...
						.append(context.AccessKeyId).append(";aws_secret_access_key=")
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_3.append("COPY ").append("\"").append(tableName_tDBBulkExec_3).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_3 = context.SecretAccessKey;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_4.append("COPY ").append("\"").append(tableName_tDBBulkExec_4).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_4 = context.SecretAccessKey;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_5.append("COPY ").append("\"").append(tableName_tDBBulkExec_5).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_5 = context.SecretAccessKey;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_6.append("COPY ").append("\"").append(tableName_tDBBulkExec_6).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_6 = context.SecretAccessKey;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_7.append("COPY ").append("\"").append(tableName_tDBBulkExec_7).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_7 = context.SecretAccessKey;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				command_tDBBulkExec_8.append("COPY ").append("\"").append(tableName_tDBBulkExec_8).append("\"")
						...
						.append(" FROM '");
				final String decryptedPwd_tDBBulkExec_8 = context.SecretAccessKey;
...
/************************************************************************************************
 * 83085 characters generated by Talend Open Studio for Data Integration on the
 * February 1, 2023 at 11:52:21 PM CST
 ************************************************************************************************/