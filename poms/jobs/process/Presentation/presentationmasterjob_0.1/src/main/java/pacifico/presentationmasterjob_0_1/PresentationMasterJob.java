...
package pacifico.presentationmasterjob_0_1;
...
/**
 * Job: PresentationMasterJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class PresentationMasterJob implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "PresentationMasterJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				PresentationMasterJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(PresentationMasterJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pacifico.getstagefiles_ppt_0_1.getStageFiles_ppt childJob_tRunJob_1 = new pacifico.getstagefiles_ppt_0_1.getStageFiles_ppt();
	    // pass DataSources
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_2 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_2 {
                    ...
                    parentContextMap_tRunJob_2.put("temp_path", context.temp_path);
                    paraList_tRunJob_2.add("--context_type " + "temp_path" + "=" + "id_String");
                        }
	...
	Object obj_tRunJob_2 = null;
		...
		pacifico.attributdimmaster_0_1.AttributDimMaster childJob_tRunJob_2 = new pacifico.attributdimmaster_0_1.AttributDimMaster();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		pacifico.paymentmethodmaster_0_1.PaymentMethodMaster childJob_tRunJob_4 = new pacifico.paymentmethodmaster_0_1.PaymentMethodMaster();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		pacifico.productmaster_0_1.ProductMaster childJob_tRunJob_5 = new pacifico.productmaster_0_1.ProductMaster();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		pacifico.storemaster_0_1.StoreMaster childJob_tRunJob_6 = new pacifico.storemaster_0_1.StoreMaster();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		pacifico.bridgemaster_0_1.BridgeMaster childJob_tRunJob_7 = new pacifico.bridgemaster_0_1.BridgeMaster();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		pacifico.salesfactmaster_0_1.SalesFactMaster childJob_tRunJob_8 = new pacifico.salesfactmaster_0_1.SalesFactMaster();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final PresentationMasterJob PresentationMasterJobClass = new PresentationMasterJob();

        int exitCode = PresentationMasterJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = PresentationMasterJob.class.getClassLoader().getResourceAsStream("pacifico/presentationmasterjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = PresentationMasterJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PresentationMasterJob");
        }
...
/************************************************************************************************
 *     79779 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:59 PM CST
 ************************************************************************************************/