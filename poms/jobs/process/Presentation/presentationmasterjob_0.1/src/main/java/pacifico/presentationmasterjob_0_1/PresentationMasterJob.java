...
public class PresentationMasterJob implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = PresentationMasterJob.class.getClassLoader()
					.getResourceAsStream("pacifico/presentationmasterjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = PresentationMasterJob.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : PresentationMasterJob");
		}
...
/************************************************************************************************
 * 74480 characters generated by Talend Open Studio for Data Integration on the
 * February 1, 2023 at 12:02:23 AM CST
 ************************************************************************************************/