...
package pacifico.getstagefilestoredim_0_1;
...
/**
 * Job: getStageFileStoreDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getStageFileStoreDim implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getStageFileStoreDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getStageFileStoreDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getStageFileStoreDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posConfig.csv");
 ...
 */
    ...
    public static void main(String[] args){
        final getStageFileStoreDim getStageFileStoreDimClass = new getStageFileStoreDim();

        int exitCode = getStageFileStoreDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getStageFileStoreDim.class.getClassLoader().getResourceAsStream("pacifico/getstagefilestoredim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getStageFileStoreDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStageFileStoreDim");
        }
...
/************************************************************************************************
 *     36102 characters generated by Talend Open Studio for Data Integration 
