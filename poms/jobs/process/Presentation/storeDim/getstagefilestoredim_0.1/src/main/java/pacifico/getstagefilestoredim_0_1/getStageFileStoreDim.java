...
public class getStageFileStoreDim implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:iAGCajKM5zWBhReXVbAfgMxLhnbaJH1neLkpKnJvLw5JrN4hKU9xpBROvEGMNaqVIYOKZZMM7HtMtetXQGvtUWKvrBQ=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStageFileStoreDim.class.getClassLoader()
					.getResourceAsStream("pacifico/getstagefilestoredim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStageFileStoreDim.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStageFileStoreDim");
		}
...
/************************************************************************************************
 * 34099 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:51:27 PM CST
 ************************************************************************************************/