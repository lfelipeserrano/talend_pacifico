...
SalesFact_tmp.discount_unit_price = PosOrderLine.discount > 0 ? PosOrderLine.price_unit + (PosOrderLine.discount * PosOrderLine.price_unit) : 0 ;
SalesFact_tmp.net_unit_price = PosOrderLine.price_unit - (PosOrderLine.price_unit * 0.1f) ;
SalesFact_tmp.extended_discount_dollar_amount = PosOrderLine.discount > 0 ?(PosOrderLine.price_unit - (PosOrderLine.discount * PosOrderLine.price_unit)) * PosOrderLine.qty : 0 ;
...
/************************************************************************************************
 *     963413 characters generated by Talend Open Studio for Data Integration 
