...
SalesFact_tmp.discount_unit_price = PosOrderLine.discount * PosOrderLine.price_unit ;
SalesFact_tmp.net_unit_price = (PosOrderLine.price_unit + (PosOrderLine.price_unit * PosOrder.amount_tax) - PosOrderLine.price_unit * PosOrderLine.discount) * PosOrderLine.qty ;
SalesFact_tmp.extended_discount_dollar_amount = (PosOrderLine.price_unit - (PosOrderLine.discount * PosOrderLine.price_unit)) * PosOrderLine.qty ;
SalesFact_tmp.extended_sales_dollar_amount = ((PosOrderLine.price_unit + (PosOrderLine.price_unit * PosOrder.amount_tax) - PosOrderLine.price_unit * PosOrderLine.discount) * PosOrderLine.qty) * PosOrderLine.qty ;
SalesFact_tmp.extended_gross_profit_dollar_amount = (((PosOrderLine.price_unit + (PosOrderLine.price_unit * PosOrder.amount_tax) - PosOrderLine.price_unit * PosOrderLine.discount) * PosOrderLine.qty) - PosOrderLine.price_unit) * PosOrderLine.qty ;
...
/************************************************************************************************
 *     963617 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:58 PM CST
 ************************************************************************************************/