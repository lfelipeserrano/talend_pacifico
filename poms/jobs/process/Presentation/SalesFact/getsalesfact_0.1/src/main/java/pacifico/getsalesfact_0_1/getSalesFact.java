...
public class getSalesFact implements TalendJob {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/stage", "posOrderLine.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
							getObjectRequest_tS3Get_1,
							new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posOrderLine.csv"),
							null, 0l, true);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.transfer.Download download_tS3Get_2 = tm_tS3Get_2.download(
							...
							new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posOrder.csv"), null,
							0l, true);
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_4 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/stage", "posSession.csv");

					com.amazonaws.services.s3.transfer.Download download_tS3Get_4 = tm_tS3Get_4.download(
							getObjectRequest_tS3Get_4,
							new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posSession.csv"),
							null, 0l, true);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getSalesFact.class.getClassLoader()
					.getResourceAsStream("pacifico/getsalesfact_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getSalesFact.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getSalesFact");
		}
...
/************************************************************************************************
 * 48841 characters generated by Talend Open Studio for Data Integration on the
 * January 7, 2023 at 11:22:18 PM CST
 ************************************************************************************************/