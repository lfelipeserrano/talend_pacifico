...
package pacifico.getsalesfact_0_1;
...
/**
 * Job: getSalesFact Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getSalesFact implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getSalesFact";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getSalesFact.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posOrderLine.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File(context.temp_path+"/posOrderLine.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posOrder.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_2 = tm_tS3Get_2.download(
			getObjectRequest_tS3Get_2, 
			new java.io.File(context.temp_path+"/posOrder.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_3 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "saleOrderLine.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_3 = tm_tS3Get_3.download(
			getObjectRequest_tS3Get_3, 
			new java.io.File(context.temp_path+"/saleOrderLine.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_4 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posSession.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_4 = tm_tS3Get_4.download(
			getObjectRequest_tS3Get_4, 
			new java.io.File(context.temp_path+"/posSession.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_5 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/presentation", "DimDate.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_5 = tm_tS3Get_5.download(
			getObjectRequest_tS3Get_5, 
			new java.io.File(context.temp_path+"/DateDimTemp.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final getSalesFact getSalesFactClass = new getSalesFact();

        int exitCode = getSalesFactClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getSalesFact.class.getClassLoader().getResourceAsStream("pacifico/getsalesfact_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getSalesFact.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getSalesFact");
        }
...
/************************************************************************************************
 *     53775 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:57 PM CST
 ************************************************************************************************/