...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tAdvancedHash_productTemplate_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp_path+"/DimProduct.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"product_key","product_id","product_name","product_description","category","category_description","weight","volume","barcode","product_code",});        
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productTemplateStruct> tHash_Lookup_productTemplate = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productTemplateStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productTemplateStruct>) 
					globalMap.get( "tHash_Lookup_productTemplate" ))
					;					
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = context.temp_path+"/productProduct.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productProduct.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
							...
							productProduct.message_main_attachment_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 2;
					
							productProduct.default_code = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"active", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_tmpl_id", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 5;
							...
							productProduct.barcode = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 6;
					
							productProduct.combination_indices = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 7;
					
							productProduct.volume = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 8;
					
							productProduct.weight = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"can_image_variant_1024_be_zoomed", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "productProduct", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
				...
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopproductTemplate = false;
 							...
 							productTemplateStruct productTemplateObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_productTemplate.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_productTemplate != null && tHash_Lookup_productTemplate.getCount(productTemplateHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'productTemplate' and it contains more one result from keys :  productTemplate.id = '" + productTemplateHashKey.id + "'");
								} // G 071
							...
							productTemplate = productTemplateDefault;
								...
								if (tHash_Lookup_productTemplate !=null && tHash_Lookup_productTemplate.hasNext()) { // G 099
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_productCategory.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_productCategory != null && tHash_Lookup_productCategory.getCount(productCategoryHashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'productCategory' and it contains more one result from keys :  productCategory.id = '" + productCategoryHashKey.id + "'");
								} // G 071
...
///////////////////////		
	    		...
	    		if(DimProduct.product_key != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(DimProduct.product_key)			
					          ;	
	    		...
	    		if(DimProduct.product_id != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(DimProduct.product_id)			
					          ;	
	    		...
	    		if(DimProduct.product_name != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(DimProduct.product_name)			
					          ;	
	    		...
	    		if(DimProduct.product_description != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(DimProduct.product_description)			
					          ;	
	    		...
	    		if(DimProduct.category != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(DimProduct.category)			
					          ;	
	    		...
	    		if(DimProduct.category_description != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(DimProduct.category_description)			
					          ;	
	    		...
	    		if(DimProduct.weight != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(DimProduct.weight)			
					          ;	
	    		...
	    		if(DimProduct.volume != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(DimProduct.volume)			
					          ;	
	    		...
	    		if(DimProduct.barcode != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(DimProduct.barcode)			
					          ;	
	    		...
	    		if(DimProduct.product_code != null) { //              
                 row_tLogRow_1[9]=    						    
				                String.valueOf(DimProduct.product_code)			
					          ;	
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)(context.temp_path+"/productProduct.csv") instanceof java.io.InputStream)){
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/DimProduct.csv";
...
public static class productTemplateStruct implements routines.system.IPersistableComparableLookupRow<productTemplateStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_productDim = new byte[0];
    static byte[] commonByteArray_PACIFICO_productDim = new byte[0];
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_productTemplate";
		...
		int tos_count_tAdvancedHash_productTemplate = 0;
			   		...
			   		// source node:tFileInputDelimited_3 - inputs:(after_tFileInputDelimited_2) outputs:(productTemplate,productTemplate) | target node:tAdvancedHash_productTemplate - inputs:(productTemplate) outputs:()
			   		// linked node: tMap_1 - inputs:(productProduct,productTemplate,productCategory) outputs:(DimProduct)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_productTemplate = 
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_3 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_3 = context.temp_path+"/productTemplate.csv";
			...
			if(footer_value_tFileInputDelimited_3 >0 || random_value_tFileInputDelimited_3 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productTemplate.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 1;
							...
							productTemplate.message_main_attachment_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 2;
					
							productTemplate.name = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sequence", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 4;
							...
							productTemplate.description = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 5;
					
							productTemplate.description_purchase = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 6;
					
							productTemplate.description_sale = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 7;
					
							productTemplate.detailed_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 8;
					
							productTemplate.type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"categ_id", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"list_price", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"volume", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"weight", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sale_ok", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"purchase_ok", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"uom_id", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"uom_po_id", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 17;
							...
							productTemplate.company_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"active", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 19;
							...
							productTemplate.color = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 20;
					
							productTemplate.default_code = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"can_image_1024_be_zoomed", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"has_configurable_attributes", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"priority", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 28;
							...
							productTemplate.service_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 29;
					
							productTemplate.sale_line_warn = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 30;
					
							productTemplate.sale_line_warn_msg = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 31;
					
							productTemplate.expense_policy = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 32;
					
							productTemplate.invoice_policy = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sale_delay", "productTemplate", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 34;
							...
							productTemplate.tracking = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 35;
					
							productTemplate.description_picking = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 36;
					
							productTemplate.description_pickingout = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 37;
					
							productTemplate.description_pickingin = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 38;
					
							productTemplate.available_in_pos = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 39;
					
							productTemplate.to_weight = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 40;
					
							productTemplate.pos_categ_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
 ...
 */
	...
	currentComponent="tFileInputDelimited_3";
                ...
                if(!((Object)(context.temp_path+"/productTemplate.csv") instanceof java.io.InputStream)){
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_productCategory";
		...
		int tos_count_tAdvancedHash_productCategory = 0;
			   		...
			   		// source node:tFileInputDelimited_1 - inputs:(after_tFileInputDelimited_2) outputs:(productCategory,productCategory) | target node:tAdvancedHash_productCategory - inputs:(productCategory) outputs:()
			   		// linked node: tMap_1 - inputs:(productProduct,productTemplate,productCategory) outputs:(DimProduct)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.temp_path+"/productCategory.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productCategory.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "productCategory", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							productCategory.name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							productCategory.complete_name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							productCategory.parent_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							productCategory.parent_path = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "productCategory", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "productCategory", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "productCategory", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "productCategory", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 9;
							...
							productCategory.removal_strategy_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 10;
					
							productCategory.packaging_reserve_method = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.temp_path+"/productCategory.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = productDim.class.getClassLoader().getResourceAsStream("pacifico/productdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = productDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
/************************************************************************************************
 *     238368 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:52 PM CST
 ************************************************************************************************/