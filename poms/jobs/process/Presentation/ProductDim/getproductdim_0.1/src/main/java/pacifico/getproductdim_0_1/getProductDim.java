...
package pacifico.getproductdim_0_1;
...
/**
 * Job: getProductDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getProductDim implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getProductDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getProductDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getProductDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productCategory.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productProduct.csv");
...
public void tS3Get_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_3 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productTemplate.csv");
...
public void tS3Get_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_4 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/presentation", "AttributeGroupBridge.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_4 = tm_tS3Get_4.download(
			getObjectRequest_tS3Get_4, 
			new java.io.File(context.temp_path+"/AttributeGroupBridge.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_5 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productAttributeProductTemplateRel.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_5 = tm_tS3Get_5.download(
			getObjectRequest_tS3Get_5, 
			new java.io.File(context.temp_path+"/productAttributeProductTemplateRel.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_6 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/presentation", "DimAttribute.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_6 = tm_tS3Get_6.download(
			getObjectRequest_tS3Get_6, 
			new java.io.File(context.temp_path+"/DimAttribute.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final getProductDim getProductDimClass = new getProductDim();

        int exitCode = getProductDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getProductDim.class.getClassLoader().getResourceAsStream("pacifico/getproductdim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getProductDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getProductDim");
        }
...
/************************************************************************************************
 *     59415 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:45:46 PM CST
 ************************************************************************************************/