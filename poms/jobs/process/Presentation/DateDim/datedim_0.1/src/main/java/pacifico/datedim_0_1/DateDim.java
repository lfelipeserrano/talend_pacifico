...
public class DateDim implements TalendJob {
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "DimDate.csv";
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimDate.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = DateDim.class.getClassLoader()
					.getResourceAsStream("pacifico/datedim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = DateDim.class.getClassLoader()
...
/************************************************************************************************
 * 41858 characters generated by Talend Open Studio for Data Integration on the
 * January 7, 2023 at 10:41:02 PM CST
 ************************************************************************************************/