...
public static class AttributeGroupBridgeStruct implements routines.system.IPersistableRow<AttributeGroupBridgeStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_AttributeGroupBridge = new byte[0];
    static byte[] commonByteArray_PACIFICO_AttributeGroupBridge = new byte[0];
...
public static class productAttributeProductTemplateRelStruct implements routines.system.IPersistableRow<productAttributeProductTemplateRelStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_AttributeGroupBridge = new byte[0];
    static byte[] commonByteArray_PACIFICO_AttributeGroupBridge = new byte[0];
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp_path+"/AttributeGroupBridge.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.temp_path+"/productAttributeProductTemplateRel.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productAttributeProductTemplateRel.csv", "ISO-8859-15",";","\n",true,1,0,
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeProductTemplateRel.product_attribute_id = ParserUtils.parseTo_Integer(temp);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_attribute_id", "productAttributeProductTemplateRel", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeProductTemplateRel.product_template_id = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_template_id", "productAttributeProductTemplateRel", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row2.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.attribute_id = '" + row2HashKey.attribute_id + "'");
								} // G 071
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.product_tmpl_id = '" + row3HashKey.product_tmpl_id + "'");
								} // G 071
...
AttributeGroupBridge_tmp.attribute_group_key = Numeric.sequence("paymentMethodSeq", 1, 1) ;
...
///////////////////////		
	    		...
	    		if(AttributeGroupBridge.attribute_group_key != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(AttributeGroupBridge.attribute_group_key)			
					          ;	
	    		...
	    		if(AttributeGroupBridge.attribute_key != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(AttributeGroupBridge.attribute_key)			
					          ;	
	    		...
	    		if(AttributeGroupBridge.product_key != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(AttributeGroupBridge.product_key)			
					          ;	
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.temp_path+"/productAttributeProductTemplateRel.csv") instanceof java.io.InputStream)){
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/AttributeGroupBridge.csv";
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(productAttributeProductTemplateRel,row2,row3) outputs:(AttributeGroupBridge)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = context.temp_path+"/DimAttribute.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/DimAttribute.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"attribute_key", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"attribute_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)(context.temp_path+"/DimAttribute.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_3 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_3 = context.temp_path+"/productProduct.csv";
			...
			if(footer_value_tFileInputDelimited_3 >0 || random_value_tFileInputDelimited_3 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_3 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productProduct.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_3 = 1;
							...
							row3.message_main_attachment_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"active", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_tmpl_id", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 6;
							...
							row3.combination_indices = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"can_image_variant_1024_be_zoomed", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "row3", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = AttributeGroupBridge.class.getClassLoader().getResourceAsStream("pacifico/attributegroupbridge_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AttributeGroupBridge.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AttributeGroupBridge");
        }
...
/************************************************************************************************
 *     154878 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:45:51 PM CST
 ************************************************************************************************/