...
package pacifico.getbridgefile_0_1;
...
/**
 * Job: getBridgeFile Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getBridgeFile implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getBridgeFile";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getBridgeFile.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getBridgeFile.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productAttributeProductTemplateRel.csv");
 ...
 */
    ...
    public static void main(String[] args){
        final getBridgeFile getBridgeFileClass = new getBridgeFile();

        int exitCode = getBridgeFileClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getBridgeFile.class.getClassLoader().getResourceAsStream("pacifico/getbridgefile_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getBridgeFile.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getBridgeFile");
        }
...
/************************************************************************************************
 *     40433 characters generated by Talend Open Studio for Data Integration 
