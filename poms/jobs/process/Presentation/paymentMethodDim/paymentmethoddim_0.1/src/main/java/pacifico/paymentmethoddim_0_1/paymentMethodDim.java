...
package pacifico.paymentmethoddim_0_1;
...
/**
 * Job: paymentMethodDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class paymentMethodDim implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "paymentMethodDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				paymentMethodDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(paymentMethodDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_paymentMethodDim.length) {
				if(length < 1024 && commonByteArray_PACIFICO_paymentMethodDim.length == 0) {
   					commonByteArray_PACIFICO_paymentMethodDim = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_paymentMethodDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_paymentMethodDim, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_paymentMethodDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_paymentMethodDim, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_paymentMethodDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_paymentMethodDim) {
...
public static class PaymetMethodDimStruct implements routines.system.IPersistableRow<PaymetMethodDimStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_paymentMethodDim = new byte[0];
    static byte[] commonByteArray_PACIFICO_paymentMethodDim = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(PaymetMethodDimStruct other) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp_path+"/DimPaymentMethod.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tLogRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"PaymetMethodDim");
					}
...
PaymetMethodDimStruct PaymetMethodDim_tmp = new PaymetMethodDimStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.temp_path+"/posPaymentMethod.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/posPaymentMethod.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							posPaymentMethod.name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 2;
					
							posPaymentMethod.outstanding_account_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							posPaymentMethod.receivable_account_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_cash_count", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 5;
							...
							posPaymentMethod.journal_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"split_transactions", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"company_id", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
							...
							posPaymentMethod.use_payment_terminal = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"active", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "posPaymentMethod", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
 ...
 */
// Start of branch "PaymetMethodDim"
if(PaymetMethodDim != null) { 
...
///////////////////////		
	    		...
	    		if(PaymetMethodDim.payment_method_key != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(PaymetMethodDim.payment_method_key)			
					          ;	
	    		...
	    		if(PaymetMethodDim.payment_method_id != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(PaymetMethodDim.payment_method_id)			
					          ;	
	    		...
	    		if(PaymetMethodDim.name != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(PaymetMethodDim.name)			
					          ;	
	    		...
	    		if(PaymetMethodDim.isCash != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(PaymetMethodDim.isCash)			
					          ;	
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.temp_path+"/posPaymentMethod.csv") instanceof java.io.InputStream)){
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"PaymetMethodDim");
			  	}
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "DimPaymentMethod.csv";
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/DimPaymentMethod.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final paymentMethodDim paymentMethodDimClass = new paymentMethodDim();

        int exitCode = paymentMethodDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = paymentMethodDim.class.getClassLoader().getResourceAsStream("pacifico/paymentmethoddim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = paymentMethodDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : paymentMethodDim");
        }
...
/************************************************************************************************
 *     110868 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:50 PM CST
 ************************************************************************************************/