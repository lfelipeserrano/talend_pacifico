...
package pacifico.getstagefilepaymentmethoddim_0_1;
...
/**
 * Job: getStageFilePaymentMethodDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getStageFilePaymentMethodDim implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getStageFilePaymentMethodDim";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getStageFilePaymentMethodDim.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getStageFilePaymentMethodDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posPaymentMethod.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File(context.temp_path+"/posPaymentMethod.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final getStageFilePaymentMethodDim getStageFilePaymentMethodDimClass = new getStageFilePaymentMethodDim();

        int exitCode = getStageFilePaymentMethodDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getStageFilePaymentMethodDim.class.getClassLoader().getResourceAsStream("pacifico/getstagefilepaymentmethoddim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getStageFilePaymentMethodDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStageFilePaymentMethodDim");
        }
...
/************************************************************************************************
 *     36228 characters generated by Talend Open Studio for Data Integration 
 *     on the February 1, 2023 at 11:45:44 PM CST
 ************************************************************************************************/