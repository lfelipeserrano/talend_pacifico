...
package pacifico.getstagefiles_ppt_0_1;
...
/**
 * Job: getStageFiles_ppt Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getStageFiles_ppt implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "getStageFiles_ppt";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getStageFiles_ppt.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getStageFiles_ppt.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tS3Get_6_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tS3Get_7_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tS3Get_7_onSubJobError(exception, errorComponent, globalMap);
			}
			
			public void tS3Get_8_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tS3Get_8_onSubJobError(exception, errorComponent, globalMap);
			}
			
			public void tS3Get_5_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tS3Get_4_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tS3Get_9_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tS3Get_9_onSubJobError(exception, errorComponent, globalMap);
			}
			
			public void tS3Get_10_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tS3Get_11_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tS3Get_6_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_7_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_8_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_5_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_4_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_9_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_10_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tS3Get_11_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productTemplate.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_1 = tm_tS3Get_1.download(
			getObjectRequest_tS3Get_1, 
			new java.io.File(context.temp_path+"/productTemplate.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productCategory.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_2 = tm_tS3Get_2.download(
			getObjectRequest_tS3Get_2, 
			new java.io.File(context.temp_path+"/productCategory.csv"), 
			null, 
			0l, 
			true);
...
public void tS3Get_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_3 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productProduct.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_3 = tm_tS3Get_3.download(
			getObjectRequest_tS3Get_3, 
			new java.io.File(context.temp_path+"/productProduct.csv"), 
			null, 
			0l, 
			true);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_3:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tS3Get_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tS3Get_6";
		...
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_6 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
	...
	try{
		...
		tm_tS3Get_6 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_6)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_6 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "resPartner.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_6 = tm_tS3Get_6.download(
			getObjectRequest_tS3Get_6, 
			new java.io.File(context.temp_path+"/resPartner.csv"), 
			null, 
			0l, 
			true);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_6:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tS3Get_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tS3Get_7_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tS3Get_7", false);
		start_Hash.put("tS3Get_7", System.currentTimeMillis());
		
	
	currentComponent="tS3Get_7";

	
		int tos_count_tS3Get_7 = 0;
		
	
	
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_7 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
		
	
	
	com.amazonaws.services.s3.transfer.TransferManager tm_tS3Get_7 = null;
	
	try{
		
		tm_tS3Get_7 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_7)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_7 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posPaymentMethod.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_7 = tm_tS3Get_7.download(
			getObjectRequest_tS3Get_7, 
			new java.io.File(context.temp_path+"/posPaymentMehtod.csv"), 
			null, 
			0l, 
			true);
	...
	}catch(java.lang.Exception e_tS3Get_7){
globalMap.put("tS3Get_7_ERROR_MESSAGE",e_tS3Get_7.getMessage());
		
		System.err.println(e_tS3Get_7.getMessage());
		
	}finally{
	
		if(tm_tS3Get_7 != null){
	         tm_tS3Get_7.shutdownNow(false);
	    }
	}
 ...
 */
	...
	/**
	 * [tS3Get_7 process_data_begin ] start
	 */
...
/**
 * [tS3Get_7 process_data_begin ] stop
 */
	
	/**
	 * [tS3Get_7 process_data_end ] start
	 */
...
/**
 * [tS3Get_7 process_data_end ] stop
 */
...
ok_Hash.put("tS3Get_7", true);
end_Hash.put("tS3Get_7", System.currentTimeMillis());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_7:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
		...
		globalMap.put("tS3Get_7_SUBPROCESS_STATE", 1);
	}
	

public void tS3Get_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tS3Get_8_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tS3Get_8", false);
		start_Hash.put("tS3Get_8", System.currentTimeMillis());
		
	
	currentComponent="tS3Get_8";

	
		int tos_count_tS3Get_8 = 0;
		
	
	
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_8 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
		
	
	
	com.amazonaws.services.s3.transfer.TransferManager tm_tS3Get_8 = null;
	
	try{
		
		tm_tS3Get_8 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_8)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_8 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posConfig.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_8 = tm_tS3Get_8.download(
			getObjectRequest_tS3Get_8, 
			new java.io.File(context.temp_path+"/posConfig.csv"), 
			null, 
			0l, 
			true);
	...
	}catch(java.lang.Exception e_tS3Get_8){
globalMap.put("tS3Get_8_ERROR_MESSAGE",e_tS3Get_8.getMessage());
		
		System.err.println(e_tS3Get_8.getMessage());
		
	}finally{
	
		if(tm_tS3Get_8 != null){
	         tm_tS3Get_8.shutdownNow(false);
	    }
	}
 ...
 */
	...
	/**
	 * [tS3Get_8 process_data_begin ] start
	 */
...
/**
 * [tS3Get_8 process_data_begin ] stop
 */
	
	/**
	 * [tS3Get_8 process_data_end ] start
	 */
...
/**
 * [tS3Get_8 process_data_end ] stop
 */
...
ok_Hash.put("tS3Get_8", true);
end_Hash.put("tS3Get_8", System.currentTimeMillis());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_8:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
		...
		globalMap.put("tS3Get_8_SUBPROCESS_STATE", 1);
	}
...
public void tS3Get_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tS3Get_5";
		...
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_5 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
	...
	try{
		...
		tm_tS3Get_5 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_5)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_5 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "resCountry.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_5 = tm_tS3Get_5.download(
			getObjectRequest_tS3Get_5, 
			new java.io.File(context.temp_path+"/resCountry.csv"), 
			null, 
			0l, 
			true);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_5:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tS3Get_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tS3Get_4_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tS3Get_4", false);
		start_Hash.put("tS3Get_4", System.currentTimeMillis());
		
	
	currentComponent="tS3Get_4";

	
		int tos_count_tS3Get_4 = 0;
		
	
	
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_4 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
		
	
	
	com.amazonaws.services.s3.transfer.TransferManager tm_tS3Get_4 = null;
	
	try{
		
		tm_tS3Get_4 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_4)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_4 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "resCompany.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_4 = tm_tS3Get_4.download(
			getObjectRequest_tS3Get_4, 
			new java.io.File(context.temp_path+"/resCompany.csv"), 
			null, 
			0l, 
			true);
	...
	}catch(java.lang.Exception e_tS3Get_4){
globalMap.put("tS3Get_4_ERROR_MESSAGE",e_tS3Get_4.getMessage());
		
		System.err.println(e_tS3Get_4.getMessage());
		
	}finally{
	
		if(tm_tS3Get_4 != null){
	         tm_tS3Get_4.shutdownNow(false);
	    }
	}
 ...
 */
	...
	/**
	 * [tS3Get_4 process_data_begin ] start
	 */
...
/**
 * [tS3Get_4 process_data_begin ] stop
 */
	
	/**
	 * [tS3Get_4 process_data_end ] start
	 */
...
/**
 * [tS3Get_4 process_data_end ] stop
 */
...
ok_Hash.put("tS3Get_4", true);
end_Hash.put("tS3Get_4", System.currentTimeMillis());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_4:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tS3Get_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tS3Get_9_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tS3Get_9", false);
		start_Hash.put("tS3Get_9", System.currentTimeMillis());
		
	
	currentComponent="tS3Get_9";

	
		int tos_count_tS3Get_9 = 0;
		
	
	
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_9 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
		
	
	
	com.amazonaws.services.s3.transfer.TransferManager tm_tS3Get_9 = null;
	
	try{
		
		tm_tS3Get_9 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_9)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_9 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "resCountryState.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_9 = tm_tS3Get_9.download(
			getObjectRequest_tS3Get_9, 
			new java.io.File(context.temp_path+"/resCountryState.csv"), 
			null, 
			0l, 
			true);
	...
	}catch(java.lang.Exception e_tS3Get_9){
globalMap.put("tS3Get_9_ERROR_MESSAGE",e_tS3Get_9.getMessage());
		
		System.err.println(e_tS3Get_9.getMessage());
		
	}finally{
	
		if(tm_tS3Get_9 != null){
	         tm_tS3Get_9.shutdownNow(false);
	    }
	}
 ...
 */
	...
	/**
	 * [tS3Get_9 process_data_begin ] start
	 */
...
/**
 * [tS3Get_9 process_data_begin ] stop
 */
	
	/**
	 * [tS3Get_9 process_data_end ] start
	 */
...
/**
 * [tS3Get_9 process_data_end ] stop
 */
...
ok_Hash.put("tS3Get_9", true);
end_Hash.put("tS3Get_9", System.currentTimeMillis());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_9:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
		...
		globalMap.put("tS3Get_9_SUBPROCESS_STATE", 1);
	}
	

public void tS3Get_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tS3Get_10_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tS3Get_10", false);
		start_Hash.put("tS3Get_10", System.currentTimeMillis());
		
	
	currentComponent="tS3Get_10";

	
		int tos_count_tS3Get_10 = 0;
		
	
	
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_10 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
		
	
	
	com.amazonaws.services.s3.transfer.TransferManager tm_tS3Get_10 = null;
	
	try{
		
		tm_tS3Get_10 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_10)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_10 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productAttribute.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_10 = tm_tS3Get_10.download(
			getObjectRequest_tS3Get_10, 
			new java.io.File(context.temp_path+"/productAttribute.csv"), 
			null, 
			0l, 
			true);
	...
	}catch(java.lang.Exception e_tS3Get_10){
globalMap.put("tS3Get_10_ERROR_MESSAGE",e_tS3Get_10.getMessage());
		
		System.err.println(e_tS3Get_10.getMessage());
		
	}finally{
	
		if(tm_tS3Get_10 != null){
	         tm_tS3Get_10.shutdownNow(false);
	    }
	}
...
/**
 * [tS3Get_10 begin ] stop
 */
	
	/**
	 * [tS3Get_10 main ] start
	 */
 ...
 */
	...
	/**
	 * [tS3Get_10 process_data_begin ] start
	 */
...
/**
 * [tS3Get_10 process_data_begin ] stop
 */
	
	/**
	 * [tS3Get_10 process_data_end ] start
	 */
...
/**
 * [tS3Get_10 process_data_end ] stop
 */
...
ok_Hash.put("tS3Get_10", true);
end_Hash.put("tS3Get_10", System.currentTimeMillis());
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Get_10:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public void tS3Get_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tS3Get_11";
		...
		com.amazonaws.services.s3.AmazonS3Client conn_tS3Get_11 = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get("conn_tS3Connection_1");
	...
	try{
		...
		tm_tS3Get_11 = com.amazonaws.services.s3.transfer.TransferManagerBuilder
				.standard()
				.withS3Client(conn_tS3Get_11)
				.build();
		
				
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_11 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "posPayment.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_11 = tm_tS3Get_11.download(
			getObjectRequest_tS3Get_11, 
			new java.io.File(context.temp_path+"/posPayment.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final getStageFiles_ppt getStageFiles_pptClass = new getStageFiles_ppt();

        int exitCode = getStageFiles_pptClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getStageFiles_ppt.class.getClassLoader().getResourceAsStream("pacifico/getstagefiles_ppt_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getStageFiles_ppt.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStageFiles_ppt");
        }
...
/************************************************************************************************
 *     82808 characters generated by Talend Open Studio for Data Integration 
