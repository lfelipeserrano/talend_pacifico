...
package pacifico.attributedim_0_1;
...
/**
 * Job: AttributeDim Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class AttributeDim implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "AttributeDim";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(AttributeDim.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_productAttributeValue_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_AttributeDim = new byte[0];
    static byte[] commonByteArray_PACIFICO_AttributeDim = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_AttributeDim.length) {
				if(length < 1024 && commonByteArray_PACIFICO_AttributeDim.length == 0) {
   					commonByteArray_PACIFICO_AttributeDim = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_AttributeDim = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_AttributeDim, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_AttributeDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_AttributeDim, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_AttributeDim, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_AttributeDim) {
...
public static class AttributeDimStruct implements routines.system.IPersistableRow<AttributeDimStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_AttributeDim = new byte[0];
    static byte[] commonByteArray_PACIFICO_AttributeDim = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(AttributeDimStruct other) {
...
public static class productAttributeStruct implements routines.system.IPersistableRow<productAttributeStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_AttributeDim = new byte[0];
    static byte[] commonByteArray_PACIFICO_AttributeDim = new byte[0];
		...
		synchronized(commonByteArrayLock_PACIFICO_AttributeDim) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.create_variant = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.create_variant,dos);
    ...
    public String toString() {
		...
		sb.append(",create_variant="+create_variant);
     ...
     * Compare keys
     */
    public int compareTo(productAttributeStruct other) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		productAttributeStruct productAttribute = new productAttributeStruct();
AttributeDimStruct AttributeDim = new AttributeDimStruct();
AttributeDimStruct row1 = AttributeDim;
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.temp_path+"/DimAttribute.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tLogRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"AttributeDim");
					}
 ...
 */
	...
	currentComponent="tMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"productAttribute");
					}
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productAttributeValueStruct> tHash_Lookup_productAttributeValue = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productAttributeValueStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productAttributeValueStruct>) 
					globalMap.get( "tHash_Lookup_productAttributeValue" ))
					;					
					
	

productAttributeValueStruct productAttributeValueHashKey = new productAttributeValueStruct();
productAttributeValueStruct productAttributeValueDefault = new productAttributeValueStruct();
// ###############################        
...
AttributeDimStruct AttributeDim_tmp = new AttributeDimStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.temp_path+"/productAttribute.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productAttribute.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
					...
					while (fid_tFileInputDelimited_1!=null && fid_tFileInputDelimited_1.nextRecord()) {
						rowstate_tFileInputDelimited_1.reset();
									...
									productAttribute = new productAttributeStruct();
									try {
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttribute.id = ParserUtils.parseTo_Integer(temp);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "productAttribute", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 1;
							...
							productAttribute.name = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttribute.sequence = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sequence", "productAttribute", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									productAttribute.sequence = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							productAttribute.create_variant = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							productAttribute.display_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 5;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttribute.create_uid = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "productAttribute", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									productAttribute.create_uid = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 6;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									productAttribute.create_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "productAttribute", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									productAttribute.create_date = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 7;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttribute.write_uid = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "productAttribute", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									productAttribute.write_uid = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									productAttribute.write_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "productAttribute", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									productAttribute.write_date = null;
 ...
 */
// Start of branch "productAttribute"
	...
	currentComponent="tMap_1";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "productAttributeValue" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopproductAttributeValue = false;
       		  	    	
       		  	    	
 							productAttributeValueStruct productAttributeValueObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    productAttributeValueHashKey.attribute_id = productAttribute.id ;
                        		    		

								
		                        	productAttributeValueHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_productAttributeValue.lookup( productAttributeValueHashKey );
								  ...
								  if(!tHash_Lookup_productAttributeValue.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_productAttributeValue != null && tHash_Lookup_productAttributeValue.getCount(productAttributeValueHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'productAttributeValue' and it contains more one result from keys :  productAttributeValue.attribute_id = '" + productAttributeValueHashKey.attribute_id + "'");
								} // G 071
							

							productAttributeValueStruct productAttributeValue = null;
                    		  	 
							   
                    		  	 
	       		  	    	productAttributeValueStruct fromLookup_productAttributeValue = null;
							productAttributeValue = productAttributeValueDefault;
										 
							
								 
							
							
								if (tHash_Lookup_productAttributeValue !=null && tHash_Lookup_productAttributeValue.hasNext()) { // G 099
								
							
								
								fromLookup_productAttributeValue = tHash_Lookup_productAttributeValue.next();
							...
							if(fromLookup_productAttributeValue != null) {
								productAttributeValue = fromLookup_productAttributeValue;
							}
 ...
 */
// Start of branch "AttributeDim"
if(AttributeDim != null) { 
...
///////////////////////		
	    		...
	    		if(AttributeDim.attribute_key != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(AttributeDim.attribute_key)			
					          ;	
	    		...
	    		if(AttributeDim.attribute_id != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(AttributeDim.attribute_id)			
					          ;	
	    		...
	    		if(AttributeDim.name != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(AttributeDim.name)			
					          ;	
	    		...
	    		if(AttributeDim.value != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(AttributeDim.value)			
					          ;	
...
} // End of branch "productAttribute"
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.temp_path+"/productAttribute.csv") instanceof java.io.InputStream)){
...
// # Lookup hashes releasing
					if(tHash_Lookup_productAttributeValue != null) {
						tHash_Lookup_productAttributeValue.endGet();
					}
					globalMap.remove( "tHash_Lookup_productAttributeValue" );
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"productAttribute");
			  	}
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"AttributeDim");
			  	}
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "DimAttribute.csv";
	...
	Object fileOrStream_tS3Put_1 = context.temp_path+"/DimAttribute.csv";
...
public static class productAttributeValueStruct implements routines.system.IPersistableComparableLookupRow<productAttributeValueStruct> {
    final static byte[] commonByteArrayLock_PACIFICO_AttributeDim = new byte[0];
    static byte[] commonByteArray_PACIFICO_AttributeDim = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final productAttributeValueStruct other = (productAttributeValueStruct) obj;
	...
	public void copyDataTo(productAttributeValueStruct other) {

		other.id = this.id;
	            other.name = this.name;
	            other.sequence = this.sequence;
	            other.attribute_id = this.attribute_id;
	            other.is_custom = this.is_custom;
	            other.html_color = this.html_color;
	...
	public void copyKeysDataTo(productAttributeValueStruct other) {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.is_custom = readString(dis,ois);
					
						this.html_color = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.is_custom = readString(dis,objectIn);
					
						this.html_color = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
					...
					writeInteger(this.id, dos, oos);
						...
						writeString(this.is_custom, dos, oos);
					
						writeString(this.html_color, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					writeInteger(this.id, dos, objectOut);
						...
						writeString(this.is_custom, dos, objectOut);
					
						writeString(this.html_color, dos, objectOut);
    ...
    public String toString() {
		...
		sb.append(",attribute_id="+String.valueOf(attribute_id));
		sb.append(",is_custom="+is_custom);
		sb.append(",html_color="+html_color);
     ...
     * Compare keys
     */
    public int compareTo(productAttributeValueStruct other) {
...
public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		productAttributeValueStruct productAttributeValue = new productAttributeValueStruct();
	...
	/**
	 * [tAdvancedHash_productAttributeValue begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_productAttributeValue", false);
		start_Hash.put("tAdvancedHash_productAttributeValue", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_productAttributeValue";

	
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"productAttributeValue");
					}
				
		int tos_count_tAdvancedHash_productAttributeValue = 0;
		

			   		// connection name:productAttributeValue
			   		// source node:tFileInputDelimited_2 - inputs:(after_tFileInputDelimited_1) outputs:(productAttributeValue,productAttributeValue) | target node:tAdvancedHash_productAttributeValue - inputs:(productAttributeValue) outputs:()
			   		// linked node: tMap_1 - inputs:(productAttribute,productAttributeValue) outputs:(AttributeDim)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_productAttributeValue = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<productAttributeValueStruct> tHash_Lookup_productAttributeValue =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<productAttributeValueStruct>getLookup(matchingModeEnum_productAttributeValue);
	   						   
		   	   	   globalMap.put("tHash_Lookup_productAttributeValue", tHash_Lookup_productAttributeValue);
...
/**
 * [tAdvancedHash_productAttributeValue begin ] stop
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = context.temp_path+"/productAttributeValue.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(context.temp_path+"/productAttributeValue.csv", "ISO-8859-15",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",e.getMessage());
					...
					while (fid_tFileInputDelimited_2!=null && fid_tFileInputDelimited_2.nextRecord()) {
						rowstate_tFileInputDelimited_2.reset();
									...
									productAttributeValue = new productAttributeValueStruct();
									try {
					...
					columnIndexWithD_tFileInputDelimited_2 = 0;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeValue.id = ParserUtils.parseTo_Integer(temp);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"id", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.id = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
							...
							productAttributeValue.name = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 2;
					
							productAttributeValue.sequence = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 3;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeValue.attribute_id = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"attribute_id", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.attribute_id = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
							...
							productAttributeValue.is_custom = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 5;
					
							productAttributeValue.html_color = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 6;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeValue.color = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"color", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.color = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 7;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeValue.create_uid = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_uid", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.create_uid = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 8;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									productAttributeValue.create_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"create_date", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.create_date = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 9;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								productAttributeValue.write_uid = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_uid", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.write_uid = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 10;
						...
						if(temp.length() > 0) {
								...
								try {
    									...
    									productAttributeValue.write_date = ParserUtils.parseTo_Date(temp, "dd-MM-yyyy");
    								
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"write_date", "productAttributeValue", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									productAttributeValue.write_date = null;
 ...
 */
// Start of branch "productAttributeValue"
if(productAttributeValue != null) { 
	...
	/**
	 * [tAdvancedHash_productAttributeValue main ] start
	 */
	...
	currentComponent="tAdvancedHash_productAttributeValue";
					...
					productAttributeValueStruct productAttributeValue_HashRow = new productAttributeValueStruct();
		   	   	   
				
				productAttributeValue_HashRow.id = productAttributeValue.id;
				
				productAttributeValue_HashRow.name = productAttributeValue.name;
				
				productAttributeValue_HashRow.sequence = productAttributeValue.sequence;
				
				productAttributeValue_HashRow.attribute_id = productAttributeValue.attribute_id;
				
				productAttributeValue_HashRow.is_custom = productAttributeValue.is_custom;
				
				productAttributeValue_HashRow.html_color = productAttributeValue.html_color;
				
				productAttributeValue_HashRow.color = productAttributeValue.color;
				
				productAttributeValue_HashRow.create_uid = productAttributeValue.create_uid;
				
				productAttributeValue_HashRow.create_date = productAttributeValue.create_date;
				
				productAttributeValue_HashRow.write_uid = productAttributeValue.write_uid;
				
				productAttributeValue_HashRow.write_date = productAttributeValue.write_date;
				
			tHash_Lookup_productAttributeValue.put(productAttributeValue_HashRow);
	...
	tos_count_tAdvancedHash_productAttributeValue++;

/**
 * [tAdvancedHash_productAttributeValue main ] stop
 */
	
	/**
	 * [tAdvancedHash_productAttributeValue process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_productAttributeValue process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_productAttributeValue process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_productAttributeValue process_data_end ] stop
 */

} // End of branch "productAttributeValue"
 ...
 */
	...
	currentComponent="tFileInputDelimited_2";
                ...
                if(!((Object)(context.temp_path+"/productAttributeValue.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	/**
	 * [tAdvancedHash_productAttributeValue end ] start
	 */
...
tHash_Lookup_productAttributeValue.endPut();

				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"productAttributeValue");
			  	}
			  	
 

ok_Hash.put("tAdvancedHash_productAttributeValue", true);
end_Hash.put("tAdvancedHash_productAttributeValue", System.currentTimeMillis());




/**
 * [tAdvancedHash_productAttributeValue end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_productAttributeValue finally ] start
	 */
...
/**
 * [tAdvancedHash_productAttributeValue finally ] stop
 */
    ...
    public static void main(String[] args){
        final AttributeDim AttributeDimClass = new AttributeDim();

        int exitCode = AttributeDimClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = AttributeDim.class.getClassLoader().getResourceAsStream("pacifico/attributedim_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AttributeDim.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AttributeDim");
        }
...
/************************************************************************************************
 *     148302 characters generated by Talend Open Studio for Data Integration 
 *     on the January 30, 2023 at 11:19:48 PM CST
 ************************************************************************************************/