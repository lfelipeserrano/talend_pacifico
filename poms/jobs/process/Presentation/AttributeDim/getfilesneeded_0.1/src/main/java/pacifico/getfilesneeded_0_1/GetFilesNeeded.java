...
package pacifico.getfilesneeded_0_1;
...
/**
 * Job: GetFilesNeeded Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class GetFilesNeeded implements TalendJob {
...
public String getTemp_path(){
	...
	private final String jobName = "GetFilesNeeded";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				GetFilesNeeded.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(GetFilesNeeded.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "productAttribute.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "productAttributeValue.csv");

		com.amazonaws.services.s3.transfer.Download download_tS3Get_2 = tm_tS3Get_2.download(
			getObjectRequest_tS3Get_2, 
			new java.io.File(context.temp_path+"/productAttributeValue.csv"), 
			null, 
			0l, 
			true);
 ...
 */
    ...
    public static void main(String[] args){
        final GetFilesNeeded GetFilesNeededClass = new GetFilesNeeded();

        int exitCode = GetFilesNeededClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = GetFilesNeeded.class.getClassLoader().getResourceAsStream("pacifico/getfilesneeded_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = GetFilesNeeded.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : GetFilesNeeded");
        }
...
/************************************************************************************************
 *     40711 characters generated by Talend Open Studio for Data Integration 
