...
public class GetFilesNeeded implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:f8o9CyU7MMLO0eeE47bxgmKv4bw6C5OGUkvJOIF7qi1cpWemYSxtraMjGKW4Op03ijBAULm3yALiWK88/GHgx5ZuRkE=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "productAttributeValue.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = GetFilesNeeded.class.getClassLoader()
					.getResourceAsStream("pacifico/getfilesneeded_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = GetFilesNeeded.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : GetFilesNeeded");
		}
...
/************************************************************************************************
 * 38742 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:49:29 PM CST
 ************************************************************************************************/