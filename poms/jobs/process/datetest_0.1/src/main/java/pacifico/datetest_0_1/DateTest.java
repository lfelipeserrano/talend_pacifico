 ...
 * @status
 */
public class DateTest implements TalendJob {
	...
	private final String jobName = "DateTest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(DateTest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tS3Put_2_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_DateTest = new byte[0];
		static byte[] commonByteArray_PACIFICO_DateTest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_DateTest.length) {
					if (length < 1024 && commonByteArray_PACIFICO_DateTest.length == 0) {
						commonByteArray_PACIFICO_DateTest = new byte[1024];
					} else {
						commonByteArray_PACIFICO_DateTest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_DateTest, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_DateTest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_DateTest, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_DateTest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_DateTest) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DateDimTemp.csv")).getAbsolutePath()
								.replace("\\", "/");
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					outtFileOutputDelimited_1.write("DateNum");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Date");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("YearMonthNum");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Calendar_Quarter");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("MonthNum");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("MonthName");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("MonthShortName");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("WeekNum");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("DayNumOfYear");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("DayNumOfMonth");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("DayNumOfWeek");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("DayName");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("DayShortName");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Quarter");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("YearQuarterNum");
					outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("DayNumOfQuarter");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimDate.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimDate.csv", "ISO-8859-15", ",",
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.DateNum = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"DateNum", "row1", temp, ex_tFileInputDelimited_1),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Date = ParserUtils.parseTo_Date(temp, "MM/dd/yyyy");
							...
							row1.Calendar_Quarter = fid_tFileInputDelimited_1
							...
							row1.MonthShortName = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.DayShortName = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.YearQuarterNum = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"YearQuarterNum", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.YearQuarterNum = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.DayNumOfQuarter = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"DayNumOfQuarter", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								row1.DayNumOfQuarter = null;
...
// # Output table : 'out1'
								out1_tmp.DateNum = row1.DateNum;
								out1_tmp.Date = TalendDate.formatDate("dd-MM-yyyy", row1.Date);
								out1_tmp.YearMonthNum = row1.YearMonthNum;
								out1_tmp.Calendar_Quarter = row1.Calendar_Quarter;
								out1_tmp.MonthNum = row1.MonthNum;
								out1_tmp.MonthName = row1.MonthName;
								out1_tmp.MonthShortName = row1.MonthShortName;
								out1_tmp.WeekNum = row1.WeekNum;
								out1_tmp.DayNumOfYear = row1.DayNumOfYear;
								out1_tmp.DayNumOfMonth = row1.DayNumOfMonth;
								out1_tmp.DayNumOfWeek = row1.DayNumOfWeek;
								out1_tmp.DayName = row1.DayName;
								out1_tmp.DayShortName = row1.DayShortName;
								out1_tmp.Quarter = row1.Quarter;
								out1_tmp.YearQuarterNum = row1.YearQuarterNum;
								out1_tmp.DayNumOfQuarter = row1.DayNumOfQuarter;
								out1 = out1_tmp;
// ###############################
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.DateNum != null) {
									sb_tFileOutputDelimited_1.append(out1.DateNum);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.Date != null) {
									sb_tFileOutputDelimited_1.append(out1.Date);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.YearMonthNum != null) {
									sb_tFileOutputDelimited_1.append(out1.YearMonthNum);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.Calendar_Quarter != null) {
									sb_tFileOutputDelimited_1.append(out1.Calendar_Quarter);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.MonthNum != null) {
									sb_tFileOutputDelimited_1.append(out1.MonthNum);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.MonthName != null) {
									sb_tFileOutputDelimited_1.append(out1.MonthName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.MonthShortName != null) {
									sb_tFileOutputDelimited_1.append(out1.MonthShortName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.WeekNum != null) {
									sb_tFileOutputDelimited_1.append(out1.WeekNum);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.DayNumOfYear != null) {
									sb_tFileOutputDelimited_1.append(out1.DayNumOfYear);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.DayNumOfMonth != null) {
									sb_tFileOutputDelimited_1.append(out1.DayNumOfMonth);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.DayNumOfWeek != null) {
									sb_tFileOutputDelimited_1.append(out1.DayNumOfWeek);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.DayName != null) {
									sb_tFileOutputDelimited_1.append(out1.DayName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.DayShortName != null) {
									sb_tFileOutputDelimited_1.append(out1.DayShortName);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.Quarter != null) {
									sb_tFileOutputDelimited_1.append(out1.Quarter);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.YearQuarterNum != null) {
									sb_tFileOutputDelimited_1.append(out1.YearQuarterNum);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (out1.DayNumOfQuarter != null) {
									sb_tFileOutputDelimited_1.append(out1.DayNumOfQuarter);
								}
					...
					if (!((Object) ("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimDate.csv") instanceof java.io.InputStream)) {
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kmAmNq8oEAQbiIRHwyVEZIGnPi6lkBhFuyq4A25hXFSEsfzEIhopF+bB0qQfjSjv0P/It2gFJXx3LzVIR5+8+iIactA=");
	...
	public void tS3Put_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String millisecTime_tS3Put_2 = null;
				...
				String key_tS3Put_2 = "DimDate.csv";
				...
				Object fileOrStream_tS3Put_2 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DateDimTemp.csv";
				...
				try {
					...
					if (!useStream_tS3Put_2) {
						...
						tm_tS3Put_2 = com.amazonaws.services.s3.transfer.TransferManagerBuilder.standard()
						...
						com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_2 = new com.amazonaws.services.s3.model.PutObjectRequest(
								"libreriapacifico/presentation", key_tS3Put_2, inputFile_tS3Put_2)
						...
						long curPartSize_tS3Put_2 = streamUtil_tS3Put_2.readFully(sourceStream_tS3Put_2,
								buffer_tS3Put_2);
						...
						if (!multiUpload_tS3Put_2) {
							...
							uploadStream_tS3Put_2 = new java.io.ByteArrayInputStream(buffer_tS3Put_2, 0,
									Long.valueOf(curPartSize_tS3Put_2).intValue());
							com.amazonaws.services.s3.model.PutObjectRequest putRequest_tS3Put_2 = new com.amazonaws.services.s3.model.PutObjectRequest(
									"libreriapacifico/presentation", key_tS3Put_2, uploadStream_tS3Put_2,
							...
							com.amazonaws.services.s3.model.InitiateMultipartUploadRequest putRequest_tS3Put_2 = new com.amazonaws.services.s3.model.InitiateMultipartUploadRequest(
									"libreriapacifico/presentation", key_tS3Put_2, objectMetadata_tS3Put_2);
							...
							try {
								while (streamHasNext_tS3Put_2) {
									com.amazonaws.services.s3.model.UploadPartRequest uploadRequest_tS3Put_2 = new com.amazonaws.services.s3.model.UploadPartRequest()
											.withBucketName("libreriapacifico/presentation").withKey(key_tS3Put_2)
											.withUploadId(uploadId_tS3Put_2).withPartNumber(partNumber_tS3Put_2)
											.withPartSize(curPartSize_tS3Put_2);
									uploadRequest_tS3Put_2.setInputStream(uploadStream_tS3Put_2);
									streamHasNext_tS3Put_2 = (1 == streamUtil_tS3Put_2.readFully(sourceStream_tS3Put_2,
											probeAvailability_tS3Put_2));
									if (!streamHasNext_tS3Put_2) {
										uploadRequest_tS3Put_2.setLastPart(true);
									}

									partTags_tS3Put_2
											.add(conn_tS3Put_2.uploadPart(uploadRequest_tS3Put_2).getPartETag());
									partNumber_tS3Put_2++;
									...
									curPartSize_tS3Put_2 = 1 + streamUtil_tS3Put_2.readFully(sourceStream_tS3Put_2,
											buffer_tS3Put_2, 1, partSizeInBytes_tS3Put_2 - 1);
								...
								com.amazonaws.services.s3.model.CompleteMultipartUploadRequest compRequest_tS3Put_2 = new com.amazonaws.services.s3.model.CompleteMultipartUploadRequest(
										"libreriapacifico/presentation", key_tS3Put_2, uploadId_tS3Put_2,
										partTags_tS3Put_2);
								conn_tS3Put_2.completeMultipartUpload(compRequest_tS3Put_2);
							} catch (java.lang.Exception uploadException_tS3Put_2) {
								globalMap.put("tS3Put_2_ERROR_MESSAGE", uploadException_tS3Put_2.getMessage());
								conn_tS3Put_2.abortMultipartUpload(
					...
					globalMap.put("tS3Put_2_ERROR_MESSAGE", e_tS3Put_2.getMessage());
	...
	public static void main(String[] args) {
		final DateTest DateTestClass = new DateTest();

		int exitCode = DateTestClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = DateTest.class.getClassLoader()
					.getResourceAsStream("pacifico/datetest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = DateTest.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DateTest");
		}
...
/************************************************************************************************
 * 102363 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 11:14:32 PM CST
 ************************************************************************************************/