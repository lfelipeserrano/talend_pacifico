...
public class AttributeDim implements TalendJob {
	...
	public void tAdvancedHash_productAttributeValue_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimAttribute.csv")).getAbsolutePath()
								.replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttribute.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"id", "productAttribute", temp, ex_tFileInputDelimited_1),
							...
							productAttribute.name = fid_tFileInputDelimited_1
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "productAttribute", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							productAttribute.create_variant = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							productAttribute.display_type = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_uid", "productAttribute", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_date", "productAttribute", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_uid", "productAttribute", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_date", "productAttribute", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "productAttribute"
						if (productAttribute != null) {
							...
							if (tHash_Lookup_productAttributeValue != null
									&& tHash_Lookup_productAttributeValue.getCount(productAttributeValueHashKey) > 1) { // G
																														// 071

								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
								// 'productAttributeValue' and it contains more one result from keys :
								// productAttributeValue.attribute_id = '" +
								// productAttributeValueHashKey.attribute_id + "'");
							} // G 071
							...
							if (tHash_Lookup_productAttributeValue != null
									&& tHash_Lookup_productAttributeValue.hasNext()) { // G 099
...
///////////////////////    			
					...
					if (!((Object) ("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttribute.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:mgyt6q4JOtmULRaxUqWkcWPi7AE/E+PF7lLblsw1D59QvCNxh5Q644fekOmQu2CZ0XraQM8gjHP8bf9ZrL/tnVJui+E=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimAttribute.csv";
	...
	public static class productAttributeValueStruct
			implements routines.system.IPersistableComparableLookupRow<productAttributeValueStruct> {
		final static byte[] commonByteArrayLock_PACIFICO_AttributeDim = new byte[0];
		static byte[] commonByteArray_PACIFICO_AttributeDim = new byte[0];
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:(productAttributeValue,productAttributeValue) | target
				// node:tAdvancedHash_productAttributeValue - inputs:(productAttributeValue)
				// outputs:()
				// linked node: tMap_1 - inputs:(productAttribute,productAttributeValue)
				// outputs:(AttributeDim)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_productAttributeValue = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttributeValue.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttributeValue.csv",
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"id", "productAttributeValue", temp, ex_tFileInputDelimited_2),
							...
							productAttributeValue.name = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 2;

							productAttributeValue.sequence = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"attribute_id", "productAttributeValue", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							productAttributeValue.is_custom = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 5;

							productAttributeValue.html_color = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"color", "productAttributeValue", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_uid", "productAttributeValue", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_date", "productAttributeValue", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_uid", "productAttributeValue", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_date", "productAttributeValue", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
// Start of branch "productAttributeValue"
					...
					if (!((Object) ("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttributeValue.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = AttributeDim.class.getClassLoader()
					.getResourceAsStream("pacifico/attributedim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = AttributeDim.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AttributeDim");
		}
 ...
 * December 7, 2022 at 11:49:40 PM CST
 ************************************************************************************************/