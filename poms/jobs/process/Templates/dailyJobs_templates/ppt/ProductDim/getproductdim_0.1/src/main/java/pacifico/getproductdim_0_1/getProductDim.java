...
public class getProductDim implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:SkDL/h2VQSdBasTbCgXkRIadDZ5rsA82eqi7EM4/37SmGOm6E1S/RxOXpOv7yGAULP/qgDS2gaeRHbxLYHLio7NpBZA=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_4 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/presentation", "AttributeGroupBridge.csv");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getProductDim.class.getClassLoader()
					.getResourceAsStream("pacifico/getproductdim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getProductDim.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getProductDim");
		}
 ...
 * December 5, 2022 at 10:50:42 PM CST
 ************************************************************************************************/