...
package pacifico.getstagefilecustomerdim_0_1;
...
/**
 * Job: getStageFileCustomerDim Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class getStageFileCustomerDim implements TalendJob {
	...
	private final String jobName = "getStageFileCustomerDim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					getStageFileCustomerDim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getStageFileCustomerDim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:uDOG5/9pSgQ9LqXMdPZVLc1i57OAbynLPTkcgYDha1QEjhth3V1xKk1KcEBOs1GaCPb80Q+7q5ZF+YB0eP7cpGsv9jU=");
	...
	public static void main(String[] args) {
		final getStageFileCustomerDim getStageFileCustomerDimClass = new getStageFileCustomerDim();

		int exitCode = getStageFileCustomerDimClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStageFileCustomerDim.class.getClassLoader()
					.getResourceAsStream("pacifico/getstagefilecustomerdim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStageFileCustomerDim.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getStageFileCustomerDim");
		}
...
/************************************************************************************************
 * 48232 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:47:48 PM CST
 ************************************************************************************************/