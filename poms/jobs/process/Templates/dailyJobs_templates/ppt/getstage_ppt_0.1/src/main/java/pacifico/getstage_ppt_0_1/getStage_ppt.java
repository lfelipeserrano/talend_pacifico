...
package pacifico.getstage_ppt_0_1;
 ...
 * @status
 */
public class getStage_ppt implements TalendJob {
	...
	private final String jobName = "getStage_ppt";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getStage_ppt.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:LJ5aaJ/wKbhSDT66t6jFm+E9WYYDvfhV/F6DVUtKAjX3WNmJmNd3UQMnSOuteZDUjd7evovmcE0+pwuVLnVk5+mBgaQ=");
	...
	public static void main(String[] args) {
		final getStage_ppt getStage_pptClass = new getStage_ppt();

		int exitCode = getStage_pptClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_ppt.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_ppt_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_ppt.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_ppt");
		}
...
/************************************************************************************************
 * 43403 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 5:49:27 PM CST
 ************************************************************************************************/