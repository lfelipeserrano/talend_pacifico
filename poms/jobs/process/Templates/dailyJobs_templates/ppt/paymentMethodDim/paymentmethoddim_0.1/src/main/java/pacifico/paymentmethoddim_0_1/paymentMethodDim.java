		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimPaymentMethod.csv")).getAbsolutePath()
								.replace("\\", "/");
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posPaymentMethod.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posPaymentMethod.csv",
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (row1.isCash != null) {
									sb_tFileOutputDelimited_1.append(row1.isCash);
								}
					...
					if (!((Object) ("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posPaymentMethod.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JXbqGTeNeGQAZeq2I6Mf/plcC93CAbcqWvGplNf0j4QPDwW7/EqlbZR/Jw1/WKz8r0TR4PWETj+DDBNPqkz8oZ60tjY=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DimPaymentMethod.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = paymentMethodDim.class.getClassLoader()
					.getResourceAsStream("pacifico/paymentmethoddim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = paymentMethodDim.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : paymentMethodDim");
		}
 ...
 * December 4, 2022 at 11:13:38 PM CST
 ************************************************************************************************/