...
public class getStageFilePaymentMethodDim implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getStageFilePaymentMethodDim.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:hbERISivlfkyRNe0wJFcAEJEdNglXu9UubOArspJl7WavNhehM0TD+ASWZtJSyLHrTs0mYz6KFsjaZpyh/D5W7ZJ2Qs=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStageFilePaymentMethodDim.class.getClassLoader().getResourceAsStream(
					"pacifico/getstagefilepaymentmethoddim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStageFilePaymentMethodDim.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getStageFilePaymentMethodDim");
		}
...
/************************************************************************************************
 * 34225 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:48:22 PM CST
 ************************************************************************************************/