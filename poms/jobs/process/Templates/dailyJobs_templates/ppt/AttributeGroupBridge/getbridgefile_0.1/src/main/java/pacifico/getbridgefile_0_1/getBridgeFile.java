...
public class getBridgeFile implements TalendJob {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:wWrGx9a0IWGPZoOB1exbN7E74MjwBwMeRB7ZwESKDW7Rfi/4bUXWdct8w4tjgd0mN+Qjb52ukSJw+lkb9QbJwI5H1Rw=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getBridgeFile.class.getClassLoader()
					.getResourceAsStream("pacifico/getbridgefile_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getBridgeFile.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getBridgeFile");
		}
...
/************************************************************************************************
 * 34051 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:50:07 PM CST
 ************************************************************************************************/