...
package pacifico.getstage_template_0_1;
...
/**
 * Job: getStage_template Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class getStage_template implements TalendJob {
	...
	private final String jobName = "getStage_template";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					getStage_template.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getStage_template.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:yX1weTxkh5SRipUPnsomMhBkJuA1LL3dHPGuEBIYmh9MX3EOYZ4GyKz2fDRvGfzVjQ3H6LDsvqclF40cwUNZgGbH+44=");
	...
	public static void main(String[] args) {
		final getStage_template getStage_templateClass = new getStage_template();

		int exitCode = getStage_templateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getStage_template.class.getClassLoader()
					.getResourceAsStream("pacifico/getstage_template_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getStage_template.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getStage_template");
		}
...
/************************************************************************************************
 * 38743 characters generated by Talend Open Studio for Data Integration on the
 * November 1, 2022 at 11:47:39 PM CST
 ************************************************************************************************/