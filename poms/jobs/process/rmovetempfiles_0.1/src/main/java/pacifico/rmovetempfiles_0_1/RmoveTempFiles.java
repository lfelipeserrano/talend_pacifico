...
package pacifico.rmovetempfiles_0_1;
 ...
 * @status
 */
public class RmoveTempFiles implements TalendJob {
	...
	private final String jobName = "RmoveTempFiles";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					RmoveTempFiles.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(RmoveTempFiles.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final RmoveTempFiles RmoveTempFilesClass = new RmoveTempFiles();

		int exitCode = RmoveTempFilesClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = RmoveTempFiles.class.getClassLoader()
					.getResourceAsStream("pacifico/rmovetempfiles_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = RmoveTempFiles.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : RmoveTempFiles");
		}
...
/************************************************************************************************
 * 28658 characters generated by Talend Open Studio for Data Integration on the
 * January 25, 2023 at 10:43:39 PM CST
 ************************************************************************************************/