...
public class productAttributeProductTemplateRel_DailyJob implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(productAttributeProductTemplateRel_DailyJob.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:7GQ/lYtqZWrTQuT3FkXGo0A+bVWZUo+G1hCCAlP5jOT7Zig92w==");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Z1W90rz+7cCy6X4sDH3jEjaV6uGsJaWPEl/Q4Ux1YIfPj0p6rOFCbkuIV1xjgd8FV0rWhJCJcQNDFqC23l+2dWt2qcs=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/productAttributeProductTemplateRel.csv";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = productAttributeProductTemplateRel_DailyJob.class.getClassLoader()
					.getResourceAsStream("pacifico/productattributeproducttemplaterel_dailyjob_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = productAttributeProductTemplateRel_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : productAttributeProductTemplateRel_DailyJob");
		}
...
/************************************************************************************************
 * 60958 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:39:56 PM CST
 ************************************************************************************************/