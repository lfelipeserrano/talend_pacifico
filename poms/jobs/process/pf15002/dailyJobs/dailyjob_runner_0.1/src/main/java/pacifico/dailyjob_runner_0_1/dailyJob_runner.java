...
package pacifico.dailyjob_runner_0_1;
...
/**
 * Job: dailyJob_runner Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class dailyJob_runner implements TalendJob {
	...
	private final String jobName = "dailyJob_runner";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dailyJob_runner.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dailyJob_runner.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.posbill_dailyjob_0_1.posBill_DailyJob childJob_tRunJob_2 = new pacifico.posbill_dailyjob_0_1.posBill_DailyJob();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.posconfig_dailyjob_0_1.posConfig_DailyJob childJob_tRunJob_3 = new pacifico.posconfig_dailyjob_0_1.posConfig_DailyJob();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleorder_dailyjob_0_1.saleOrder_DailyJob childJob_tRunJob_4 = new pacifico.saleorder_dailyjob_0_1.saleOrder_DailyJob();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleorderoption_dailyjob_0_1.saleOrderOption_DailyJob childJob_tRunJob_5 = new pacifico.saleorderoption_dailyjob_0_1.saleOrderOption_DailyJob();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplate_dailyjob_0_1.saleOrderTemplate_DailyJob childJob_tRunJob_6 = new pacifico.saleordertemplate_dailyjob_0_1.saleOrderTemplate_DailyJob();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplateline_dailyjob_0_1.saleOrderTemplateLine_DailyJob childJob_tRunJob_7 = new pacifico.saleordertemplateline_dailyjob_0_1.saleOrderTemplateLine_DailyJob();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplateoption_dailyjob_0_1.saleOrderTemplateOption_DailyJob childJob_tRunJob_8 = new pacifico.saleordertemplateoption_dailyjob_0_1.saleOrderTemplateOption_DailyJob();
				// pass DataSources
	...
	public static void main(String[] args) {
		final dailyJob_runner dailyJob_runnerClass = new dailyJob_runner();

		int exitCode = dailyJob_runnerClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dailyJob_runner.class.getClassLoader()
					.getResourceAsStream("pacifico/dailyjob_runner_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dailyJob_runner.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dailyJob_runner");
		}
...
/************************************************************************************************
 * 79967 characters generated by Talend Open Studio for Data Integration on the
 * October 31, 2022 at 10:58:30 PM CST
 ************************************************************************************************/