...
package pacifico.productattributevalue_0_1;
...
/**
 * Job: ProductAttributeValue Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class ProductAttributeValue implements TalendJob {
	...
	private final String jobName = "ProductAttributeValue";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ProductAttributeValue.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ProductAttributeValue.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:F/9o2aZZznNyVVlE1F1803IVfg81YyymjR6CF/S9nDlpPR3W/REEN7ib+ZjyrEFwv/aPO7W4SI/aRsCaQdjh0DRyUdc=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "productAttributeValue.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "productAttributeValue.csv";
	...
	public static void main(String[] args) {
		final ProductAttributeValue ProductAttributeValueClass = new ProductAttributeValue();

		int exitCode = ProductAttributeValueClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ProductAttributeValue.class.getClassLoader()
					.getResourceAsStream("pacifico/productattributevalue_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ProductAttributeValue.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductAttributeValue");
		}
...
/************************************************************************************************
 * 39118 characters generated by Talend Open Studio for Data Integration on the
 * December 4, 2022 at 10:31:42 PM CST
 ************************************************************************************************/