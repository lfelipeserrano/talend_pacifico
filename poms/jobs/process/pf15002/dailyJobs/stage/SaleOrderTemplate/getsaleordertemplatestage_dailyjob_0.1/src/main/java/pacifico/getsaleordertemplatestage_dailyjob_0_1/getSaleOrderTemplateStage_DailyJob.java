...
package pacifico.getsaleordertemplatestage_dailyjob_0_1;
...
/**
 * Job: getSaleOrderTemplateStage_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class getSaleOrderTemplateStage_DailyJob implements TalendJob {
	...
	private final String jobName = "getSaleOrderTemplateStage_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					getSaleOrderTemplateStage_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getSaleOrderTemplateStage_DailyJob.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:otHNqvyKax22JF+DRBtMDUGTeQHxGLObx7Kl1xHqpddR2qGU9iIyxHtKh6JAMAuN8v+UI9IjY2LGlzXOLUd02rsjhtc=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "saleOrderTemplate_20221031.csv");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/stage", "saleOrderTemplate.csv");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_getSaleOrderTemplateStage_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob.length == 0) {
						commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_getSaleOrderTemplateStage_DailyJob) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.number_of_days = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											...
											"number_of_days", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								row2.number_of_days = null;
							...
							row2.mail_template_id = fid_tFileInputDelimited_2
...
///////////////////////		
							...
							if (row2.note != null) { //
								row_tLogRow_2[0] = String.valueOf(row2.note);

							} //

							if (row2.number_of_days != null) { //
								row_tLogRow_2[1] = String.valueOf(row2.number_of_days);

							} //

							if (row2.require_signature != null) { //
								row_tLogRow_2[2] = String.valueOf(row2.require_signature);

							} //

							if (row2.require_payment != null) { //
								row_tLogRow_2[3] = String.valueOf(row2.require_payment);

							} //

							if (row2.mail_template_id != null) { //
								row_tLogRow_2[4] = String.valueOf(row2.mail_template_id);

							} //

							if (row2.active != null) { //
								row_tLogRow_2[5] = String.valueOf(row2.active);

							} //

							if (row2.company_id != null) { //
								row_tLogRow_2[6] = String.valueOf(row2.company_id);

							} //

							if (row2.id != null) { //
								row_tLogRow_2[7] = String.valueOf(row2.id);

							} //

							if (row2.name != null) { //
								row_tLogRow_2[8] = String.valueOf(row2.name);

							} //

							if (row2.create_uid != null) { //
								row_tLogRow_2[9] = String.valueOf(row2.create_uid);

							} //

							if (row2.create_date != null) { //
								row_tLogRow_2[10] = FormatterUtils.format_Date(row2.create_date, "dd-MM-yyyy");

							} //

							if (row2.write_uid != null) { //
								row_tLogRow_2[11] = String.valueOf(row2.write_uid);

							} //

							if (row2.write_date != null) { //
								row_tLogRow_2[12] = FormatterUtils.format_Date(row2.write_date, "dd-MM-yyyy");
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.number_of_days = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"number_of_days", "row1", temp, ex_tFileInputDelimited_1),
							...
							row1.mail_template_id = fid_tFileInputDelimited_1
...
///////////////////////		
							...
							if (row1.note != null) { //
								row_tLogRow_1[0] = String.valueOf(row1.note);

							} //

							if (row1.number_of_days != null) { //
								row_tLogRow_1[1] = String.valueOf(row1.number_of_days);

							} //

							if (row1.require_signature != null) { //
								row_tLogRow_1[2] = String.valueOf(row1.require_signature);

							} //

							if (row1.require_payment != null) { //
								row_tLogRow_1[3] = String.valueOf(row1.require_payment);

							} //

							if (row1.mail_template_id != null) { //
								row_tLogRow_1[4] = String.valueOf(row1.mail_template_id);

							} //

							if (row1.active != null) { //
								row_tLogRow_1[5] = String.valueOf(row1.active);

							} //

							if (row1.company_id != null) { //
								row_tLogRow_1[6] = String.valueOf(row1.company_id);
							...
							if (row1.name != null) { //
								row_tLogRow_1[8] = String.valueOf(row1.name);

							} //

							if (row1.create_uid != null) { //
								row_tLogRow_1[9] = String.valueOf(row1.create_uid);

							} //

							if (row1.create_date != null) { //
								row_tLogRow_1[10] = FormatterUtils.format_Date(row1.create_date, "dd-MM-yyyy");

							} //

							if (row1.write_uid != null) { //
								row_tLogRow_1[11] = String.valueOf(row1.write_uid);

							} //

							if (row1.write_date != null) { //
								row_tLogRow_1[12] = FormatterUtils.format_Date(row1.write_date, "dd-MM-yyyy");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final getSaleOrderTemplateStage_DailyJob getSaleOrderTemplateStage_DailyJobClass = new getSaleOrderTemplateStage_DailyJob();

		int exitCode = getSaleOrderTemplateStage_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getSaleOrderTemplateStage_DailyJob.class.getClassLoader()
					.getResourceAsStream(
							"pacifico/getsaleordertemplatestage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getSaleOrderTemplateStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getSaleOrderTemplateStage_DailyJob");
		}
...
/************************************************************************************************
 * 127025 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:38:07 PM CST
 ************************************************************************************************/