		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getSaleOrderTemplateStage_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FNNqjNo26Bdkex93Kk7JqQ7nFQHrzs2bGj8XLhK5jFrNU8iLINiFY7sCQkDrXSYJfXK7sVOP/N8DbiGTXz81lY1kXDM=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "saleOrderTemplate_20221031.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "saleOrderTemplate.csv");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_PACIFICO_getSaleOrderTemplateStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"number_of_days", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
							...
							row2.mail_template_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
///////////////////////		
	    		...
	    		if(row2.number_of_days != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(row2.number_of_days)			
					          ;	
	    		...
	    		if(row2.require_signature != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(row2.require_signature)			
					          ;	
	    		...
	    		if(row2.require_payment != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(row2.require_payment)			
					          ;	
	    		...
	    		if(row2.mail_template_id != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(row2.mail_template_id)			
					          ;	
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"number_of_days", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
							...
							row1.mail_template_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
	    		...
	    		if(row1.number_of_days != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(row1.number_of_days)			
					          ;	
	    		...
	    		if(row1.require_signature != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.require_signature)			
					          ;	
	    		...
	    		if(row1.require_payment != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row1.require_payment)			
					          ;	
	    		...
	    		if(row1.mail_template_id != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row1.mail_template_id)			
					          ;	
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getSaleOrderTemplateStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/getsaleordertemplatestage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getSaleOrderTemplateStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getSaleOrderTemplateStage_DailyJob");
        }
...
/************************************************************************************************
 *     127025 characters generated by Talend Open Studio for Data Integration 
