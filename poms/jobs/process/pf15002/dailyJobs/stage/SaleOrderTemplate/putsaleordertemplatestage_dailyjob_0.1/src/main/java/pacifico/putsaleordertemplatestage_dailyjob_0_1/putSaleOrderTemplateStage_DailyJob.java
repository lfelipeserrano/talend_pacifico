...
package pacifico.putsaleordertemplatestage_dailyjob_0_1;
...
/**
 * Job: putSaleOrderTemplateStage_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class putSaleOrderTemplateStage_DailyJob implements TalendJob {
	...
	private final String jobName = "putSaleOrderTemplateStage_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					putSaleOrderTemplateStage_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(putSaleOrderTemplateStage_DailyJob.this,
	...
	public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
		final static byte[] commonByteArrayLock_PACIFICO_putSaleOrderTemplateStage_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob = new byte[0];
		...
		public String getMail_template_id() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob.length == 0) {
						commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_putSaleOrderTemplateStage_DailyJob) {
				...
				try {
					...
					this.number_of_days = readInteger(dis);
					...
					this.mail_template_id = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.number_of_days, dos);
				...
				writeString(this.mail_template_id, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_2.length() == 0) {
					outtFileOutputDelimited_2.write("note");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("number_of_days");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("require_signature");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("require_payment");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("mail_template_id");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
				...
				util_tLogRow_1.addRow(new String[] { "note", "number_of_days", "require_signature", "require_payment",
						"mail_template_id", "active", "company_id", "id", "name", "create_uid", "create_date",
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "note", "number_of_days", "require_signature", "require_payment",
						"mail_template_id", "active", "company_id", "id", "name", "create_uid", "create_date",
						"write_uid", "write_date", });
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							rawFile.note = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.number_of_days = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											...
											"number_of_days", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.number_of_days = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.require_signature = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_signature", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.require_signature = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.require_payment = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_payment", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.require_payment = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 4;

							rawFile.mail_template_id = fid_tFileInputDelimited_2
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									delta_tmp.note = rawFile.note;
									delta_tmp.number_of_days = rawFile.number_of_days;
									delta_tmp.require_signature = rawFile.require_signature;
									delta_tmp.require_payment = rawFile.require_payment;
									delta_tmp.mail_template_id = rawFile.mail_template_id;
...
///////////////////////		
								...
								if (delta.note != null) { //
									row_tLogRow_2[0] = String.valueOf(delta.note);

								} //

								if (delta.number_of_days != null) { //
									row_tLogRow_2[1] = String.valueOf(delta.number_of_days);

								} //

								if (delta.require_signature != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.require_signature);

								} //

								if (delta.require_payment != null) { //
									row_tLogRow_2[3] = String.valueOf(delta.require_payment);

								} //

								if (delta.mail_template_id != null) { //
									row_tLogRow_2[4] = String.valueOf(delta.mail_template_id);

								} //

								if (delta.active != null) { //
									row_tLogRow_2[5] = String.valueOf(delta.active);

								} //

								if (delta.company_id != null) { //
									row_tLogRow_2[6] = String.valueOf(delta.company_id);

								} //

								if (delta.id != null) { //
									row_tLogRow_2[7] = String.valueOf(delta.id);

								} //

								if (delta.name != null) { //
									row_tLogRow_2[8] = String.valueOf(delta.name);
...
///////////////////////    			
								...
								if (deltaRows.note != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.note);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.number_of_days != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.number_of_days);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.require_signature != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.require_signature);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.require_payment != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.require_payment);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.mail_template_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.mail_template_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
// for output
								...
								rowsMerged.note = deltRows.note;
								rowsMerged.number_of_days = deltRows.number_of_days;
								rowsMerged.require_signature = deltRows.require_signature;
								rowsMerged.require_payment = deltRows.require_payment;
								rowsMerged.mail_template_id = deltRows.mail_template_id;
...
///////////////////////		
								...
								if (rowsMerged.note != null) { //
									row_tLogRow_1[0] = String.valueOf(rowsMerged.note);

								} //

								if (rowsMerged.number_of_days != null) { //
									row_tLogRow_1[1] = String.valueOf(rowsMerged.number_of_days);

								} //

								if (rowsMerged.require_signature != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.require_signature);

								} //

								if (rowsMerged.require_payment != null) { //
									row_tLogRow_1[3] = String.valueOf(rowsMerged.require_payment);

								} //

								if (rowsMerged.mail_template_id != null) { //
									row_tLogRow_1[4] = String.valueOf(rowsMerged.mail_template_id);

								} //

								if (rowsMerged.active != null) { //
									row_tLogRow_1[5] = String.valueOf(rowsMerged.active);

								} //

								if (rowsMerged.company_id != null) { //
									row_tLogRow_1[6] = String.valueOf(rowsMerged.company_id);

								} //

								if (rowsMerged.id != null) { //
									row_tLogRow_1[7] = String.valueOf(rowsMerged.id);

								} //

								if (rowsMerged.name != null) { //
									row_tLogRow_1[8] = String.valueOf(rowsMerged.name);
...
///////////////////////    			
								...
								if (rowsMergedResult.note != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.note);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.number_of_days != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.number_of_days);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.require_signature != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.require_signature);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.require_payment != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.require_payment);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.mail_template_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.mail_template_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							stageRows.note = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.number_of_days = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"number_of_days", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.number_of_days = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.require_signature = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_signature", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.require_signature = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.require_payment = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_payment", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.require_payment = null;

							}

							columnIndexWithD_tFileInputDelimited_3 = 4;

							stageRows.mail_template_id = fid_tFileInputDelimited_3
...
// for output
							...
							rowsMerged.note = stageRows.note;
							rowsMerged.number_of_days = stageRows.number_of_days;
							rowsMerged.require_signature = stageRows.require_signature;
							rowsMerged.require_payment = stageRows.require_payment;
							rowsMerged.mail_template_id = stageRows.mail_template_id;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:VMnOSscaVQZM6Dqy+6DD8d8LijAypw79oNobGIWzbRBvyYI9zR9cw5cElfDg6YqjjhNN61RtadJNKJZJDYf3wvpz2a8=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "saleOrderTemplate.csv";
	...
	public static class stageFileStruct implements routines.system.IPersistableComparableLookupRow<stageFileStruct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.number_of_days = readInteger(dis, ois);
				...
				this.mail_template_id = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.number_of_days = readInteger(dis, objectIn);
				...
				this.mail_template_id = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.number_of_days, dos, oos);
				...
				writeString(this.mail_template_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.number_of_days, dos, objectOut);
				...
				writeString(this.mail_template_id, dos, objectOut);
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							stageFile.note = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.number_of_days = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"number_of_days", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.number_of_days = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.require_signature = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_signature", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.require_signature = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.require_payment = ParserUtils.parseTo_Boolean(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"require_payment", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.require_payment = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 4;

							stageFile.mail_template_id = fid_tFileInputDelimited_1
...
// Start of branch "stageFile"
						if (stageFile != null) {
							...
							stageFile_HashRow.note = stageFile.note;

							stageFile_HashRow.number_of_days = stageFile.number_of_days;

							stageFile_HashRow.require_signature = stageFile.require_signature;

							stageFile_HashRow.require_payment = stageFile.require_payment;

							stageFile_HashRow.mail_template_id = stageFile.mail_template_id;
	...
	public static void main(String[] args) {
		final putSaleOrderTemplateStage_DailyJob putSaleOrderTemplateStage_DailyJobClass = new putSaleOrderTemplateStage_DailyJob();

		int exitCode = putSaleOrderTemplateStage_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putSaleOrderTemplateStage_DailyJob.class.getClassLoader()
					.getResourceAsStream(
							"pacifico/putsaleordertemplatestage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putSaleOrderTemplateStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putSaleOrderTemplateStage_DailyJob");
		}
...
/************************************************************************************************
 * 297723 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:38:24 PM CST
 ************************************************************************************************/