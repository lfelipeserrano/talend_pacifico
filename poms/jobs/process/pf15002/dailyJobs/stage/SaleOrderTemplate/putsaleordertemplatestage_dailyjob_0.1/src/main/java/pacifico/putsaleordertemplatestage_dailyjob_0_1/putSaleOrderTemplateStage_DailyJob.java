		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(putSaleOrderTemplateStage_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"note","number_of_days","require_signature","require_payment","mail_template_id","active","company_id","id","name","create_uid","create_date","write_uid","write_date",});        
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"note","number_of_days","require_signature","require_payment","mail_template_id","active","company_id","id","name","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"number_of_days", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"require_signature", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"require_payment", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
							...
							rawFile.mail_template_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
///////////////////////		
	    		...
	    		if(delta.number_of_days != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(delta.number_of_days)			
					          ;	
	    		...
	    		if(delta.require_signature != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(delta.require_signature)			
					          ;	
	    		...
	    		if(delta.require_payment != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(delta.require_payment)			
					          ;	
	    		...
	    		if(delta.mail_template_id != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(delta.mail_template_id)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.number_of_days
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(deltaRows.require_signature != null) {
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.require_signature
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(deltaRows.require_payment != null) {
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.require_payment
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(deltaRows.mail_template_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.mail_template_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
///////////////////////		
	    		...
	    		if(rowsMerged.note != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(rowsMerged.note)			
					          ;	
	    		...
	    		if(rowsMerged.number_of_days != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(rowsMerged.number_of_days)			
					          ;	
	    		...
	    		if(rowsMerged.require_signature != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(rowsMerged.require_signature)			
					          ;	
	    		...
	    		if(rowsMerged.require_payment != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(rowsMerged.require_payment)			
					          ;	
	    		...
	    		if(rowsMerged.mail_template_id != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(rowsMerged.mail_template_id)			
					          ;	
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"number_of_days", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"require_signature", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"require_payment", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 4;
							...
							stageRows.mail_template_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:7PV61HCJcoG/j5fZtjah9WKUVWlw0MDH5PTXhUBaRBKO0v3wr8es6zm41hr8zQ4C3fRS54fwT18wGQuqbvTU5zQd3JQ=");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"number_of_days", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"require_signature", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"require_payment", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
							...
							stageFile.mail_template_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = putSaleOrderTemplateStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/putsaleordertemplatestage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = putSaleOrderTemplateStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : putSaleOrderTemplateStage_DailyJob");
        }
...
/************************************************************************************************
 *     297699 characters generated by Talend Open Studio for Data Integration 
 *     on the November 2, 2022 at 11:08:49 PM CST
 ************************************************************************************************/