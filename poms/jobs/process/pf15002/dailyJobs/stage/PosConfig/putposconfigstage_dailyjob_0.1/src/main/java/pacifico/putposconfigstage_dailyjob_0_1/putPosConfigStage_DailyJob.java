...
public class putPosConfigStage_DailyJob implements TalendJob {
	...
	public void tAdvancedHash_stageFile_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "id", "name", "picking_type_id", "journal_id",
						"invoice_journal_id", "iface_cashdrawer", "iface_electronic_scale",
						"iface_customer_facing_display_via_proxy", "iface_customer_facing_display_local",
						"iface_print_via_proxy", "iface_scan_via_proxy", "iface_big_scrollbars",
						"iface_orderline_customer_notes", "iface_print_auto", "iface_print_skip_screen",
						"iface_tax_included", "iface_start_categ_id", "iface_display_categ_images",
						"restrict_price_control", "set_maximum_difference", "receipt_header", "receipt_footer",
						"proxy_ip", "active", "uuid", "sequence_id", "sequence_line_id", "pricelist_id", "company_id",
						"barcode_nomenclature_id", "group_pos_manager_id", "group_pos_user_id", "iface_tipproduct",
						"tip_product_id", "default_fiscal_position_id", "use_pricelist", "tax_regime",
						"tax_regime_selection", "start_category", "limit_categories", "module_account",
						"module_pos_restaurant", "module_pos_discount", "module_pos_loyalty", "module_pos_mercury",
						"product_configurator", "is_posbox", "is_header_or_footer", "module_pos_hr",
						"amount_authorized_diff", "other_devices", "rounding_method", "cash_rounding",
						"only_round_cash_method", "manual_discount", "ship_later", "warehouse_id", "route_id",
						"picking_policy", "limited_products_loading", "limited_products_amount",
						"product_load_background", "limited_partners_loading", "limited_partners_amount",
						"partner_load_background", "create_uid", "create_date", "write_uid", "write_date",
						"epson_printer_ip", "crm_team_id", "down_payment_product_id", });
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "name", "picking_type_id", "journal_id",
						"invoice_journal_id", "iface_cashdrawer", "iface_electronic_scale",
						"iface_customer_facing_display_via_proxy", "iface_customer_facing_display_local",
						"iface_print_via_proxy", "iface_scan_via_proxy", "iface_big_scrollbars",
						"iface_orderline_customer_notes", "iface_print_auto", "iface_print_skip_screen",
...
// # Lookup's keys initialization
				...
				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<stageFileStruct> tHash_Lookup_stageFile = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<stageFileStruct>) ((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<stageFileStruct>) globalMap
						.get("tHash_Lookup_stageFile"));
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											...
											"id", "rawFile", temp, ex_tFileInputDelimited_2),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"picking_type_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"journal_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"invoice_journal_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.iface_cashdrawer = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							rawFile.iface_electronic_scale = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							rawFile.iface_customer_facing_display_via_proxy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 8;

							rawFile.iface_customer_facing_display_local = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							rawFile.iface_print_via_proxy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 10;

							rawFile.iface_scan_via_proxy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 11;

							rawFile.iface_big_scrollbars = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 12;

							rawFile.iface_orderline_customer_notes = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_auto", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_skip_screen", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.iface_tax_included = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 16;

							rawFile.iface_start_categ_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 17;

							rawFile.iface_display_categ_images = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 18;

							rawFile.restrict_price_control = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 19;

							rawFile.set_maximum_difference = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 20;

							rawFile.receipt_header = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 21;

							rawFile.receipt_footer = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"active", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_line_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pricelist_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"company_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"barcode_nomenclature_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_manager_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_user_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.iface_tipproduct = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 33;

							rawFile.tip_product_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 34;

							rawFile.default_fiscal_position_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 35;

							rawFile.use_pricelist = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							rawFile.tax_regime_selection = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"start_category", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.limit_categories = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"module_account", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.module_pos_restaurant = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 42;

							rawFile.module_pos_discount = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 43;

							rawFile.module_pos_loyalty = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 44;

							rawFile.module_pos_mercury = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 45;

							rawFile.product_configurator = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							rawFile.is_header_or_footer = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 48;

							rawFile.module_pos_hr = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 49;

							rawFile.amount_authorized_diff = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 50;

							rawFile.other_devices = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 51;

							rawFile.rounding_method = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 52;

							rawFile.cash_rounding = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 53;

							rawFile.only_round_cash_method = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"manual_discount", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"warehouse_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.picking_policy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 59;

							rawFile.limited_products_loading = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_products_amount", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.product_load_background = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 62;

							rawFile.limited_partners_loading = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_partners_amount", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.partner_load_background = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_uid", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_date", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_uid", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_date", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.epson_printer_ip = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"down_payment_product_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
// Start of branch "rawFile"
						if (rawFile != null) {
							...
							if (tHash_Lookup_stageFile != null
									&& tHash_Lookup_stageFile.getCount(stageFileHashKey) > 1) { // G 071

								// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
								// 'stageFile' and it contains more one result from keys : stageFile.id = '" +
								// stageFileHashKey.id + "'");
							} // G 071
...
///////////////////////		
								...
								if (delta.id != null) { //
									row_tLogRow_2[0] = String.valueOf(delta.id);

								} //

								if (delta.name != null) { //
									row_tLogRow_2[1] = String.valueOf(delta.name);

								} //

								if (delta.picking_type_id != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.picking_type_id);

								} //

								if (delta.journal_id != null) { //
									row_tLogRow_2[3] = String.valueOf(delta.journal_id);

								} //

								if (delta.invoice_journal_id != null) { //
									row_tLogRow_2[4] = String.valueOf(delta.invoice_journal_id);

								} //

								if (delta.iface_cashdrawer != null) { //
									row_tLogRow_2[5] = String.valueOf(delta.iface_cashdrawer);

								} //

								if (delta.iface_electronic_scale != null) { //
									row_tLogRow_2[6] = String.valueOf(delta.iface_electronic_scale);

								} //

								if (delta.iface_customer_facing_display_via_proxy != null) { //
									row_tLogRow_2[7] = String.valueOf(delta.iface_customer_facing_display_via_proxy);

								} //

								if (delta.iface_customer_facing_display_local != null) { //
									row_tLogRow_2[8] = String.valueOf(delta.iface_customer_facing_display_local);

								} //

								if (delta.iface_print_via_proxy != null) { //
									row_tLogRow_2[9] = String.valueOf(delta.iface_print_via_proxy);

								} //

								if (delta.iface_scan_via_proxy != null) { //
									row_tLogRow_2[10] = String.valueOf(delta.iface_scan_via_proxy);

								} //

								if (delta.iface_big_scrollbars != null) { //
									row_tLogRow_2[11] = String.valueOf(delta.iface_big_scrollbars);

								} //

								if (delta.iface_orderline_customer_notes != null) { //
									row_tLogRow_2[12] = String.valueOf(delta.iface_orderline_customer_notes);

								} //

								if (delta.iface_print_auto != null) { //
									row_tLogRow_2[13] = String.valueOf(delta.iface_print_auto);

								} //

								if (delta.iface_print_skip_screen != null) { //
									row_tLogRow_2[14] = String.valueOf(delta.iface_print_skip_screen);

								} //

								if (delta.iface_tax_included != null) { //
									row_tLogRow_2[15] = String.valueOf(delta.iface_tax_included);

								} //

								if (delta.iface_start_categ_id != null) { //
									row_tLogRow_2[16] = String.valueOf(delta.iface_start_categ_id);

								} //

								if (delta.iface_display_categ_images != null) { //
									row_tLogRow_2[17] = String.valueOf(delta.iface_display_categ_images);

								} //

								if (delta.restrict_price_control != null) { //
									row_tLogRow_2[18] = String.valueOf(delta.restrict_price_control);

								} //

								if (delta.set_maximum_difference != null) { //
									row_tLogRow_2[19] = String.valueOf(delta.set_maximum_difference);

								} //

								if (delta.receipt_header != null) { //
									row_tLogRow_2[20] = String.valueOf(delta.receipt_header);

								} //

								if (delta.receipt_footer != null) { //
									row_tLogRow_2[21] = String.valueOf(delta.receipt_footer);

								} //

								if (delta.proxy_ip != null) { //
									row_tLogRow_2[22] = String.valueOf(delta.proxy_ip);

								} //

								if (delta.active != null) { //
									row_tLogRow_2[23] = String.valueOf(delta.active);

								} //

								if (delta.uuid != null) { //
									row_tLogRow_2[24] = String.valueOf(delta.uuid);

								} //

								if (delta.sequence_id != null) { //
									row_tLogRow_2[25] = String.valueOf(delta.sequence_id);

								} //

								if (delta.sequence_line_id != null) { //
									row_tLogRow_2[26] = String.valueOf(delta.sequence_line_id);

								} //

								if (delta.pricelist_id != null) { //
									row_tLogRow_2[27] = String.valueOf(delta.pricelist_id);

								} //

								if (delta.company_id != null) { //
									row_tLogRow_2[28] = String.valueOf(delta.company_id);

								} //

								if (delta.barcode_nomenclature_id != null) { //
									row_tLogRow_2[29] = String.valueOf(delta.barcode_nomenclature_id);

								} //

								if (delta.group_pos_manager_id != null) { //
									row_tLogRow_2[30] = String.valueOf(delta.group_pos_manager_id);

								} //

								if (delta.group_pos_user_id != null) { //
									row_tLogRow_2[31] = String.valueOf(delta.group_pos_user_id);

								} //

								if (delta.iface_tipproduct != null) { //
									row_tLogRow_2[32] = String.valueOf(delta.iface_tipproduct);

								} //

								if (delta.tip_product_id != null) { //
									row_tLogRow_2[33] = String.valueOf(delta.tip_product_id);

								} //

								if (delta.default_fiscal_position_id != null) { //
									row_tLogRow_2[34] = String.valueOf(delta.default_fiscal_position_id);

								} //

								if (delta.use_pricelist != null) { //
									row_tLogRow_2[35] = String.valueOf(delta.use_pricelist);

								} //

								if (delta.tax_regime != null) { //
									row_tLogRow_2[36] = String.valueOf(delta.tax_regime);

								} //

								if (delta.tax_regime_selection != null) { //
									row_tLogRow_2[37] = String.valueOf(delta.tax_regime_selection);

								} //

								if (delta.start_category != null) { //
									row_tLogRow_2[38] = String.valueOf(delta.start_category);

								} //

								if (delta.limit_categories != null) { //
									row_tLogRow_2[39] = String.valueOf(delta.limit_categories);

								} //

								if (delta.module_account != null) { //
									row_tLogRow_2[40] = String.valueOf(delta.module_account);

								} //

								if (delta.module_pos_restaurant != null) { //
									row_tLogRow_2[41] = String.valueOf(delta.module_pos_restaurant);

								} //

								if (delta.module_pos_discount != null) { //
									row_tLogRow_2[42] = String.valueOf(delta.module_pos_discount);

								} //

								if (delta.module_pos_loyalty != null) { //
									row_tLogRow_2[43] = String.valueOf(delta.module_pos_loyalty);

								} //

								if (delta.module_pos_mercury != null) { //
									row_tLogRow_2[44] = String.valueOf(delta.module_pos_mercury);

								} //

								if (delta.product_configurator != null) { //
									row_tLogRow_2[45] = String.valueOf(delta.product_configurator);

								} //

								if (delta.is_posbox != null) { //
									row_tLogRow_2[46] = String.valueOf(delta.is_posbox);

								} //

								if (delta.is_header_or_footer != null) { //
									row_tLogRow_2[47] = String.valueOf(delta.is_header_or_footer);

								} //

								if (delta.module_pos_hr != null) { //
									row_tLogRow_2[48] = String.valueOf(delta.module_pos_hr);

								} //

								if (delta.amount_authorized_diff != null) { //
									row_tLogRow_2[49] = String.valueOf(delta.amount_authorized_diff);

								} //

								if (delta.other_devices != null) { //
									row_tLogRow_2[50] = String.valueOf(delta.other_devices);

								} //

								if (delta.rounding_method != null) { //
									row_tLogRow_2[51] = String.valueOf(delta.rounding_method);

								} //

								if (delta.cash_rounding != null) { //
									row_tLogRow_2[52] = String.valueOf(delta.cash_rounding);

								} //

								if (delta.only_round_cash_method != null) { //
									row_tLogRow_2[53] = String.valueOf(delta.only_round_cash_method);

								} //

								if (delta.manual_discount != null) { //
									row_tLogRow_2[54] = String.valueOf(delta.manual_discount);

								} //

								if (delta.ship_later != null) { //
									row_tLogRow_2[55] = String.valueOf(delta.ship_later);

								} //

								if (delta.warehouse_id != null) { //
									row_tLogRow_2[56] = String.valueOf(delta.warehouse_id);

								} //

								if (delta.route_id != null) { //
									row_tLogRow_2[57] = String.valueOf(delta.route_id);

								} //

								if (delta.picking_policy != null) { //
									row_tLogRow_2[58] = String.valueOf(delta.picking_policy);

								} //

								if (delta.limited_products_loading != null) { //
									row_tLogRow_2[59] = String.valueOf(delta.limited_products_loading);

								} //

								if (delta.limited_products_amount != null) { //
									row_tLogRow_2[60] = String.valueOf(delta.limited_products_amount);

								} //

								if (delta.product_load_background != null) { //
									row_tLogRow_2[61] = String.valueOf(delta.product_load_background);

								} //

								if (delta.limited_partners_loading != null) { //
									row_tLogRow_2[62] = String.valueOf(delta.limited_partners_loading);

								} //

								if (delta.limited_partners_amount != null) { //
									row_tLogRow_2[63] = String.valueOf(delta.limited_partners_amount);

								} //

								if (delta.partner_load_background != null) { //
									row_tLogRow_2[64] = String.valueOf(delta.partner_load_background);

								} //

								if (delta.create_uid != null) { //
									row_tLogRow_2[65] = String.valueOf(delta.create_uid);

								} //

								if (delta.create_date != null) { //
									row_tLogRow_2[66] = FormatterUtils.format_Date(delta.create_date, "dd-MM-yyyy");

								} //

								if (delta.write_uid != null) { //
									row_tLogRow_2[67] = String.valueOf(delta.write_uid);

								} //

								if (delta.write_date != null) { //
									row_tLogRow_2[68] = FormatterUtils.format_Date(delta.write_date, "dd-MM-yyyy");

								} //

								if (delta.epson_printer_ip != null) { //
									row_tLogRow_2[69] = String.valueOf(delta.epson_printer_ip);

								} //

								if (delta.crm_team_id != null) { //
									row_tLogRow_2[70] = String.valueOf(delta.crm_team_id);

								} //

								if (delta.down_payment_product_id != null) { //
									row_tLogRow_2[71] = String.valueOf(delta.down_payment_product_id);
...
///////////////////////    			
								...
								if (deltaRows.id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.name != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.name);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.picking_type_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.picking_type_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.journal_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.journal_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.invoice_journal_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.invoice_journal_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_cashdrawer != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_cashdrawer);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_electronic_scale != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_electronic_scale);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_customer_facing_display_via_proxy != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_customer_facing_display_via_proxy);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_customer_facing_display_local != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_customer_facing_display_local);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_print_via_proxy != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_print_via_proxy);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_scan_via_proxy != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_scan_via_proxy);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_big_scrollbars != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_big_scrollbars);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_orderline_customer_notes != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_orderline_customer_notes);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_print_auto != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_print_auto);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_print_skip_screen != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_print_skip_screen);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_tax_included != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_tax_included);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_start_categ_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_start_categ_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_display_categ_images != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_display_categ_images);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.restrict_price_control != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.restrict_price_control);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.set_maximum_difference != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.set_maximum_difference);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.receipt_header != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.receipt_header);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.receipt_footer != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.receipt_footer);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.proxy_ip != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.proxy_ip);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.active != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.active);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.uuid != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.uuid);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.sequence_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.sequence_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.sequence_line_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.sequence_line_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.pricelist_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.pricelist_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.company_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.company_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.barcode_nomenclature_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.barcode_nomenclature_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.group_pos_manager_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.group_pos_manager_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.group_pos_user_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.group_pos_user_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.iface_tipproduct != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.iface_tipproduct);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.tip_product_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.tip_product_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.default_fiscal_position_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.default_fiscal_position_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.use_pricelist != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.use_pricelist);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.tax_regime != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.tax_regime);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.tax_regime_selection != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.tax_regime_selection);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.start_category != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.start_category);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.limit_categories != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.limit_categories);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.module_account != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.module_account);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.module_pos_restaurant != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.module_pos_restaurant);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.module_pos_discount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.module_pos_discount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.module_pos_loyalty != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.module_pos_loyalty);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.module_pos_mercury != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.module_pos_mercury);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.product_configurator != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.product_configurator);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.is_posbox != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.is_posbox);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.is_header_or_footer != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.is_header_or_footer);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.module_pos_hr != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.module_pos_hr);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.amount_authorized_diff != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.amount_authorized_diff);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.other_devices != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.other_devices);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.rounding_method != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.rounding_method);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.cash_rounding != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.cash_rounding);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.only_round_cash_method != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.only_round_cash_method);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.manual_discount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.manual_discount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.ship_later != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.ship_later);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.warehouse_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.warehouse_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.route_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.route_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.picking_policy != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.picking_policy);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.limited_products_loading != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.limited_products_loading);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.limited_products_amount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.limited_products_amount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.product_load_background != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.product_load_background);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.limited_partners_loading != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.limited_partners_loading);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.limited_partners_amount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.limited_partners_amount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.partner_load_background != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.partner_load_background);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.create_uid != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.create_uid);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.create_date != null) {
									sb_tFileOutputDelimited_1
											.append(FormatterUtils.format_Date(deltaRows.create_date, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.write_uid != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.write_uid);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.write_date != null) {
									sb_tFileOutputDelimited_1
											.append(FormatterUtils.format_Date(deltaRows.write_date, "dd-MM-yyyy"));
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.epson_printer_ip != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.epson_printer_ip);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.crm_team_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.crm_team_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.down_payment_product_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.down_payment_product_id);
								}
...
///////////////////////		
								...
								if (rowsMerged.id != null) { //
									row_tLogRow_1[0] = String.valueOf(rowsMerged.id);

								} //

								if (rowsMerged.name != null) { //
									row_tLogRow_1[1] = String.valueOf(rowsMerged.name);

								} //

								if (rowsMerged.picking_type_id != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.picking_type_id);

								} //

								if (rowsMerged.journal_id != null) { //
									row_tLogRow_1[3] = String.valueOf(rowsMerged.journal_id);

								} //

								if (rowsMerged.invoice_journal_id != null) { //
									row_tLogRow_1[4] = String.valueOf(rowsMerged.invoice_journal_id);

								} //

								if (rowsMerged.iface_cashdrawer != null) { //
									row_tLogRow_1[5] = String.valueOf(rowsMerged.iface_cashdrawer);

								} //

								if (rowsMerged.iface_electronic_scale != null) { //
									row_tLogRow_1[6] = String.valueOf(rowsMerged.iface_electronic_scale);

								} //

								if (rowsMerged.iface_customer_facing_display_via_proxy != null) { //
									row_tLogRow_1[7] = String
											.valueOf(rowsMerged.iface_customer_facing_display_via_proxy);

								} //

								if (rowsMerged.iface_customer_facing_display_local != null) { //
									row_tLogRow_1[8] = String.valueOf(rowsMerged.iface_customer_facing_display_local);

								} //

								if (rowsMerged.iface_print_via_proxy != null) { //
									row_tLogRow_1[9] = String.valueOf(rowsMerged.iface_print_via_proxy);

								} //

								if (rowsMerged.iface_scan_via_proxy != null) { //
									row_tLogRow_1[10] = String.valueOf(rowsMerged.iface_scan_via_proxy);

								} //

								if (rowsMerged.iface_big_scrollbars != null) { //
									row_tLogRow_1[11] = String.valueOf(rowsMerged.iface_big_scrollbars);

								} //

								if (rowsMerged.iface_orderline_customer_notes != null) { //
									row_tLogRow_1[12] = String.valueOf(rowsMerged.iface_orderline_customer_notes);

								} //

								if (rowsMerged.iface_print_auto != null) { //
									row_tLogRow_1[13] = String.valueOf(rowsMerged.iface_print_auto);

								} //

								if (rowsMerged.iface_print_skip_screen != null) { //
									row_tLogRow_1[14] = String.valueOf(rowsMerged.iface_print_skip_screen);

								} //

								if (rowsMerged.iface_tax_included != null) { //
									row_tLogRow_1[15] = String.valueOf(rowsMerged.iface_tax_included);

								} //

								if (rowsMerged.iface_start_categ_id != null) { //
									row_tLogRow_1[16] = String.valueOf(rowsMerged.iface_start_categ_id);

								} //

								if (rowsMerged.iface_display_categ_images != null) { //
									row_tLogRow_1[17] = String.valueOf(rowsMerged.iface_display_categ_images);

								} //

								if (rowsMerged.restrict_price_control != null) { //
									row_tLogRow_1[18] = String.valueOf(rowsMerged.restrict_price_control);

								} //

								if (rowsMerged.set_maximum_difference != null) { //
									row_tLogRow_1[19] = String.valueOf(rowsMerged.set_maximum_difference);

								} //

								if (rowsMerged.receipt_header != null) { //
									row_tLogRow_1[20] = String.valueOf(rowsMerged.receipt_header);

								} //

								if (rowsMerged.receipt_footer != null) { //
									row_tLogRow_1[21] = String.valueOf(rowsMerged.receipt_footer);

								} //

								if (rowsMerged.proxy_ip != null) { //
									row_tLogRow_1[22] = String.valueOf(rowsMerged.proxy_ip);

								} //

								if (rowsMerged.active != null) { //
									row_tLogRow_1[23] = String.valueOf(rowsMerged.active);

								} //

								if (rowsMerged.uuid != null) { //
									row_tLogRow_1[24] = String.valueOf(rowsMerged.uuid);

								} //

								if (rowsMerged.sequence_id != null) { //
									row_tLogRow_1[25] = String.valueOf(rowsMerged.sequence_id);

								} //

								if (rowsMerged.sequence_line_id != null) { //
									row_tLogRow_1[26] = String.valueOf(rowsMerged.sequence_line_id);

								} //

								if (rowsMerged.pricelist_id != null) { //
									row_tLogRow_1[27] = String.valueOf(rowsMerged.pricelist_id);

								} //

								if (rowsMerged.company_id != null) { //
									row_tLogRow_1[28] = String.valueOf(rowsMerged.company_id);

								} //

								if (rowsMerged.barcode_nomenclature_id != null) { //
									row_tLogRow_1[29] = String.valueOf(rowsMerged.barcode_nomenclature_id);

								} //

								if (rowsMerged.group_pos_manager_id != null) { //
									row_tLogRow_1[30] = String.valueOf(rowsMerged.group_pos_manager_id);

								} //

								if (rowsMerged.group_pos_user_id != null) { //
									row_tLogRow_1[31] = String.valueOf(rowsMerged.group_pos_user_id);

								} //

								if (rowsMerged.iface_tipproduct != null) { //
									row_tLogRow_1[32] = String.valueOf(rowsMerged.iface_tipproduct);

								} //

								if (rowsMerged.tip_product_id != null) { //
									row_tLogRow_1[33] = String.valueOf(rowsMerged.tip_product_id);

								} //

								if (rowsMerged.default_fiscal_position_id != null) { //
									row_tLogRow_1[34] = String.valueOf(rowsMerged.default_fiscal_position_id);

								} //

								if (rowsMerged.use_pricelist != null) { //
									row_tLogRow_1[35] = String.valueOf(rowsMerged.use_pricelist);

								} //

								if (rowsMerged.tax_regime != null) { //
									row_tLogRow_1[36] = String.valueOf(rowsMerged.tax_regime);

								} //

								if (rowsMerged.tax_regime_selection != null) { //
									row_tLogRow_1[37] = String.valueOf(rowsMerged.tax_regime_selection);

								} //

								if (rowsMerged.start_category != null) { //
									row_tLogRow_1[38] = String.valueOf(rowsMerged.start_category);

								} //

								if (rowsMerged.limit_categories != null) { //
									row_tLogRow_1[39] = String.valueOf(rowsMerged.limit_categories);

								} //

								if (rowsMerged.module_account != null) { //
									row_tLogRow_1[40] = String.valueOf(rowsMerged.module_account);

								} //

								if (rowsMerged.module_pos_restaurant != null) { //
									row_tLogRow_1[41] = String.valueOf(rowsMerged.module_pos_restaurant);

								} //

								if (rowsMerged.module_pos_discount != null) { //
									row_tLogRow_1[42] = String.valueOf(rowsMerged.module_pos_discount);

								} //

								if (rowsMerged.module_pos_loyalty != null) { //
									row_tLogRow_1[43] = String.valueOf(rowsMerged.module_pos_loyalty);

								} //

								if (rowsMerged.module_pos_mercury != null) { //
									row_tLogRow_1[44] = String.valueOf(rowsMerged.module_pos_mercury);

								} //

								if (rowsMerged.product_configurator != null) { //
									row_tLogRow_1[45] = String.valueOf(rowsMerged.product_configurator);

								} //

								if (rowsMerged.is_posbox != null) { //
									row_tLogRow_1[46] = String.valueOf(rowsMerged.is_posbox);

								} //

								if (rowsMerged.is_header_or_footer != null) { //
									row_tLogRow_1[47] = String.valueOf(rowsMerged.is_header_or_footer);

								} //

								if (rowsMerged.module_pos_hr != null) { //
									row_tLogRow_1[48] = String.valueOf(rowsMerged.module_pos_hr);

								} //

								if (rowsMerged.amount_authorized_diff != null) { //
									row_tLogRow_1[49] = String.valueOf(rowsMerged.amount_authorized_diff);

								} //

								if (rowsMerged.other_devices != null) { //
									row_tLogRow_1[50] = String.valueOf(rowsMerged.other_devices);

								} //

								if (rowsMerged.rounding_method != null) { //
									row_tLogRow_1[51] = String.valueOf(rowsMerged.rounding_method);

								} //

								if (rowsMerged.cash_rounding != null) { //
									row_tLogRow_1[52] = String.valueOf(rowsMerged.cash_rounding);

								} //

								if (rowsMerged.only_round_cash_method != null) { //
									row_tLogRow_1[53] = String.valueOf(rowsMerged.only_round_cash_method);

								} //

								if (rowsMerged.manual_discount != null) { //
									row_tLogRow_1[54] = String.valueOf(rowsMerged.manual_discount);

								} //

								if (rowsMerged.ship_later != null) { //
									row_tLogRow_1[55] = String.valueOf(rowsMerged.ship_later);

								} //

								if (rowsMerged.warehouse_id != null) { //
									row_tLogRow_1[56] = String.valueOf(rowsMerged.warehouse_id);

								} //

								if (rowsMerged.route_id != null) { //
									row_tLogRow_1[57] = String.valueOf(rowsMerged.route_id);

								} //

								if (rowsMerged.picking_policy != null) { //
									row_tLogRow_1[58] = String.valueOf(rowsMerged.picking_policy);

								} //

								if (rowsMerged.limited_products_loading != null) { //
									row_tLogRow_1[59] = String.valueOf(rowsMerged.limited_products_loading);

								} //

								if (rowsMerged.limited_products_amount != null) { //
									row_tLogRow_1[60] = String.valueOf(rowsMerged.limited_products_amount);

								} //

								if (rowsMerged.product_load_background != null) { //
									row_tLogRow_1[61] = String.valueOf(rowsMerged.product_load_background);

								} //

								if (rowsMerged.limited_partners_loading != null) { //
									row_tLogRow_1[62] = String.valueOf(rowsMerged.limited_partners_loading);

								} //

								if (rowsMerged.limited_partners_amount != null) { //
									row_tLogRow_1[63] = String.valueOf(rowsMerged.limited_partners_amount);

								} //

								if (rowsMerged.partner_load_background != null) { //
									row_tLogRow_1[64] = String.valueOf(rowsMerged.partner_load_background);

								} //

								if (rowsMerged.create_uid != null) { //
									row_tLogRow_1[65] = String.valueOf(rowsMerged.create_uid);

								} //

								if (rowsMerged.create_date != null) { //
									row_tLogRow_1[66] = FormatterUtils.format_Date(rowsMerged.create_date,
											"dd-MM-yyyy");

								} //

								if (rowsMerged.write_uid != null) { //
									row_tLogRow_1[67] = String.valueOf(rowsMerged.write_uid);

								} //

								if (rowsMerged.write_date != null) { //
									row_tLogRow_1[68] = FormatterUtils.format_Date(rowsMerged.write_date, "dd-MM-yyyy");

								} //

								if (rowsMerged.epson_printer_ip != null) { //
									row_tLogRow_1[69] = String.valueOf(rowsMerged.epson_printer_ip);

								} //

								if (rowsMerged.crm_team_id != null) { //
									row_tLogRow_1[70] = String.valueOf(rowsMerged.crm_team_id);

								} //

								if (rowsMerged.down_payment_product_id != null) { //
									row_tLogRow_1[71] = String.valueOf(rowsMerged.down_payment_product_id);
...
///////////////////////    			
								...
								if (rowsMergedResult.id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.name != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.name);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.picking_type_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.picking_type_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.journal_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.journal_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.invoice_journal_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.invoice_journal_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_cashdrawer != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_cashdrawer);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_electronic_scale != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_electronic_scale);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_customer_facing_display_via_proxy != null) {
									sb_tFileOutputDelimited_2
											.append(rowsMergedResult.iface_customer_facing_display_via_proxy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_customer_facing_display_local != null) {
									sb_tFileOutputDelimited_2
											.append(rowsMergedResult.iface_customer_facing_display_local);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_print_via_proxy != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_print_via_proxy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_scan_via_proxy != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_scan_via_proxy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_big_scrollbars != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_big_scrollbars);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_orderline_customer_notes != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_orderline_customer_notes);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_print_auto != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_print_auto);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_print_skip_screen != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_print_skip_screen);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_tax_included != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_tax_included);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_start_categ_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_start_categ_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_display_categ_images != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_display_categ_images);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.restrict_price_control != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.restrict_price_control);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.set_maximum_difference != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.set_maximum_difference);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.receipt_header != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.receipt_header);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.receipt_footer != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.receipt_footer);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.proxy_ip != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.proxy_ip);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.active != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.active);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.uuid != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.uuid);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.sequence_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.sequence_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.sequence_line_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.sequence_line_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.pricelist_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.pricelist_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.company_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.company_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.barcode_nomenclature_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.barcode_nomenclature_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.group_pos_manager_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.group_pos_manager_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.group_pos_user_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.group_pos_user_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.iface_tipproduct != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_tipproduct);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.tip_product_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.tip_product_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.default_fiscal_position_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.default_fiscal_position_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.use_pricelist != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.use_pricelist);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.tax_regime != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.tax_regime);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.tax_regime_selection != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.tax_regime_selection);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.start_category != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.start_category);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.limit_categories != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.limit_categories);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.module_account != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.module_account);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.module_pos_restaurant != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.module_pos_restaurant);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.module_pos_discount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.module_pos_discount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.module_pos_loyalty != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.module_pos_loyalty);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.module_pos_mercury != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.module_pos_mercury);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.product_configurator != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.product_configurator);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.is_posbox != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.is_posbox);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.is_header_or_footer != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.is_header_or_footer);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.module_pos_hr != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.module_pos_hr);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.amount_authorized_diff != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.amount_authorized_diff);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.other_devices != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.other_devices);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.rounding_method != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.rounding_method);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.cash_rounding != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.cash_rounding);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.only_round_cash_method != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.only_round_cash_method);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.manual_discount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.manual_discount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.ship_later != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.ship_later);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.warehouse_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.warehouse_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.route_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.route_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.picking_policy != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.picking_policy);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.limited_products_loading != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.limited_products_loading);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.limited_products_amount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.limited_products_amount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.product_load_background != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.product_load_background);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.limited_partners_loading != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.limited_partners_loading);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.limited_partners_amount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.limited_partners_amount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.partner_load_background != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.partner_load_background);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.create_uid != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.create_uid);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (rowsMergedResult.write_uid != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.write_uid);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (rowsMergedResult.epson_printer_ip != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.epson_printer_ip);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.crm_team_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.crm_team_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.down_payment_product_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.down_payment_product_id);
								}
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"id", "stageRows", temp, ex_tFileInputDelimited_3),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"picking_type_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"journal_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"invoice_journal_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.iface_cashdrawer = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 6;

							stageRows.iface_electronic_scale = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 7;

							stageRows.iface_customer_facing_display_via_proxy = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 8;

							stageRows.iface_customer_facing_display_local = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 9;

							stageRows.iface_print_via_proxy = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 10;

							stageRows.iface_scan_via_proxy = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 11;

							stageRows.iface_big_scrollbars = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 12;

							stageRows.iface_orderline_customer_notes = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_auto", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_skip_screen", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.iface_tax_included = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 16;

							stageRows.iface_start_categ_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 17;

							stageRows.iface_display_categ_images = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 18;

							stageRows.restrict_price_control = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 19;

							stageRows.set_maximum_difference = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 20;

							stageRows.receipt_header = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 21;

							stageRows.receipt_footer = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"active", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_line_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pricelist_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"company_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"barcode_nomenclature_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_manager_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_user_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.iface_tipproduct = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 33;

							stageRows.tip_product_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 34;

							stageRows.default_fiscal_position_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 35;

							stageRows.use_pricelist = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 36;

							stageRows.tax_regime = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 37;

							stageRows.tax_regime_selection = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"start_category", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.limit_categories = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"module_account", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.module_pos_restaurant = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 42;

							stageRows.module_pos_discount = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 43;

							stageRows.module_pos_loyalty = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 44;

							stageRows.module_pos_mercury = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 45;

							stageRows.product_configurator = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							stageRows.is_header_or_footer = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 48;

							stageRows.module_pos_hr = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 49;

							stageRows.amount_authorized_diff = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 50;

							stageRows.other_devices = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 51;

							stageRows.rounding_method = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 52;

							stageRows.cash_rounding = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 53;

							stageRows.only_round_cash_method = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"manual_discount", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.ship_later = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"warehouse_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.picking_policy = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 59;

							stageRows.limited_products_loading = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_products_amount", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.product_load_background = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 62;

							stageRows.limited_partners_loading = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_partners_amount", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.partner_load_background = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_uid", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_date", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_uid", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_date", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.epson_printer_ip = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 70;

							stageRows.crm_team_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"down_payment_product_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
///////////////////////		
							...
							if (rowsMerged.iface_customer_facing_display_via_proxy != null) { //
								row_tLogRow_1[7] = String.valueOf(rowsMerged.iface_customer_facing_display_via_proxy);
							...
							if (rowsMerged.create_date != null) { //
								row_tLogRow_1[66] = FormatterUtils.format_Date(rowsMerged.create_date, "dd-MM-yyyy");
...
///////////////////////    			
							...
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (rowsMergedResult.iface_customer_facing_display_local != null) {
								sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_customer_facing_display_local);
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (rowsMergedResult.iface_print_via_proxy != null) {
								sb_tFileOutputDelimited_2.append(rowsMergedResult.iface_print_via_proxy);
							...
							if (rowsMergedResult.create_date != null) {
								sb_tFileOutputDelimited_2
										.append(FormatterUtils.format_Date(rowsMergedResult.create_date, "dd-MM-yyyy"));
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (rowsMergedResult.write_uid != null) {
								sb_tFileOutputDelimited_2.append(rowsMergedResult.write_uid);
							...
							if (rowsMergedResult.write_date != null) {
								sb_tFileOutputDelimited_2
										.append(FormatterUtils.format_Date(rowsMergedResult.write_date, "dd-MM-yyyy"));
							}
							sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
							if (rowsMergedResult.epson_printer_ip != null) {
								sb_tFileOutputDelimited_2.append(rowsMergedResult.epson_printer_ip);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:o6WObzGgunHPJ+0uvqQZhI7AM71ze45s02htQblY3JJvP/MjF5xv1bPwHculw8gGxc2Za8/r7MbpmEH316c5tjKSKIY=");
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:(stageFile,stageFile) | target node:tAdvancedHash_stageFile -
				// inputs:(stageFile) outputs:()
				// linked node: tMap_1 - inputs:(rawFile,stageFile) outputs:(delta)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_stageFile = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"id", "stageFile", temp, ex_tFileInputDelimited_1),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"picking_type_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"journal_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"invoice_journal_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.iface_cashdrawer = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							stageFile.iface_electronic_scale = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							stageFile.iface_customer_facing_display_via_proxy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 8;

							stageFile.iface_customer_facing_display_local = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							stageFile.iface_print_via_proxy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							stageFile.iface_scan_via_proxy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							stageFile.iface_big_scrollbars = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							stageFile.iface_orderline_customer_notes = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_auto", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_skip_screen", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.iface_tax_included = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							stageFile.iface_start_categ_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 17;

							stageFile.iface_display_categ_images = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 18;

							stageFile.restrict_price_control = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 19;

							stageFile.set_maximum_difference = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 20;

							stageFile.receipt_header = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 21;

							stageFile.receipt_footer = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"active", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_line_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"pricelist_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"company_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"barcode_nomenclature_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_manager_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_user_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.iface_tipproduct = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 33;

							stageFile.tip_product_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 34;

							stageFile.default_fiscal_position_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 35;

							stageFile.use_pricelist = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 36;

							stageFile.tax_regime = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 37;

							stageFile.tax_regime_selection = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"start_category", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.limit_categories = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"module_account", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.module_pos_restaurant = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 42;

							stageFile.module_pos_discount = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 43;

							stageFile.module_pos_loyalty = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 44;

							stageFile.module_pos_mercury = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 45;

							stageFile.product_configurator = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							stageFile.is_header_or_footer = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 48;

							stageFile.module_pos_hr = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 49;

							stageFile.amount_authorized_diff = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 50;

							stageFile.other_devices = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 51;

							stageFile.rounding_method = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 52;

							stageFile.cash_rounding = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 53;

							stageFile.only_round_cash_method = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"manual_discount", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.ship_later = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"warehouse_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.picking_policy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 59;

							stageFile.limited_products_loading = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_products_amount", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.product_load_background = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 62;

							stageFile.limited_partners_loading = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_partners_amount", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.partner_load_background = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_uid", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"create_date", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_uid", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"write_date", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.epson_printer_ip = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 70;

							stageFile.crm_team_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"down_payment_product_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "stageFile"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putPosConfigStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/putposconfigstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putPosConfigStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putPosConfigStage_DailyJob");
		}
...
/************************************************************************************************
 * 820374 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:36:02 PM CST
 ************************************************************************************************/