		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:eupUgRRYC2K5cMPAOgVcnWcS4W7+CuYqy5EeeY6PsgJwYDTimsjUp3HQmFZVWKv/6sgFF/dy8k1HwMm4WKyCWtzJRRE=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "posConfig_20221031.csv");
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"picking_type_id", "row2", temp, ex_tFileInputDelimited_2),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"journal_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"invoice_journal_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.iface_cashdrawer = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							row2.iface_electronic_scale = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							row2.iface_customer_facing_display_via_proxy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 8;

							row2.iface_customer_facing_display_local = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							row2.iface_print_via_proxy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 10;

							row2.iface_scan_via_proxy = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 11;

							row2.iface_big_scrollbars = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 12;

							row2.iface_orderline_customer_notes = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_auto", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_skip_screen", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.iface_tax_included = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 16;

							row2.iface_start_categ_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 17;

							row2.iface_display_categ_images = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 18;

							row2.restrict_price_control = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 19;

							row2.set_maximum_difference = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_line_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"barcode_nomenclature_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_manager_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_user_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.iface_tipproduct = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.default_fiscal_position_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.tax_regime_selection = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"start_category", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.limit_categories = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"module_account", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.module_pos_restaurant = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 42;

							row2.module_pos_discount = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 43;

							row2.module_pos_loyalty = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 44;

							row2.module_pos_mercury = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 45;

							row2.product_configurator = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.is_header_or_footer = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.amount_authorized_diff = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.rounding_method = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.only_round_cash_method = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"manual_discount", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"warehouse_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.limited_products_loading = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_products_amount", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.product_load_background = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 62;

							row2.limited_partners_loading = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_partners_amount", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							row2.partner_load_background = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							row2.epson_printer_ip = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"down_payment_product_id", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
///////////////////////		
							...
							if (row2.name != null) { //
								row_tLogRow_2[1] = String.valueOf(row2.name);

							} //

							if (row2.picking_type_id != null) { //
								row_tLogRow_2[2] = String.valueOf(row2.picking_type_id);

							} //

							if (row2.journal_id != null) { //
								row_tLogRow_2[3] = String.valueOf(row2.journal_id);

							} //

							if (row2.invoice_journal_id != null) { //
								row_tLogRow_2[4] = String.valueOf(row2.invoice_journal_id);

							} //

							if (row2.iface_cashdrawer != null) { //
								row_tLogRow_2[5] = String.valueOf(row2.iface_cashdrawer);

							} //

							if (row2.iface_electronic_scale != null) { //
								row_tLogRow_2[6] = String.valueOf(row2.iface_electronic_scale);

							} //

							if (row2.iface_customer_facing_display_via_proxy != null) { //
								row_tLogRow_2[7] = String.valueOf(row2.iface_customer_facing_display_via_proxy);

							} //

							if (row2.iface_customer_facing_display_local != null) { //
								row_tLogRow_2[8] = String.valueOf(row2.iface_customer_facing_display_local);

							} //

							if (row2.iface_print_via_proxy != null) { //
								row_tLogRow_2[9] = String.valueOf(row2.iface_print_via_proxy);

							} //

							if (row2.iface_scan_via_proxy != null) { //
								row_tLogRow_2[10] = String.valueOf(row2.iface_scan_via_proxy);

							} //

							if (row2.iface_big_scrollbars != null) { //
								row_tLogRow_2[11] = String.valueOf(row2.iface_big_scrollbars);

							} //

							if (row2.iface_orderline_customer_notes != null) { //
								row_tLogRow_2[12] = String.valueOf(row2.iface_orderline_customer_notes);

							} //

							if (row2.iface_print_auto != null) { //
								row_tLogRow_2[13] = String.valueOf(row2.iface_print_auto);

							} //

							if (row2.iface_print_skip_screen != null) { //
								row_tLogRow_2[14] = String.valueOf(row2.iface_print_skip_screen);

							} //

							if (row2.iface_tax_included != null) { //
								row_tLogRow_2[15] = String.valueOf(row2.iface_tax_included);

							} //

							if (row2.iface_start_categ_id != null) { //
								row_tLogRow_2[16] = String.valueOf(row2.iface_start_categ_id);

							} //

							if (row2.iface_display_categ_images != null) { //
								row_tLogRow_2[17] = String.valueOf(row2.iface_display_categ_images);

							} //

							if (row2.restrict_price_control != null) { //
								row_tLogRow_2[18] = String.valueOf(row2.restrict_price_control);

							} //

							if (row2.set_maximum_difference != null) { //
								row_tLogRow_2[19] = String.valueOf(row2.set_maximum_difference);

							} //

							if (row2.receipt_header != null) { //
								row_tLogRow_2[20] = String.valueOf(row2.receipt_header);

							} //

							if (row2.receipt_footer != null) { //
								row_tLogRow_2[21] = String.valueOf(row2.receipt_footer);

							} //

							if (row2.proxy_ip != null) { //
								row_tLogRow_2[22] = String.valueOf(row2.proxy_ip);

							} //

							if (row2.active != null) { //
								row_tLogRow_2[23] = String.valueOf(row2.active);

							} //

							if (row2.uuid != null) { //
								row_tLogRow_2[24] = String.valueOf(row2.uuid);

							} //

							if (row2.sequence_id != null) { //
								row_tLogRow_2[25] = String.valueOf(row2.sequence_id);

							} //

							if (row2.sequence_line_id != null) { //
								row_tLogRow_2[26] = String.valueOf(row2.sequence_line_id);

							} //

							if (row2.pricelist_id != null) { //
								row_tLogRow_2[27] = String.valueOf(row2.pricelist_id);

							} //

							if (row2.company_id != null) { //
								row_tLogRow_2[28] = String.valueOf(row2.company_id);

							} //

							if (row2.barcode_nomenclature_id != null) { //
								row_tLogRow_2[29] = String.valueOf(row2.barcode_nomenclature_id);

							} //

							if (row2.group_pos_manager_id != null) { //
								row_tLogRow_2[30] = String.valueOf(row2.group_pos_manager_id);

							} //

							if (row2.group_pos_user_id != null) { //
								row_tLogRow_2[31] = String.valueOf(row2.group_pos_user_id);

							} //

							if (row2.iface_tipproduct != null) { //
								row_tLogRow_2[32] = String.valueOf(row2.iface_tipproduct);

							} //

							if (row2.tip_product_id != null) { //
								row_tLogRow_2[33] = String.valueOf(row2.tip_product_id);

							} //

							if (row2.default_fiscal_position_id != null) { //
								row_tLogRow_2[34] = String.valueOf(row2.default_fiscal_position_id);

							} //

							if (row2.use_pricelist != null) { //
								row_tLogRow_2[35] = String.valueOf(row2.use_pricelist);

							} //

							if (row2.tax_regime != null) { //
								row_tLogRow_2[36] = String.valueOf(row2.tax_regime);

							} //

							if (row2.tax_regime_selection != null) { //
								row_tLogRow_2[37] = String.valueOf(row2.tax_regime_selection);

							} //

							if (row2.start_category != null) { //
								row_tLogRow_2[38] = String.valueOf(row2.start_category);

							} //

							if (row2.limit_categories != null) { //
								row_tLogRow_2[39] = String.valueOf(row2.limit_categories);

							} //

							if (row2.module_account != null) { //
								row_tLogRow_2[40] = String.valueOf(row2.module_account);

							} //

							if (row2.module_pos_restaurant != null) { //
								row_tLogRow_2[41] = String.valueOf(row2.module_pos_restaurant);

							} //

							if (row2.module_pos_discount != null) { //
								row_tLogRow_2[42] = String.valueOf(row2.module_pos_discount);

							} //

							if (row2.module_pos_loyalty != null) { //
								row_tLogRow_2[43] = String.valueOf(row2.module_pos_loyalty);

							} //

							if (row2.module_pos_mercury != null) { //
								row_tLogRow_2[44] = String.valueOf(row2.module_pos_mercury);

							} //

							if (row2.product_configurator != null) { //
								row_tLogRow_2[45] = String.valueOf(row2.product_configurator);

							} //

							if (row2.is_posbox != null) { //
								row_tLogRow_2[46] = String.valueOf(row2.is_posbox);

							} //

							if (row2.is_header_or_footer != null) { //
								row_tLogRow_2[47] = String.valueOf(row2.is_header_or_footer);

							} //

							if (row2.module_pos_hr != null) { //
								row_tLogRow_2[48] = String.valueOf(row2.module_pos_hr);

							} //

							if (row2.amount_authorized_diff != null) { //
								row_tLogRow_2[49] = String.valueOf(row2.amount_authorized_diff);

							} //

							if (row2.other_devices != null) { //
								row_tLogRow_2[50] = String.valueOf(row2.other_devices);

							} //

							if (row2.rounding_method != null) { //
								row_tLogRow_2[51] = String.valueOf(row2.rounding_method);

							} //

							if (row2.cash_rounding != null) { //
								row_tLogRow_2[52] = String.valueOf(row2.cash_rounding);

							} //

							if (row2.only_round_cash_method != null) { //
								row_tLogRow_2[53] = String.valueOf(row2.only_round_cash_method);

							} //

							if (row2.manual_discount != null) { //
								row_tLogRow_2[54] = String.valueOf(row2.manual_discount);

							} //

							if (row2.ship_later != null) { //
								row_tLogRow_2[55] = String.valueOf(row2.ship_later);

							} //

							if (row2.warehouse_id != null) { //
								row_tLogRow_2[56] = String.valueOf(row2.warehouse_id);

							} //

							if (row2.route_id != null) { //
								row_tLogRow_2[57] = String.valueOf(row2.route_id);

							} //

							if (row2.picking_policy != null) { //
								row_tLogRow_2[58] = String.valueOf(row2.picking_policy);

							} //

							if (row2.limited_products_loading != null) { //
								row_tLogRow_2[59] = String.valueOf(row2.limited_products_loading);

							} //

							if (row2.limited_products_amount != null) { //
								row_tLogRow_2[60] = String.valueOf(row2.limited_products_amount);

							} //

							if (row2.product_load_background != null) { //
								row_tLogRow_2[61] = String.valueOf(row2.product_load_background);

							} //

							if (row2.limited_partners_loading != null) { //
								row_tLogRow_2[62] = String.valueOf(row2.limited_partners_loading);

							} //

							if (row2.limited_partners_amount != null) { //
								row_tLogRow_2[63] = String.valueOf(row2.limited_partners_amount);

							} //

							if (row2.partner_load_background != null) { //
								row_tLogRow_2[64] = String.valueOf(row2.partner_load_background);

							} //

							if (row2.create_uid != null) { //
								row_tLogRow_2[65] = String.valueOf(row2.create_uid);

							} //

							if (row2.create_date != null) { //
								row_tLogRow_2[66] = FormatterUtils.format_Date(row2.create_date, "dd-MM-yyyy");

							} //

							if (row2.write_uid != null) { //
								row_tLogRow_2[67] = String.valueOf(row2.write_uid);

							} //

							if (row2.write_date != null) { //
								row_tLogRow_2[68] = FormatterUtils.format_Date(row2.write_date, "dd-MM-yyyy");

							} //

							if (row2.epson_printer_ip != null) { //
								row_tLogRow_2[69] = String.valueOf(row2.epson_printer_ip);

							} //

							if (row2.crm_team_id != null) { //
								row_tLogRow_2[70] = String.valueOf(row2.crm_team_id);

							} //

							if (row2.down_payment_product_id != null) { //
								row_tLogRow_2[71] = String.valueOf(row2.down_payment_product_id);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"picking_type_id", "row1", temp, ex_tFileInputDelimited_1),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"journal_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"invoice_journal_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.iface_cashdrawer = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							row1.iface_electronic_scale = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							row1.iface_customer_facing_display_via_proxy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 8;

							row1.iface_customer_facing_display_local = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							row1.iface_print_via_proxy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.iface_scan_via_proxy = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							row1.iface_big_scrollbars = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							row1.iface_orderline_customer_notes = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_auto", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"iface_print_skip_screen", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.iface_tax_included = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							row1.iface_start_categ_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 17;

							row1.iface_display_categ_images = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 18;

							row1.restrict_price_control = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 19;

							row1.set_maximum_difference = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence_line_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"barcode_nomenclature_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_manager_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"group_pos_user_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.iface_tipproduct = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.default_fiscal_position_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.tax_regime_selection = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"start_category", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.limit_categories = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"module_account", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.module_pos_restaurant = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 42;

							row1.module_pos_discount = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 43;

							row1.module_pos_loyalty = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 44;

							row1.module_pos_mercury = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 45;

							row1.product_configurator = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.is_header_or_footer = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.amount_authorized_diff = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.rounding_method = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.only_round_cash_method = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"manual_discount", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"warehouse_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.limited_products_loading = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_products_amount", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.product_load_background = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 62;

							row1.limited_partners_loading = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"limited_partners_amount", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.partner_load_background = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.epson_printer_ip = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"down_payment_product_id", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
///////////////////////		
							...
							if (row1.picking_type_id != null) { //
								row_tLogRow_1[2] = String.valueOf(row1.picking_type_id);

							} //

							if (row1.journal_id != null) { //
								row_tLogRow_1[3] = String.valueOf(row1.journal_id);

							} //

							if (row1.invoice_journal_id != null) { //
								row_tLogRow_1[4] = String.valueOf(row1.invoice_journal_id);

							} //

							if (row1.iface_cashdrawer != null) { //
								row_tLogRow_1[5] = String.valueOf(row1.iface_cashdrawer);

							} //

							if (row1.iface_electronic_scale != null) { //
								row_tLogRow_1[6] = String.valueOf(row1.iface_electronic_scale);

							} //

							if (row1.iface_customer_facing_display_via_proxy != null) { //
								row_tLogRow_1[7] = String.valueOf(row1.iface_customer_facing_display_via_proxy);

							} //

							if (row1.iface_customer_facing_display_local != null) { //
								row_tLogRow_1[8] = String.valueOf(row1.iface_customer_facing_display_local);

							} //

							if (row1.iface_print_via_proxy != null) { //
								row_tLogRow_1[9] = String.valueOf(row1.iface_print_via_proxy);

							} //

							if (row1.iface_scan_via_proxy != null) { //
								row_tLogRow_1[10] = String.valueOf(row1.iface_scan_via_proxy);

							} //

							if (row1.iface_big_scrollbars != null) { //
								row_tLogRow_1[11] = String.valueOf(row1.iface_big_scrollbars);

							} //

							if (row1.iface_orderline_customer_notes != null) { //
								row_tLogRow_1[12] = String.valueOf(row1.iface_orderline_customer_notes);

							} //

							if (row1.iface_print_auto != null) { //
								row_tLogRow_1[13] = String.valueOf(row1.iface_print_auto);

							} //

							if (row1.iface_print_skip_screen != null) { //
								row_tLogRow_1[14] = String.valueOf(row1.iface_print_skip_screen);

							} //

							if (row1.iface_tax_included != null) { //
								row_tLogRow_1[15] = String.valueOf(row1.iface_tax_included);

							} //

							if (row1.iface_start_categ_id != null) { //
								row_tLogRow_1[16] = String.valueOf(row1.iface_start_categ_id);

							} //

							if (row1.iface_display_categ_images != null) { //
								row_tLogRow_1[17] = String.valueOf(row1.iface_display_categ_images);

							} //

							if (row1.restrict_price_control != null) { //
								row_tLogRow_1[18] = String.valueOf(row1.restrict_price_control);

							} //

							if (row1.set_maximum_difference != null) { //
								row_tLogRow_1[19] = String.valueOf(row1.set_maximum_difference);

							} //

							if (row1.receipt_header != null) { //
								row_tLogRow_1[20] = String.valueOf(row1.receipt_header);

							} //

							if (row1.receipt_footer != null) { //
								row_tLogRow_1[21] = String.valueOf(row1.receipt_footer);

							} //

							if (row1.proxy_ip != null) { //
								row_tLogRow_1[22] = String.valueOf(row1.proxy_ip);

							} //

							if (row1.active != null) { //
								row_tLogRow_1[23] = String.valueOf(row1.active);

							} //

							if (row1.uuid != null) { //
								row_tLogRow_1[24] = String.valueOf(row1.uuid);

							} //

							if (row1.sequence_id != null) { //
								row_tLogRow_1[25] = String.valueOf(row1.sequence_id);

							} //

							if (row1.sequence_line_id != null) { //
								row_tLogRow_1[26] = String.valueOf(row1.sequence_line_id);

							} //

							if (row1.pricelist_id != null) { //
								row_tLogRow_1[27] = String.valueOf(row1.pricelist_id);

							} //

							if (row1.company_id != null) { //
								row_tLogRow_1[28] = String.valueOf(row1.company_id);

							} //

							if (row1.barcode_nomenclature_id != null) { //
								row_tLogRow_1[29] = String.valueOf(row1.barcode_nomenclature_id);

							} //

							if (row1.group_pos_manager_id != null) { //
								row_tLogRow_1[30] = String.valueOf(row1.group_pos_manager_id);

							} //

							if (row1.group_pos_user_id != null) { //
								row_tLogRow_1[31] = String.valueOf(row1.group_pos_user_id);

							} //

							if (row1.iface_tipproduct != null) { //
								row_tLogRow_1[32] = String.valueOf(row1.iface_tipproduct);

							} //

							if (row1.tip_product_id != null) { //
								row_tLogRow_1[33] = String.valueOf(row1.tip_product_id);

							} //

							if (row1.default_fiscal_position_id != null) { //
								row_tLogRow_1[34] = String.valueOf(row1.default_fiscal_position_id);

							} //

							if (row1.use_pricelist != null) { //
								row_tLogRow_1[35] = String.valueOf(row1.use_pricelist);

							} //

							if (row1.tax_regime != null) { //
								row_tLogRow_1[36] = String.valueOf(row1.tax_regime);

							} //

							if (row1.tax_regime_selection != null) { //
								row_tLogRow_1[37] = String.valueOf(row1.tax_regime_selection);

							} //

							if (row1.start_category != null) { //
								row_tLogRow_1[38] = String.valueOf(row1.start_category);

							} //

							if (row1.limit_categories != null) { //
								row_tLogRow_1[39] = String.valueOf(row1.limit_categories);

							} //

							if (row1.module_account != null) { //
								row_tLogRow_1[40] = String.valueOf(row1.module_account);

							} //

							if (row1.module_pos_restaurant != null) { //
								row_tLogRow_1[41] = String.valueOf(row1.module_pos_restaurant);

							} //

							if (row1.module_pos_discount != null) { //
								row_tLogRow_1[42] = String.valueOf(row1.module_pos_discount);

							} //

							if (row1.module_pos_loyalty != null) { //
								row_tLogRow_1[43] = String.valueOf(row1.module_pos_loyalty);

							} //

							if (row1.module_pos_mercury != null) { //
								row_tLogRow_1[44] = String.valueOf(row1.module_pos_mercury);

							} //

							if (row1.product_configurator != null) { //
								row_tLogRow_1[45] = String.valueOf(row1.product_configurator);

							} //

							if (row1.is_posbox != null) { //
								row_tLogRow_1[46] = String.valueOf(row1.is_posbox);

							} //

							if (row1.is_header_or_footer != null) { //
								row_tLogRow_1[47] = String.valueOf(row1.is_header_or_footer);

							} //

							if (row1.module_pos_hr != null) { //
								row_tLogRow_1[48] = String.valueOf(row1.module_pos_hr);

							} //

							if (row1.amount_authorized_diff != null) { //
								row_tLogRow_1[49] = String.valueOf(row1.amount_authorized_diff);

							} //

							if (row1.other_devices != null) { //
								row_tLogRow_1[50] = String.valueOf(row1.other_devices);

							} //

							if (row1.rounding_method != null) { //
								row_tLogRow_1[51] = String.valueOf(row1.rounding_method);

							} //

							if (row1.cash_rounding != null) { //
								row_tLogRow_1[52] = String.valueOf(row1.cash_rounding);

							} //

							if (row1.only_round_cash_method != null) { //
								row_tLogRow_1[53] = String.valueOf(row1.only_round_cash_method);

							} //

							if (row1.manual_discount != null) { //
								row_tLogRow_1[54] = String.valueOf(row1.manual_discount);

							} //

							if (row1.ship_later != null) { //
								row_tLogRow_1[55] = String.valueOf(row1.ship_later);

							} //

							if (row1.warehouse_id != null) { //
								row_tLogRow_1[56] = String.valueOf(row1.warehouse_id);

							} //

							if (row1.route_id != null) { //
								row_tLogRow_1[57] = String.valueOf(row1.route_id);

							} //

							if (row1.picking_policy != null) { //
								row_tLogRow_1[58] = String.valueOf(row1.picking_policy);

							} //

							if (row1.limited_products_loading != null) { //
								row_tLogRow_1[59] = String.valueOf(row1.limited_products_loading);

							} //

							if (row1.limited_products_amount != null) { //
								row_tLogRow_1[60] = String.valueOf(row1.limited_products_amount);

							} //

							if (row1.product_load_background != null) { //
								row_tLogRow_1[61] = String.valueOf(row1.product_load_background);

							} //

							if (row1.limited_partners_loading != null) { //
								row_tLogRow_1[62] = String.valueOf(row1.limited_partners_loading);

							} //

							if (row1.limited_partners_amount != null) { //
								row_tLogRow_1[63] = String.valueOf(row1.limited_partners_amount);

							} //

							if (row1.partner_load_background != null) { //
								row_tLogRow_1[64] = String.valueOf(row1.partner_load_background);

							} //

							if (row1.create_uid != null) { //
								row_tLogRow_1[65] = String.valueOf(row1.create_uid);

							} //

							if (row1.create_date != null) { //
								row_tLogRow_1[66] = FormatterUtils.format_Date(row1.create_date, "dd-MM-yyyy");

							} //

							if (row1.write_uid != null) { //
								row_tLogRow_1[67] = String.valueOf(row1.write_uid);

							} //

							if (row1.write_date != null) { //
								row_tLogRow_1[68] = FormatterUtils.format_Date(row1.write_date, "dd-MM-yyyy");

							} //

							if (row1.epson_printer_ip != null) { //
								row_tLogRow_1[69] = String.valueOf(row1.epson_printer_ip);

							} //

							if (row1.crm_team_id != null) { //
								row_tLogRow_1[70] = String.valueOf(row1.crm_team_id);

							} //

							if (row1.down_payment_product_id != null) { //
								row_tLogRow_1[71] = String.valueOf(row1.down_payment_product_id);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getPosConfigStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/getposconfigstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getPosConfigStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getPosConfigStage_DailyJob");
		}
...
/************************************************************************************************
 * 305577 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:35:37 PM CST
 ************************************************************************************************/