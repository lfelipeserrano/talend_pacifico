...
public class runPosConfigStage_DailyJob implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runPosConfigStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/runposconfigstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runPosConfigStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runPosConfigStage_DailyJob");
		}
...
/************************************************************************************************
 * 37171 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2022 at 10:49:21 PM CST
 ************************************************************************************************/