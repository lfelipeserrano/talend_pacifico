...
public class ProductAttributeProductTemplateRel implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ProductAttributeProductTemplateRel.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:m4S4rQqMfd2qaij27Ud3K8AlCXVnxqYMjaP37wiBWELtJZ5Fa2sIicDgOWt0K6fE+5HP4gEr391va2+lCMDPGcyekuk=");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ProductAttributeProductTemplateRel.class.getClassLoader()
					.getResourceAsStream(
							"pacifico/productattributeproducttemplaterel_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ProductAttributeProductTemplateRel.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : ProductAttributeProductTemplateRel");
		}
...
/************************************************************************************************
 * 39326 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:32:37 PM CST
 ************************************************************************************************/