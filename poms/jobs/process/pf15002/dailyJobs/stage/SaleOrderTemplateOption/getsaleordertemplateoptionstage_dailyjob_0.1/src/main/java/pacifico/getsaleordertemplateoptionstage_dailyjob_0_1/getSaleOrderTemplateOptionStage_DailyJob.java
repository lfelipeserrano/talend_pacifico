		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getSaleOrderTemplateOptionStage_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0QIUEGbIkHG9udC90B2nDkFipiveTo01afrlBkBYhZAz0szSehiHFTXfv7shl4EdY+BGUg2MuosyFap4x370HFfihKY=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "saleOrderTemplateOption_20221031.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "saleOrderTemplateOption.csv");
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob.length == 0) {
			...
			strReturn = new String(commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"quantity", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getSaleOrderTemplateOptionStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/getsaleordertemplateoptionstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getSaleOrderTemplateOptionStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getSaleOrderTemplateOptionStage_DailyJob");
        }
...
/************************************************************************************************
 *     118289 characters generated by Talend Open Studio for Data Integration 
