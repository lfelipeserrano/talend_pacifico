...
package pacifico.getsaleordertemplateoptionstage_dailyjob_0_1;
...
/**
 * Job: getSaleOrderTemplateOptionStage_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class getSaleOrderTemplateOptionStage_DailyJob implements TalendJob {
	...
	private final String jobName = "getSaleOrderTemplateOptionStage_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					getSaleOrderTemplateOptionStage_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getSaleOrderTemplateOptionStage_DailyJob.this,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:w7URfN87J79iQQix7sPLkKRfco6KUb9ktE2Rs6T5jbAlSGH7S+a4atdF6XmqtF15uTOi2m43AeogWemrGJnkfpdibVE=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "saleOrderTemplateOption_20221031.csv");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/stage", "saleOrderTemplateOption.csv");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob.length) {
					if (length < 1024
							&& commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob.length == 0) {
						commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_getSaleOrderTemplateOptionStage_DailyJob) {
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_order_template_id", "row2", temp, ex_tFileInputDelimited_2),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row2.quantity = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"quantity", "row2", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
///////////////////////		
							...
							if (row2.sale_order_template_id != null) { //
								row_tLogRow_2[1] = String.valueOf(row2.sale_order_template_id);

							} //

							if (row2.company_id != null) { //
								row_tLogRow_2[2] = String.valueOf(row2.company_id);
							...
							if (row2.uom_id != null) { //
								row_tLogRow_2[5] = String.valueOf(row2.uom_id);

							} //

							if (row2.quantity != null) { //
								row_tLogRow_2[6] = String.valueOf(row2.quantity);

							} //

							if (row2.create_uid != null) { //
								row_tLogRow_2[7] = String.valueOf(row2.create_uid);

							} //

							if (row2.create_date != null) { //
								row_tLogRow_2[8] = FormatterUtils.format_Date(row2.create_date, "dd-MM-yyyy");

							} //

							if (row2.write_uid != null) { //
								row_tLogRow_2[9] = String.valueOf(row2.write_uid);

							} //

							if (row2.write_date != null) { //
								row_tLogRow_2[10] = FormatterUtils.format_Date(row2.write_date, "dd-MM-yyyy");
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_order_template_id", "row1", temp, ex_tFileInputDelimited_1),
...
///////////////////////		
							...
							if (row1.sale_order_template_id != null) { //
								row_tLogRow_1[1] = String.valueOf(row1.sale_order_template_id);

							} //

							if (row1.company_id != null) { //
								row_tLogRow_1[2] = String.valueOf(row1.company_id);
							...
							if (row1.uom_id != null) { //
								row_tLogRow_1[5] = String.valueOf(row1.uom_id);

							} //

							if (row1.quantity != null) { //
								row_tLogRow_1[6] = String.valueOf(row1.quantity);

							} //

							if (row1.create_uid != null) { //
								row_tLogRow_1[7] = String.valueOf(row1.create_uid);

							} //

							if (row1.create_date != null) { //
								row_tLogRow_1[8] = FormatterUtils.format_Date(row1.create_date, "dd-MM-yyyy");

							} //

							if (row1.write_uid != null) { //
								row_tLogRow_1[9] = String.valueOf(row1.write_uid);

							} //

							if (row1.write_date != null) { //
								row_tLogRow_1[10] = FormatterUtils.format_Date(row1.write_date, "dd-MM-yyyy");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final getSaleOrderTemplateOptionStage_DailyJob getSaleOrderTemplateOptionStage_DailyJobClass = new getSaleOrderTemplateOptionStage_DailyJob();

		int exitCode = getSaleOrderTemplateOptionStage_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getSaleOrderTemplateOptionStage_DailyJob.class.getClassLoader()
					.getResourceAsStream("pacifico/getsaleordertemplateoptionstage_dailyjob_0_1/contexts/" + contextStr
							+ ".properties");
			if (inContext == null) {
				inContext = getSaleOrderTemplateOptionStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getSaleOrderTemplateOptionStage_DailyJob");
		}
...
/************************************************************************************************
 * 118289 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:39:05 PM CST
 ************************************************************************************************/