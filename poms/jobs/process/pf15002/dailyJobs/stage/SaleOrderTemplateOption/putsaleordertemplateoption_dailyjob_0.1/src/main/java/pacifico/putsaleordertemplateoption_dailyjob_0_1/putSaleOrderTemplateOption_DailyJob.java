		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(putSaleOrderTemplateOption_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","sale_order_template_id","company_id","name","product_id","uom_id","quantity","create_uid","create_date","write_uid","write_date",});        
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","sale_order_template_id","company_id","name","product_id","uom_id","quantity","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"uom_id", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"quantity", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"uom_id", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"quantity", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3Ybr5foeC7Aouz7MTOHDSuDXNDshCwo4qa6eE3PRpVmxcXEfRZ85YNwvrwpfmNfLHadlv/GuH1BJIS9qYLk23I4aYqw=");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"uom_id", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"quantity", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = putSaleOrderTemplateOption_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/putsaleordertemplateoption_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = putSaleOrderTemplateOption_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : putSaleOrderTemplateOption_DailyJob");
        }
...
/************************************************************************************************
 *     264637 characters generated by Talend Open Studio for Data Integration 
 *     on the November 2, 2022 at 11:24:05 PM CST
 ************************************************************************************************/