...
package pacifico.putsaleordertemplateoption_dailyjob_0_1;
...
/**
 * Job: putSaleOrderTemplateOption_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class putSaleOrderTemplateOption_DailyJob implements TalendJob {
	...
	private final String jobName = "putSaleOrderTemplateOption_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					putSaleOrderTemplateOption_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(putSaleOrderTemplateOption_DailyJob.this,
	...
	public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
		final static byte[] commonByteArrayLock_PACIFICO_putSaleOrderTemplateOption_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob.length == 0) {
						commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateOption_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_putSaleOrderTemplateOption_DailyJob) {
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "id", "sale_order_template_id", "company_id", "name", "product_id",
						"uom_id", "quantity", "create_uid", "create_date", "write_uid", "write_date", });
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "sale_order_template_id", "company_id", "name", "product_id",
						"uom_id", "quantity", "create_uid", "create_date", "write_uid", "write_date", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.quantity = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"quantity", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.quantity = null;
...
///////////////////////		
								...
								if (delta.sale_order_template_id != null) { //
									row_tLogRow_2[1] = String.valueOf(delta.sale_order_template_id);

								} //

								if (delta.company_id != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.company_id);
								...
								if (delta.uom_id != null) { //
									row_tLogRow_2[5] = String.valueOf(delta.uom_id);

								} //

								if (delta.quantity != null) { //
									row_tLogRow_2[6] = String.valueOf(delta.quantity);

								} //

								if (delta.create_uid != null) { //
									row_tLogRow_2[7] = String.valueOf(delta.create_uid);

								} //

								if (delta.create_date != null) { //
									row_tLogRow_2[8] = FormatterUtils.format_Date(delta.create_date, "dd-MM-yyyy");

								} //

								if (delta.write_uid != null) { //
									row_tLogRow_2[9] = String.valueOf(delta.write_uid);

								} //

								if (delta.write_date != null) { //
									row_tLogRow_2[10] = FormatterUtils.format_Date(delta.write_date, "dd-MM-yyyy");
...
///////////////////////		
								...
								if (rowsMerged.sale_order_template_id != null) { //
									row_tLogRow_1[1] = String.valueOf(rowsMerged.sale_order_template_id);

								} //

								if (rowsMerged.company_id != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.company_id);
								...
								if (rowsMerged.uom_id != null) { //
									row_tLogRow_1[5] = String.valueOf(rowsMerged.uom_id);

								} //

								if (rowsMerged.quantity != null) { //
									row_tLogRow_1[6] = String.valueOf(rowsMerged.quantity);

								} //

								if (rowsMerged.create_uid != null) { //
									row_tLogRow_1[7] = String.valueOf(rowsMerged.create_uid);

								} //

								if (rowsMerged.create_date != null) { //
									row_tLogRow_1[8] = FormatterUtils.format_Date(rowsMerged.create_date, "dd-MM-yyyy");

								} //

								if (rowsMerged.write_uid != null) { //
									row_tLogRow_1[9] = String.valueOf(rowsMerged.write_uid);

								} //

								if (rowsMerged.write_date != null) { //
									row_tLogRow_1[10] = FormatterUtils.format_Date(rowsMerged.write_date, "dd-MM-yyyy");
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.uom_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.quantity = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"quantity", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.quantity = null;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:fwas6YRN6mrw0Wweluae5KxOrCIOLeGoBzd4VicidOGNFEjGTKjeckHAftyqUb05SdOrJFXuYj/GIxoDyg+jD+KEoQA=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "saleOrderTemplateOption.csv";
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"uom_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.uom_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.quantity = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"quantity", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.quantity = null;
...
// Start of branch "stageFile"
	...
	public static void main(String[] args) {
		final putSaleOrderTemplateOption_DailyJob putSaleOrderTemplateOption_DailyJobClass = new putSaleOrderTemplateOption_DailyJob();

		int exitCode = putSaleOrderTemplateOption_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putSaleOrderTemplateOption_DailyJob.class.getClassLoader()
					.getResourceAsStream(
							"pacifico/putsaleordertemplateoption_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putSaleOrderTemplateOption_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putSaleOrderTemplateOption_DailyJob");
		}
...
/************************************************************************************************
 * 264661 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:39:26 PM CST
 ************************************************************************************************/