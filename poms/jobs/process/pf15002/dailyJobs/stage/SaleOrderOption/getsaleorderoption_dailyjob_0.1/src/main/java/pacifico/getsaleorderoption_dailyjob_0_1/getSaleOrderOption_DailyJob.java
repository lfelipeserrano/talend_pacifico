...
package pacifico.getsaleorderoption_dailyjob_0_1;
...
/**
 * Job: getSaleOrderOption_DailyJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getSaleOrderOption_DailyJob implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "getSaleOrderOption_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getSaleOrderOption_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getSaleOrderOption_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:8Ibk1n6QXo69q8Lx3vpJ3Q7lZihE0Y+YG5OJmWnNVfTd2OmfEgpNjKuDBpfDdL0Gd6zsf1MB9MiaT4LGY6TELWL1jT0=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "saleOrderOption_20221031.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "saleOrderOption.csv");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_getSaleOrderOption_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_getSaleOrderOption_DailyJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_getSaleOrderOption_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_getSaleOrderOption_DailyJob.length == 0) {
   					commonByteArray_PACIFICO_getSaleOrderOption_DailyJob = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_getSaleOrderOption_DailyJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_getSaleOrderOption_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getSaleOrderOption_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_getSaleOrderOption_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getSaleOrderOption_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_getSaleOrderOption_DailyJob) {
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_2 = 0;
					...
					columnIndexWithD_tFileInputDelimited_2 = 1;
							...
							row2.order_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 2;
					
							row2.line_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 4;
							...
							row2.product_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 5;
					
							row2.price_unit = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 6;
					
							row2.discount = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 7;
					
							row2.uom_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 8;
					
							row2.quantity = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
///////////////////////		
	    		...
	    		if(row2.price_unit != null) { //              
                 row_tLogRow_2[5]=    						    
				                String.valueOf(row2.price_unit)			
					          ;	
	    		...
	    		if(row2.create_date != null) { //              
                 row_tLogRow_2[11]=    						    
				                String.valueOf(row2.create_date)			
					          ;	
	    		...
	    		if(row2.write_date != null) { //              
                 row_tLogRow_2[13]=    						    
				                String.valueOf(row2.write_date)			
					          ;	
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.line_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 5;
							...
							row1.price_unit = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 6;
					
							row1.discount = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 7;
					
							row1.uom_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
	    		...
	    		if(row1.line_id != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.line_id)			
					          ;	
	    		...
	    		if(row1.price_unit != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row1.price_unit)			
					          ;	
	    		...
	    		if(row1.write_date != null) { //              
                 row_tLogRow_1[13]=    						    
				                String.valueOf(row1.write_date)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final getSaleOrderOption_DailyJob getSaleOrderOption_DailyJobClass = new getSaleOrderOption_DailyJob();

        int exitCode = getSaleOrderOption_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getSaleOrderOption_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/getsaleorderoption_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getSaleOrderOption_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getSaleOrderOption_DailyJob");
        }
...
/************************************************************************************************
 *     106895 characters generated by Talend Open Studio for Data Integration 
