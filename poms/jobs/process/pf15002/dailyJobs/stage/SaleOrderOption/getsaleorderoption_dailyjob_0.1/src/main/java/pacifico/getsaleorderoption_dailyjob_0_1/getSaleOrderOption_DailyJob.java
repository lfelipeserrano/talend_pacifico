		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:AaH5eGwbq0iQgS5ryz7RPB7lciH/f5GE+awKihLLbpfuWG/a0iyoSh2OKJohlSp8d6bGiaZM4rGTEK8UDAENVY7X3Ro=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/raw", "saleOrderOption_20221031.csv");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest(
							"libreriapacifico/stage", "saleOrderOption.csv");
...
///////////////////////		
							...
							if (row2.order_id != null) { //
								row_tLogRow_2[1] = String.valueOf(row2.order_id);

							} //

							if (row2.line_id != null) { //
								row_tLogRow_2[2] = String.valueOf(row2.line_id);

							} //

							if (row2.name != null) { //
								row_tLogRow_2[3] = String.valueOf(row2.name);
							...
							if (row2.price_unit != null) { //
								row_tLogRow_2[5] = String.valueOf(row2.price_unit);

							} //

							if (row2.discount != null) { //
								row_tLogRow_2[6] = String.valueOf(row2.discount);

							} //

							if (row2.uom_id != null) { //
								row_tLogRow_2[7] = String.valueOf(row2.uom_id);

							} //

							if (row2.quantity != null) { //
								row_tLogRow_2[8] = String.valueOf(row2.quantity);

							} //

							if (row2.sequence != null) { //
								row_tLogRow_2[9] = String.valueOf(row2.sequence);

							} //

							if (row2.create_uid != null) { //
								row_tLogRow_2[10] = String.valueOf(row2.create_uid);

							} //

							if (row2.create_date != null) { //
								row_tLogRow_2[11] = String.valueOf(row2.create_date);

							} //

							if (row2.write_uid != null) { //
								row_tLogRow_2[12] = String.valueOf(row2.write_uid);

							} //

							if (row2.write_date != null) { //
								row_tLogRow_2[13] = String.valueOf(row2.write_date);
...
///////////////////////		
							...
							if (row1.order_id != null) { //
								row_tLogRow_1[1] = String.valueOf(row1.order_id);

							} //

							if (row1.line_id != null) { //
								row_tLogRow_1[2] = String.valueOf(row1.line_id);
							...
							if (row1.price_unit != null) { //
								row_tLogRow_1[5] = String.valueOf(row1.price_unit);

							} //

							if (row1.discount != null) { //
								row_tLogRow_1[6] = String.valueOf(row1.discount);

							} //

							if (row1.uom_id != null) { //
								row_tLogRow_1[7] = String.valueOf(row1.uom_id);

							} //

							if (row1.quantity != null) { //
								row_tLogRow_1[8] = String.valueOf(row1.quantity);

							} //

							if (row1.sequence != null) { //
								row_tLogRow_1[9] = String.valueOf(row1.sequence);

							} //

							if (row1.create_uid != null) { //
								row_tLogRow_1[10] = String.valueOf(row1.create_uid);

							} //

							if (row1.create_date != null) { //
								row_tLogRow_1[11] = String.valueOf(row1.create_date);

							} //

							if (row1.write_uid != null) { //
								row_tLogRow_1[12] = String.valueOf(row1.write_uid);

							} //

							if (row1.write_date != null) { //
								row_tLogRow_1[13] = String.valueOf(row1.write_date);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getSaleOrderOption_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/getsaleorderoption_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getSaleOrderOption_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : getSaleOrderOption_DailyJob");
		}
...
/************************************************************************************************
 * 106895 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:37:24 PM CST
 ************************************************************************************************/