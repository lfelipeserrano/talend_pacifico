...
public class runSaleOrderOptionStage_DailyJob implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(runSaleOrderOptionStage_DailyJob.this,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runSaleOrderOptionStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/runsaleorderoptionstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runSaleOrderOptionStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runSaleOrderOptionStage_DailyJob");
		}
...
/************************************************************************************************
 * 37283 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:32:58 PM CST
 ************************************************************************************************/