		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(putSaleOrderOptionStage_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","order_id","line_id","name","product_id","price_unit","discount","uom_id","quantity","sequence","create_uid","create_date","write_uid","write_date",});        
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/christian/Downloads/delta.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","order_id","line_id","name","product_id","price_unit","discount","uom_id","quantity","sequence","create_uid","create_date","write_uid","write_date",});        
...
///////////////////////		
	    		...
	    		if(delta.product_id != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(delta.product_id)			
					          ;	
	    		...
	    		if(delta.price_unit != null) { //              
                 row_tLogRow_2[5]=    						    
				                String.valueOf(delta.price_unit)			
					          ;	
	    		...
	    		if(delta.create_date != null) { //              
                 row_tLogRow_2[11]=    						    
				                String.valueOf(delta.create_date)			
					          ;	
	    		...
	    		if(delta.write_date != null) { //              
                 row_tLogRow_2[13]=    						    
				                String.valueOf(delta.write_date)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.product_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(deltaRows.price_unit != null) {
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.price_unit
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
///////////////////////		
	    		...
	    		if(rowsMerged.order_id != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(rowsMerged.order_id)			
					          ;	
	    		...
	    		if(rowsMerged.line_id != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(rowsMerged.line_id)			
					          ;	
	    		...
	    		if(rowsMerged.product_id != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(rowsMerged.product_id)			
					          ;	
	    		...
	    		if(rowsMerged.price_unit != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(rowsMerged.price_unit)			
					          ;	
	    		...
	    		if(rowsMerged.discount != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(rowsMerged.discount)			
					          ;	
	    		...
	    		if(rowsMerged.uom_id != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(rowsMerged.uom_id)			
					          ;	
	    		...
	    		if(rowsMerged.quantity != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(rowsMerged.quantity)			
					          ;	
	    		...
	    		if(rowsMerged.create_date != null) { //              
                 row_tLogRow_1[11]=    						    
				                String.valueOf(rowsMerged.create_date)			
					          ;	
	    		...
	    		if(rowsMerged.write_date != null) { //              
                 row_tLogRow_1[13]=    						    
				                String.valueOf(rowsMerged.write_date)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            rowsMergedResult.order_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(rowsMergedResult.line_id != null) {
                        sb_tFileOutputDelimited_2.append(
                            rowsMergedResult.line_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_3 = 0;
					...
					columnIndexWithD_tFileInputDelimited_3 = 4;
							...
							stageRows.product_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 5;
					
							stageRows.price_unit = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
					...
					columnIndexWithD_tFileInputDelimited_3 = 10;
							...
							stageRows.create_uid = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
						
				
					columnIndexWithD_tFileInputDelimited_3 = 11;
					
							stageRows.create_date = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
					...
					columnIndexWithD_tFileInputDelimited_3 = 13;
							...
							stageRows.write_date = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:fxfSSQoGZof4Cx3NEwaa34wCCZOKoCsS2BxS6hfIWEmSOigrDvXEqbNwuRQWpifqUR3cjWgPxV2IgXEHobfx3lIdwiU=");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 4;
							...
							stageFile.product_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 5;
					
							stageFile.price_unit = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 10;
							...
							stageFile.create_uid = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 11;
					
							stageFile.create_date = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 13;
							...
							stageFile.write_date = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = putSaleOrderOptionStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/putsaleorderoptionstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = putSaleOrderOptionStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : putSaleOrderOptionStage_DailyJob");
        }
...
/************************************************************************************************
 *     242827 characters generated by Talend Open Studio for Data Integration 
 *     on the November 2, 2022 at 11:08:09 PM CST
 ************************************************************************************************/