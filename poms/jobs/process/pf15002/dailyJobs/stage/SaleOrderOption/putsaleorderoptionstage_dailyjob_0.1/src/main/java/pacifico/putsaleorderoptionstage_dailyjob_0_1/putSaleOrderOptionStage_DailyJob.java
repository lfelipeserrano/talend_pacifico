...
package pacifico.putsaleorderoptionstage_dailyjob_0_1;
...
/**
 * Job: putSaleOrderOptionStage_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class putSaleOrderOptionStage_DailyJob implements TalendJob {
	...
	private final String jobName = "putSaleOrderOptionStage_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					putSaleOrderOptionStage_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(putSaleOrderOptionStage_DailyJob.this,
	...
	public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
		final static byte[] commonByteArrayLock_PACIFICO_putSaleOrderOptionStage_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob.length == 0) {
						commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderOptionStage_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_putSaleOrderOptionStage_DailyJob) {
				...
				try {
					...
					this.price_unit = readString(dis);

					this.discount = readString(dis);

					this.uom_id = readString(dis);
					...
					this.create_date = readString(dis);

					this.write_uid = readString(dis);

					this.write_date = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.price_unit, dos);
				...
				writeString(this.create_date, dos);

				// String

				writeString(this.write_uid, dos);

				// String

				writeString(this.write_date, dos);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_2.length() == 0) {
					...
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("line_id");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("name");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("product_id");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("price_unit");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("discount");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("uom_id");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
				...
				util_tLogRow_1.addRow(new String[] { "id", "order_id", "line_id", "name", "product_id", "price_unit",
						"discount", "uom_id", "quantity", "sequence", "create_uid", "create_date", "write_uid",
						"write_date", });
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "order_id", "line_id", "name", "product_id", "price_unit",
						"discount", "uom_id", "quantity", "sequence", "create_uid", "create_date", "write_uid",
						"write_date", });
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							rawFile.id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 1;

							rawFile.order_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 2;

							rawFile.line_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							rawFile.product_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 5;

							rawFile.price_unit = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 6;

							rawFile.discount = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 7;

							rawFile.uom_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 8;

							rawFile.quantity = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 9;

							rawFile.sequence = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 10;

							rawFile.create_uid = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 11;

							rawFile.create_date = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 12;

							rawFile.write_uid = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 13;

							rawFile.write_date = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									delta_tmp.order_id = rawFile.order_id;
									delta_tmp.line_id = rawFile.line_id;
									delta_tmp.name = rawFile.name;
									delta_tmp.product_id = rawFile.product_id;
									delta_tmp.price_unit = rawFile.price_unit;
									delta_tmp.discount = rawFile.discount;
									delta_tmp.uom_id = rawFile.uom_id;
									delta_tmp.quantity = rawFile.quantity;
...
///////////////////////		
								...
								if (delta.order_id != null) { //
									row_tLogRow_2[1] = String.valueOf(delta.order_id);

								} //

								if (delta.line_id != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.line_id);

								} //

								if (delta.name != null) { //
									row_tLogRow_2[3] = String.valueOf(delta.name);

								} //

								if (delta.product_id != null) { //
									row_tLogRow_2[4] = String.valueOf(delta.product_id);

								} //

								if (delta.price_unit != null) { //
									row_tLogRow_2[5] = String.valueOf(delta.price_unit);

								} //

								if (delta.discount != null) { //
									row_tLogRow_2[6] = String.valueOf(delta.discount);

								} //

								if (delta.uom_id != null) { //
									row_tLogRow_2[7] = String.valueOf(delta.uom_id);

								} //

								if (delta.quantity != null) { //
									row_tLogRow_2[8] = String.valueOf(delta.quantity);

								} //

								if (delta.sequence != null) { //
									row_tLogRow_2[9] = String.valueOf(delta.sequence);

								} //

								if (delta.create_uid != null) { //
									row_tLogRow_2[10] = String.valueOf(delta.create_uid);

								} //

								if (delta.create_date != null) { //
									row_tLogRow_2[11] = String.valueOf(delta.create_date);

								} //

								if (delta.write_uid != null) { //
									row_tLogRow_2[12] = String.valueOf(delta.write_uid);

								} //

								if (delta.write_date != null) { //
									row_tLogRow_2[13] = String.valueOf(delta.write_date);
...
///////////////////////    			
								...
								if (deltaRows.order_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.order_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.line_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.line_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								...
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.product_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.product_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.price_unit != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.price_unit);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.discount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.discount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.uom_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.uom_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.quantity != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.quantity);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.sequence != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.sequence);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								...
								if (deltaRows.create_date != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.create_date);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								...
								if (deltaRows.write_date != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.write_date);
								}
...
// for output
								...
								rowsMerged.order_id = deltRows.order_id;
								rowsMerged.line_id = deltRows.line_id;
								rowsMerged.name = deltRows.name;
								rowsMerged.product_id = deltRows.product_id;
								rowsMerged.price_unit = deltRows.price_unit;
								rowsMerged.discount = deltRows.discount;
								rowsMerged.uom_id = deltRows.uom_id;
								rowsMerged.quantity = deltRows.quantity;
...
///////////////////////		
								...
								if (rowsMerged.order_id != null) { //
									row_tLogRow_1[1] = String.valueOf(rowsMerged.order_id);

								} //

								if (rowsMerged.line_id != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.line_id);

								} //

								if (rowsMerged.name != null) { //
									row_tLogRow_1[3] = String.valueOf(rowsMerged.name);

								} //

								if (rowsMerged.product_id != null) { //
									row_tLogRow_1[4] = String.valueOf(rowsMerged.product_id);

								} //

								if (rowsMerged.price_unit != null) { //
									row_tLogRow_1[5] = String.valueOf(rowsMerged.price_unit);

								} //

								if (rowsMerged.discount != null) { //
									row_tLogRow_1[6] = String.valueOf(rowsMerged.discount);

								} //

								if (rowsMerged.uom_id != null) { //
									row_tLogRow_1[7] = String.valueOf(rowsMerged.uom_id);

								} //

								if (rowsMerged.quantity != null) { //
									row_tLogRow_1[8] = String.valueOf(rowsMerged.quantity);

								} //

								if (rowsMerged.sequence != null) { //
									row_tLogRow_1[9] = String.valueOf(rowsMerged.sequence);

								} //

								if (rowsMerged.create_uid != null) { //
									row_tLogRow_1[10] = String.valueOf(rowsMerged.create_uid);

								} //

								if (rowsMerged.create_date != null) { //
									row_tLogRow_1[11] = String.valueOf(rowsMerged.create_date);

								} //

								if (rowsMerged.write_uid != null) { //
									row_tLogRow_1[12] = String.valueOf(rowsMerged.write_uid);

								} //

								if (rowsMerged.write_date != null) { //
									row_tLogRow_1[13] = String.valueOf(rowsMerged.write_date);
...
///////////////////////    			
								...
								if (rowsMergedResult.order_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.order_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.line_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.line_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.product_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.product_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.price_unit != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.price_unit);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.discount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.discount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.uom_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.uom_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.quantity != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.quantity);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.sequence != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.sequence);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (rowsMergedResult.create_date != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.create_date);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (rowsMergedResult.write_date != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.write_date);
								}
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							stageRows.id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 1;

							stageRows.order_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 2;

							stageRows.line_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
							...
							stageRows.product_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 5;

							stageRows.price_unit = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 6;

							stageRows.discount = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 7;

							stageRows.uom_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 8;

							stageRows.quantity = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 9;

							stageRows.sequence = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 10;

							stageRows.create_uid = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 11;

							stageRows.create_date = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 12;

							stageRows.write_uid = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 13;

							stageRows.write_date = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
							...
							rowsMerged.order_id = stageRows.order_id;
							rowsMerged.line_id = stageRows.line_id;
							rowsMerged.name = stageRows.name;
							rowsMerged.product_id = stageRows.product_id;
							rowsMerged.price_unit = stageRows.price_unit;
							rowsMerged.discount = stageRows.discount;
							rowsMerged.uom_id = stageRows.uom_id;
							rowsMerged.quantity = stageRows.quantity;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:MVS3qm3ODDoGKikycq2ivfGTcX66Yx1Xp1EXJKSOULYdW7ZLx71Tzod63qAKu09HHeeMYWFI26xQa+Rai/dGAcLWjhI=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "saleOrderOption.csv";
	...
	public static class stageFileStruct implements routines.system.IPersistableComparableLookupRow<stageFileStruct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.line_id = readString(dis, ois);
				...
				this.uom_id = readString(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.line_id = readString(dis, objectIn);

				this.name = readString(dis, objectIn);

				this.product_id = readString(dis, objectIn);

				this.price_unit = readString(dis, objectIn);

				this.discount = readString(dis, objectIn);

				this.uom_id = readString(dis, objectIn);

				this.quantity = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeString(this.line_id, dos, oos);
				...
				writeString(this.uom_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.line_id, dos, objectOut);

				writeString(this.name, dos, objectOut);

				writeString(this.product_id, dos, objectOut);

				writeString(this.price_unit, dos, objectOut);

				writeString(this.discount, dos, objectOut);

				writeString(this.uom_id, dos, objectOut);

				writeString(this.quantity, dos, objectOut);
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							stageFile.id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							stageFile.order_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							stageFile.line_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							stageFile.product_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							stageFile.price_unit = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 6;

							stageFile.discount = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 7;

							stageFile.uom_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 8;

							stageFile.quantity = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 9;

							stageFile.sequence = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							stageFile.create_uid = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 11;

							stageFile.create_date = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 12;

							stageFile.write_uid = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 13;

							stageFile.write_date = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "stageFile"
						if (stageFile != null) {
							...
							stageFile_HashRow.order_id = stageFile.order_id;

							stageFile_HashRow.line_id = stageFile.line_id;

							stageFile_HashRow.name = stageFile.name;

							stageFile_HashRow.product_id = stageFile.product_id;

							stageFile_HashRow.price_unit = stageFile.price_unit;

							stageFile_HashRow.discount = stageFile.discount;

							stageFile_HashRow.uom_id = stageFile.uom_id;

							stageFile_HashRow.quantity = stageFile.quantity;
	...
	public static void main(String[] args) {
		final putSaleOrderOptionStage_DailyJob putSaleOrderOptionStage_DailyJobClass = new putSaleOrderOptionStage_DailyJob();

		int exitCode = putSaleOrderOptionStage_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putSaleOrderOptionStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/putsaleorderoptionstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putSaleOrderOptionStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putSaleOrderOptionStage_DailyJob");
		}
...
/************************************************************************************************
 * 242851 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:37:54 PM CST
 ************************************************************************************************/