	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "id", "name", "type_tax_use", "tax_scope", "amount_type", "active",
						"company_id", "sequence", "amount", "description", "price_include", "include_base_amount",
						"is_base_affected", "analytic", "tax_group_id", "tax_exigibility",
						"cash_basis_transition_account_id", "country_id", "create_uid", "create_date", "write_uid",
						"write_date", });
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "name", "type_tax_use", "tax_scope", "amount_type", "active",
						"company_id", "sequence", "amount", "description", "price_include", "include_base_amount",
						"is_base_affected", "analytic", "tax_group_id", "tax_exigibility",
						"cash_basis_transition_account_id", "country_id", "create_uid", "create_date", "write_uid",
						"write_date", });
				...
				try {
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							rawFile.type_tax_use = fid_tFileInputDelimited_2
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"price_include", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"include_base_amount", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_base_affected", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"analytic", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"tax_group_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							rawFile.tax_exigibility = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 16;

							rawFile.cash_basis_transition_account_id = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"country_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
///////////////////////		
								...
								if (delta.type_tax_use != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.type_tax_use);

								} //

								if (delta.tax_scope != null) { //
									row_tLogRow_2[3] = String.valueOf(delta.tax_scope);

								} //

								if (delta.amount_type != null) { //
									row_tLogRow_2[4] = String.valueOf(delta.amount_type);
								...
								if (delta.sequence != null) { //
									row_tLogRow_2[7] = String.valueOf(delta.sequence);

								} //

								if (delta.amount != null) { //
									row_tLogRow_2[8] = String.valueOf(delta.amount);

								} //

								if (delta.description != null) { //
									row_tLogRow_2[9] = String.valueOf(delta.description);

								} //

								if (delta.price_include != null) { //
									row_tLogRow_2[10] = String.valueOf(delta.price_include);

								} //

								if (delta.include_base_amount != null) { //
									row_tLogRow_2[11] = String.valueOf(delta.include_base_amount);

								} //

								if (delta.is_base_affected != null) { //
									row_tLogRow_2[12] = String.valueOf(delta.is_base_affected);

								} //

								if (delta.analytic != null) { //
									row_tLogRow_2[13] = String.valueOf(delta.analytic);

								} //

								if (delta.tax_group_id != null) { //
									row_tLogRow_2[14] = String.valueOf(delta.tax_group_id);

								} //

								if (delta.tax_exigibility != null) { //
									row_tLogRow_2[15] = String.valueOf(delta.tax_exigibility);

								} //

								if (delta.cash_basis_transition_account_id != null) { //
									row_tLogRow_2[16] = String.valueOf(delta.cash_basis_transition_account_id);

								} //

								if (delta.country_id != null) { //
									row_tLogRow_2[17] = String.valueOf(delta.country_id);

								} //

								if (delta.create_uid != null) { //
									row_tLogRow_2[18] = String.valueOf(delta.create_uid);

								} //

								if (delta.create_date != null) { //
									row_tLogRow_2[19] = FormatterUtils.format_Date(delta.create_date, "dd-MM-yyyy");

								} //

								if (delta.write_uid != null) { //
									row_tLogRow_2[20] = String.valueOf(delta.write_uid);

								} //

								if (delta.write_date != null) { //
									row_tLogRow_2[21] = FormatterUtils.format_Date(delta.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								if (deltaRows.type_tax_use != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.type_tax_use);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.tax_scope != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.tax_scope);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.amount_type != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.amount_type);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								...
								if (deltaRows.amount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.amount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.description != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.description);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.price_include != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.price_include);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.include_base_amount != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.include_base_amount);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.is_base_affected != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.is_base_affected);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.analytic != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.analytic);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.tax_group_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.tax_group_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.tax_exigibility != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.tax_exigibility);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.cash_basis_transition_account_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.cash_basis_transition_account_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.country_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.country_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
///////////////////////		
								...
								if (rowsMerged.type_tax_use != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.type_tax_use);

								} //

								if (rowsMerged.tax_scope != null) { //
									row_tLogRow_1[3] = String.valueOf(rowsMerged.tax_scope);

								} //

								if (rowsMerged.amount_type != null) { //
									row_tLogRow_1[4] = String.valueOf(rowsMerged.amount_type);
								...
								if (rowsMerged.sequence != null) { //
									row_tLogRow_1[7] = String.valueOf(rowsMerged.sequence);

								} //

								if (rowsMerged.amount != null) { //
									row_tLogRow_1[8] = String.valueOf(rowsMerged.amount);

								} //

								if (rowsMerged.description != null) { //
									row_tLogRow_1[9] = String.valueOf(rowsMerged.description);

								} //

								if (rowsMerged.price_include != null) { //
									row_tLogRow_1[10] = String.valueOf(rowsMerged.price_include);

								} //

								if (rowsMerged.include_base_amount != null) { //
									row_tLogRow_1[11] = String.valueOf(rowsMerged.include_base_amount);

								} //

								if (rowsMerged.is_base_affected != null) { //
									row_tLogRow_1[12] = String.valueOf(rowsMerged.is_base_affected);

								} //

								if (rowsMerged.analytic != null) { //
									row_tLogRow_1[13] = String.valueOf(rowsMerged.analytic);

								} //

								if (rowsMerged.tax_group_id != null) { //
									row_tLogRow_1[14] = String.valueOf(rowsMerged.tax_group_id);

								} //

								if (rowsMerged.tax_exigibility != null) { //
									row_tLogRow_1[15] = String.valueOf(rowsMerged.tax_exigibility);

								} //

								if (rowsMerged.cash_basis_transition_account_id != null) { //
									row_tLogRow_1[16] = String.valueOf(rowsMerged.cash_basis_transition_account_id);

								} //

								if (rowsMerged.country_id != null) { //
									row_tLogRow_1[17] = String.valueOf(rowsMerged.country_id);

								} //

								if (rowsMerged.create_uid != null) { //
									row_tLogRow_1[18] = String.valueOf(rowsMerged.create_uid);

								} //

								if (rowsMerged.create_date != null) { //
									row_tLogRow_1[19] = FormatterUtils.format_Date(rowsMerged.create_date,
											"dd-MM-yyyy");

								} //

								if (rowsMerged.write_uid != null) { //
									row_tLogRow_1[20] = String.valueOf(rowsMerged.write_uid);

								} //

								if (rowsMerged.write_date != null) { //
									row_tLogRow_1[21] = FormatterUtils.format_Date(rowsMerged.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								if (rowsMergedResult.type_tax_use != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.type_tax_use);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.tax_scope != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.tax_scope);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.amount_type != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.amount_type);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								if (rowsMergedResult.amount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.amount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.description != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.description);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.price_include != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.price_include);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.include_base_amount != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.include_base_amount);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.is_base_affected != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.is_base_affected);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.analytic != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.analytic);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.tax_group_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.tax_group_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.tax_exigibility != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.tax_exigibility);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.cash_basis_transition_account_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.cash_basis_transition_account_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.country_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.country_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
				...
				try {
					...
					while (fid_tFileInputDelimited_3 != null && fid_tFileInputDelimited_3.nextRecord()) {
						...
						try {
							...
							stageRows.type_tax_use = fid_tFileInputDelimited_3
							...
							stageRows.amount_type = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.description = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"price_include", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"include_base_amount", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_base_affected", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"analytic", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"tax_group_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							stageRows.tax_exigibility = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);

							columnIndexWithD_tFileInputDelimited_3 = 16;

							stageRows.cash_basis_transition_account_id = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"country_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
...
///////////////////////		
							...
							if (rowsMerged.create_date != null) { //
								row_tLogRow_1[19] = FormatterUtils.format_Date(rowsMerged.create_date, "dd-MM-yyyy");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JafHU80OnRXmXthnIwelI8dhlxf+05a5pA89EUPenm/11Y68iYCcw+5eReaKDrprl7GC+JPC9gS05TDforA5x4d8S3c=");
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							stageFile.type_tax_use = fid_tFileInputDelimited_1
							...
							stageFile.amount_type = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"amount", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.description = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"price_include", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"include_base_amount", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"is_base_affected", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"analytic", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"tax_group_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							stageFile.tax_exigibility = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							stageFile.cash_basis_transition_account_id = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"country_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "stageFile"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putAccountTaxStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/putaccounttaxstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putAccountTaxStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putAccountTaxStage_DailyJob");
		}
...
/************************************************************************************************
 * 388696 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:34:15 PM CST
 ************************************************************************************************/