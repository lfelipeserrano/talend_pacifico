...
public class runAccountTaxStage_DailyJob implements TalendJob {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = runAccountTaxStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/runaccounttaxstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = runAccountTaxStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : runAccountTaxStage_DailyJob");
		}
...
/************************************************************************************************
 * 37193 characters generated by Talend Open Studio for Data Integration on the
 * December 7, 2022 at 11:31:54 PM CST
 ************************************************************************************************/