...
package pacifico.getaccounttaxstage_dailyjob_0_1;
...
/**
 * Job: getAccountTaxStage_DailyJob Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class getAccountTaxStage_DailyJob implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "getAccountTaxStage_DailyJob";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				getAccountTaxStage_DailyJob.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(getAccountTaxStage_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Bp2jLYcb5Sk2FZ8bNHAU9uXYuVEmSfJU9sIGSsHiGgsLyb8jEVkN6OE8kunYKN0FseQMQiA9WTLQkzzruyGtjwurInc=");
...
public void tS3Get_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_1 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/raw", "accountTax_20221031.csv");
...
public void tS3Get_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try{
		...
		com.amazonaws.services.s3.model.GetObjectRequest getObjectRequest_tS3Get_2 = new com.amazonaws.services.s3.model.GetObjectRequest("libreriapacifico/stage", "accountTax.csv");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_getAccountTaxStage_DailyJob = new byte[0];
    static byte[] commonByteArray_PACIFICO_getAccountTaxStage_DailyJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_getAccountTaxStage_DailyJob.length) {
				if(length < 1024 && commonByteArray_PACIFICO_getAccountTaxStage_DailyJob.length == 0) {
   					commonByteArray_PACIFICO_getAccountTaxStage_DailyJob = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_getAccountTaxStage_DailyJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_getAccountTaxStage_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getAccountTaxStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_getAccountTaxStage_DailyJob, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_getAccountTaxStage_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_getAccountTaxStage_DailyJob) {
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_2 = 2;
							...
							row2.type_tax_use = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 3;
					
							row2.tax_scope = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
						
				
					columnIndexWithD_tFileInputDelimited_2 = 4;
					
							row2.amount_type = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
					...
					columnIndexWithD_tFileInputDelimited_2 = 10;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.price_include = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_include", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									row2.price_include = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 11;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.include_base_amount = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"include_base_amount", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									row2.include_base_amount = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 12;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.is_base_affected = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_base_affected", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									row2.is_base_affected = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 13;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.analytic = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"analytic", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 14;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row2.tax_group_id = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"tax_group_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
    							
						} else {						
							
								
									row2.tax_group_id = null;
					...
					columnIndexWithD_tFileInputDelimited_2 = 16;
							...
							row2.cash_basis_transition_account_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"country_id", "row2", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
///////////////////////		
	    		...
	    		if(row2.type_tax_use != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(row2.type_tax_use)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.tax_scope != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(row2.tax_scope)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.amount_type != null) { //              
                 row_tLogRow_2[4]=    						    
				                String.valueOf(row2.amount_type)			
					          ;	
	    		...
	    		if(row2.price_include != null) { //              
                 row_tLogRow_2[10]=    						    
				                String.valueOf(row2.price_include)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.include_base_amount != null) { //              
                 row_tLogRow_2[11]=    						    
				                String.valueOf(row2.include_base_amount)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.is_base_affected != null) { //              
                 row_tLogRow_2[12]=    						    
				                String.valueOf(row2.is_base_affected)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.analytic != null) { //              
                 row_tLogRow_2[13]=    						    
				                String.valueOf(row2.analytic)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.tax_group_id != null) { //              
                 row_tLogRow_2[14]=    						    
				                String.valueOf(row2.tax_group_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.tax_exigibility != null) { //              
                 row_tLogRow_2[15]=    						    
				                String.valueOf(row2.tax_exigibility)			
					          ;	
							
	    		} //			
    			   				
	    		if(row2.cash_basis_transition_account_id != null) { //              
                 row_tLogRow_2[16]=    						    
				                String.valueOf(row2.cash_basis_transition_account_id)			
					          ;	
	    		...
	    		if(row2.country_id != null) { //              
                 row_tLogRow_2[17]=    						    
				                String.valueOf(row2.country_id)			
					          ;	
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.type_tax_use = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 3;
					
							row1.tax_scope = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 4;
					
							row1.amount_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
					...
					columnIndexWithD_tFileInputDelimited_1 = 10;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.price_include = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"price_include", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.price_include = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 11;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.include_base_amount = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"include_base_amount", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.include_base_amount = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 12;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.is_base_affected = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"is_base_affected", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.is_base_affected = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 13;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.analytic = ParserUtils.parseTo_Boolean(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"analytic", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 14;
						...
						if(temp.length() > 0) {
								...
								try {
    								...
    								row1.tax_group_id = ParserUtils.parseTo_Integer(temp);
    							
    							} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"tax_group_id", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
    							
						} else {						
							
								
									row1.tax_group_id = null;
					...
					columnIndexWithD_tFileInputDelimited_1 = 16;
							...
							row1.cash_basis_transition_account_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
	    		...
	    		if(row1.type_tax_use != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row1.type_tax_use)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.tax_scope != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row1.tax_scope)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.amount_type != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row1.amount_type)			
					          ;	
	    		...
	    		if(row1.price_include != null) { //              
                 row_tLogRow_1[10]=    						    
				                String.valueOf(row1.price_include)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.include_base_amount != null) { //              
                 row_tLogRow_1[11]=    						    
				                String.valueOf(row1.include_base_amount)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.is_base_affected != null) { //              
                 row_tLogRow_1[12]=    						    
				                String.valueOf(row1.is_base_affected)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.analytic != null) { //              
                 row_tLogRow_1[13]=    						    
				                String.valueOf(row1.analytic)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.tax_group_id != null) { //              
                 row_tLogRow_1[14]=    						    
				                String.valueOf(row1.tax_group_id)			
					          ;	
	    		...
	    		if(row1.tax_exigibility != null) { //              
                 row_tLogRow_1[15]=    						    
				                String.valueOf(row1.tax_exigibility)			
					          ;	
							
	    		} //			
    			   				
	    		if(row1.cash_basis_transition_account_id != null) { //              
                 row_tLogRow_1[16]=    						    
				                String.valueOf(row1.cash_basis_transition_account_id)			
					          ;	
	    		...
	    		if(row1.country_id != null) { //              
                 row_tLogRow_1[17]=    						    
				                String.valueOf(row1.country_id)			
					          ;	
 ...
 */
    ...
    public static void main(String[] args){
        final getAccountTaxStage_DailyJob getAccountTaxStage_DailyJobClass = new getAccountTaxStage_DailyJob();

        int exitCode = getAccountTaxStage_DailyJobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = getAccountTaxStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/getaccounttaxstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = getAccountTaxStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : getAccountTaxStage_DailyJob");
        }
...
/************************************************************************************************
 *     159745 characters generated by Talend Open Studio for Data Integration 
 *     on the December 5, 2022 at 10:32:11 PM CST
 ************************************************************************************************/