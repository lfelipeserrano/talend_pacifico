...
package pacifico.putposbillstage_dailyjob_0_1;
...
/**
 * Job: putPosBillStage_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class putPosBillStage_DailyJob implements TalendJob {
	...
	private final String jobName = "putPosBillStage_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					putPosBillStage_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(putPosBillStage_DailyJob.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
		final static byte[] commonByteArrayLock_PACIFICO_putPosBillStage_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_putPosBillStage_DailyJob = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_putPosBillStage_DailyJob) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_2.length() == 0) {
					...
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("value");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
				...
				util_tLogRow_1.addRow(new String[] { "id", "name", "value", "create_uid", "create_date", "write_uid",
						"write_date", });
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "name", "value", "create_uid", "create_date", "write_uid",
						"write_date", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.name = ParserUtils.parseTo_Float(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"name", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.value = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"value", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
...
///////////////////////		
								...
								if (delta.name != null) { //
									row_tLogRow_2[1] = FormatterUtils.formatUnwithE(delta.name);

								} //

								if (delta.value != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.value);

								} //

								if (delta.create_uid != null) { //
									row_tLogRow_2[3] = String.valueOf(delta.create_uid);

								} //

								if (delta.create_date != null) { //
									row_tLogRow_2[4] = FormatterUtils.format_Date(delta.create_date, "dd-MM-yyyy");

								} //

								if (delta.write_uid != null) { //
									row_tLogRow_2[5] = String.valueOf(delta.write_uid);

								} //

								if (delta.write_date != null) { //
									row_tLogRow_2[6] = FormatterUtils.format_Date(delta.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.value != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.value);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
// for output
								...
								rowsMerged.value = deltRows.value;
...
///////////////////////		
								...
								if (rowsMerged.name != null) { //
									row_tLogRow_1[1] = FormatterUtils.formatUnwithE(rowsMerged.name);

								} //

								if (rowsMerged.value != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.value);

								} //

								if (rowsMerged.create_uid != null) { //
									row_tLogRow_1[3] = String.valueOf(rowsMerged.create_uid);

								} //

								if (rowsMerged.create_date != null) { //
									row_tLogRow_1[4] = FormatterUtils.format_Date(rowsMerged.create_date, "dd-MM-yyyy");

								} //

								if (rowsMerged.write_uid != null) { //
									row_tLogRow_1[5] = String.valueOf(rowsMerged.write_uid);

								} //

								if (rowsMerged.write_date != null) { //
									row_tLogRow_1[6] = FormatterUtils.format_Date(rowsMerged.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.value != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.value);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.name = ParserUtils.parseTo_Float(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"name", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.value = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"value", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.value = null;
...
// for output
							...
							rowsMerged.value = stageRows.value;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:HjwQ59lgo7L9lGn+GcAKFesjdTj1ww5W5sb8TQyhNC61n89N906gi2/W8wNBwdU8SU2h5rhNvmxbxIjUESv15LyrKp0=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "posBill.csv";
	...
	public static class stageFileStruct implements routines.system.IPersistableComparableLookupRow<stageFileStruct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.value = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				if (length == -1) {
					...
					this.name = objectIn.readFloat();
				}

				this.value = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.value, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				if (this.name == null) {
					...
					objectOut.writeFloat(this.name);
				}

				writeInteger(this.value, dos, objectOut);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.name = ParserUtils.parseTo_Float(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"name", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.value = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"value", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "stageFile"
						if (stageFile != null) {
							...
							stageFile_HashRow.value = stageFile.value;
	...
	public static void main(String[] args) {
		final putPosBillStage_DailyJob putPosBillStage_DailyJobClass = new putPosBillStage_DailyJob();

		int exitCode = putPosBillStage_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putPosBillStage_DailyJob.class.getClassLoader().getResourceAsStream(
					"pacifico/putposbillstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putPosBillStage_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putPosBillStage_DailyJob");
		}
...
/************************************************************************************************
 * 215410 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:35:19 PM CST
 ************************************************************************************************/