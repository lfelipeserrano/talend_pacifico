 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","name","value","create_uid","create_date","write_uid","write_date",});        
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"id","name","value","create_uid","create_date","write_uid","write_date",});        
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"name", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"value", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
///////////////////////		
	    		...
	    		if(delta.name != null) { //              
                 row_tLogRow_2[1]=    						
								FormatterUtils.formatUnwithE(delta.name)
					          ;	
...
///////////////////////		
	    		...
	    		if(rowsMerged.name != null) { //              
                 row_tLogRow_1[1]=    						
								FormatterUtils.formatUnwithE(rowsMerged.name)
					          ;	
	    		...
	    		if(rowsMerged.value != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(rowsMerged.value)			
					          ;	
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"name", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"value", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:d4EpURCEowMUxDgRHY3Ynm4jaY1c0LE5twA3oPTqu9moUQsBPYG+lTiumnDI/s0nGUg24FRhYHnZIj8cmA9cgN45eq4=");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"name", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"value", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = putPosBillStage_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/putposbillstage_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = putPosBillStage_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : putPosBillStage_DailyJob");
        }
...
/************************************************************************************************
 *     215386 characters generated by Talend Open Studio for Data Integration 
 *     on the November 2, 2022 at 10:36:30 PM CST
 ************************************************************************************************/