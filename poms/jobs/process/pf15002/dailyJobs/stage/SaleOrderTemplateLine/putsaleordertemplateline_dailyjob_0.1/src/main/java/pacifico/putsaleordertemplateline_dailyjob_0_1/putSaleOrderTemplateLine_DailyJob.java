...
package pacifico.putsaleordertemplateline_dailyjob_0_1;
...
/**
 * Job: putSaleOrderTemplateLine_DailyJob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class putSaleOrderTemplateLine_DailyJob implements TalendJob {
	...
	private final String jobName = "putSaleOrderTemplateLine_DailyJob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					putSaleOrderTemplateLine_DailyJob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(putSaleOrderTemplateLine_DailyJob.this,
	...
	public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
		final static byte[] commonByteArrayLock_PACIFICO_putSaleOrderTemplateLine_DailyJob = new byte[0];
		static byte[] commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob.length) {
					if (length < 1024 && commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob.length == 0) {
						commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob = new byte[1024];
					} else {
						commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_putSaleOrderTemplateLine_DailyJob) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (filetFileOutputDelimited_2.length() == 0) {
					...
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("sale_order_template_id");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					...
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("product_uom_qty");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("product_uom_id");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("display_type");
					outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
				...
				util_tLogRow_1.addRow(new String[] { "id", "sequence", "sale_order_template_id", "company_id", "name",
						"product_id", "product_uom_qty", "product_uom_id", "display_type", "create_uid", "create_date",
...
///////////////////////    			
				...
				util_tLogRow_2.addRow(new String[] { "id", "sequence", "sale_order_template_id", "company_id", "name",
						"product_id", "product_uom_qty", "product_uom_id", "display_type", "create_uid", "create_date",
						"write_uid", "write_date", });
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.sale_order_template_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_order_template_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.sale_order_template_id = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 3;

							rawFile.company_id = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.product_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.product_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.product_uom_qty = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_uom_qty", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.product_uom_qty = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rawFile.product_uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_uom_id", "rawFile", temp, ex_tFileInputDelimited_2),
											ex_tFileInputDelimited_2));
								}

							} else {

								rawFile.product_uom_id = null;

							}

							columnIndexWithD_tFileInputDelimited_2 = 8;

							rawFile.display_type = fid_tFileInputDelimited_2
...
// # Filter conditions 
								if (rejectedInnerJoin_tMap_1) {
									...
									delta_tmp.sale_order_template_id = rawFile.sale_order_template_id;
									delta_tmp.company_id = rawFile.company_id;
									delta_tmp.name = rawFile.name;
									delta_tmp.product_id = rawFile.product_id;
									delta_tmp.product_uom_qty = rawFile.product_uom_qty;
									delta_tmp.product_uom_id = rawFile.product_uom_id;
									delta_tmp.display_type = rawFile.display_type;
...
///////////////////////		
								...
								if (delta.sequence != null) { //
									row_tLogRow_2[1] = String.valueOf(delta.sequence);

								} //

								if (delta.sale_order_template_id != null) { //
									row_tLogRow_2[2] = String.valueOf(delta.sale_order_template_id);

								} //

								if (delta.company_id != null) { //
									row_tLogRow_2[3] = String.valueOf(delta.company_id);

								} //

								if (delta.name != null) { //
									row_tLogRow_2[4] = String.valueOf(delta.name);

								} //

								if (delta.product_id != null) { //
									row_tLogRow_2[5] = String.valueOf(delta.product_id);

								} //

								if (delta.product_uom_qty != null) { //
									row_tLogRow_2[6] = String.valueOf(delta.product_uom_qty);

								} //

								if (delta.product_uom_id != null) { //
									row_tLogRow_2[7] = String.valueOf(delta.product_uom_id);

								} //

								if (delta.display_type != null) { //
									row_tLogRow_2[8] = String.valueOf(delta.display_type);

								} //

								if (delta.create_uid != null) { //
									row_tLogRow_2[9] = String.valueOf(delta.create_uid);

								} //

								if (delta.create_date != null) { //
									row_tLogRow_2[10] = FormatterUtils.format_Date(delta.create_date, "dd-MM-yyyy");

								} //

								if (delta.write_uid != null) { //
									row_tLogRow_2[11] = String.valueOf(delta.write_uid);

								} //

								if (delta.write_date != null) { //
									row_tLogRow_2[12] = FormatterUtils.format_Date(delta.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.sale_order_template_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.sale_order_template_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								...
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.product_uom_qty != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.product_uom_qty);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.product_uom_id != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.product_uom_id);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (deltaRows.display_type != null) {
									sb_tFileOutputDelimited_1.append(deltaRows.display_type);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
// for output
								...
								rowsMerged.sale_order_template_id = deltRows.sale_order_template_id;
								rowsMerged.company_id = deltRows.company_id;
								rowsMerged.name = deltRows.name;
								rowsMerged.product_id = deltRows.product_id;
								rowsMerged.product_uom_qty = deltRows.product_uom_qty;
								rowsMerged.product_uom_id = deltRows.product_uom_id;
								rowsMerged.display_type = deltRows.display_type;
...
///////////////////////		
								...
								if (rowsMerged.sequence != null) { //
									row_tLogRow_1[1] = String.valueOf(rowsMerged.sequence);

								} //

								if (rowsMerged.sale_order_template_id != null) { //
									row_tLogRow_1[2] = String.valueOf(rowsMerged.sale_order_template_id);

								} //

								if (rowsMerged.company_id != null) { //
									row_tLogRow_1[3] = String.valueOf(rowsMerged.company_id);

								} //

								if (rowsMerged.name != null) { //
									row_tLogRow_1[4] = String.valueOf(rowsMerged.name);

								} //

								if (rowsMerged.product_id != null) { //
									row_tLogRow_1[5] = String.valueOf(rowsMerged.product_id);

								} //

								if (rowsMerged.product_uom_qty != null) { //
									row_tLogRow_1[6] = String.valueOf(rowsMerged.product_uom_qty);

								} //

								if (rowsMerged.product_uom_id != null) { //
									row_tLogRow_1[7] = String.valueOf(rowsMerged.product_uom_id);

								} //

								if (rowsMerged.display_type != null) { //
									row_tLogRow_1[8] = String.valueOf(rowsMerged.display_type);

								} //

								if (rowsMerged.create_uid != null) { //
									row_tLogRow_1[9] = String.valueOf(rowsMerged.create_uid);

								} //

								if (rowsMerged.create_date != null) { //
									row_tLogRow_1[10] = FormatterUtils.format_Date(rowsMerged.create_date,
											"dd-MM-yyyy");

								} //

								if (rowsMerged.write_uid != null) { //
									row_tLogRow_1[11] = String.valueOf(rowsMerged.write_uid);

								} //

								if (rowsMerged.write_date != null) { //
									row_tLogRow_1[12] = FormatterUtils.format_Date(rowsMerged.write_date, "dd-MM-yyyy");
...
///////////////////////    			
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.sale_order_template_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.sale_order_template_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								...
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.product_uom_qty != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.product_uom_qty);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.product_uom_id != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.product_uom_id);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
								if (rowsMergedResult.display_type != null) {
									sb_tFileOutputDelimited_2.append(rowsMergedResult.display_type);
								}
								sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.sale_order_template_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_order_template_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.sale_order_template_id = null;

							}

							columnIndexWithD_tFileInputDelimited_3 = 3;

							stageRows.company_id = fid_tFileInputDelimited_3
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.product_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.product_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.product_uom_qty = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_uom_qty", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.product_uom_qty = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageRows.product_uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_uom_id", "stageRows", temp, ex_tFileInputDelimited_3),
											ex_tFileInputDelimited_3));
								}

							} else {

								stageRows.product_uom_id = null;

							}

							columnIndexWithD_tFileInputDelimited_3 = 8;

							stageRows.display_type = fid_tFileInputDelimited_3
									.get(columnIndexWithD_tFileInputDelimited_3);
...
// for output
							...
							rowsMerged.sale_order_template_id = stageRows.sale_order_template_id;
							rowsMerged.company_id = stageRows.company_id;
							rowsMerged.name = stageRows.name;
							rowsMerged.product_id = stageRows.product_id;
							rowsMerged.product_uom_qty = stageRows.product_uom_qty;
							rowsMerged.product_uom_id = stageRows.product_uom_id;
							rowsMerged.display_type = stageRows.display_type;
...
///////////////////////		
							...
							if (rowsMerged.create_date != null) { //
								row_tLogRow_1[10] = FormatterUtils.format_Date(rowsMerged.create_date, "dd-MM-yyyy");
...
///////////////////////    			
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XpNrmTscDvF9KKsLNf9483OQTn3xRHUTf+Hu+ywCjCFq9e5PPfJtK8UD9nu8TUwLIZqfx/LQwVS1x5x9KnodPHHKeJ4=");
	...
	public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String key_tS3Put_1 = "saleOrderTemplateLine.csv";
	...
	public static class stageFileStruct implements routines.system.IPersistableComparableLookupRow<stageFileStruct> {
		...
		public void copyDataTo(stageFileStruct other) {
			...
			other.product_uom_id = this.product_uom_id;
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.sale_order_template_id = readInteger(dis, ois);
				...
				this.product_uom_qty = readInteger(dis, ois);

				this.product_uom_id = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.sale_order_template_id = readInteger(dis, objectIn);
				...
				this.product_uom_qty = readInteger(dis, objectIn);

				this.product_uom_id = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.sale_order_template_id, dos, oos);
				...
				writeInteger(this.product_uom_qty, dos, oos);

				writeInteger(this.product_uom_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.sale_order_template_id, dos, objectOut);
				...
				writeInteger(this.product_uom_qty, dos, objectOut);

				writeInteger(this.product_uom_id, dos, objectOut);
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sequence", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.sale_order_template_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"sale_order_template_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.sale_order_template_id = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 3;

							stageFile.company_id = fid_tFileInputDelimited_1
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.product_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.product_id = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.product_uom_qty = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_uom_qty", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.product_uom_qty = null;
							...
							if (temp.length() > 0) {
								...
								try {
									...
									stageFile.product_uom_id = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"product_uom_id", "stageFile", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}

							} else {

								stageFile.product_uom_id = null;

							}

							columnIndexWithD_tFileInputDelimited_1 = 8;

							stageFile.display_type = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "stageFile"
						if (stageFile != null) {
							...
							stageFile_HashRow.sale_order_template_id = stageFile.sale_order_template_id;
							...
							stageFile_HashRow.product_uom_qty = stageFile.product_uom_qty;

							stageFile_HashRow.product_uom_id = stageFile.product_uom_id;

							stageFile_HashRow.display_type = stageFile.display_type;
	...
	public static void main(String[] args) {
		final putSaleOrderTemplateLine_DailyJob putSaleOrderTemplateLine_DailyJobClass = new putSaleOrderTemplateLine_DailyJob();

		int exitCode = putSaleOrderTemplateLine_DailyJobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = putSaleOrderTemplateLine_DailyJob.class.getClassLoader()
					.getResourceAsStream(
							"pacifico/putsaleordertemplateline_dailyjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = putSaleOrderTemplateLine_DailyJob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : putSaleOrderTemplateLine_DailyJob");
		}
...
/************************************************************************************************
 * 282410 characters generated by Talend Open Studio for Data Integration on the
 * December 5, 2022 at 10:38:55 PM CST
 ************************************************************************************************/