		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(putSaleOrderTemplateLine_DailyJob.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class rowsMergedResultStruct implements routines.system.IPersistableRow<rowsMergedResultStruct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_PACIFICO_putSaleOrderTemplateLine_DailyJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sale_order_template_id", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_id", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_uom_qty", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
									rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_uom_id", "rawFile", temp, ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
								}
					...
					columnIndexWithD_tFileInputDelimited_2 = 8;
							...
							rawFile.display_type = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);
...
///////////////////////		
	    		...
	    		if(delta.sale_order_template_id != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(delta.sale_order_template_id)			
					          ;	
	    		...
	    		if(delta.product_uom_qty != null) { //              
                 row_tLogRow_2[6]=    						    
				                String.valueOf(delta.product_uom_qty)			
					          ;	
	    		...
	    		if(delta.product_uom_id != null) { //              
                 row_tLogRow_2[7]=    						    
				                String.valueOf(delta.product_uom_id)			
					          ;	
	    		...
	    		if(delta.display_type != null) { //              
                 row_tLogRow_2[8]=    						    
				                String.valueOf(delta.display_type)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.sale_order_template_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.product_uom_qty
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(deltaRows.product_uom_id != null) {
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.product_uom_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(deltaRows.display_type != null) {
                        sb_tFileOutputDelimited_1.append(
                            deltaRows.display_type
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
...
///////////////////////		
	    		...
	    		if(rowsMerged.sale_order_template_id != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(rowsMerged.sale_order_template_id)			
					          ;	
	    		...
	    		if(rowsMerged.product_uom_qty != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(rowsMerged.product_uom_qty)			
					          ;	
	    		...
	    		if(rowsMerged.product_uom_id != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(rowsMerged.product_uom_id)			
					          ;	
	    		...
	    		if(rowsMerged.display_type != null) { //              
                 row_tLogRow_1[8]=    						    
				                String.valueOf(rowsMerged.display_type)			
					          ;	
 ...
 */
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            rowsMergedResult.sale_order_template_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                        ...
                        sb_tFileOutputDelimited_2.append(
                            rowsMergedResult.product_uom_qty
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(rowsMergedResult.product_uom_id != null) {
                        sb_tFileOutputDelimited_2.append(
                            rowsMergedResult.product_uom_id
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(rowsMergedResult.display_type != null) {
                        sb_tFileOutputDelimited_2.append(
                            rowsMergedResult.display_type
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sale_order_template_id", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 3;
							...
							stageRows.company_id = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_id", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_uom_qty", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
...
globalMap.put("tFileInputDelimited_3_ERROR_MESSAGE",ex_tFileInputDelimited_3.getMessage());
									rowstate_tFileInputDelimited_3.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_uom_id", "stageRows", temp, ex_tFileInputDelimited_3), ex_tFileInputDelimited_3));
								}
					...
					columnIndexWithD_tFileInputDelimited_3 = 8;
							...
							stageRows.display_type = fid_tFileInputDelimited_3.get(columnIndexWithD_tFileInputDelimited_3);
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NqDvuMtrIrUbB2IYQwPw5DxwRuMQpSp9tEO7lFp18TNRQVS4VPJUiQQxO+4VZQfOzwyLZ4aIouSkOG5LBpImZlrgHLA=");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"sale_order_template_id", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 3;
							...
							stageFile.company_id = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_id", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_uom_qty", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"product_uom_id", "stageFile", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
					...
					columnIndexWithD_tFileInputDelimited_1 = 8;
							...
							stageFile.display_type = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = putSaleOrderTemplateLine_DailyJob.class.getClassLoader().getResourceAsStream("pacifico/putsaleordertemplateline_dailyjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = putSaleOrderTemplateLine_DailyJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : putSaleOrderTemplateLine_DailyJob");
        }
...
/************************************************************************************************
 *     282386 characters generated by Talend Open Studio for Data Integration 
 *     on the November 2, 2022 at 11:16:08 PM CST
 ************************************************************************************************/