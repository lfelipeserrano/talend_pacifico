...
package pacifico.saleorderoption_job_0_1;
...
/**
 * Job: saleOrderOption_Job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class saleOrderOption_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "saleOrderOption_Job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				saleOrderOption_Job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(saleOrderOption_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_saleOrderOption_Job = new byte[0];
    static byte[] commonByteArray_PACIFICO_saleOrderOption_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_saleOrderOption_Job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_saleOrderOption_Job.length == 0) {
   					commonByteArray_PACIFICO_saleOrderOption_Job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_saleOrderOption_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_saleOrderOption_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_saleOrderOption_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_saleOrderOption_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_saleOrderOption_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_saleOrderOption_Job) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrderOption_20221026.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Xryk6qzEICq6JnRfHjPJn/C9HaH+Ak8ZfMzc2HOi4m42bUXRAA==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  \"sale_order_option\".\"id\", \n  \"sale_order_option\".\"order_id\", \n  \"sale_order_option\".\"line_id\", \n "
+" \"sale_order_option\".\"name\", \n  \"sale_order_option\".\"product_id\", \n  \"sale_order_option\".\"price_unit\", \n  \""
+"sale_order_option\".\"discount\", \n  \"sale_order_option\".\"uom_id\", \n  \"sale_order_option\".\"quantity\", \n  \"sale_"
+"order_option\".\"sequence\", \n  \"sale_order_option\".\"create_uid\", \n  \"sale_order_option\".\"create_date\", \n  \"sal"
+"e_order_option\".\"write_uid\", \n  \"sale_order_option\".\"write_date\"\nFROM \"sale_order_option\"";
...
public void tS3Connection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:41NGkjPzAKexupWJ1S1OSO5ZL3x+9D+46dLlZG0DTnUg4VWYytUFzcfppF06rqVpGwJbup8ooeE3Ov/RnRZ1rE5cDfk=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "saleOrderOption_20221026.csv";
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrderOption_20221026.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final saleOrderOption_Job saleOrderOption_JobClass = new saleOrderOption_Job();

        int exitCode = saleOrderOption_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = saleOrderOption_Job.class.getClassLoader().getResourceAsStream("pacifico/saleorderoption_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = saleOrderOption_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrderOption_Job");
        }
...
/************************************************************************************************
 *     79898 characters generated by Talend Open Studio for Data Integration 
