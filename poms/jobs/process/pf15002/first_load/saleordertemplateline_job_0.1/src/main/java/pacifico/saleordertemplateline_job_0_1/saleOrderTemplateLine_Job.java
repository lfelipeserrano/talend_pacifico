...
package pacifico.saleordertemplateline_job_0_1;
...
/**
 * Job: saleOrderTemplateLine_Job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class saleOrderTemplateLine_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "saleOrderTemplateLine_Job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				saleOrderTemplateLine_Job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(saleOrderTemplateLine_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_saleOrderTemplateLine_Job = new byte[0];
    static byte[] commonByteArray_PACIFICO_saleOrderTemplateLine_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_saleOrderTemplateLine_Job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_saleOrderTemplateLine_Job.length == 0) {
   					commonByteArray_PACIFICO_saleOrderTemplateLine_Job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_saleOrderTemplateLine_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_saleOrderTemplateLine_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_saleOrderTemplateLine_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_saleOrderTemplateLine_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_saleOrderTemplateLine_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_saleOrderTemplateLine_Job) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrderTemplateLine_20221026.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("product_uom_qty");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("product_uom_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DrDj4+6eLG1jSTFOwWFBwYAtkSGW7IUFY9ZDXx4gPjyLMhbbcQ==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT \n  \"sale_order_template_line\".\"id\", \n  \"sale_order_template_line\".\"sequence\", \n  \"sale_order_template_l"
+"ine\".\"sale_order_template_id\", \n  \"sale_order_template_line\".\"company_id\", \n  \"sale_order_template_line\".\"name"
+"\", \n  \"sale_order_template_line\".\"product_id\", \n  \"sale_order_template_line\".\"product_uom_qty\", \n  \"sale_order"
+"_template_line\".\"product_uom_id\", \n  \"sale_order_template_line\".\"display_type\", \n  \"sale_order_template_line\"."
+"\"create_uid\", \n  \"sale_order_template_line\".\"create_date\", \n  \"sale_order_template_line\".\"write_uid\", \n  \"sal"
+"e_order_template_line\".\"write_date\"\nFROM \"sale_order_template_line\"";
            ...
            row1.sequence = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    row1.sequence = null;
            }
		                    }
            ...
            row1.sale_order_template_id = rs_tDBInput_1.getInt(3);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.company_id = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.company_id = null;
            }
		                    }
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.product_id = null;
							} else {
		                          
            row1.product_id = rs_tDBInput_1.getInt(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.product_id = null;
            }
		                    }
            ...
            row1.product_uom_qty = rs_tDBInput_1.getBigDecimal(7);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.product_uom_id = rs_tDBInput_1.getInt(8);
            if(rs_tDBInput_1.wasNull()){
                    row1.product_uom_id = null;
            }
		                    }
        	...
        	row1.display_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
...
public void tS3Connection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3equLM2VH+j+Ir5jKtcLsoDLZDvOF9mViMXAUw9NsrVJB1Ut2qGJJIOky5zVJMka8zM+dWtSM+fPhVk2qSrKgw0o0m0=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "saleOrderTemplateLine_20221026.csv";
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrderTemplateLine_20221026.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final saleOrderTemplateLine_Job saleOrderTemplateLine_JobClass = new saleOrderTemplateLine_Job();

        int exitCode = saleOrderTemplateLine_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = saleOrderTemplateLine_Job.class.getClassLoader().getResourceAsStream("pacifico/saleordertemplateline_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = saleOrderTemplateLine_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrderTemplateLine_Job");
        }
...
/************************************************************************************************
 *     79145 characters generated by Talend Open Studio for Data Integration 
 *     on the October 26, 2022 at 11:10:04 PM CST
 ************************************************************************************************/