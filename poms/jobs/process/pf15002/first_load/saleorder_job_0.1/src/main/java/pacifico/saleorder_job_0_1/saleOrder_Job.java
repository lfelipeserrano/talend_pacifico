...
package pacifico.saleorder_job_0_1;
...
/**
 * Job: saleOrder_Job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class saleOrder_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "saleOrder_Job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				saleOrder_Job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(saleOrder_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_saleOrder_Job = new byte[0];
    static byte[] commonByteArray_PACIFICO_saleOrder_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_saleOrder_Job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_saleOrder_Job.length == 0) {
   					commonByteArray_PACIFICO_saleOrder_Job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_saleOrder_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_saleOrder_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_saleOrder_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_saleOrder_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_saleOrder_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_saleOrder_Job) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrder_20221026.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:WBSK44QXIhIilcawZX2neQCu38AHRXZAf8DVgyueuVdLAACCjw==");
...
public void tS3Connection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:XrWBzzMaVMSDfjd8L9QNGJhfRejUvNWlXd0jFb1TiNd826ZHLUXJQWwvStStI/yytWqPfxaRNvGgyUenEgATxaDyUaE=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrder_20221026.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final saleOrder_Job saleOrder_JobClass = new saleOrder_Job();

        int exitCode = saleOrder_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = saleOrder_Job.class.getClassLoader().getResourceAsStream("pacifico/saleorder_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = saleOrder_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrder_Job");
        }
...
/************************************************************************************************
 *     119933 characters generated by Talend Open Studio for Data Integration 
