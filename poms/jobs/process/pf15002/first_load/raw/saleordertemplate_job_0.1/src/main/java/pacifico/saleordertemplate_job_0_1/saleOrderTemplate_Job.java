...
package pacifico.saleordertemplate_job_0_1;
...
/**
 * Job: saleOrderTemplate_Job Purpose: <br>
 * Description: <br>
 * 
 * @author
 ...
 * @status
 */
public class saleOrderTemplate_Job implements TalendJob {
	...
	private final String jobName = "saleOrderTemplate_Job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					saleOrderTemplate_Job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(saleOrderTemplate_Job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tS3Connection_3_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tS3Connection_3_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PACIFICO_saleOrderTemplate_Job = new byte[0];
		static byte[] commonByteArray_PACIFICO_saleOrderTemplate_Job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PACIFICO_saleOrderTemplate_Job.length) {
					if (length < 1024 && commonByteArray_PACIFICO_saleOrderTemplate_Job.length == 0) {
						commonByteArray_PACIFICO_saleOrderTemplate_Job = new byte[1024];
					} else {
						commonByteArray_PACIFICO_saleOrderTemplate_Job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PACIFICO_saleOrderTemplate_Job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_saleOrderTemplate_Job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PACIFICO_saleOrderTemplate_Job, 0, length);
				strReturn = new String(commonByteArray_PACIFICO_saleOrderTemplate_Job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PACIFICO_saleOrderTemplate_Job) {
				...
				try {
					...
					this.mail_template_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.mail_template_id, dos);
		...
		public String toString() {
			...
			sb.append(",mail_template_id=" + String.valueOf(mail_template_id));
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrderTemplate_20221026.csv"))
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:kc+PdiveAXvmFh7fofkMyKDlXJFae6uV72GOiioO78ifwdu8Tw==");
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"sale_order_template\".\"id\", \n  \"sale_order_template\".\"name\", \n  \"sale_order_template\".\"note\", \n  "
						+ "\"sale_order_template\".\"number_of_days\", \n  \"sale_order_template\".\"require_signature\", \n  \"sale_order_template\""
						+ ".\"require_payment\", \n  \"sale_order_template\".\"mail_template_id\", \n  \"sale_order_template\".\"active\", \n  \"sale_"
						+ "order_template\".\"company_id\", \n  \"sale_order_template\".\"create_uid\", \n  \"sale_order_template\".\"create_date\", "
						+ "\n  \"sale_order_template\".\"write_uid\", \n  \"sale_order_template\".\"write_date\"\nFROM \"sale_order_template\"";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.note = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.number_of_days = null;
						} else {

							row1.number_of_days = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								row1.number_of_days = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							row1.require_signature = rs_tDBInput_1.getBoolean(5);
							if (rs_tDBInput_1.wasNull()) {
								row1.require_signature = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row1.require_payment = rs_tDBInput_1.getBoolean(6);
							if (rs_tDBInput_1.wasNull()) {
								row1.require_payment = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							row1.mail_template_id = null;
						} else {

							row1.mail_template_id = rs_tDBInput_1.getInt(7);
							if (rs_tDBInput_1.wasNull()) {
								row1.mail_template_id = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row1.active = rs_tDBInput_1.getBoolean(8);
							if (rs_tDBInput_1.wasNull()) {
								row1.active = null;
							}
						}
						...
						if (colQtyInRs_tDBInput_1 < 10) {
							...
							row1.create_uid = rs_tDBInput_1.getInt(10);
							if (rs_tDBInput_1.wasNull()) {
								row1.create_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							...
							row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 11);
						}
						if (colQtyInRs_tDBInput_1 < 12) {
							row1.write_uid = null;
						} else {

							row1.write_uid = rs_tDBInput_1.getInt(12);
							if (rs_tDBInput_1.wasNull()) {
								row1.write_uid = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 13) {
							...
							row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 13);
						}
						...
						if (row1.number_of_days != null) {
							sb_tFileOutputDelimited_1.append(row1.number_of_days);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.require_signature != null) {
							sb_tFileOutputDelimited_1.append(row1.require_signature);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.require_payment != null) {
							sb_tFileOutputDelimited_1.append(row1.require_payment);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.mail_template_id != null) {
							sb_tFileOutputDelimited_1.append(row1.mail_template_id);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row1.active != null) {
	...
	public void tS3Connection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Eu/Ao5dtkkmPw46gx6dvW87ILhDahh80s8JzBGTDZwSe0b8Bc9onFFG5Xc8ZJ4GwCzqhdnwRHB2aMuVAAKOBzwM+4ec=");

				com.amazonaws.auth.AWSCredentials credentials_tS3Connection_3 = new com.amazonaws.auth.BasicAWSCredentials(
						"AKIAVMNG53PS4OCUVYGK", decryptedPassword_tS3Connection_3);
				com.amazonaws.auth.AWSCredentialsProvider credentialsProvider_tS3Connection_3 = new com.amazonaws.auth.AWSStaticCredentialsProvider(
						credentials_tS3Connection_3);
				...
				com.amazonaws.services.s3.AmazonS3ClientBuilder builder_tS3Connection_3 = com.amazonaws.services.s3.AmazonS3ClientBuilder
						.standard();
				...
				if (useRegionEndpoint_tS3Connection_3 && regionEndpoint_tS3Connection_3 != null
						&& !regionEndpoint_tS3Connection_3.isEmpty()) {
					builder_tS3Connection_3
							.withEndpointConfiguration(
									new com.amazonaws.client.builder.AwsClientBuilder.EndpointConfiguration(
											regionEndpoint_tS3Connection_3, null))
				...
				builder_tS3Connection_3.withCredentials(credentialsProvider_tS3Connection_3)
						.withClientConfiguration(cc_tS3Connection_3);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tS3Connection_3:OnSubjobOk", "",
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				com.amazonaws.services.s3.AmazonS3Client conn_tS3Put_1 = (com.amazonaws.services.s3.AmazonS3Client) globalMap
						.get("conn_tS3Connection_3");

				String key_tS3Put_1 = "saleOrderTemplate_20221026.csv";
				...
				Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/saleOrderTemplate_20221026.csv";
	...
	public static void main(String[] args) {
		final saleOrderTemplate_Job saleOrderTemplate_JobClass = new saleOrderTemplate_Job();

		int exitCode = saleOrderTemplate_JobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = saleOrderTemplate_Job.class.getClassLoader()
					.getResourceAsStream("pacifico/saleordertemplate_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = saleOrderTemplate_Job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrderTemplate_Job");
		}
	...
	private void closeS3Connections() {
		try {
			com.amazonaws.services.s3.AmazonS3Client conn_tS3Connection_3 = (com.amazonaws.services.s3.AmazonS3Client) globalMap
					.get("conn_tS3Connection_3");
...
/************************************************************************************************
 * 80606 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 12:10:28 AM CST
 ************************************************************************************************/