...
package pacifico.posbill_job_0_1;
...
/**
 * Job: posBill_Job Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class posBill_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "posBill_Job";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(posBill_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_posBill_Job = new byte[0];
    static byte[] commonByteArray_PACIFICO_posBill_Job = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_posBill_Job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_posBill_Job.length == 0) {
   					commonByteArray_PACIFICO_posBill_Job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_posBill_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_posBill_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_posBill_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_posBill_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_posBill_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_posBill_Job) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posBill_20221026.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:b7Dq5lvt0hWe1FJGWm2ugbedjiILDHNqjaOXW8U+AftMIbEFEg==");
...
public void tS3Connection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:5ZsiPZA3Ww50ofW8l5t40E9zlP8QZPxToXjy6Lf8E552HqtEMUdWFH6dFCIk6rezXxFhfyKstUEeR4Sc9I0bu9eW2H8=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "posBill_20221026.csv";
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/posBill_20221026.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final posBill_Job posBill_JobClass = new posBill_Job();

        int exitCode = posBill_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = posBill_Job.class.getClassLoader().getResourceAsStream("pacifico/posbill_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = posBill_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : posBill_Job");
        }
...
/************************************************************************************************
 *     70202 characters generated by Talend Open Studio for Data Integration 
