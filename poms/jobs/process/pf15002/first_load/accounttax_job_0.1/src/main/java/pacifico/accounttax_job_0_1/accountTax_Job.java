...
package pacifico.accounttax_job_0_1;
...
/**
 * Job: accountTax_Job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class accountTax_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "accountTax_Job";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				accountTax_Job.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(accountTax_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_PACIFICO_accountTax_Job = new byte[0];
    static byte[] commonByteArray_PACIFICO_accountTax_Job = new byte[0];
    ...
    public String loopKey;
			    ...
			    public Integer cash_basis_transition_account_id;

				public Integer getCash_basis_transition_account_id () {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PACIFICO_accountTax_Job.length) {
				if(length < 1024 && commonByteArray_PACIFICO_accountTax_Job.length == 0) {
   					commonByteArray_PACIFICO_accountTax_Job = new byte[1024];
				} else {
   					commonByteArray_PACIFICO_accountTax_Job = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PACIFICO_accountTax_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_accountTax_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PACIFICO_accountTax_Job, 0, length);
			strReturn = new String(commonByteArray_PACIFICO_accountTax_Job, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PACIFICO_accountTax_Job) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.tax_group_id = dis.readInt();
					
					this.tax_exigibility = readString(dis);
					
						this.cash_basis_transition_account_id = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.tax_group_id);
					...
					// Integer
						...
						writeInteger(this.cash_basis_transition_account_id,dos);
    ...
    public String toString() {
		...
		sb.append(",cash_basis_transition_account_id="+String.valueOf(cash_basis_transition_account_id));
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/accountTax_20221026.csv")).getAbsolutePath().replace("\\","/");
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("name");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("type_tax_use");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("tax_scope");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("amount_type");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        ...
                                        outtFileOutputDelimited_1.write("description");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("price_include");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("include_base_amount");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("is_base_affected");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("analytic");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("tax_group_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("tax_exigibility");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("cash_basis_transition_account_id");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:XZfmm+Qo8NLlVQnBToKjo2dDFinsFR7dKYtb/Fot8vdKrz9Z2w==");
...
+"\"tax_scope\", \n  \"account_tax\".\"amount_type\", \n  \"account_tax\".\"active\", \n  \"account_tax\".\"company_id\", \n  "
+"\"account_tax\".\"sequence\", \n  \"account_tax\".\"amount\", \n  \"account_tax\".\"description\", \n  \"account_tax\".\"pr"
+"ice_include\", \n  \"account_tax\".\"include_base_amount\", \n  \"account_tax\".\"is_base_affected\", \n  \"account_tax\"."
+"\"analytic\", \n  \"account_tax\".\"tax_group_id\", \n  \"account_tax\".\"tax_exigibility\", \n  \"account_tax\".\"cash_bas"
+"is_transition_account_id\", \n  \"account_tax\".\"country_id\", \n  \"account_tax\".\"create_uid\", \n  \"account_tax\".\"c"
+"reate_date\", \n  \"account_tax\".\"write_uid\", \n  \"account_tax\".\"write_date\"\nFROM \"account_tax\"";
        	...
        	row1.name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.type_tax_use = null;
							} else {
	                         		
        	row1.type_tax_use = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.tax_scope = null;
							} else {
	                         		
        	row1.tax_scope = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.amount_type = null;
							} else {
	                         		
        	row1.amount_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.active = null;
							} else {
	                         		
            row1.active = rs_tDBInput_1.getBoolean(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.active = null;
            }
		                    }
            ...
            row1.company_id = rs_tDBInput_1.getInt(7);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.sequence = rs_tDBInput_1.getInt(8);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.amount = rs_tDBInput_1.getBigDecimal(9);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.price_include = rs_tDBInput_1.getBoolean(11);
            if(rs_tDBInput_1.wasNull()){
                    row1.price_include = null;
            }
		                    }
            ...
            row1.include_base_amount = rs_tDBInput_1.getBoolean(12);
            if(rs_tDBInput_1.wasNull()){
                    row1.include_base_amount = null;
            }
		                    }
            ...
            row1.is_base_affected = rs_tDBInput_1.getBoolean(13);
            if(rs_tDBInput_1.wasNull()){
                    row1.is_base_affected = null;
            }
		                    }
            ...
            row1.analytic = rs_tDBInput_1.getBoolean(14);
            if(rs_tDBInput_1.wasNull()){
                    row1.analytic = null;
            }
		                    }
            ...
            row1.tax_group_id = rs_tDBInput_1.getInt(15);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.tax_exigibility = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.cash_basis_transition_account_id = null;
							} else {
		                          
            row1.cash_basis_transition_account_id = rs_tDBInput_1.getInt(17);
            if(rs_tDBInput_1.wasNull()){
                    row1.cash_basis_transition_account_id = null;
            }
		                    }
            ...
            row1.country_id = rs_tDBInput_1.getInt(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.create_uid = rs_tDBInput_1.getInt(19);
            if(rs_tDBInput_1.wasNull()){
                    row1.create_uid = null;
            }
		                    }
			...
			row1.create_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 20);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.write_uid = null;
							} else {
		                          
            row1.write_uid = rs_tDBInput_1.getInt(21);
            if(rs_tDBInput_1.wasNull()){
                    row1.write_uid = null;
            }
		                    }
			...
			row1.write_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 22);
		                    }
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            if(row1.amount != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.amount.setScale(0, java.math.RoundingMode.HALF_UP).toPlainString()
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.include_base_amount
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row1.is_base_affected != null) {
                        sb_tFileOutputDelimited_1.append(
                            row1.is_base_affected
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row1.cash_basis_transition_account_id
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        sb_tFileOutputDelimited_1.append(
...
public void tS3Connection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:17h8kZRfJ/xttSXKPukdaD25UXn4JmQKYRQz/oAZ0vzrjGbkCnoYMcRnBUDY9VYp9MQvKDjWLBcu3Zq7Tt42IghU4TY=");
...
public void tS3Put_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	String key_tS3Put_1 = "accountTax_20221026.csv";
	...
	Object fileOrStream_tS3Put_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/accountTax_20221026.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final accountTax_Job accountTax_JobClass = new accountTax_Job();

        int exitCode = accountTax_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = accountTax_Job.class.getClassLoader().getResourceAsStream("pacifico/accounttax_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = accountTax_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : accountTax_Job");
        }
...
/************************************************************************************************
 *     93838 characters generated by Talend Open Studio for Data Integration 
