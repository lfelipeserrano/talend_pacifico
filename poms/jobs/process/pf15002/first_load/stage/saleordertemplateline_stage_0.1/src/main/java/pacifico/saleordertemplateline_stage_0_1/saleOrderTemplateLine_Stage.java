...
package pacifico.saleordertemplateline_stage_0_1;
...
/**
 * Job: saleOrderTemplateLine_Stage Purpose: <br>
 * Description: Move account taxt data to stage <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class saleOrderTemplateLine_Stage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "saleOrderTemplateLine_Stage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				saleOrderTemplateLine_Stage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(saleOrderTemplateLine_Stage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:bSDcwjA56G4xY1nqGrIosmRH0KPyKbiYQe5Mx7dWdi+w0VioGYlHjTQu/KFIB5C6AaUpgmhVCn0aj3Awwoi9lj2Z3Bs=");
...
public void tS3Copy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    try{
        ...
        final String from_key_tS3Copy_1 = "saleOrderTemplateLine_20221026.csv";
        final String to_bucket_tS3Copy_1 = "libreriapacifico/stage"; 
        final String to_key_tS3Copy_1 = "saleOrderTemplateLine.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final saleOrderTemplateLine_Stage saleOrderTemplateLine_StageClass = new saleOrderTemplateLine_Stage();

        int exitCode = saleOrderTemplateLine_StageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = saleOrderTemplateLine_Stage.class.getClassLoader().getResourceAsStream("pacifico/saleordertemplateline_stage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = saleOrderTemplateLine_Stage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrderTemplateLine_Stage");
        }
...
/************************************************************************************************
 *     39242 characters generated by Talend Open Studio for Data Integration 
