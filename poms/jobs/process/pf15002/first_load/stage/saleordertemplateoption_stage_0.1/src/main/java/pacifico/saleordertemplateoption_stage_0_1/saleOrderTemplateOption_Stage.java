...
package pacifico.saleordertemplateoption_stage_0_1;
...
/**
 * Job: saleOrderTemplateOption_Stage Purpose: <br>
 * Description: Move account taxt data to stage <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class saleOrderTemplateOption_Stage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "saleOrderTemplateOption_Stage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				saleOrderTemplateOption_Stage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(saleOrderTemplateOption_Stage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:8hesTWsFcS3BjJOeLuHfzZdHIPM4104sNnj940YhG1yWnIEk7a+IkI45TMHuYoqtqUvYk0wKHCNQAwo97AtyyO3BDrY=");
...
public void tS3Copy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    try{
        ...
        final String from_key_tS3Copy_1 = "saleOrderTemplateOption_20221026.csv";
        final String to_bucket_tS3Copy_1 = "libreriapacifico/stage"; 
        final String to_key_tS3Copy_1 = "saleOrderTemplateOptioncsv";
 ...
 */
    ...
    public static void main(String[] args){
        final saleOrderTemplateOption_Stage saleOrderTemplateOption_StageClass = new saleOrderTemplateOption_Stage();

        int exitCode = saleOrderTemplateOption_StageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = saleOrderTemplateOption_Stage.class.getClassLoader().getResourceAsStream("pacifico/saleordertemplateoption_stage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = saleOrderTemplateOption_Stage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : saleOrderTemplateOption_Stage");
        }
...
/************************************************************************************************
 *     39273 characters generated by Talend Open Studio for Data Integration 
 *     on the October 27, 2022 at 12:08:12 AM CST
 ************************************************************************************************/