...
package pacifico.posconfig_stage_0_1;
...
/**
 * Job: posConfig_Stage Purpose: <br>
 * Description: Move account taxt data to stage <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class posConfig_Stage implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "posConfig_Stage";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				posConfig_Stage.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(posConfig_Stage.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tS3Connection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0dEuHx/6ePZezlV8E30WKpUtki/zQy1/be1UqorEAkp09ie8e9dGrPs5gUjAM4BkMzkGzIbP6ls+V0Ji3/9d8Mhfqbk=");
...
public void tS3Copy_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
    ...
    try{
        ...
        final String from_key_tS3Copy_1 = "posConfig_20221026.csv";
        final String to_bucket_tS3Copy_1 = "libreriapacifico/stage"; 
        final String to_key_tS3Copy_1 = "posConfig.csv";
 ...
 */
    ...
    public static void main(String[] args){
        final posConfig_Stage posConfig_StageClass = new posConfig_Stage();

        int exitCode = posConfig_StageClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = posConfig_Stage.class.getClassLoader().getResourceAsStream("pacifico/posconfig_stage_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = posConfig_Stage.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : posConfig_Stage");
        }
...
/************************************************************************************************
 *     39050 characters generated by Talend Open Studio for Data Integration 
