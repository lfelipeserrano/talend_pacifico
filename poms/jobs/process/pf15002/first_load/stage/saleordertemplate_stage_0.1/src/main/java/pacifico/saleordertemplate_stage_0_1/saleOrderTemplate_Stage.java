...
package pacifico.saleordertemplate_stage_0_1;
...
/**
 * Job: saleOrderTemplate_Stage Purpose: <br>
 ...
 * @status
 */
public class saleOrderTemplate_Stage implements TalendJob {
	...
	private final String jobName = "saleOrderTemplate_Stage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					saleOrderTemplate_Stage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(saleOrderTemplate_Stage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tS3Connection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:s8zM1p/MgajnliOSITSgJEVoNOvUkQXpYtDkCPzrrm6ppQpTuPmMqLwgStO8+KbQNZIFP+Fv2jm0+zMuj8qSV5TARJk=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					final String from_key_tS3Copy_1 = "saleOrderTemplate_20221026.csv";
					final String to_bucket_tS3Copy_1 = "libreriapacifico/stage";
					final String to_key_tS3Copy_1 = "saleOrderTemplate.csv";
	...
	public static void main(String[] args) {
		final saleOrderTemplate_Stage saleOrderTemplate_StageClass = new saleOrderTemplate_Stage();

		int exitCode = saleOrderTemplate_StageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = saleOrderTemplate_Stage.class.getClassLoader()
					.getResourceAsStream("pacifico/saleordertemplate_stage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = saleOrderTemplate_Stage.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : saleOrderTemplate_Stage");
		}
...
/************************************************************************************************
 * 39178 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 12:11:34 AM CST
 ************************************************************************************************/