...
package pacifico.moverawtostage_0_1;
...
/**
 * Job: MoveRawToStage Purpose: Move raw data to stage<br>
 * Description: Moving csv files in raw data to stage <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class MoveRawToStage implements TalendJob {
	...
	private final String jobName = "MoveRawToStage";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MoveRawToStage.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MoveRawToStage.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.accounttax_stage_0_1.accountTax_Stage childJob_tRunJob_1 = new pacifico.accounttax_stage_0_1.accountTax_Stage();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.posbill_stage_0_1.posBill_Stage childJob_tRunJob_2 = new pacifico.posbill_stage_0_1.posBill_Stage();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.posconfig_stage_0_1.posConfig_Stage childJob_tRunJob_3 = new pacifico.posconfig_stage_0_1.posConfig_Stage();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleorder_stage_0_1.saleOrder_Stage childJob_tRunJob_5 = new pacifico.saleorder_stage_0_1.saleOrder_Stage();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleorderoption_stage_0_1.saleOrderOption_Stage childJob_tRunJob_6 = new pacifico.saleorderoption_stage_0_1.saleOrderOption_Stage();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplate_stage_0_1.saleOrderTemplate_Stage childJob_tRunJob_7 = new pacifico.saleordertemplate_stage_0_1.saleOrderTemplate_Stage();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplateline_stage_0_1.saleOrderTemplateLine_Stage childJob_tRunJob_4 = new pacifico.saleordertemplateline_stage_0_1.saleOrderTemplateLine_Stage();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				pacifico.saleordertemplateoption_stage_0_1.saleOrderTemplateOption_Stage childJob_tRunJob_8 = new pacifico.saleordertemplateoption_stage_0_1.saleOrderTemplateOption_Stage();
				// pass DataSources
	...
	public static void main(String[] args) {
		final MoveRawToStage MoveRawToStageClass = new MoveRawToStage();

		int exitCode = MoveRawToStageClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MoveRawToStage.class.getClassLoader()
					.getResourceAsStream("pacifico/moverawtostage_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MoveRawToStage.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : MoveRawToStage");
		}
...
/************************************************************************************************
 * 79916 characters generated by Talend Open Studio for Data Integration on the
 * October 27, 2022 at 12:08:12 AM CST
 ************************************************************************************************/