...
package pacifico.parenttest_0_1;
 ...
 * @status
 */
public class ParentTest implements TalendJob {
	...
	private final String jobName = "ParentTest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ParentTest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_1 {
					private void transmitContext_0() {
						...
						paraList_tRunJob_1.add("--context_type " + "temp_path" + "=" + "id_String");
					}
				...
				pacifico.childtest_0_1.ChildTest childJob_tRunJob_1 = new pacifico.childtest_0_1.ChildTest();
				// pass DataSources
	...
	public static void main(String[] args) {
		final ParentTest ParentTestClass = new ParentTest();

		int exitCode = ParentTestClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ParentTest.class.getClassLoader()
					.getResourceAsStream("pacifico/parenttest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ParentTest.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ParentTest");
		}
 ...
 * January 25, 2023 at 10:49:35 PM CST
 ************************************************************************************************/